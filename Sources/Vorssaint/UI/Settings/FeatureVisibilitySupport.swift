...
enum SettingsPage: Hashable {
    ...
    case mouse, switcher, keyDebounce, cutPaste, autoQuit, uninstaller, urlCleaner, whatsAppDownloads, homebrew, media, clipboard, windowLayout, shelf, quickTools, textSnippets, screenshot, radialMenu
