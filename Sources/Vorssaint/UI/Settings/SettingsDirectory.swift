        ...
        return [
            ...
            (categories.windowsControls, [
                SettingsDirectoryItem(page: .mouse, title: s.tabMouse, icon: "computermouse",
                                      keywords: [s.mouseScrollingSection, s.invertMouseScroll,
                                                 s.invertVerticalScroll, s.invertHorizontalScroll,
                                                 s.scrollDirectionEnableButton,
                                                 s.middleClickTapPicker, s.smoothScrollName,
                                                 s.smoothScrollVerticalLabel, s.smoothScrollHorizontalLabel,
