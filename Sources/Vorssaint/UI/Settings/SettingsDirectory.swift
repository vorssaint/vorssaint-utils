    ...
    static func sections(_ s: Strings,
        ...
        return [
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .authenticator,
                                      title: FeatureStrings.authenticator(language).pageTitle,
                                      icon: "key.horizontal",
                                      keywords: [FeatureStrings.authenticator(language).paletteTitle,
                                                 FeatureStrings.authenticator(language).scanScreen,
                                                 "TOTP", "2FA", "OTP"]),
