                ...
                SettingsDirectoryItem(page: .mouse, title: s.tabMouse, icon: "computermouse",
                                       ...
                                       featureKeywords: [
                                        ...
                                        (.smoothScroll, [s.smoothScrollName,
                                                         s.smoothScrollVerticalLabel,
                                                         s.smoothScrollHorizontalLabel,
                                                         s.smoothScrollStepLabel,
                                                         s.smoothScrollStepCaption,
                                                         s.smoothScrollSpeedLabel,
                                                         s.smoothScrollSpeedCaption,
                                                         s.smoothScrollDurationLabel,
                                                         s.smoothScrollDurationCaption,
