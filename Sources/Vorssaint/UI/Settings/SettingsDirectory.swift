    ...
    static func sections(_ s: Strings,
        ...
        return [
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .keyOverrides,
                                      title: FeatureStrings.keyOverrides(language).pageTitle,
                                      icon: "keyboard.badge.ellipsis",
                                      keywords: [FeatureStrings.keyOverrides(language).keyDictation,
                                                 FeatureStrings.keyOverrides(language).keySpotlight,
                                                 FeatureStrings.keyOverrides(language).keyFocus,
                                                 FeatureStrings.keyOverrides(language).keyMissionControl,
                                                 FeatureStrings.keyOverrides(language).keyLaunchpad,
                                                 FeatureStrings.keyOverrides(language).actionMicMute,
                                                 "F3", "F4", "F5", "F6",
                                                 "F13", "F14", "F15", "F16", "F17", "F19", "F20"]),
