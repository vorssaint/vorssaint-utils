    ...
    static func sections(_ s: Strings,
        ...
        return [
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .selectionActions,
                                      title: FeatureStrings.selectionActions(language).pageTitle,
                                      icon: "selection.pin.in.out",
                                      keywords: [FeatureStrings.selectionActions(language).enableToggleTitle,
                                                 FeatureStrings.selectionActions(language).copyTitle,
                                                 FeatureStrings.selectionActions(language).translateTitle,
                                                 FeatureStrings.selectionActions(language).calculateTitle]),
