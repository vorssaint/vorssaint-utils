...
enum AppFeature: String, CaseIterable {
    ...
    case quickLauncher, quickToggles, colorPicker, screenOCR, cleaningMode, mediaTools,
         ...
         commandBar, screenRecorder, killProcess, eyeGuard
...
extension AppFeature {
    ...
    var group: FeatureGroup {
        ...
        case .quickLauncher, .quickToggles, .colorPicker, .screenOCR, .cleaningMode, .mediaTools,
             ...
             .scratchpad, .commandBar, .screenRecorder, .killProcess, .eyeGuard:
            return .tools
    ...
    var enabledKeys: [String] {
        ...
        case .eyeGuard: return [DefaultsKey.eyeGuardEnabled]
    ...
    var permissions: [AppPermission] {
        ...
        case .clipboardHistory, .shelf, .urlCleaner,
             ...
             .scratchpad, .monitorGPU, .monitorNetwork, .fanControl, .killProcess, .eyeGuard:
            return []
        }
    }
