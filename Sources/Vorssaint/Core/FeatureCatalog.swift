...
enum AppFeature: String, CaseIterable {
    ...
    case quickLauncher, quickToggles, colorPicker, screenOCR, cleaningMode, mediaTools,
         ...
         commandBar, screenRecorder, killProcess, portManager, notch, notchCalendar, notchNotifications, notchGestures, notchTimer, notchAccessories, notchLyrics, notchQueue, notchDownloads
...
extension AppFeature {
    ...
    var group: FeatureGroup {
        ...
        case .quickLauncher, .quickToggles, .colorPicker, .screenOCR, .cleaningMode, .mediaTools,
             ...
             .scratchpad, .commandBar, .screenRecorder, .killProcess, .portManager, .notch, .notchCalendar, .notchNotifications, .notchGestures, .notchTimer, .notchAccessories, .notchLyrics, .notchQueue, .notchDownloads:
            return .tools
