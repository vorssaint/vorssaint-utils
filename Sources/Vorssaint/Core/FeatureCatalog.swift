...
enum AppFeature: String, CaseIterable {
    ...
    case quickLauncher, quickToggles, colorPicker, screenOCR, cleaningMode, mediaTools,
         ...
         commandBar, screenRecorder, killProcess, liveTranslation
...
extension AppFeature {
    ...
    func monitorsPermissionChanges(boolFor: (String) -> Bool) -> Bool {
        ...
        case .screenOCR, .cleaningMode, .screenshot, .commandBar, .screenRecorder, .liveTranslation:
            return false
        default:
            return true
        }
    ...
    var group: FeatureGroup {
        ...
        case .quickLauncher, .quickToggles, .colorPicker, .screenOCR, .cleaningMode, .mediaTools,
             ...
             .scratchpad, .commandBar, .screenRecorder, .killProcess, .liveTranslation:
            return .tools
    ...
    var symbolName: String {
        ...
        case .liveTranslation: return "character.bubble"
        }
    }

    var availabilityKey: String { DefaultsKey.featureAvailable(rawValue) }

    var isBeta: Bool { self == .fanControl || self == .killProcess || self == .liveTranslation }
    ...
    var permissions: [AppPermission] {
        ...
        case .liveTranslation: return [.screenRecording]
