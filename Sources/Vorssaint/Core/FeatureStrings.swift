...
extension WindowLayoutFeatureStrings {
    static let ko = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "같은 디스플레이에서 절반, 2/3, 1/3 순으로 바뀝니다. 끄면 옆 디스플레이로 이동합니다.",
        gapNone: "없음",
        gapTiny: "아주 작게",
        gapSmall: "작게",
        gapMedium: "중간",
...
struct WindowLayoutFeatureStrings {
    ...
    static let ptBR = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "Metade, depois dois terços e um terço na mesma tela. Desligado, a repetição move a janela para a tela ao lado.",
        gapNone: "Nenhum",
        gapTiny: "Minúsculo",
        gapSmall: "Pequeno",
        gapMedium: "Médio",
    ...
    static let tr = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "Aynı ekranda yarım, ardından üçte iki ve üçte bir. Kapalıyken tekrar pencereyi yandaki ekrana taşır.",
        gapNone: "Yok",
        gapTiny: "Çok küçük",
        gapSmall: "Küçük",
        gapMedium: "Orta",
    ...
    static let ru = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "Половина, затем две трети и треть на том же дисплее. Если выключено, повтор переносит окно на соседний дисплей.",
        gapNone: "Нет",
        gapTiny: "Крошечный",
        gapSmall: "Маленький",
        gapMedium: "Средний",
    ...
    static let es = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "Mitad, luego dos tercios y un tercio en la misma pantalla. Desactivado, la repetición mueve la ventana a la pantalla contigua.",
        gapNone: "Ninguno",
        gapTiny: "Diminuto",
        gapSmall: "Pequeño",
        gapMedium: "Mediano",
    ...
    static let de = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "Hälfte, dann zwei Drittel und ein Drittel auf demselben Bildschirm. Ausgeschaltet schiebt die Wiederholung das Fenster auf den Nachbarbildschirm.",
        gapNone: "Kein",
        gapTiny: "Winzig",
        gapSmall: "Klein",
        gapMedium: "Mittel",
    ...
    static let fr = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "Moitié, puis deux tiers et un tiers sur le même écran. Désactivé, la répétition déplace la fenêtre vers l’écran voisin.",
        gapNone: "Aucun",
        gapTiny: "Minuscule",
        gapSmall: "Petit",
        gapMedium: "Moyen",
    ...
    static let it = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "Metà, poi due terzi e un terzo sullo stesso schermo. Se disattivato, la ripetizione sposta la finestra sullo schermo accanto.",
        gapNone: "Nessuno",
        gapTiny: "Minuscolo",
        gapSmall: "Piccolo",
        gapMedium: "Medio",
    ...
    static let ja = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "同じディスプレイで半分、2/3、1/3の順に変わります。オフの場合、繰り返すと隣のディスプレイへ移動します。",
        gapNone: "なし",
        gapTiny: "極小",
        gapSmall: "小",
        gapMedium: "中",
    ...
    static let zhHans = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "在同一显示器上依次切换为一半、三分之二和三分之一。关闭后，重复操作会把窗口移到相邻显示器。",
        gapNone: "无",
        gapTiny: "极小",
        gapSmall: "小",
        gapMedium: "中",
    ...
    static let zhTW = WindowLayoutFeatureStrings(
        ...
        sideRepeatCycleCaption: "在同一顯示器上依序切換為一半、三分之二和三分之一。關閉後，重複操作會把視窗移到相鄰的顯示器。",
        gapNone: "無",
        gapTiny: "極小",
        gapSmall: "小",
        gapMedium: "中",
