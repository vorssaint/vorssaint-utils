...
extension WindowLayoutFeatureStrings {
    static let ko = WindowLayoutFeatureStrings(
        ...
        topQuarter: "위쪽 1/4",
        upperCenterQuarter: "위쪽 가운데 1/4",
        lowerCenterQuarter: "아래쪽 가운데 1/4",
...
struct WindowLayoutFeatureStrings {
    ...
    let upperCenterQuarter: String
    let lowerCenterQuarter: String
    ...
    static let enUS = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Top 1/4",
        upperCenterQuarter: "Upper center 1/4",
        lowerCenterQuarter: "Lower center 1/4",
    ...
    static let ptBR = WindowLayoutFeatureStrings(
        ...
        topThird: "Topo 1/3",
        middleThird: "Meio 1/3",
        bottomThird: "Base 1/3",
        topTwoThirds: "Topo 2/3",
        bottomTwoThirds: "Base 2/3",
        topQuarter: "Topo 1/4",
        upperCenterQuarter: "Centro superior 1/4",
        lowerCenterQuarter: "Centro inferior 1/4",
        bottomQuarter: "Base 1/4",
    ...
    static let tr = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Üst 1/4",
        upperCenterQuarter: "Üst orta 1/4",
        lowerCenterQuarter: "Alt orta 1/4",
    ...
    static let ru = WindowLayoutFeatureStrings(
        ...
        upperCenterQuarter: "Верхняя средняя 1/4",
        lowerCenterQuarter: "Нижняя средняя 1/4",
    ...
    static let es = WindowLayoutFeatureStrings(
        ...
        centerTwoThirds: "2/3 centro",
        topThird: "Arriba 1/3",
        middleThird: "Medio 1/3",
        bottomThird: "Abajo 1/3",
        topTwoThirds: "Arriba 2/3",
        bottomTwoThirds: "Abajo 2/3",
        topQuarter: "Arriba 1/4",
        upperCenterQuarter: "Centro superior 1/4",
        lowerCenterQuarter: "Centro inferior 1/4",
        bottomQuarter: "Abajo 1/4",
    ...
    static let de = WindowLayoutFeatureStrings(
        ...
        topQuarter: "Oben 1/4",
        upperCenterQuarter: "Obere Mitte 1/4",
        lowerCenterQuarter: "Untere Mitte 1/4",
    ...
    static let fr = WindowLayoutFeatureStrings(
        ...
        topThird: "Haut 1/3",
        middleThird: "Milieu 1/3",
        bottomThird: "Bas 1/3",
        topTwoThirds: "Haut 2/3",
        bottomTwoThirds: "Bas 2/3",
        topQuarter: "Haut 1/4",
        upperCenterQuarter: "Centre haut 1/4",
        lowerCenterQuarter: "Centre bas 1/4",
        bottomQuarter: "Bas 1/4",
    ...
    static let it = WindowLayoutFeatureStrings(
        ...
        centerTwoThirds: "2/3 centro",
        topThird: "Alto 1/3",
        middleThird: "Centro 1/3",
        bottomThird: "Basso 1/3",
        topTwoThirds: "Alto 2/3",
        bottomTwoThirds: "Basso 2/3",
        topQuarter: "Alto 1/4",
        upperCenterQuarter: "Centro alto 1/4",
        lowerCenterQuarter: "Centro basso 1/4",
        bottomQuarter: "Basso 1/4",
    ...
    static let ja = WindowLayoutFeatureStrings(
        ...
        topQuarter: "上 1/4",
        upperCenterQuarter: "上中央 1/4",
        lowerCenterQuarter: "下中央 1/4",
        bottomQuarter: "下 1/4",
        leftQuarter: "左 1/4",
    ...
    static let zhHans = WindowLayoutFeatureStrings(
        ...
        bottomTwoThirds: "下 2/3",
        topQuarter: "上 1/4",
        upperCenterQuarter: "上中 1/4",
        lowerCenterQuarter: "下中 1/4",
        bottomQuarter: "下 1/4",
        leftQuarter: "左侧 1/4",
