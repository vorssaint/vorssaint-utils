...
struct MixerFeatureStrings {
    ...
    static let he = MixerFeatureStrings(hideInactiveApps: "הסתר אפליקציות לא פעילות", pin: "הצמד למעלה", unpin: "בטל הצמדה", moveUp: "הזז למעלה", moveDown: "הזז למטה", arrange: "החזק Command וגרור כדי לסדר מחדש")
}
