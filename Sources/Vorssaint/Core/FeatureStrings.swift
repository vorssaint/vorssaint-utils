...
extension WindowLayoutFeatureStrings {
    static let ko = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "상단 가장자리 스냅 레이아웃 패널",
        snapLayoutsCaption: "가장자리 스냅이 켜져 있을 때 창을 화면 위쪽으로 드래그하면 배치를 선택할 수 있는 패널이 표시됩니다.",
...
struct WindowLayoutFeatureStrings {
    ...
    let snapLayoutsEnable: String
    let snapLayoutsCaption: String
    ...
    static let enUS = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Snap Layouts panel at the top edge",
        snapLayoutsCaption: "While edge snapping is on, dragging a window to the top of the screen shows a panel of layout choices to drop it into.",
    ...
    static let ptBR = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Painel de disposições rápidas na borda superior",
        snapLayoutsCaption: "Com o encaixe nas bordas ativado, arrastar uma janela até o topo da tela mostra um painel com opções de disposição.",
    ...
    static let tr = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Üst kenarda Hızlı Yerleşim paneli",
        snapLayoutsCaption: "Kenara yerleştirme açıkken bir pencereyi ekranın üstüne sürüklemek, düzen seçeneklerinin olduğu bir panel gösterir.",
    ...
    static let ru = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Панель быстрых раскладок у верхнего края",
        snapLayoutsCaption: "Когда включена привязка к краям, перетаскивание окна к верхнему краю экрана показывает панель с вариантами раскладки.",
    ...
    static let es = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Panel de disposiciones rápidas en el borde superior",
        snapLayoutsCaption: "Con el ajuste a los bordes activado, arrastrar una ventana hacia la parte superior de la pantalla muestra un panel con opciones de disposición.",
    ...
    static let de = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Snap-Layouts-Panel am oberen Rand",
        snapLayoutsCaption: "Bei aktivierter Randanordnung zeigt das Ziehen eines Fensters an den oberen Bildschirmrand ein Panel mit Layout-Auswahl.",
    ...
    static let fr = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Panneau Snap Layouts en haut de l’écran",
        snapLayoutsCaption: "Lorsque l’ancrage aux bords est activé, faire glisser une fenêtre vers le haut de l’écran affiche un panneau de choix de disposition.",
    ...
    static let it = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "Pannello Snap Layouts al bordo superiore",
        snapLayoutsCaption: "Con l’allineamento ai bordi attivo, trascinare una finestra verso il bordo superiore dello schermo mostra un pannello tra cui scegliere la disposizione.",
    ...
    static let ja = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "上端のスナップレイアウトパネル",
        snapLayoutsCaption: "エッジスナップがオンのとき、ウインドウを画面上端にドラッグするとレイアウトを選べるパネルが表示されます。",
    ...
    static let zhHans = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "顶部边缘的贴靠布局面板",
        snapLayoutsCaption: "开启边缘贴靠后，将窗口拖到屏幕顶部会显示一个可选择布局的面板。",
    ...
    static let zhTW = WindowLayoutFeatureStrings(
        ...
        snapLayoutsEnable: "頂部邊緣的貼齊版面面板",
        snapLayoutsCaption: "開啟邊緣貼齊後，將視窗拖到螢幕頂部會顯示可選擇版面的面板。",
