...
struct WindowDirectionalStrings {
    ...
    static func localized(_ language: AppLanguage) -> WindowDirectionalStrings {
        ...
        case .uk: return .init(title: "Гарячі клавіші + вказівник", caption: "Утримуйте гарячі клавіші, перемістіть вказівник до краю або кута екрана та відпустіть, щоб розмістити активне вікно.")
        }
    }
}
