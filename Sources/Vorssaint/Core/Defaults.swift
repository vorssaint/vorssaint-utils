...
enum DefaultsKey {
    ...
    static let menuBarUsageBarUseSystemColor = "menuBarUsageBarUseSystemColor" // ignore threshold hex; use label color
...
enum Defaults {
    ...
    static let registeredDefaults: [String: Any] = [
        ...
        DefaultsKey.menuBarUsageBarUseSystemColor: false,
