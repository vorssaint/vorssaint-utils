...
struct MouseButtonFeatureStrings {
    ...
    let actionVolumeUp: String
    let actionVolumeDown: String
    let actionVolumeMute: String
    let actionMediaPlayPause: String
    let actionMediaPrevious: String
    let actionMediaNext: String
    let actionDisplayBrightnessUp: String
    let actionDisplayBrightnessDown: String
    let actionMissionControl: String
    let actionAppExpose: String
    let actionLaunchpad: String
    let actionShowDesktop: String
    let actionSpaceLeft: String
    let actionSpaceRight: String
    let actionMediaFastForward: String
    let actionMediaRewind: String
    let actionKeyboardBrightnessUp: String
    let actionKeyboardBrightnessDown: String
    let actionScrollUp: String
    let actionScrollDown: String
    let actionScrollLeft: String
    let actionScrollRight: String
    let repeatWhileHeld: String
...
extension MouseButtonFeatureStrings {
    static let enUS = MouseButtonFeatureStrings(
        ...
        actionVolumeMute: "Mute / unmute",
        actionMediaPlayPause: "Play / pause",
        actionMediaPrevious: "Previous track",
        actionMediaNext: "Next track",
        actionDisplayBrightnessUp: "Brightness +",
        actionDisplayBrightnessDown: "Brightness −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "Application windows",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Show desktop",
        actionSpaceLeft: "Move left a space",
        actionSpaceRight: "Move right a space",
        actionMediaFastForward: "Fast forward",
        actionMediaRewind: "Rewind",
        actionKeyboardBrightnessUp: "Keyboard brightness +",
        actionKeyboardBrightnessDown: "Keyboard brightness −",
        actionScrollUp: "Scroll up",
        actionScrollDown: "Scroll down",
        actionScrollLeft: "Scroll left",
        actionScrollRight: "Scroll right",
        repeatWhileHeld: "Repeat while held",
        removeButton: "Remove",
    ...
    static let ptBR = MouseButtonFeatureStrings(
        ...
        actionLabel: "Ação",
        actionShortcut: "Atalho",
        actionVolumeUp: "Volume +",
        actionVolumeDown: "Volume −",
        actionVolumeMute: "Silenciar / ativar som",
        actionMediaPlayPause: "Reproduzir / pausar",
        actionMediaPrevious: "Faixa anterior",
        actionMediaNext: "Próxima faixa",
        actionDisplayBrightnessUp: "Brilho +",
        actionDisplayBrightnessDown: "Brilho −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "Janelas do aplicativo",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Mostrar mesa",
        actionSpaceLeft: "Mover um espaço à esquerda",
        actionSpaceRight: "Mover um espaço à direita",
        actionMediaFastForward: "Avançar rápido",
        actionMediaRewind: "Retroceder",
        actionKeyboardBrightnessUp: "Aumentar brilho do teclado",
        actionKeyboardBrightnessDown: "Diminuir brilho do teclado",
        actionScrollUp: "Rolar para cima",
        actionScrollDown: "Rolar para baixo",
        actionScrollLeft: "Rolar para a esquerda",
        actionScrollRight: "Rolar para a direita",
        repeatWhileHeld: "Repetir enquanto mantém pressionado",
    ...
    static let tr = MouseButtonFeatureStrings(
        ...
        actionLabel: "Eylem",
        actionShortcut: "Kısayol",
        actionVolumeUp: "Ses +",
        actionVolumeDown: "Ses −",
        actionVolumeMute: "Sesi kapat / aç",
        actionMediaPlayPause: "Oynat / duraklat",
        actionMediaPrevious: "Önceki parça",
        actionMediaNext: "Sonraki parça",
        actionDisplayBrightnessUp: "Parlaklık +",
        actionDisplayBrightnessDown: "Parlaklık −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "Uygulama pencereleri",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Masaüstünü göster",
        actionSpaceLeft: "Bir alan sola git",
        actionSpaceRight: "Bir alan sağa git",
        actionMediaFastForward: "Hızlı ileri",
        actionMediaRewind: "Geri sar",
        actionKeyboardBrightnessUp: "Klavye parlaklığını artır",
        actionKeyboardBrightnessDown: "Klavye parlaklığını azalt",
        actionScrollUp: "Yukarı kaydır",
        actionScrollDown: "Aşağı kaydır",
        actionScrollLeft: "Sola kaydır",
        actionScrollRight: "Sağa kaydır",
        repeatWhileHeld: "Basılı tutarken tekrarla",
        removeButton: "Kaldır",
    ...
    static let ru = MouseButtonFeatureStrings(
        ...
        actionShortcut: "Сочетание клавиш",
        actionVolumeUp: "Громкость +",
        actionVolumeDown: "Громкость −",
        actionVolumeMute: "Вкл. / выкл. звук",
        actionMediaPlayPause: "Воспроизвести / пауза",
        actionMediaPrevious: "Предыдущий трек",
        actionMediaNext: "Следующий трек",
        actionDisplayBrightnessUp: "Яркость +",
        actionDisplayBrightnessDown: "Яркость −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "Окна приложения",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Показать рабочий стол",
        actionSpaceLeft: "Перейти влево по рабочим столам",
        actionSpaceRight: "Перейти вправо по рабочим столам",
        actionMediaFastForward: "Перемотать вперёд",
        actionMediaRewind: "Перемотать назад",
        actionKeyboardBrightnessUp: "Яркость клавиатуры +",
        actionKeyboardBrightnessDown: "Яркость клавиатуры −",
        actionScrollUp: "Прокрутить вверх",
        actionScrollDown: "Прокрутить вниз",
        actionScrollLeft: "Прокрутить влево",
        actionScrollRight: "Прокрутить вправо",
        repeatWhileHeld: "Повторять при удержании",
    ...
    static let es = MouseButtonFeatureStrings(
        ...
        actionLabel: "Acción",
        actionShortcut: "Atajo",
        actionVolumeUp: "Volumen +",
        actionVolumeDown: "Volumen −",
        actionVolumeMute: "Silenciar / activar sonido",
        actionMediaPlayPause: "Reproducir / pausar",
        actionMediaPrevious: "Pista anterior",
        actionMediaNext: "Pista siguiente",
        actionDisplayBrightnessUp: "Brillo +",
        actionDisplayBrightnessDown: "Brillo −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "Ventanas de la app",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Mostrar escritorio",
        actionSpaceLeft: "Ir a un espacio a la izquierda",
        actionSpaceRight: "Ir a un espacio a la derecha",
        actionMediaFastForward: "Avance rápido",
        actionMediaRewind: "Rebobinar",
        actionKeyboardBrightnessUp: "Subir brillo del teclado",
        actionKeyboardBrightnessDown: "Bajar brillo del teclado",
        actionScrollUp: "Desplazar arriba",
        actionScrollDown: "Desplazar abajo",
        actionScrollLeft: "Desplazar a la izquierda",
        actionScrollRight: "Desplazar a la derecha",
        repeatWhileHeld: "Repetir al mantener pulsado",
    ...
    static let de = MouseButtonFeatureStrings(
        ...
        actionLabel: "Aktion",
        actionShortcut: "Kurzbefehl",
        actionVolumeUp: "Lautstärke +",
        actionVolumeDown: "Lautstärke −",
        actionVolumeMute: "Stummschalten / Ton an",
        actionMediaPlayPause: "Wiedergabe / Pause",
        actionMediaPrevious: "Vorheriger Titel",
        actionMediaNext: "Nächster Titel",
        actionDisplayBrightnessUp: "Helligkeit +",
        actionDisplayBrightnessDown: "Helligkeit −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "App-Fenster",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Schreibtisch einblenden",
        actionSpaceLeft: "Einen Bereich nach links",
        actionSpaceRight: "Einen Bereich nach rechts",
        actionMediaFastForward: "Schneller Vorlauf",
        actionMediaRewind: "Zurückspulen",
        actionKeyboardBrightnessUp: "Tastatur heller",
        actionKeyboardBrightnessDown: "Tastatur dunkler",
        actionScrollUp: "Nach oben scrollen",
        actionScrollDown: "Nach unten scrollen",
        actionScrollLeft: "Nach links scrollen",
        actionScrollRight: "Nach rechts scrollen",
        repeatWhileHeld: "Beim Gedrückthalten wiederholen",
    ...
    static let fr = MouseButtonFeatureStrings(
        ...
        actionLabel: "Action",
        actionShortcut: "Raccourci",
        actionVolumeUp: "Volume +",
        actionVolumeDown: "Volume −",
        actionVolumeMute: "Couper / rétablir le son",
        actionMediaPlayPause: "Lire / mettre en pause",
        actionMediaPrevious: "Piste précédente",
        actionMediaNext: "Piste suivante",
        actionDisplayBrightnessUp: "Luminosité +",
        actionDisplayBrightnessDown: "Luminosité −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "Fenêtres de l’app",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Afficher le bureau",
        actionSpaceLeft: "Aller à l’espace de gauche",
        actionSpaceRight: "Aller à l’espace de droite",
        actionMediaFastForward: "Avance rapide",
        actionMediaRewind: "Rembobiner",
        actionKeyboardBrightnessUp: "Augmenter la luminosité du clavier",
        actionKeyboardBrightnessDown: "Baisser la luminosité du clavier",
        actionScrollUp: "Faire défiler vers le haut",
        actionScrollDown: "Faire défiler vers le bas",
        actionScrollLeft: "Faire défiler vers la gauche",
        actionScrollRight: "Faire défiler vers la droite",
        repeatWhileHeld: "Répéter tant que le bouton est maintenu",
    ...
    static let it = MouseButtonFeatureStrings(
        ...
        actionLabel: "Azione",
        actionShortcut: "Abbreviazione",
        actionVolumeUp: "Volume +",
        actionVolumeDown: "Volume −",
        actionVolumeMute: "Disattiva / attiva audio",
        actionMediaPlayPause: "Riproduci / pausa",
        actionMediaPrevious: "Brano precedente",
        actionMediaNext: "Brano successivo",
        actionDisplayBrightnessUp: "Luminosità +",
        actionDisplayBrightnessDown: "Luminosità −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "Finestre dell’app",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "Mostra scrivania",
        actionSpaceLeft: "Vai a uno spazio a sinistra",
        actionSpaceRight: "Vai a uno spazio a destra",
        actionMediaFastForward: "Avanzamento rapido",
        actionMediaRewind: "Riavvolgi",
        actionKeyboardBrightnessUp: "Aumenta luminosità tastiera",
        actionKeyboardBrightnessDown: "Riduci luminosità tastiera",
        actionScrollUp: "Scorri in alto",
        actionScrollDown: "Scorri in basso",
        actionScrollLeft: "Scorri a sinistra",
        actionScrollRight: "Scorri a destra",
        repeatWhileHeld: "Ripeti mentre tieni premuto",
    ...
    static let ja = MouseButtonFeatureStrings(
        ...
        actionVolumeUp: "音量 +",
        actionVolumeDown: "音量 −",
        actionVolumeMute: "消音 / 消音解除",
        actionMediaPlayPause: "再生 / 一時停止",
        actionMediaPrevious: "前のトラック",
        actionMediaNext: "次のトラック",
        actionDisplayBrightnessUp: "画面の明るさ +",
        actionDisplayBrightnessDown: "画面の明るさ −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "アプリケーションウインドウ",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "デスクトップを表示",
        actionSpaceLeft: "左の操作スペースへ移動",
        actionSpaceRight: "右の操作スペースへ移動",
        actionMediaFastForward: "早送り",
        actionMediaRewind: "巻き戻し",
        actionKeyboardBrightnessUp: "キーボードを明るくする",
        actionKeyboardBrightnessDown: "キーボードを暗くする",
        actionScrollUp: "上にスクロール",
        actionScrollDown: "下にスクロール",
        actionScrollLeft: "左にスクロール",
        actionScrollRight: "右にスクロール",
        repeatWhileHeld: "押している間くり返す",
        removeButton: "削除",
    ...
    static let ko = MouseButtonFeatureStrings(
        ...
        actionVolumeUp: "볼륨 +",
        actionVolumeDown: "볼륨 −",
        actionVolumeMute: "음소거 / 해제",
        actionMediaPlayPause: "재생 / 일시 정지",
        actionMediaPrevious: "이전 트랙",
        actionMediaNext: "다음 트랙",
        actionDisplayBrightnessUp: "화면 밝기 +",
        actionDisplayBrightnessDown: "화면 밝기 −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "앱 윈도우",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "데스크톱 보기",
        actionSpaceLeft: "왼쪽 공간으로 이동",
        actionSpaceRight: "오른쪽 공간으로 이동",
        actionMediaFastForward: "빨리 감기",
        actionMediaRewind: "되감기",
        actionKeyboardBrightnessUp: "키보드 밝기 높이기",
        actionKeyboardBrightnessDown: "키보드 밝기 낮추기",
        actionScrollUp: "위로 스크롤",
        actionScrollDown: "아래로 스크롤",
        actionScrollLeft: "왼쪽으로 스크롤",
        actionScrollRight: "오른쪽으로 스크롤",
        repeatWhileHeld: "누르고 있는 동안 반복",
        removeButton: "제거",
    ...
    static let zhHans = MouseButtonFeatureStrings(
        ...
        actionVolumeUp: "音量 +",
        actionVolumeDown: "音量 −",
        actionVolumeMute: "静音 / 取消静音",
        actionMediaPlayPause: "播放 / 暂停",
        actionMediaPrevious: "上一曲",
        actionMediaNext: "下一曲",
        actionDisplayBrightnessUp: "屏幕亮度 +",
        actionDisplayBrightnessDown: "屏幕亮度 −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "应用窗口",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "显示桌面",
        actionSpaceLeft: "移到左侧空间",
        actionSpaceRight: "移到右侧空间",
        actionMediaFastForward: "快进",
        actionMediaRewind: "快退",
        actionKeyboardBrightnessUp: "调高键盘亮度",
        actionKeyboardBrightnessDown: "调低键盘亮度",
        actionScrollUp: "向上滚动",
        actionScrollDown: "向下滚动",
        actionScrollLeft: "向左滚动",
        actionScrollRight: "向右滚动",
        repeatWhileHeld: "按住时重复",
        removeButton: "移除",
    ...
    static let zhTW = MouseButtonFeatureStrings(
        ...
        actionVolumeUp: "音量 +",
        actionVolumeDown: "音量 −",
        actionVolumeMute: "靜音 / 取消靜音",
        actionMediaPlayPause: "播放 / 暫停",
        actionMediaPrevious: "上一首",
        actionMediaNext: "下一首",
        actionDisplayBrightnessUp: "螢幕亮度 +",
        actionDisplayBrightnessDown: "螢幕亮度 −",
        actionMissionControl: "Mission Control",
        actionAppExpose: "App 視窗",
        actionLaunchpad: "Launchpad",
        actionShowDesktop: "顯示桌面",
        actionSpaceLeft: "移到左側空間",
        actionSpaceRight: "移到右側空間",
        actionMediaFastForward: "快轉",
        actionMediaRewind: "倒轉",
        actionKeyboardBrightnessUp: "提高鍵盤亮度",
        actionKeyboardBrightnessDown: "降低鍵盤亮度",
        actionScrollUp: "向上捲動",
        actionScrollDown: "向下捲動",
        actionScrollLeft: "向左捲動",
        actionScrollRight: "向右捲動",
        repeatWhileHeld: "按住時重複",
        removeButton: "移除",
