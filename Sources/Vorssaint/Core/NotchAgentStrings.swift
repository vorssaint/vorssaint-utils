...
extension NotchAgentStrings {
    static let enUS = NotchAgentStrings(
        ...
        settingsDescription: "Reads the usage Claude Code and Codex record on this Mac and the plan limits the Claude app saves. Prompts, replies and files are never read, and your usage never leaves your Mac.",
    ...
    static let ptBR = NotchAgentStrings(
        ...
        settingsDescription: "Lê o uso que o Claude Code e o Codex registram neste Mac e os limites do plano que o app Claude salva. Prompts, respostas e arquivos nunca são lidos, e o seu uso nunca sai do seu Mac.",
    ...
    static let es = NotchAgentStrings(
        ...
        settingsDescription: "Lee el uso que Claude Code y Codex registran en este Mac y los límites del plan que guarda la app de Claude. Nunca se leen instrucciones, respuestas ni archivos, y tu uso nunca sale de tu Mac.",
    ...
    static let de = NotchAgentStrings(
        ...
        settingsDescription: "Liest die Nutzung, die Claude Code und Codex auf diesem Mac protokollieren, und die Planlimits, die die Claude-App speichert. Prompts, Antworten und Dateien werden nie gelesen, und deine Nutzung verlässt nie deinen Mac.",
    ...
    static let fr = NotchAgentStrings(
        ...
        settingsDescription: "Lit l’usage que Claude Code et Codex enregistrent sur ce Mac et les limites du forfait que l’app Claude enregistre. Les requêtes, réponses et fichiers ne sont jamais lus, et votre usage ne quitte jamais votre Mac.",
    ...
    static let it = NotchAgentStrings(
        ...
        settingsDescription: "Legge l’utilizzo che Claude Code e Codex registrano su questo Mac e i limiti del piano che l’app Claude salva. Prompt, risposte e file non vengono mai letti, e il tuo utilizzo non lascia mai il tuo Mac.",
    ...
    static let ru = NotchAgentStrings(
        ...
        settingsDescription: "Читает сведения об использовании, которые Claude Code и Codex записывают на этом Mac, и лимиты тарифа, которые сохраняет приложение Claude. Запросы, ответы и файлы не читаются, а сведения об использовании никогда не покидают ваш Mac.",
    ...
    static let tr = NotchAgentStrings(
        ...
        settingsDescription: "Claude Code ve Codex’in bu Mac’e kaydettiği kullanımı ve Claude uygulamasının kaydettiği plan sınırlarını okur. İstemler, yanıtlar ve dosyalar asla okunmaz ve kullanımınız Mac’inizden asla çıkmaz.",
    ...
    static let ja = NotchAgentStrings(
        ...
        settingsDescription: "Claude CodeとCodexがこのMacに記録する使用状況と、Claudeアプリが保存するプラン上限を読み取ります。プロンプト、応答、ファイルは読み取らず、使用状況がMacの外に送信されることはありません。",
        restingTitle: "AIの上限",
        limitsCard: "上限",
        spendCard: "使用額",
        liveCard: "実行中",
        ...
        claudeLimitsCurrentFormat: "Claudeアプリから取得、%@に更新",
    ...
    static let ko = NotchAgentStrings(
        ...
        settingsDescription: "Claude Code와 Codex가 이 Mac에 기록하는 사용량과 Claude 앱이 저장하는 플랜 한도를 읽습니다. 프롬프트, 응답, 파일은 읽지 않으며, 사용량은 Mac 밖으로 나가지 않습니다.",
        restingTitle: "AI 한도",
        limitsCard: "한도",
        spendCard: "사용 금액",
        liveCard: "지금",
    ...
    static let zhHans = NotchAgentStrings(
        ...
        settingsDescription: "读取 Claude Code 和 Codex 在这台 Mac 上记录的用量，以及 Claude App 保存的套餐额度。不会读取提示、回复和文件，你的用量也不会离开你的 Mac。",
        restingTitle: "AI 额度",
        limitsCard: "额度",
        spendCard: "花费",
        liveCard: "当前",
        ...
        claudeLimitsCurrentFormat: "读取自 Claude App，%@更新",
    ...
    static let zhTW = NotchAgentStrings(
        ...
        settingsDescription: "讀取 Claude Code 與 Codex 在這台 Mac 上記錄的用量，以及 Claude App 儲存的方案額度。不會讀取提示、回覆與檔案，你的用量也不會離開你的 Mac。",
        restingTitle: "AI 額度",
        limitsCard: "額度",
        spendCard: "花費",
        liveCard: "目前",
        ...
        claudeLimitsCurrentFormat: "讀取自 Claude App，%@更新",
    ...
    static let zhHK = NotchAgentStrings(
        ...
        settingsDescription: "讀取 Claude Code 與 Codex 在這部 Mac 上記錄的用量，以及 Claude App 儲存的計劃額度。不會讀取提示、回覆與檔案，你的用量也不會離開你的 Mac。",
        restingTitle: "AI 額度",
        limitsCard: "額度",
        spendCard: "花費",
        liveCard: "目前",
