...
extension NotchAgentStrings {
    ...
    static let ar = NotchAgentStrings(
        title: "وكلاء الذكاء الاصطناعي",
        hubDescription: "تابع في الجزيرة الديناميكية حدود الخطة والرموز وقيمة الـ API والعمل الجاري لدى Claude وCodex.",
        settingsDescription: "يقرأ الاستخدام الذي يسجّله Claude Code وCodex على هذا الـ Mac، وحدود الخطة التي يحفظها تطبيق Claude. ولا تُحفظ المطالبات ولا الردود ولا الملفات، ولا يغادر استخدامك جهازك أبدًا.",
        restingTitle: "حدود الذكاء الاصطناعي",
        limitsCard: "الحدود",
        spendCard: "الإنفاق",
        liveCard: "الآن",
        trendCard: "الاتجاه",
        ...
        session: "الجلسة",
        weekly: "الأسبوع",
        estimated: "تقدير من هذا الـ Mac",
        claudeLimitsHint: "إعداد حدود الخطة…",
        waitingForLimits: "تظهر الحدود بعد الرد التالي",
        noSession: "لا توجد جلسة قيد التشغيل",
        apiValue: "قيمة الـ API",
        tokensFormat: "الرموز: %@",
        cachedFormat: "%@ من الذاكرة المؤقتة",
        writtenFormat: "%@ مكتوبة",
        savedFormat: "%@ وفّرتها الذاكرة المؤقتة",
        planMultipleFormat: "%1$@ ضعف سعر %2$@",
        idle: "خامل",
        noActivity: "لا شيء في هذه المدة",
        empty: "لا يوجد استخدام من Claude Code أو Codex بعد. ويظهر هنا فور عمل أيٍّ منهما على هذا الـ Mac.",
        loading: "قراءة الاستخدام…",
        noCards: "اختر ما تعرضه هذه الصفحة من إعدادات الجزيرة الديناميكية.",
        unpriced: "بعض النماذج بلا سعر معروف، لذا هذا حد أدنى.",
        streak: "أيام متتالية",
        activeDays: "الأيام النشطة",
        busiestDay: "أكثر الأيام انشغالًا",
        finishedFormat: "انتهى %@",
        limitRenewed: "تجدّد الحد",
        budgetTitle: "الميزانية اليومية",
        leftFormat: "بقي %@",
        usedFormat: "استُخدم %@",
        agents: "الوكلاء",
        found: "موجود على هذا الـ Mac",
        notFound: "غير موجود على هذا الـ Mac",
        cardsTitle: "البطاقات",
        cardsHint: "اسحب لإعادة الترتيب. وتأخذ الرسوم البيانية عرض الجزيرة كاملًا.",
        limitsAs: "إظهار الحدود بصيغة",
        remaining: "المتبقي",
        used: "المستخدم",
        liveTitle: "أثناء عمل أحد الوكلاء",
        liveActivity: "الإظهار في الجزيرة الديناميكية المغلقة",
        readout: "بجانب الكاميرا",
        readoutElapsed: "الوقت",
        readoutTokens: "الرموز المكتوبة",
        readoutLimit: "الحد",
        alerts: "التنبيهات",
        finishAlert: "عند انتهاء مهمة",
        finishAfter: "للمهام الأطول من",
        anyLength: "أي مدة",
        limitAlert: "عند الاقتراب من حد الخطة",
        limitAt: "التحذير عند",
        budget: "ميزانية قيمة الـ API اليومية",
        off: "إيقاف",
        updatedFormat: "حُدِّث %@",
        claudeLimitsTitle: "حدود خطة Claude",
        claudeLimitsCurrentFormat: "مقروءة من تطبيق Claude، حُدِّثت %@",
        claudeLimitsStaleFormat: "آخر مرة تحقق فيها تطبيق Claude منها كانت %@.",
        claudeLimitsMenuBar: "لا يتحقق Claude من حدودك إلا وأيقونته في شريط القوائم. فعّل الأيقونة من إعدادات تطبيق Claude، وتظهر حدودك هنا خلال دقائق.",
        claudeLimitsNoApp: "تأتي حدود الخطة من تطبيق Claude، وهو غير موجود على هذا الـ Mac. وحتى ذلك الحين تُقدَّر جلسة الخمس ساعات من نشاط Claude Code.",
        claudeLimitsPrivacy: "يقرأ Vorssaint النسب التي يحفظها تطبيق Claude على هذا الـ Mac. ولا يُستخدم أي تسجيل دخول ولا يُرسل شيء.",
        openClaude: "فتح Claude",
        getClaude: "الحصول على تطبيق Claude",
        priceUpdates: "إبقاء الأسعار محدّثة",
        priceUpdatesHint: "ينزّل قائمة الأسعار العامة من GitHub مرة في اليوم، فتحصل النماذج الجديدة على قيمة API دون تحديث التطبيق. ولا يُرسل أي شيء عن استخدامك.",
        pricesFromFormat: "قائمة أسعار %@",
        valueNote: "قيمة الـ API هي ما كان العمل نفسه سيكلفه بأسعار قائمة الـ API. أما الخطط فتتقاضى سعرًا ثابتًا بدلًا من ذلك.")
}
