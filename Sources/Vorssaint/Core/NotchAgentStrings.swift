...
struct NotchAgentStrings {
    ...
    let closestToLimit: String
    let showWindowLength: String
    let limitAt: String
    let budget: String
    let off: String
...
extension NotchAgentStrings {
    static let enUS = NotchAgentStrings(
        ...
        closestToLimit: "Closest to its limit",
        showWindowLength: "Show the window’s length before the percentage",
        limitAt: "Warn at",
    ...
    static let ptBR = NotchAgentStrings(
        ...
        closestToLimit: "Mais perto do limite",
        showWindowLength: "Mostrar a duração da janela antes da porcentagem",
        limitAt: "Avisar em",
    ...
    static let es = NotchAgentStrings(
        ...
        closestToLimit: "Más cercano a su límite",
        showWindowLength: "Mostrar la duración de la ventana antes del porcentaje",
        limitAt: "Avisar al",
    ...
    static let de = NotchAgentStrings(
        ...
        closestToLimit: "Am nächsten am Limit",
        showWindowLength: "Fensterlänge vor dem Prozentwert anzeigen",
        limitAt: "Warnen bei",
    ...
    static let fr = NotchAgentStrings(
        ...
        closestToLimit: "Le plus proche de sa limite",
        showWindowLength: "Afficher la durée de la fenêtre avant le pourcentage",
        limitAt: "Avertir à",
    ...
    static let it = NotchAgentStrings(
        ...
        closestToLimit: "Più vicino al limite",
        showWindowLength: "Mostra la durata della finestra prima della percentuale",
        limitAt: "Avvisa al",
    ...
    static let ru = NotchAgentStrings(
        ...
        closestToLimit: "Ближе всего к лимиту",
        showWindowLength: "Показывать длительность окна перед процентом",
    ...
    static let tr = NotchAgentStrings(
        ...
        closestToLimit: "Sınırına en yakın",
        showWindowLength: "Yüzdeden önce pencere süresini göster",
        limitAt: "Uyarı eşiği",
    ...
    static let ja = NotchAgentStrings(
        ...
        closestToLimit: "上限に最も近い",
        showWindowLength: "割合の前にウィンドウの長さを表示",
        limitAt: "通知するしきい値",
        budget: "API換算額の1日の予算",
        off: "オフ",
        updatedFormat: "最終更新：%@",
    ...
    static let ko = NotchAgentStrings(
        ...
        closestToLimit: "한도에 가장 가까움",
        showWindowLength: "퍼센트 앞에 창 길이 표시",
        limitAt: "알림 기준",
    ...
    static let zhHans = NotchAgentStrings(
        ...
        anyLength: "任意时长",
        limitAlert: "接近套餐额度时",
        closestToLimit: "最接近额度",
        showWindowLength: "在百分比前显示窗口时长",
        limitAt: "提醒阈值",
        budget: "每日 API 价值预算",
        off: "关闭",
        updatedFormat: "上次更新：%@",
    ...
    static let zhTW = NotchAgentStrings(
        ...
        anyLength: "任何長度",
        limitAlert: "接近方案額度時",
        closestToLimit: "最接近額度",
        showWindowLength: "在百分比前顯示視窗時長",
        limitAt: "提醒門檻",
        budget: "每日 API 價值預算",
        off: "關閉",
        updatedFormat: "上次更新：%@",
