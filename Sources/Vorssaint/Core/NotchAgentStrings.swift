...
struct NotchAgentStrings {
    ...
    let proxyHubsTitle: String
    let proxyHubsDescription: String
    let proxyAddHub: String
    let proxyAddHubTitle: String
    let proxyAddHubDescription: String
    let proxyHubURL: String
    let proxyHubKey: String
    let proxyHubLabel: String
    let proxyHubLabelPrompt: String
    let proxyHubKeyNote: String
    let proxyHubInvalidURL: String
    let proxyHubSaveFailed: String
    let proxyAddHubButton: String
    let proxyCancel: String
    let proxyRemoveHub: String
    let proxyHubOff: String
    let proxyHubChecking: String
    let proxyHubReadyFormat: String
    let proxyHubRemoteDisabled: String
    let proxyHubWrongKey: String
    let proxyHubBlocked: String
    let proxyHubManagementOff: String
    let proxyHubInsecure: String
    let proxyHubUnreachable: String
    let proxyHubFailedFormat: String
    let proxyHubAccountFailed: String
    let proxyHubAccountFormat: String
...
extension NotchAgentStrings {
    static let enUS = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI hubs",
        proxyHubsDescription: "Shows the limits of every Claude and Codex account a CLIProxyAPI hub pools, next to the agents on this Mac.",
        proxyAddHub: "Add hub…",
        proxyAddHubTitle: "Add a CLIProxyAPI hub",
        proxyAddHubDescription: "Vorssaint asks the hub for the limits of each account it pools. The hub makes the requests to Anthropic and OpenAI itself, so no account token reaches this Mac.",
        proxyHubURL: "Hub URL",
        proxyHubKey: "Management key",
        proxyHubLabel: "Label (optional)",
        proxyHubLabelPrompt: "Defaults to the hub’s host name",
        proxyHubKeyNote: "Vorssaint keeps the key in a file only your user can read. Settings backups leave it out.",
        proxyHubInvalidURL: "Enter the hub’s address, like https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint couldn’t save the hub.",
        proxyAddHubButton: "Add hub",
        proxyCancel: "Cancel",
        proxyRemoveHub: "Remove",
        proxyHubOff: "Checked only while the AI page is on",
        proxyHubChecking: "Checking…",
        proxyHubReadyFormat: "Connected · accounts: %@",
        proxyHubRemoteDisabled: "The hub accepts management calls from its own machine only. Set remote-management.allow-remote to true in its config.yaml.",
        proxyHubWrongKey: "The hub refused this key. Vorssaint stopped asking, because the hub blocks a Mac after five wrong keys. Remove the hub and add it again with the right key.",
        proxyHubBlocked: "The hub blocked this Mac after too many wrong keys. Vorssaint asks again in 30 minutes.",
        proxyHubManagementOff: "The hub’s management API is off. Set remote-management.secret-key in its config.yaml.",
        proxyHubInsecure: "macOS allows plain http only to an IP address. Use https, or the hub’s IP address.",
        proxyHubUnreachable: "Can’t reach the hub. The Dynamic Island keeps the last readings.",
        proxyHubFailedFormat: "The hub answered with an error (HTTP %@).",
        proxyHubAccountFailed: "The hub couldn’t read this account",
    ...
    static let uk = NotchAgentStrings(
        ...
        proxyHubsTitle: "Хаби CLIProxyAPI",
        proxyHubsDescription: "Показує ліміти кожного облікового запису Claude і Codex, який об’єднує хаб CLIProxyAPI, поруч з агентами на цьому Mac.",
        proxyAddHub: "Додати хаб…",
        proxyAddHubTitle: "Додати хаб CLIProxyAPI",
        proxyAddHubDescription: "Vorssaint запитує в хаба ліміти кожного облікового запису, який він об’єднує. Хаб сам надсилає запити до Anthropic і OpenAI, тому жоден токен облікового запису не потрапляє на цей Mac.",
        proxyHubURL: "URL хаба",
        proxyHubKey: "Ключ керування",
        proxyHubLabel: "Назва (необов’язково)",
        proxyHubLabelPrompt: "Типово – ім’я хоста хаба",
        proxyHubKeyNote: "Vorssaint зберігає ключ у файлі, який може читати лише ваш користувач. Резервні копії налаштувань його не містять.",
        proxyHubInvalidURL: "Введіть адресу хаба, наприклад https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint не вдалося зберегти хаб.",
        proxyAddHubButton: "Додати хаб",
        proxyCancel: "Скасувати",
        proxyRemoveHub: "Вилучити",
        proxyHubOff: "Перевіряється лише тоді, коли сторінку ШІ ввімкнено",
        proxyHubChecking: "Перевірка…",
        proxyHubReadyFormat: "Під’єднано · облікових записів: %@",
        proxyHubRemoteDisabled: "Хаб приймає виклики керування лише зі своєї машини. Установіть remote-management.allow-remote у true в його config.yaml.",
        proxyHubWrongKey: "Хаб відхилив цей ключ. Vorssaint припинив запити, бо хаб блокує Mac після п’яти неправильних ключів. Вилучіть хаб і додайте його знову з правильним ключем.",
        proxyHubBlocked: "Хаб заблокував цей Mac після забагатьох неправильних ключів. Vorssaint спробує знову через 30 хвилин.",
        proxyHubManagementOff: "API керування хаба вимкнено. Установіть remote-management.secret-key в його config.yaml.",
        proxyHubInsecure: "macOS дозволяє звичайний http лише до IP-адреси. Використовуйте https або IP-адресу хаба.",
        proxyHubUnreachable: "Не вдається зв’язатися з хабом. Dynamic Island показує останні дані.",
        proxyHubFailedFormat: "Хаб відповів помилкою (HTTP %@).",
        proxyHubAccountFailed: "Хаб не зміг прочитати цей обліковий запис",
    ...
    static let ptBR = NotchAgentStrings(
        ...
        proxyHubsTitle: "Hubs do CLIProxyAPI",
        proxyHubsDescription: "Mostra os limites de cada conta do Claude e do Codex que um hub do CLIProxyAPI reúne, ao lado dos agentes deste Mac.",
        proxyAddHub: "Adicionar hub…",
        proxyAddHubTitle: "Adicionar um hub do CLIProxyAPI",
        proxyAddHubDescription: "O Vorssaint pede ao hub os limites de cada conta que ele reúne. O próprio hub faz as solicitações à Anthropic e à OpenAI, então nenhum token de conta chega a este Mac.",
        proxyHubURL: "URL do hub",
        proxyHubKey: "Chave de gerenciamento",
        proxyHubLabel: "Nome (opcional)",
        proxyHubLabelPrompt: "Usa o nome do host do hub por padrão",
        proxyHubKeyNote: "O Vorssaint guarda a chave em um arquivo que só o seu usuário pode ler. Os backups de ajustes não a incluem.",
        proxyHubInvalidURL: "Digite o endereço do hub, como https://hub.example.net:8310.",
        proxyHubSaveFailed: "O Vorssaint não conseguiu salvar o hub.",
        proxyAddHubButton: "Adicionar hub",
        proxyCancel: "Cancelar",
        proxyRemoveHub: "Remover",
        proxyHubOff: "Verificado só enquanto a página de IA está ativada",
        proxyHubChecking: "Verificando…",
        proxyHubReadyFormat: "Conectado · contas: %@",
        proxyHubRemoteDisabled: "O hub aceita chamadas de gerenciamento só da própria máquina. Defina remote-management.allow-remote como true no config.yaml dele.",
        proxyHubWrongKey: "O hub recusou esta chave. O Vorssaint parou de perguntar, porque o hub bloqueia um Mac após cinco chaves erradas. Remova o hub e adicione-o de novo com a chave certa.",
        proxyHubBlocked: "O hub bloqueou este Mac após chaves erradas demais. O Vorssaint tenta de novo em 30 minutos.",
        proxyHubManagementOff: "A API de gerenciamento do hub está desativada. Defina remote-management.secret-key no config.yaml dele.",
        proxyHubInsecure: "O macOS só permite http simples para um endereço IP. Use https ou o endereço IP do hub.",
        proxyHubUnreachable: "Não foi possível acessar o hub. O Dynamic Island mantém as últimas leituras.",
        proxyHubFailedFormat: "O hub respondeu com um erro (HTTP %@).",
        proxyHubAccountFailed: "O hub não conseguiu ler esta conta",
    ...
    static let es = NotchAgentStrings(
        ...
        proxyHubsTitle: "Hubs de CLIProxyAPI",
        proxyHubsDescription: "Muestra los límites de cada cuenta de Claude y Codex que reúne un hub de CLIProxyAPI, junto a los agentes de este Mac.",
        proxyAddHub: "Añadir hub…",
        proxyAddHubTitle: "Añadir un hub de CLIProxyAPI",
        proxyAddHubDescription: "Vorssaint pide al hub los límites de cada cuenta que reúne. El propio hub hace las solicitudes a Anthropic y OpenAI, así que ningún token de cuenta llega a este Mac.",
        proxyHubURL: "URL del hub",
        proxyHubKey: "Clave de gestión",
        proxyHubLabel: "Nombre (opcional)",
        proxyHubLabelPrompt: "Por omisión, el nombre de host del hub",
        proxyHubKeyNote: "Vorssaint guarda la clave en un archivo que solo tu usuario puede leer. Las copias de seguridad de los ajustes no la incluyen.",
        proxyHubInvalidURL: "Introduce la dirección del hub, como https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint no pudo guardar el hub.",
        proxyAddHubButton: "Añadir hub",
        proxyCancel: "Cancelar",
        proxyRemoveHub: "Eliminar",
        proxyHubOff: "Solo se comprueba mientras la página de IA está activada",
        proxyHubChecking: "Comprobando…",
        proxyHubReadyFormat: "Conectado · cuentas: %@",
        proxyHubRemoteDisabled: "El hub solo acepta llamadas de gestión desde su propia máquina. Pon remote-management.allow-remote en true en su config.yaml.",
        proxyHubWrongKey: "El hub rechazó esta clave. Vorssaint dejó de preguntar, porque el hub bloquea un Mac tras cinco claves erróneas. Elimina el hub y vuelve a añadirlo con la clave correcta.",
        proxyHubBlocked: "El hub bloqueó este Mac tras demasiadas claves erróneas. Vorssaint volverá a preguntar dentro de 30 minutos.",
        proxyHubManagementOff: "La API de gestión del hub está desactivada. Define remote-management.secret-key en su config.yaml.",
        proxyHubInsecure: "macOS solo permite http sin cifrar hacia una dirección IP. Usa https o la dirección IP del hub.",
        proxyHubUnreachable: "No se puede conectar con el hub. El Dynamic Island conserva las últimas lecturas.",
        proxyHubFailedFormat: "El hub respondió con un error (HTTP %@).",
        proxyHubAccountFailed: "El hub no pudo leer esta cuenta",
    ...
    static let sk = NotchAgentStrings(
        ...
        proxyHubsTitle: "Huby CLIProxyAPI",
        proxyHubsDescription: "Zobrazuje limity každého účtu Claude a Codex, ktorý hub CLIProxyAPI združuje, vedľa agentov na tomto Macu.",
        proxyAddHub: "Pridať hub…",
        proxyAddHubTitle: "Pridať hub CLIProxyAPI",
        proxyAddHubDescription: "Vorssaint sa pýta hubu na limity každého účtu, ktorý združuje. Požiadavky do Anthropic a OpenAI posiela sám hub, takže sa na tento Mac nedostane žiadny token účtu.",
        proxyHubURL: "URL hubu",
        proxyHubKey: "Kľúč na správu",
        proxyHubLabel: "Názov (voliteľný)",
        proxyHubLabelPrompt: "Predvolene názov hostiteľa hubu",
        proxyHubKeyNote: "Vorssaint uchováva kľúč v súbore, ktorý môže čítať iba váš používateľ. Zálohy nastavení ho neobsahujú.",
        proxyHubInvalidURL: "Zadajte adresu hubu, napríklad https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint nedokázal uložiť hub.",
        proxyAddHubButton: "Pridať hub",
        proxyCancel: "Zrušiť",
        proxyRemoveHub: "Odstrániť",
        proxyHubOff: "Kontroluje sa, iba keď je stránka AI zapnutá",
        proxyHubChecking: "Kontroluje sa…",
        proxyHubReadyFormat: "Pripojené · účty: %@",
        proxyHubRemoteDisabled: "Hub prijíma volania na správu iba zo svojho počítača. V jeho config.yaml nastavte remote-management.allow-remote na true.",
        proxyHubWrongKey: "Hub tento kľúč odmietol. Vorssaint sa prestal pýtať, pretože hub po piatich nesprávnych kľúčoch Mac zablokuje. Odstráňte hub a pridajte ho znova so správnym kľúčom.",
        proxyHubBlocked: "Hub zablokoval tento Mac po príliš mnohých nesprávnych kľúčoch. Vorssaint to skúsi znova o 30 minút.",
        proxyHubManagementOff: "API na správu hubu je vypnuté. V jeho config.yaml nastavte remote-management.secret-key.",
        proxyHubInsecure: "macOS povoľuje nešifrovaný http iba na IP adresu. Použite https alebo IP adresu hubu.",
        proxyHubUnreachable: "Hub je nedostupný. Dynamic Island si ponecháva posledné údaje.",
        proxyHubFailedFormat: "Hub odpovedal chybou (HTTP %@).",
        proxyHubAccountFailed: "Hub nedokázal prečítať tento účet",
    ...
    static let de = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI-Hubs",
        proxyHubsDescription: "Zeigt die Limits jedes Claude- und Codex-Kontos, das ein CLIProxyAPI-Hub bündelt, neben den Agenten auf diesem Mac.",
        proxyAddHub: "Hub hinzufügen …",
        proxyAddHubTitle: "CLIProxyAPI-Hub hinzufügen",
        proxyAddHubDescription: "Vorssaint fragt den Hub nach den Limits jedes Kontos, das er bündelt. Der Hub stellt die Anfragen an Anthropic und OpenAI selbst, daher erreicht kein Konto-Token diesen Mac.",
        proxyHubURL: "Hub-URL",
        proxyHubKey: "Verwaltungsschlüssel",
        proxyHubLabel: "Name (optional)",
        proxyHubLabelPrompt: "Standardmäßig der Hostname des Hubs",
        proxyHubKeyNote: "Vorssaint bewahrt den Schlüssel in einer Datei auf, die nur dein Benutzer lesen kann. Einstellungs-Backups lassen ihn aus.",
        proxyHubInvalidURL: "Gib die Adresse des Hubs ein, etwa https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint konnte den Hub nicht sichern.",
        proxyAddHubButton: "Hub hinzufügen",
        proxyCancel: "Abbrechen",
        proxyRemoveHub: "Entfernen",
        proxyHubOff: "Wird nur geprüft, solange die KI-Seite aktiv ist",
        proxyHubChecking: "Wird geprüft …",
        proxyHubReadyFormat: "Verbunden · Konten: %@",
        proxyHubRemoteDisabled: "Der Hub nimmt Verwaltungsaufrufe nur vom eigenen Rechner an. Setze remote-management.allow-remote in seiner config.yaml auf true.",
        proxyHubWrongKey: "Der Hub hat diesen Schlüssel abgelehnt. Vorssaint fragt nicht mehr, weil der Hub einen Mac nach fünf falschen Schlüsseln sperrt. Entferne den Hub und füge ihn mit dem richtigen Schlüssel erneut hinzu.",
        proxyHubBlocked: "Der Hub hat diesen Mac nach zu vielen falschen Schlüsseln gesperrt. Vorssaint fragt in 30 Minuten erneut.",
        proxyHubManagementOff: "Die Verwaltungs-API des Hubs ist aus. Setze remote-management.secret-key in seiner config.yaml.",
        proxyHubInsecure: "macOS erlaubt unverschlüsseltes http nur zu einer IP-Adresse. Verwende https oder die IP-Adresse des Hubs.",
        proxyHubUnreachable: "Der Hub ist nicht erreichbar. Die Dynamic Island behält die letzten Werte.",
        proxyHubFailedFormat: "Der Hub hat mit einem Fehler geantwortet (HTTP %@).",
        proxyHubAccountFailed: "Der Hub konnte dieses Konto nicht lesen",
    ...
    static let fr = NotchAgentStrings(
        ...
        proxyHubsTitle: "Hubs CLIProxyAPI",
        proxyHubsDescription: "Affiche les limites de chaque compte Claude et Codex qu’un hub CLIProxyAPI regroupe, à côté des agents de ce Mac.",
        proxyAddHub: "Ajouter un hub…",
        proxyAddHubTitle: "Ajouter un hub CLIProxyAPI",
        proxyAddHubDescription: "Vorssaint demande au hub les limites de chaque compte qu’il regroupe. Le hub envoie lui-même les requêtes à Anthropic et OpenAI\u{00A0}: aucun jeton de compte n’arrive sur ce Mac.",
        proxyHubURL: "URL du hub",
        proxyHubKey: "Clé de gestion",
        proxyHubLabel: "Nom (facultatif)",
        proxyHubLabelPrompt: "Par défaut, le nom d’hôte du hub",
        proxyHubKeyNote: "Vorssaint garde la clé dans un fichier que seul votre utilisateur peut lire. Les sauvegardes des réglages ne l’incluent pas.",
        proxyHubInvalidURL: "Saisissez l’adresse du hub, par exemple https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint n’a pas pu enregistrer le hub.",
        proxyAddHubButton: "Ajouter le hub",
        proxyCancel: "Annuler",
        proxyRemoveHub: "Supprimer",
        proxyHubOff: "Vérifié uniquement quand la page IA est activée",
        proxyHubChecking: "Vérification…",
        proxyHubReadyFormat: "Connecté · comptes\u{00A0}: %@",
        proxyHubRemoteDisabled: "Le hub n’accepte les appels de gestion que depuis sa propre machine. Réglez remote-management.allow-remote sur true dans son config.yaml.",
        proxyHubWrongKey: "Le hub a refusé cette clé. Vorssaint a cessé de l’interroger, car le hub bloque un Mac après cinq clés erronées. Supprimez le hub puis ajoutez-le de nouveau avec la bonne clé.",
        proxyHubBlocked: "Le hub a bloqué ce Mac après trop de clés erronées. Vorssaint réessaiera dans 30 minutes.",
        proxyHubManagementOff: "L’API de gestion du hub est désactivée. Définissez remote-management.secret-key dans son config.yaml.",
        proxyHubInsecure: "macOS n’autorise le http non chiffré que vers une adresse IP. Utilisez https ou l’adresse IP du hub.",
        proxyHubUnreachable: "Impossible de joindre le hub. Le Dynamic Island conserve les dernières valeurs.",
        proxyHubFailedFormat: "Le hub a répondu par une erreur (HTTP %@).",
        proxyHubAccountFailed: "Le hub n’a pas pu lire ce compte",
        proxyHubAccountFormat: "Via %@",
    ...
    static let it = NotchAgentStrings(
        ...
        proxyHubsTitle: "Hub CLIProxyAPI",
        proxyHubsDescription: "Mostra i limiti di ogni account Claude e Codex che un hub CLIProxyAPI raggruppa, accanto agli agenti di questo Mac.",
        proxyAddHub: "Aggiungi hub…",
        proxyAddHubTitle: "Aggiungi un hub CLIProxyAPI",
        proxyAddHubDescription: "Vorssaint chiede all’hub i limiti di ogni account che raggruppa. È l’hub stesso a inviare le richieste ad Anthropic e OpenAI, quindi nessun token di account arriva su questo Mac.",
        proxyHubURL: "URL dell’hub",
        proxyHubKey: "Chiave di gestione",
        proxyHubLabel: "Nome (facoltativo)",
        proxyHubLabelPrompt: "Di default il nome host dell’hub",
        proxyHubKeyNote: "Vorssaint conserva la chiave in un file che solo il tuo utente può leggere. I backup delle impostazioni non la includono.",
        proxyHubInvalidURL: "Inserisci l’indirizzo dell’hub, ad esempio https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint non è riuscito a salvare l’hub.",
        proxyAddHubButton: "Aggiungi hub",
        proxyCancel: "Annulla",
        proxyRemoveHub: "Rimuovi",
        proxyHubOff: "Controllato solo mentre la pagina IA è attiva",
        proxyHubChecking: "Controllo in corso…",
        proxyHubReadyFormat: "Connesso · account: %@",
        proxyHubRemoteDisabled: "L’hub accetta chiamate di gestione solo dalla propria macchina. Imposta remote-management.allow-remote su true nel suo config.yaml.",
        proxyHubWrongKey: "L’hub ha rifiutato questa chiave. Vorssaint ha smesso di chiedere, perché l’hub blocca un Mac dopo cinque chiavi errate. Rimuovi l’hub e aggiungilo di nuovo con la chiave giusta.",
        proxyHubBlocked: "L’hub ha bloccato questo Mac dopo troppe chiavi errate. Vorssaint riprova tra 30 minuti.",
        proxyHubManagementOff: "L’API di gestione dell’hub è disattivata. Imposta remote-management.secret-key nel suo config.yaml.",
        proxyHubInsecure: "macOS consente http non cifrato solo verso un indirizzo IP. Usa https o l’indirizzo IP dell’hub.",
        proxyHubUnreachable: "Impossibile raggiungere l’hub. Il Dynamic Island mantiene le ultime letture.",
        proxyHubFailedFormat: "L’hub ha risposto con un errore (HTTP %@).",
        proxyHubAccountFailed: "L’hub non è riuscito a leggere questo account",
    ...
    static let ru = NotchAgentStrings(
        ...
        proxyHubsTitle: "Хабы CLIProxyAPI",
        proxyHubsDescription: "Показывает лимиты каждой учётной записи Claude и Codex, которую объединяет хаб CLIProxyAPI, рядом с агентами на этом Mac.",
        proxyAddHub: "Добавить хаб…",
        proxyAddHubTitle: "Добавить хаб CLIProxyAPI",
        proxyAddHubDescription: "Vorssaint запрашивает у хаба лимиты каждой учётной записи, которую он объединяет. Хаб сам отправляет запросы в Anthropic и OpenAI, поэтому ни один токен учётной записи не попадает на этот Mac.",
        proxyHubURL: "URL хаба",
        proxyHubKey: "Ключ управления",
        proxyHubLabel: "Название (необязательно)",
        proxyHubLabelPrompt: "По умолчанию – имя хоста хаба",
        proxyHubKeyNote: "Vorssaint хранит ключ в файле, который может читать только ваш пользователь. Резервные копии настроек его не содержат.",
        proxyHubInvalidURL: "Введите адрес хаба, например https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint не удалось сохранить хаб.",
        proxyAddHubButton: "Добавить хаб",
        proxyCancel: "Отменить",
        proxyRemoveHub: "Удалить",
        proxyHubOff: "Проверяется, только пока страница ИИ включена",
        proxyHubChecking: "Проверка…",
        proxyHubReadyFormat: "Подключено · учётных записей: %@",
        proxyHubRemoteDisabled: "Хаб принимает вызовы управления только со своей машины. Установите remote-management.allow-remote в true в его config.yaml.",
        proxyHubWrongKey: "Хаб отклонил этот ключ. Vorssaint перестал обращаться к нему, так как хаб блокирует Mac после пяти неверных ключей. Удалите хаб и добавьте его снова с верным ключом.",
        proxyHubBlocked: "Хаб заблокировал этот Mac после слишком многих неверных ключей. Vorssaint попробует снова через 30 минут.",
        proxyHubManagementOff: "API управления хаба выключен. Задайте remote-management.secret-key в его config.yaml.",
        proxyHubInsecure: "macOS разрешает обычный http только к IP-адресу. Используйте https или IP-адрес хаба.",
        proxyHubUnreachable: "Не удаётся связаться с хабом. Dynamic Island показывает последние данные.",
        proxyHubFailedFormat: "Хаб ответил ошибкой (HTTP %@).",
        proxyHubAccountFailed: "Хаб не смог прочитать эту учётную запись",
        proxyHubAccountFormat: "Через %@",
    ...
    static let tr = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI hub’ları",
        proxyHubsDescription: "Bir CLIProxyAPI hub’ının topladığı her Claude ve Codex hesabının limitlerini bu Mac’teki ajanların yanında gösterir.",
        proxyAddHub: "Hub ekle…",
        proxyAddHubTitle: "CLIProxyAPI hub’ı ekle",
        proxyAddHubDescription: "Vorssaint, hub’dan topladığı her hesabın limitlerini ister. Anthropic ve OpenAI’a istekleri hub kendisi gönderir, bu yüzden hiçbir hesap token’ı bu Mac’e ulaşmaz.",
        proxyHubURL: "Hub URL’si",
        proxyHubKey: "Yönetim anahtarı",
        proxyHubLabel: "Ad (isteğe bağlı)",
        proxyHubLabelPrompt: "Varsayılan olarak hub’ın ana makine adı",
        proxyHubKeyNote: "Vorssaint anahtarı yalnızca kullanıcınızın okuyabildiği bir dosyada tutar. Ayar yedekleri onu içermez.",
        proxyHubInvalidURL: "Hub’ın adresini girin, örneğin https://hub.example.net:8310.",
        proxyHubSaveFailed: "Vorssaint hub’ı kaydedemedi.",
        proxyAddHubButton: "Hub ekle",
        proxyCancel: "Vazgeç",
        proxyRemoveHub: "Kaldır",
        proxyHubOff: "Yalnızca yapay zekâ sayfası açıkken denetlenir",
        proxyHubChecking: "Denetleniyor…",
        proxyHubReadyFormat: "Bağlandı · hesaplar: %@",
        proxyHubRemoteDisabled: "Hub yönetim çağrılarını yalnızca kendi makinesinden kabul ediyor. config.yaml dosyasında remote-management.allow-remote değerini true yapın.",
        proxyHubWrongKey: "Hub bu anahtarı reddetti. Hub beş yanlış anahtardan sonra Mac’i engellediği için Vorssaint sormayı bıraktı. Hub’ı kaldırıp doğru anahtarla yeniden ekleyin.",
        proxyHubBlocked: "Hub, çok fazla yanlış anahtardan sonra bu Mac’i engelledi. Vorssaint 30 dakika sonra yeniden sorar.",
        proxyHubManagementOff: "Hub’ın yönetim API’si kapalı. config.yaml dosyasında remote-management.secret-key değerini ayarlayın.",
        proxyHubInsecure: "macOS şifresiz http’ye yalnızca bir IP adresine izin verir. https ya da hub’ın IP adresini kullanın.",
        proxyHubUnreachable: "Hub’a ulaşılamıyor. Dynamic Island son okumaları tutar.",
        proxyHubFailedFormat: "Hub bir hatayla yanıt verdi (HTTP %@).",
        proxyHubAccountFailed: "Hub bu hesabı okuyamadı",
    ...
    static let ja = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI ハブ",
        proxyHubsDescription: "CLIProxyAPI ハブがまとめている Claude と Codex の各アカウントの上限を、この Mac のエージェントと並べて表示します。",
        proxyAddHub: "ハブを追加…",
        proxyAddHubTitle: "CLIProxyAPI ハブを追加",
        proxyAddHubDescription: "Vorssaint は、ハブがまとめている各アカウントの上限をハブに問い合わせます。Anthropic と OpenAI へのリクエストはハブ自身が行うため、アカウントのトークンがこの Mac に届くことはありません。",
        proxyHubURL: "ハブの URL",
        proxyHubKey: "管理キー",
        proxyHubLabel: "名前（オプション）",
        proxyHubLabelPrompt: "省略時はハブのホスト名",
        proxyHubKeyNote: "Vorssaint はキーを、あなたのユーザだけが読めるファイルに保存します。設定のバックアップには含まれません。",
        proxyHubInvalidURL: "ハブのアドレスを入力してください（例：https://hub.example.net:8310）。",
        proxyHubSaveFailed: "Vorssaint はハブを保存できませんでした。",
        proxyAddHubButton: "ハブを追加",
        proxyCancel: "キャンセル",
        proxyRemoveHub: "削除",
        proxyHubOff: "AI ページがオンのときだけ確認します",
        proxyHubChecking: "確認中…",
        proxyHubReadyFormat: "接続済み・アカウント：%@",
        proxyHubRemoteDisabled: "このハブは自身のマシンからの管理呼び出ししか受け付けません。config.yaml で remote-management.allow-remote を true にしてください。",
        proxyHubWrongKey: "ハブがこのキーを拒否しました。ハブは誤ったキーが 5 回続くと Mac をブロックするため、Vorssaint は問い合わせを止めました。ハブを削除し、正しいキーで追加し直してください。",
        proxyHubBlocked: "誤ったキーが多すぎたため、ハブがこの Mac をブロックしました。Vorssaint は 30 分後にもう一度問い合わせます。",
        proxyHubManagementOff: "ハブの管理 API がオフです。config.yaml で remote-management.secret-key を設定してください。",
        proxyHubInsecure: "macOS は暗号化されていない http を IP アドレス宛てにしか許可しません。https かハブの IP アドレスを使ってください。",
        proxyHubUnreachable: "ハブに接続できません。Dynamic Island には最後の値が残ります。",
        proxyHubFailedFormat: "ハブがエラーを返しました（HTTP %@）。",
        proxyHubAccountFailed: "ハブがこのアカウントを読み取れませんでした",
    ...
    static let ko = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI 허브",
        proxyHubsDescription: "CLIProxyAPI 허브가 모아 둔 모든 Claude 및 Codex 계정의 한도를 이 Mac의 에이전트 옆에 표시합니다.",
        proxyAddHub: "허브 추가…",
        proxyAddHubTitle: "CLIProxyAPI 허브 추가",
        proxyAddHubDescription: "Vorssaint는 허브가 모아 둔 각 계정의 한도를 허브에 요청합니다. Anthropic과 OpenAI에 대한 요청은 허브가 직접 보내므로 계정 토큰이 이 Mac에 전달되지 않습니다.",
        proxyHubURL: "허브 URL",
        proxyHubKey: "관리 키",
        proxyHubLabel: "이름(선택 사항)",
        proxyHubLabelPrompt: "기본값은 허브의 호스트 이름",
        proxyHubKeyNote: "Vorssaint는 키를 사용자 본인만 읽을 수 있는 파일에 보관합니다. 설정 백업에는 포함되지 않습니다.",
        proxyHubInvalidURL: "허브 주소를 입력하십시오(예: https://hub.example.net:8310).",
        proxyHubSaveFailed: "Vorssaint가 허브를 저장하지 못했습니다.",
        proxyAddHubButton: "허브 추가",
        proxyCancel: "취소",
        proxyRemoveHub: "제거",
        proxyHubOff: "AI 페이지가 켜져 있을 때만 확인합니다",
        proxyHubChecking: "확인 중…",
        proxyHubReadyFormat: "연결됨 · 계정: %@",
        proxyHubRemoteDisabled: "허브가 자신의 컴퓨터에서 오는 관리 호출만 받습니다. config.yaml에서 remote-management.allow-remote를 true로 설정하십시오.",
        proxyHubWrongKey: "허브가 이 키를 거부했습니다. 허브는 잘못된 키가 다섯 번 들어오면 Mac을 차단하므로 Vorssaint가 요청을 멈췄습니다. 허브를 제거한 다음 올바른 키로 다시 추가하십시오.",
        proxyHubBlocked: "잘못된 키가 너무 많아 허브가 이 Mac을 차단했습니다. Vorssaint는 30분 후에 다시 요청합니다.",
        proxyHubManagementOff: "허브의 관리 API가 꺼져 있습니다. config.yaml에서 remote-management.secret-key를 설정하십시오.",
        proxyHubInsecure: "macOS는 암호화되지 않은 http를 IP 주소로만 허용합니다. https나 허브의 IP 주소를 사용하십시오.",
        proxyHubUnreachable: "허브에 연결할 수 없습니다. Dynamic Island에는 마지막 값이 남아 있습니다.",
        proxyHubFailedFormat: "허브가 오류로 응답했습니다(HTTP %@).",
        proxyHubAccountFailed: "허브가 이 계정을 읽지 못했습니다",
    ...
    static let zhHans = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI 中心",
        proxyHubsDescription: "在此 Mac 上的代理旁边，显示 CLIProxyAPI 中心汇集的每个 Claude 和 Codex 账户的额度。",
        proxyAddHub: "添加中心…",
        proxyAddHubTitle: "添加 CLIProxyAPI 中心",
        proxyAddHubDescription: "Vorssaint 会向中心询问它汇集的每个账户的额度。发往 Anthropic 和 OpenAI 的请求由中心自己发出，因此账户令牌不会到达此 Mac。",
        proxyHubURL: "中心 URL",
        proxyHubKey: "管理密钥",
        proxyHubLabel: "名称（可选）",
        proxyHubLabelPrompt: "默认为中心的主机名",
        proxyHubKeyNote: "Vorssaint 将密钥保存在只有你的用户可以读取的文件中。设置备份不包含它。",
        proxyHubInvalidURL: "请输入中心的地址，例如 https://hub.example.net:8310。",
        proxyHubSaveFailed: "Vorssaint 无法保存该中心。",
        proxyAddHubButton: "添加中心",
        proxyCancel: "取消",
        proxyRemoveHub: "移除",
        proxyHubOff: "仅在 AI 页面开启时检查",
        proxyHubChecking: "正在检查…",
        proxyHubReadyFormat: "已连接 · 账户：%@",
        proxyHubRemoteDisabled: "该中心只接受来自其自身机器的管理调用。请在它的 config.yaml 中将 remote-management.allow-remote 设为 true。",
        proxyHubWrongKey: "中心拒绝了此密钥。由于中心会在五次错误密钥后封锁 Mac，Vorssaint 已停止询问。请移除该中心，再用正确的密钥重新添加。",
        proxyHubBlocked: "错误密钥太多，中心已封锁此 Mac。Vorssaint 将在 30 分钟后再次询问。",
        proxyHubManagementOff: "中心的管理 API 已关闭。请在它的 config.yaml 中设置 remote-management.secret-key。",
        proxyHubInsecure: "macOS 只允许以明文 http 连接 IP 地址。请使用 https 或中心的 IP 地址。",
        proxyHubUnreachable: "无法连接到中心。Dynamic Island 会保留最后的读数。",
        proxyHubFailedFormat: "中心返回了错误（HTTP %@）。",
        proxyHubAccountFailed: "中心无法读取此账户",
    ...
    static let zhTW = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI 中心",
        proxyHubsDescription: "在此 Mac 上的代理旁邊，顯示 CLIProxyAPI 中心彙集的每個 Claude 和 Codex 帳號的額度。",
        proxyAddHub: "加入中心⋯",
        proxyAddHubTitle: "加入 CLIProxyAPI 中心",
        proxyAddHubDescription: "Vorssaint 會向中心詢問它彙集的每個帳號的額度。傳往 Anthropic 和 OpenAI 的請求由中心自己送出，因此帳號權杖不會到達此 Mac。",
        proxyHubURL: "中心 URL",
        proxyHubKey: "管理密鑰",
        proxyHubLabel: "名稱（選用）",
        proxyHubLabelPrompt: "預設為中心的主機名稱",
        proxyHubKeyNote: "Vorssaint 會將密鑰存放在只有你的使用者可以讀取的檔案中。設定備份不包含它。",
        proxyHubInvalidURL: "請輸入中心的位址，例如 https://hub.example.net:8310。",
        proxyHubSaveFailed: "Vorssaint 無法儲存該中心。",
        proxyAddHubButton: "加入中心",
        proxyCancel: "取消",
        proxyRemoveHub: "移除",
        proxyHubOff: "僅在 AI 頁面開啟時檢查",
        proxyHubChecking: "正在檢查⋯",
        proxyHubReadyFormat: "已連線 · 帳號：%@",
        proxyHubRemoteDisabled: "該中心只接受來自其本機的管理呼叫。請在它的 config.yaml 中將 remote-management.allow-remote 設為 true。",
        proxyHubWrongKey: "中心拒絕了此密鑰。由於中心會在五次錯誤密鑰後封鎖 Mac，Vorssaint 已停止詢問。請移除該中心，再以正確的密鑰重新加入。",
        proxyHubBlocked: "錯誤密鑰太多，中心已封鎖此 Mac。Vorssaint 會在 30 分鐘後再次詢問。",
        proxyHubManagementOff: "中心的管理 API 已關閉。請在它的 config.yaml 中設定 remote-management.secret-key。",
        proxyHubInsecure: "macOS 只允許以未加密的 http 連線至 IP 位址。請使用 https 或中心的 IP 位址。",
        proxyHubUnreachable: "無法連線至中心。Dynamic Island 會保留最後的讀數。",
        proxyHubFailedFormat: "中心回傳了錯誤（HTTP %@）。",
        proxyHubAccountFailed: "中心無法讀取此帳號",
    ...
    static let zhHK = NotchAgentStrings(
        ...
        proxyHubsTitle: "CLIProxyAPI 中心",
        proxyHubsDescription: "在此 Mac 上的代理旁邊，顯示 CLIProxyAPI 中心匯集的每個 Claude 和 Codex 帳户的額度。",
        proxyAddHub: "加入中心⋯",
        proxyAddHubTitle: "加入 CLIProxyAPI 中心",
        proxyAddHubDescription: "Vorssaint 會向中心查詢它匯集的每個帳户的額度。傳往 Anthropic 和 OpenAI 的要求由中心自己發出，因此帳户權杖不會到達此 Mac。",
        proxyHubURL: "中心 URL",
        proxyHubKey: "管理密碼匙",
        proxyHubLabel: "名稱（可選）",
        proxyHubLabelPrompt: "預設為中心的主機名稱",
        proxyHubKeyNote: "Vorssaint 會將密碼匙存放在只有你的使用者可以讀取的檔案中。設定備份不包括它。",
        proxyHubInvalidURL: "請輸入中心的地址，例如 https://hub.example.net:8310。",
        proxyHubSaveFailed: "Vorssaint 無法儲存該中心。",
        proxyAddHubButton: "加入中心",
        proxyCancel: "取消",
        proxyRemoveHub: "移除",
        proxyHubOff: "只在 AI 頁面開啟時檢查",
        proxyHubChecking: "正在檢查⋯",
        proxyHubReadyFormat: "已連線 · 帳户：%@",
        proxyHubRemoteDisabled: "該中心只接受來自其本機的管理呼叫。請在它的 config.yaml 中將 remote-management.allow-remote 設為 true。",
        proxyHubWrongKey: "中心拒絕了此密碼匙。由於中心會在五次錯誤密碼匙後封鎖 Mac，Vorssaint 已停止查詢。請移除該中心，再以正確的密碼匙重新加入。",
        proxyHubBlocked: "錯誤密碼匙太多，中心已封鎖此 Mac。Vorssaint 會在 30 分鐘後再次查詢。",
        proxyHubManagementOff: "中心的管理 API 已關閉。請在它的 config.yaml 中設定 remote-management.secret-key。",
        proxyHubInsecure: "macOS 只容許以未加密的 http 連線至 IP 地址。請使用 https 或中心的 IP 地址。",
        proxyHubUnreachable: "無法連線至中心。Dynamic Island 會保留最後的讀數。",
        proxyHubFailedFormat: "中心傳回了錯誤（HTTP %@）。",
        proxyHubAccountFailed: "中心無法讀取此帳户",
        proxyHubAccountFormat: "透過 %@",
