...
extension FeatureHubStrings {
    static let ko = FeatureHubStrings(
        ...
        explainAudioCapture: "믹서가 앱별 볼륨을 조절할 수 있게 합니다.",
...
extension FeatureHubStrings {
    ...
    static let ptBR = FeatureHubStrings(
        ...
        explainAudioCapture: "Deixa o mixer ajustar o volume de cada app.",
    ...
    static let tr = FeatureHubStrings(
        ...
        explainAudioCapture: "Mikserin her uygulamanın sesini ayarlamasını sağlar.",
    ...
    static let ru = FeatureHubStrings(
        ...
        explainAudioCapture: "Позволяет микшеру настраивать громкость каждого приложения.",
    ...
    static let es = FeatureHubStrings(
        ...
        explainAudioCapture: "Permite que el mezclador ajuste el volumen de cada app.",
    ...
    static let de = FeatureHubStrings(
        ...
        explainAudioCapture: "Lässt den Mixer die Lautstärke jeder App regeln.",
    ...
    static let fr = FeatureHubStrings(
        ...
        explainAudioCapture: "Permet au mixeur d'ajuster le volume de chaque app.",
    ...
    static let it = FeatureHubStrings(
        ...
        explainAudioCapture: "Permette al mixer di regolare il volume di ogni app.",
    ...
    static let ja = FeatureHubStrings(
        ...
        explainAudioCapture: "ミキサーがアプリごとの音量を調整できるようにします。",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        explainAudioCapture: "让混音器调整每个 App 的音量。",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        explainAudioCapture: "讓混音器調整每個 App 的音量。",
    ...
    static let ar = FeatureHubStrings(
        pageTitle: "المزايا",
        intro: "ثبّت ما تستخدمه فقط. وكل ما تلغي تثبيته يختفي من التطبيق بأكمله ويتوقف عن التحميل.",
        tabFeatures: "المزايا",
        ...
        groupWindowsDock: "النوافذ والـ Dock",
        groupMouseKeyboard: "الماوس ولوحة المفاتيح",
        groupClipboardFiles: "الحافظة والملفات",
        groupSound: "الصوت",
        groupEnergyDisplay: "الطاقة والشاشة",
        groupTools: "الأدوات",
        groupMonitor: "مراقبة النظام",
        permissionsIntro: "ما الذي يفعله كل إذن وأي المزايا تستخدمه. أما بقية الأذونات فتُطلب عند استخدامها فقط.",
        usedByFormat: "يستخدمه %@",
        usedByNone: "لا شيء مفعّل يستخدم هذا الإذن حاليًا.",
        unusedBanner: "منحت هذا الإذن، لكن لا شيء مفعّل يحتاج إليه. يمكنك سحبه من إعدادات النظام إن أردت.",
        statusGranted: "ممنوح",
        statusMissing: "غير ممنوح",
        statusUnknown: "لا يستطيع التطبيق التحقق من هذا",
        requestButton: "طلب",
        openSystemSettings: "فتح إعدادات النظام",
        permAccessibility: "إمكانية الوصول",
        permScreenRecording: "تسجيل الشاشة",
        permFullDisk: "الوصول الكامل للقرص",
        permFilesAndFolders: "الملفات والمجلدات",
        permNotifications: "الإشعارات",
        permAutomationFinder: "أتمتة Finder",
        permAutomationTerminal: "أتمتة Terminal",
        permAudioCapture: "صوت التطبيقات",
        explainAccessibility: "يتيح للمزايا التفاعل مع النقرات والمفاتيح وتحريك النوافذ.",
        explainScreenRecording: "يتيح للمزايا عرض مصغّرات النوافذ وقراءة النص على الشاشة.",
        explainFullDisk: "يتيح للمنظّف وأداة إلغاء التثبيت العثور على الملفات المتبقية في كل مكان.",
        explainFilesAndFolders: "يتيح لتنظيف تنزيلات WhatsApp وللمنظّم التجريبي فحص مجلد التنزيلات.",
        explainNotifications: "يتيح للتطبيق إشعارك بالتنبيهات التي فعّلتها.",
        explainAutomationFinder: "يتيح للتطبيق أن يطلب من Finder نقل الملفات نيابةً عنك.",
        explainAutomationTerminal: "يتيح فتح أوامر Homebrew في Terminal.",
        explainAudioCapture: "يتيح للخالط ضبط مستوى صوت كل تطبيق.",
        descSwitcher: "بدّل بين التطبيقات والنوافذ مع المعاينات",
        descDockPreview: "معاينات النوافذ عند تمرير المؤشر فوق الـ Dock",
        descDockClick: "انقر أيقونة في الـ Dock لتصغير النوافذ أو التنقل بينها",
        descWindowMaximizer: "الزر الأخضر يكبّر بدلًا من ملء الشاشة",
        descWindowLayout: "رتّب النوافذ بالاختصارات أو المحاذاة عند الحواف، ثم اضبطها بالسحب",
        descAutoQuit: "إنهاء التطبيقات عند إغلاق آخر نافذة لها",
        descScrollInverter: "عكس اتجاه عجلة الماوس",
        descSmoothScroll: "تمرير سلس ومتحرك بالماوس",
        descMouseNavigation: "أزرار الماوس الجانبية للتنقل للخلف والأمام",
        descMiddleClick: "النقر بثلاثة أصابع يعمل كنقرة وسطى",
        descKeyboardDebounce: "تجاهل الضغطات المزدوجة غير المقصودة",
        descClipboardHistory: "احتفظ بسجل محلي لما تنسخه",
        descPastePlain: "لصق النص بدون تنسيق",
        descFinderCutPaste: "قص الملفات ولصقها في Finder",
        descShelf: "أفلِت الملفات على شريط القائمة للاحتفاظ بها",
        descURLCleaner: "الروابط المنسوخة تفقد مقاطع التتبع",
        descMixer: "شريط تمرير للصوت لكل تطبيق",
        descSoundOutputSwitcher: "التنقل بين مخارج الصوت باختصار",
        descMicMute: "كتم الميكروفون من أي مكان",
        descMusicBlock: "منع تطبيق Music من تشغيل نفسه",
        descKeepAwake: "أبقِ الـ Mac مستيقظًا عند الطلب",
        descExtraBrightness: "سطوع إضافي على شاشات XDR",
        descQuickLauncher: "لوحة عائمة بأدواتك المفضلة",
        descColorPicker: "التقط أي لون على الشاشة",
        descScreenOCR: "انسخ النص أو رموز QR من أي شيء على الشاشة",
        descCleaningMode: "قفل لوحة المفاتيح والشاشة للتنظيف",
        descMediaTools: "ضغط الفيديوهات والصور وملفات GIF",
        descCleaner: "امسح ذاكرات التخزين المؤقت والملفات غير المرغوبة",
        descUninstaller: "أزِل التطبيقات وبقاياها",
        descHomebrew: "أبقِ حزم Homebrew محدّثة",
        descMonitorCPU: "استخدام المعالج وحرارته",
        descMonitorGPU: "استخدام بطاقة الرسوم وحرارتها",
        descMonitorMemory: "استخدام الذاكرة وضغطها",
        ...
        installAllButton: "تثبيت الكل",
        uninstallAllButton: "إلغاء تثبيت الكل",
        presetsTitle: "ابدأ بحزمة",
        presetsCaption: "نقرة واحدة تُعد التطبيق حسب طريقة استخدامك للـ Mac. وكل ما عداها يبقى على بعد نقرة واحدة.",
        presetEssentialName: "الأساسيات",
        presetEssentialDesc: "خالط الصوت ومراقبة النظام والإبقاء مستيقظًا.",
        presetWindowsName: "النوافذ",
        presetWindowsDesc: "مبدّل التطبيقات وتخطيط النوافذ ومزايا الـ Dock.",
        presetBatteryName: "البطارية والهدوء",
        presetBatteryDesc: "مراقبة خفيفة للبطارية والذاكرة والمعالج. ولا شيء يراقب الإدخال.",
        presetApplyButton: "تطبيق",
        presetConfirmFormat: "تثبيت حزمة %1$@ وإلغاء تثبيت البقية؟ لا يُحذف شيء، وكل شيء يعود بنقرة واحدة.",
        presetConfirmApply: "تطبيق الحزمة",
        presetConfirmCancel: "إلغاء",
        energyIdle: "لا شيء في وضع السكون",
        energyMouse: "يراقب الماوس",
        energyPointer: "يراقب إدخال المؤشر",
        energyKeyboard: "يراقب لوحة المفاتيح",
        energyInputs: "يراقب الماوس ولوحة المفاتيح",
        energyPeriodic: "يتحقق على فترات",
        energyHelp: "ما تُبقيه الميزة نشطًا أثناء تشغيلها. أما المزايا الملغى تثبيتها فلا تحمّل شيئًا على الإطلاق.",
        explainAppManagement: "يتيح للتحديثات استبدال التطبيقات التي ثبّتها مدير الحزم أو إزالتها.",
