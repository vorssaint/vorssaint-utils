...
struct FeatureHubStrings {
    ...
    let descQuarantineManager: String
...
extension FeatureHubStrings {
    static let ko = FeatureHubStrings(
        ...
        descQuarantineManager: "인터넷에서 다운로드된 항목의 격리 플래그 해제",
...
extension FeatureHubStrings {
    static let enUS = FeatureHubStrings(
        ...
        descQuarantineManager: "Clear the downloaded-from-the-internet flag",
    ...
    static let ptBR = FeatureHubStrings(
        ...
        descQuarantineManager: "Remova o sinalizador de baixado da internet",
    ...
    static let tr = FeatureHubStrings(
        ...
        descQuarantineManager: "İnternetten indirildi bayrağını temizle",
    ...
    static let ru = FeatureHubStrings(
        ...
        descQuarantineManager: "Снимает флаг «загружено из интернета»",
    ...
    static let es = FeatureHubStrings(
        ...
        descQuarantineManager: "Quita el indicador de descargado de Internet",
    ...
    static let de = FeatureHubStrings(
        ...
        descQuarantineManager: "Entfernt das Internet-Download-Flag",
    ...
    static let fr = FeatureHubStrings(
        ...
        descQuarantineManager: "Retire l’indicateur de téléchargement Internet",
    ...
    static let it = FeatureHubStrings(
        ...
        descQuarantineManager: "Rimuove il flag di download da Internet",
    ...
    static let ja = FeatureHubStrings(
        ...
        descQuarantineManager: "インターネットからダウンロードされた項目の隔離フラグを解除",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        descQuarantineManager: "清除来自互联网下载的隔离标记",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        descQuarantineManager: "清除從網路下載的隔離標記",
    ...
    static let zhHK = FeatureHubStrings(
        ...
        descCleaner: "清理快取和垃圾檔案",
        descUninstaller: "移除 App 並清除殘留",
        descQuarantineManager: "清除從互聯網下載的隔離標記",
        descHomebrew: "讓 Homebrew 套件保持最新",
        descMonitorCPU: "處理器使用率與溫度",
