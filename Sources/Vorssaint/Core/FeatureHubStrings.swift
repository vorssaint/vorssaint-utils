...
extension FeatureHubStrings {
    ...
    static let he = FeatureHubStrings(
        ...
        explainAudioCapture: "מאפשר למיקסר להתאים את עוצמת הקול של כל אפליקציה, לפסים של Dynamic Island לעקוב אחרי המוזיקה ולהקלטות מסך לכלול את הצליל של ה-Mac.",
        ...
        descMixer: "עוצמת קול לכל אפליקציה, הצמדה וסדר משלך",
