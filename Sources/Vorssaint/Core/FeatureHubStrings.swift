...
extension FeatureHubStrings {
    ...
    static let nl = FeatureHubStrings(
        pageTitle: "Functies",
        intro: "Installeer alleen wat je gebruikt. Wat je verwijdert, verdwijnt uit de hele app en wordt niet meer geladen.",
        tabFeatures: "Functies",
        tabPermissions: "Toestemmingen",
        activeCountFormat: "%1$d van %2$d functies geïnstalleerd",
        monitorAllOffNote: "Als alles uit staat, verdwijnt de monitor uit het paneel en de menubalk.",
        titleDockClick: "Dock-klikken",
        titleMouseNavigation: "Zijknoppen",
        titleMusicBlock: "Muziek-app-blokkering",
        groupWindowsDock: "Vensters en Dock",
        groupMouseKeyboard: "Muis en toetsenbord",
        groupClipboardFiles: "Klembord en bestanden",
        groupSound: "Geluid",
        groupEnergyDisplay: "Energie en beeldscherm",
        groupTools: "Hulpmiddelen",
        groupMonitor: "Systeemmonitor",
        permissionsIntro: "Wat elke toestemming doet en welke functies deze gebruiken. Andere toegang wordt alleen gevraagd wanneer je die gebruikt.",
        usedByFormat: "Gebruikt door %@",
        usedByNone: "Niets dat nu aan staat, gebruikt deze toestemming.",
        unusedBanner: "Je hebt deze toestemming gegeven, maar niets dat aan staat heeft het nodig. Je kunt het intrekken in Systeeminstellingen als je wilt.",
        statusGranted: "Verleend",
        statusMissing: "Niet verleend",
        statusUnknown: "De app kan dit niet controleren",
        requestButton: "Aanvragen",
        openSystemSettings: "Systeeminstellingen openen",
        permAccessibility: "Toegankelijkheid",
        permScreenRecording: "Schermopname",
        permFullDisk: "Volledige schijftoegang",
        permFilesAndFolders: "Bestanden en mappen",
        permNotifications: "Meldingen",
        permAutomationFinder: "Finder-automatisering",
        permAutomationTerminal: "Terminal-automatisering",
        permAudioCapture: "App-audio",
        explainAccessibility: "Laat functies reageren op klikken en toetsen, en vensters verplaatsen.",
        explainScreenRecording: "Laat functies vensterminiaturen tonen en tekst op het scherm lezen.",
        explainFullDisk: "Laat de opruimer en de verwijderaar overal achtergebleven bestanden vinden.",
        explainFilesAndFolders: "Laat de WhatsApp-downloadopruiming en de experimentele organizer je Downloads-map inspecteren.",
        explainNotifications: "Laat de app je waarschuwen over meldingen die je hebt ingeschakeld.",
        explainAutomationFinder: "Laat de app Finder vragen om bestanden voor je te verplaatsen.",
        explainAutomationTerminal: "Laat Homebrew-opdrachten openen in Terminal.",
        explainAudioCapture: "Laat de mixer het volume van elke app aanpassen.",
        descSwitcher: "Wissel tussen apps en vensters met voorvertoningen",
        descDockPreview: "Vensterminiaturen wanneer je over het Dock zweeft",
        descDockClick: "Klik op een Dock-symbool om te minimaliseren of tussen vensters te wisselen",
        descWindowMaximizer: "De groene knop maximaliseert in plaats van volledig scherm",
        descWindowLayout: "Schik vensters met sneltoetsen of magnetische randen, en pas ze aan door te slepen",
        descAutoQuit: "Sluit apps af zodra hun laatste venster sluit",
        descScrollInverter: "Keer de richting van het muiswiel om",
        descSmoothScroll: "Vloeiend, geanimeerd scrollen met de muis",
        descMouseNavigation: "Zijknoppen van de muis gaan terug en vooruit",
        descMiddleClick: "Klik met drie vingers werkt als middelste klik",
        descKeyboardDebounce: "Negeer per ongeluk dubbele toetsaanslagen",
        descClipboardHistory: "Bewaar een lokale geschiedenis van wat je kopieert",
        descPastePlain: "Plak tekst zonder opmaak",
        descFinderCutPaste: "Knip en plak bestanden in Finder",
        descShelf: "Zet bestanden op de menubalk om ze vast te houden",
        descURLCleaner: "Gekopieerde links verliezen hun trackingrommel",
        descMixer: "Een volumeschuif voor elke app",
        descSoundOutputSwitcher: "Wissel tussen geluidsuitgangen met een sneltoets",
        descMicMute: "Demp de microfoon vanaf overal",
        descMusicBlock: "Voorkom dat de Muziek-app zichzelf opent",
        descKeepAwake: "Houd de Mac wakker wanneer je wilt",
        descExtraBrightness: "Extra helderheid op XDR-schermen",
        descQuickLauncher: "Een zwevend paneel met je favoriete hulpmiddelen",
        descColorPicker: "Kies elke kleur op het scherm",
        descScreenOCR: "Kopieer tekst of QR-codes van alles op het scherm",
        descCleaningMode: "Vergrendel toetsenbord en scherm om schoon te maken",
        descMediaTools: "Comprimeer video's, afbeeldingen en GIF's",
        descCleaner: "Ruim caches en rommelbestanden op",
        descUninstaller: "Verwijder apps en hun restanten",
        descHomebrew: "Houd Homebrew-pakketten up-to-date",
        descMonitorCPU: "Processorgebruik en temperatuur",
        descMonitorGPU: "GPU-gebruik en temperatuur",
        descMonitorMemory: "Geheugengebruik en -druk",
        descMonitorNetwork: "Netwerksnelheid en -gebruik",
        descMonitorDisk: "Schijfruimte en -activiteit",
        descMonitorPower: "Batterij, stroom en opladen",
        installButton: "Installeren",
        uninstallButton: "Verwijderen",
        footerNote: "Verwijderen wist niets: de functie verdwijnt gewoon uit de app en wordt niet meer geladen. Installeer hem op elk moment opnieuw en alles komt terug zoals het was.",
        restartNote: "Functies die je in deze sessie hebt verwijderd, blijven geladen totdat de app herstart. Herstart nu om ze uit het geheugen te verwijderen.",
        restartButton: "Nu herstarten",
        installAllButton: "Alles installeren",
        uninstallAllButton: "Alles verwijderen",
        presetsTitle: "Begin met een bundel",
        presetsCaption: "Eén klik stelt de app in op hoe je je Mac gebruikt. De rest blijft één klik verwijderd.",
        presetEssentialName: "Basis",
        presetEssentialDesc: "Volumemixer, systeemmonitor en wakker houden.",
        presetWindowsName: "Vensters",
        presetWindowsDesc: "App-wisselaar, vensterindeling en de Dock-functies.",
        presetBatteryName: "Batterij en stilte",
        presetBatteryDesc: "Een compacte monitor met batterij, geheugen en processor. Niets luistert naar invoer.",
        presetApplyButton: "Toepassen",
        presetConfirmFormat: "Bundel %1$@ installeren en de rest verwijderen? Er wordt niets verwijderd en alles komt met één klik terug.",
        presetConfirmApply: "Bundel toepassen",
        presetConfirmCancel: "Annuleren",
        energyIdle: "Niets in rust",
        energyMouse: "Luistert naar de muis",
        energyPointer: "Luistert naar aanwijzerinvoer",
        energyKeyboard: "Luistert naar het toetsenbord",
        energyInputs: "Luistert naar muis en toetsenbord",
        energyPeriodic: "Controleert met tussenpozen",
        energyHelp: "Wat de functie actief houdt terwijl hij aan staat. Verwijderde functies laden helemaal niets.",
        explainAppManagement: "Laat updates apps vervangen of verwijderen die door de pakketbeheerder zijn geïnstalleerd.",
        onboardingSelectedPermissionsTitle: "Toestemmingen voor jouw keuzes",
        onboardingNoSelectedPermissions: "Je hoeft geen toestemming te geven om de installatie te voltooien.",
        onboardingOtherPermissionsTitle: "Overige toestemmingen",
        onboardingOtherPermissionsCaption: "Optioneel. Geef deze nu of later, wanneer een functie ze nodig heeft."
    )
    ...
    static let fr = FeatureHubStrings(
        ...
        footerNote: "Désinstaller n'efface rien : la fonction disparaît simplement de l'app et ne se charge plus. Réinstallez-la quand vous voulez, tout revient comme avant.",
        ...
        presetConfirmFormat: "Installer le pack %1$@ et désinstaller le reste ? Rien n'est effacé et tout revient en un clic.",
