...
extension FeatureHubStrings {
    static let ko = FeatureHubStrings(
        ...
        explainAutomationTerminal: "Homebrew 명령을 %@에서 열 수 있게 합니다.",
...
extension FeatureHubStrings {
    static let enUS = FeatureHubStrings(
        ...
        permAutomationTerminal: "%@ automation",
        ...
        explainAutomationTerminal: "Lets Homebrew commands open in %@.",
    ...
    static let ptBR = FeatureHubStrings(
        ...
        permAutomationTerminal: "Automação do %@",
        ...
        explainAutomationTerminal: "Deixa os comandos do Homebrew abrirem no %@.",
    ...
    static let tr = FeatureHubStrings(
        ...
        permAutomationTerminal: "%@ otomasyonu",
        ...
        explainAutomationTerminal: "Homebrew komutlarının %@'de açılmasını sağlar.",
    ...
    static let ru = FeatureHubStrings(
        ...
        permAutomationTerminal: "Автоматизация %@",
        ...
        explainAutomationTerminal: "Позволяет командам Homebrew открываться в %@.",
    ...
    static let es = FeatureHubStrings(
        ...
        permAutomationTerminal: "Automatización de %@",
        ...
        explainAutomationTerminal: "Permite que los comandos de Homebrew se abran en %@.",
    ...
    static let de = FeatureHubStrings(
        ...
        explainAutomationTerminal: "Lässt Homebrew-Befehle im %@ öffnen.",
    ...
    static let fr = FeatureHubStrings(
        ...
        permAutomationTerminal: "Automatisation de %@",
        ...
        explainAutomationTerminal: "Permet aux commandes Homebrew de s'ouvrir dans %@.",
    ...
    static let it = FeatureHubStrings(
        ...
        permAutomationTerminal: "Automazione di %@",
        ...
        explainAutomationTerminal: "Permette ai comandi Homebrew di aprirsi in %@.",
    ...
    static let ja = FeatureHubStrings(
        ...
        explainAutomationTerminal: "Homebrewのコマンドを %@ で開けるようにします。",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        explainAutomationTerminal: "让 Homebrew 命令在 %@ 中打开。",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        explainAutomationTerminal: "讓 Homebrew 指令在 %@ 中打開。",
    ...
    static let zhHK = FeatureHubStrings(
        ...
        explainAutomationTerminal: "讓 Homebrew 指令在 %@ 中開啟。",
        explainAudioCapture: "讓混音器調整每個 App 的音量。",
        descSwitcher: "帶預覽地切換 App 和視窗",
        descDockPreview: "游標停在 Dock 上時顯示視窗預覽",
