...
extension FeatureHubStrings {
    ...
    static let vi = FeatureHubStrings(
        pageTitle: "Tính năng",
        intro: "Chỉ cài đặt những gì đang dùng. Gỡ cài đặt tính năng nào thì tính năng đó biến mất khỏi toàn bộ ứng dụng và không còn được tải nữa.",
        tabFeatures: "Tính năng",
        tabPermissions: "Quyền",
        activeCountFormat: "%1$d trên %2$d tính năng đã cài đặt",
        monitorAllOffNote: "Khi tắt hết, Bộ giám sát biến mất khỏi bảng điều khiển và thanh menu.",
        titleDockClick: "Nhấp Dock",
        titleMouseNavigation: "Nút bên hông",
        titleMusicBlock: "Chặn ứng dụng Nhạc",
        groupWindowsDock: "Cửa sổ và Dock",
        groupMouseKeyboard: "Chuột và bàn phím",
        groupClipboardFiles: "Khay nhớ tạm và tệp",
        groupSound: "Âm thanh",
        groupEnergyDisplay: "Năng lượng và màn hình",
        groupTools: "Công cụ",
        groupMonitor: "Bộ giám sát hệ thống",
        permissionsIntro: "Vai trò của từng quyền và những tính năng sử dụng quyền đó. Các quyền truy cập khác chỉ được yêu cầu khi thực sự dùng đến.",
        usedByFormat: "Được dùng bởi %@",
        usedByNone: "Hiện không có tính năng nào đang bật sử dụng quyền này.",
        unusedBanner: "Quyền này đã được cấp, nhưng không có tính năng nào đang bật cần đến nó. Có thể thu hồi trong Cài đặt Hệ thống nếu muốn.",
        statusGranted: "Đã cấp",
        statusMissing: "Chưa cấp",
        statusUnknown: "Ứng dụng không thể kiểm tra quyền này",
        requestButton: "Yêu cầu",
        openSystemSettings: "Mở Cài đặt Hệ thống",
        permAccessibility: "Trợ năng",
        permScreenRecording: "Ghi màn hình",
        permFullDisk: "Toàn quyền truy cập ổ đĩa",
        permFilesAndFolders: "Tệp và thư mục",
        permNotifications: "Thông báo",
        permAutomationFinder: "Tự động hóa Finder",
        permAutomationTerminal: "Tự động hóa Terminal",
        permAudioCapture: "Âm thanh ứng dụng",
        explainAccessibility: "Cho phép các tính năng phản hồi khi nhấp và nhấn phím, cũng như di chuyển cửa sổ.",
        explainScreenRecording: "Cho phép các tính năng hiển thị hình thu nhỏ cửa sổ và đọc văn bản trên màn hình.",
        explainFullDisk: "Cho phép trình dọn dẹp và trình gỡ cài đặt tìm tệp còn sót lại ở mọi nơi.",
        explainFilesAndFolders: "Cho phép chức năng dọn dẹp tệp tải xuống của WhatsApp và trình sắp xếp thử nghiệm kiểm tra thư mục Tải xuống.",
        explainNotifications: "Cho phép ứng dụng thông báo về các cảnh báo đã bật.",
        explainAutomationFinder: "Cho phép ứng dụng yêu cầu Finder di chuyển tệp thay cho người dùng.",
        explainAutomationTerminal: "Cho phép các lệnh Homebrew mở trong Terminal.",
        explainAudioCapture: "Cho phép bộ trộn âm điều chỉnh âm lượng của từng ứng dụng.",
        descSwitcher: "Chuyển đổi ứng dụng và cửa sổ kèm bản xem trước",
        descDockPreview: "Xem trước cửa sổ khi di chuột qua Dock",
        descDockClick: "Nhấp biểu tượng Dock để thu nhỏ hoặc chuyển cửa sổ",
        descWindowMaximizer: "Nút xanh lá phóng to thay vì toàn màn hình",
        descWindowLayout: "Sắp xếp cửa sổ bằng phím tắt hoặc ghim vào cạnh màn hình, rồi điều chỉnh bằng cách kéo",
        descAutoQuit: "Thoát ứng dụng khi cửa sổ cuối cùng đóng lại",
        descScrollInverter: "Đảo chiều cuộn của con lăn chuột",
        descSmoothScroll: "Cuộn chuột mượt mà, có hiệu ứng chuyển động",
        descMouseNavigation: "Nút bên hông của chuột dùng để lùi và tiến",
        descMiddleClick: "Nhấp bằng ba ngón tay hoạt động như nhấp giữa",
        descKeyboardDebounce: "Bỏ qua các lần nhấn phím đúp ngoài ý muốn",
        descClipboardHistory: "Lưu lịch sử cục bộ những gì đã sao chép",
        descPastePlain: "Dán văn bản không định dạng",
        descFinderCutPaste: "Cắt và dán tệp trong Finder",
        descShelf: "Thả tệp vào thanh menu để giữ tạm",
        descURLCleaner: "Liên kết đã sao chép được loại bỏ tham số theo dõi",
        descMixer: "Thanh trượt âm lượng riêng cho từng ứng dụng",
        descSoundOutputSwitcher: "Chuyển đổi đầu ra âm thanh bằng phím tắt",
        descMicMute: "Tắt tiếng micro từ bất kỳ đâu",
        descMusicBlock: "Ngăn ứng dụng Nhạc tự khởi chạy",
        descKeepAwake: "Giữ Mac ở trạng thái thức khi cần",
        descExtraBrightness: "Độ sáng bổ sung trên màn hình XDR",
        descQuickLauncher: "Bảng nổi chứa các công cụ yêu thích",
        descColorPicker: "Chọn bất kỳ màu nào trên màn hình",
        descScreenOCR: "Sao chép văn bản hoặc mã QR từ bất kỳ đâu trên màn hình",
        descCleaningMode: "Khóa bàn phím và màn hình để vệ sinh",
        descMediaTools: "Nén video, hình ảnh và GIF",
        descCleaner: "Dọn dẹp bộ nhớ đệm và tệp rác",
        descUninstaller: "Gỡ bỏ ứng dụng cùng các tệp còn sót lại",
        descHomebrew: "Giữ các gói Homebrew luôn cập nhật",
        descMonitorCPU: "Mức sử dụng và nhiệt độ bộ xử lý",
        descMonitorGPU: "Mức sử dụng và nhiệt độ đồ họa",
        descMonitorMemory: "Mức sử dụng và áp lực bộ nhớ",
        descMonitorNetwork: "Tốc độ và mức sử dụng mạng",
        descMonitorDisk: "Dung lượng và hoạt động ổ đĩa",
        descMonitorPower: "Pin, nguồn điện và sạc",
        installButton: "Cài đặt",
        uninstallButton: "Gỡ cài đặt",
        footerNote: "Gỡ cài đặt không xóa bất cứ điều gì: tính năng chỉ rời khỏi ứng dụng và ngừng tải. Cài đặt lại bất cứ lúc nào và mọi thứ sẽ trở lại như cũ.",
        restartNote: "Các tính năng đã gỡ cài đặt trong phiên này vẫn được tải cho đến khi ứng dụng khởi động lại. Khởi động lại ngay để giải phóng chúng khỏi bộ nhớ.",
        restartButton: "Khởi động lại ngay",
        installAllButton: "Cài đặt tất cả",
        uninstallAllButton: "Gỡ cài đặt tất cả",
        presetsTitle: "Bắt đầu với một gói",
        presetsCaption: "Chỉ một lần nhấp để thiết lập ứng dụng theo cách sử dụng Mac. Mọi thứ khác vẫn chỉ cách một lần nhấp.",
        presetEssentialName: "Cơ bản",
        presetEssentialDesc: "Bộ trộn âm lượng, bộ giám sát hệ thống và giữ thức.",
        presetWindowsName: "Cửa sổ",
        presetWindowsDesc: "Bộ chuyển đổi ứng dụng, sắp xếp cửa sổ và các tính năng Dock.",
        presetBatteryName: "Pin và yên tĩnh",
        presetBatteryDesc: "Bộ giám sát gọn nhẹ với pin, bộ nhớ và bộ xử lý. Không có gì theo dõi đầu vào.",
        presetApplyButton: "Áp dụng",
        presetConfirmFormat: "Cài đặt gói %1$@ và gỡ cài đặt phần còn lại? Không có gì bị xóa, và mọi thứ có thể quay lại chỉ với một lần nhấp.",
        presetConfirmApply: "Áp dụng gói",
        presetConfirmCancel: "Hủy",
        energyIdle: "Không hoạt động khi rảnh",
        energyMouse: "Theo dõi chuột",
        energyPointer: "Theo dõi đầu vào con trỏ",
        energyKeyboard: "Theo dõi bàn phím",
        energyInputs: "Theo dõi chuột và bàn phím",
        energyPeriodic: "Kiểm tra theo chu kỳ",
        energyHelp: "Chi phí duy trì khi tính năng đang bật. Tính năng đã gỡ cài đặt không tải bất cứ điều gì.",
        explainAppManagement: "Cho phép các bản cập nhật thay thế hoặc gỡ bỏ ứng dụng đã cài đặt qua trình quản lý gói.",
        onboardingSelectedPermissionsTitle: "Quyền cần cho các lựa chọn đã chọn",
        onboardingNoSelectedPermissions: "Không cần cấp quyền nào để hoàn tất thiết lập.",
        onboardingOtherPermissionsTitle: "Quyền khác",
        onboardingOtherPermissionsCaption: "Tùy chọn. Có thể cấp các quyền này ngay bây giờ hoặc sau, khi một tính năng cần đến."
    )
}
