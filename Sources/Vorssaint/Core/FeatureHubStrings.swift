...
extension FeatureHubStrings {
    ...
    static let he = FeatureHubStrings(
        pageTitle: "תכונות",
        intro: "התקן רק מה שאתה משתמש. כל מה שתסיר ייעלם מהאפליקציה כולה ויפסיק להיטען.",
        tabFeatures: "תכונות",
        tabPermissions: "הרשאות",
        activeCountFormat: "%1$d מתוך %2$d תכונות מותקנות",
        monitorAllOffNote: "כשהכל כבוי, המוניטור עוזב את הפאנל ואת שורת התפריט.",
        titleDockClick: "לחיצות ב-Dock",
        titleMouseNavigation: "כפתורי צד",
        titleMusicBlock: "חוסם אפליקציית מוזיקה",
        groupWindowsDock: "חלונות ו-Dock",
        groupMouseKeyboard: "עכבר ומקלדת",
        groupClipboardFiles: "לוח וקבצים",
        groupSound: "קול",
        groupEnergyDisplay: "אנרגיה ותצוגה",
        groupTools: "כלים",
        groupMonitor: "מוניטור מערכת",
        permissionsIntro: "מה כל הרשאה עושה ואילו תכונות משתמשות בה. גישות אחרות מתבקשות רק כשאתה משתמש בהן.",
        usedByFormat: "בשימוש על ידי %@",
        usedByNone: "שום דבר שמופעל לא משתמש בהרשאה זו כרגע.",
        unusedBanner: "הענקת הרשאה זו, אבל שום דבר שמופעל לא צריך אותה. אם תרצה, שלול אותה בהגדרות מערכת.",
        statusGranted: "הוענקה",
        statusMissing: "לא הוענקה",
        statusUnknown: "האפליקציה לא יכולה לבדוק את זו",
        requestButton: "בקש",
        openSystemSettings: "פתח הגדרות מערכת",
        permAccessibility: "נגישות",
        permScreenRecording: "הקלטת מסך",
        permFullDisk: "גישה מלאה לדיסק",
        permFilesAndFolders: "קבצים ותיקיות",
        permNotifications: "התראות",
        permAutomationFinder: "אוטומציית Finder",
        permAutomationTerminal: "אוטומציית טרמינל",
        permAudioCapture: "אודיו של אפליקציות",
        explainAccessibility: "מאפשר לתכונות להגיב ללחיצות ומקשים ולהזיז חלונות.",
        explainScreenRecording: "מאפשר לתכונות להציג תמונות ממוזערות של חלונות ולקרוא טקסט על המסך.",
        explainFullDisk: "מאפשר למנקה ולמסיר למצוא קבצים שנותרו בכל מקום.",
        explainFilesAndFolders: "מאפשר לניקוי הורדות WhatsApp ולמארגן הניסיוני לבדוק את תיקיית ההורדות.",
        explainNotifications: "מאפשר לאפליקציה להודיע לך על התראות שהפעלת.",
        explainAutomationFinder: "מאפשר לאפליקציה לבקש מ-Finder להזיז קבצים עבורך.",
        explainAutomationTerminal: "מאפשר לפקודות Homebrew להיפתח בטרמינל.",
        explainAudioCapture: "מאפשר למיקסר להתאים את עוצמת הקול של כל אפליקציה.",
        descSwitcher: "עבור בין אפליקציות וחלונות עם תצוגה מקדימה",
        descDockPreview: "תצוגות מקדימות של חלונות בריחוף מעל ה-Dock",
        descDockClick: "לחץ על אייקון ב-Dock למזעור או מעבר בין חלונות",
        descWindowMaximizer: "הכפתור הירוק מגדיל במקום מסך מלא",
        descWindowLayout: "סדר חלונות עם קיצורי דרך או הצמדה לקצוות, ואז התאם בגרירה",
        descAutoQuit: "סגור אפליקציות כשהחלון האחרון שלהן נסגר",
        descScrollInverter: "הפוך את כיוון גלגל העכבר",
        descSmoothScroll: "גלילה חלקה ומונפשת בעכבר",
        descMouseNavigation: "כפתורי צד בעכבר הולכים אחורה וקדימה",
        descMiddleClick: "לחיצה בשלוש אצבעות פועלת כלחיצה אמצעית",
        descKeyboardDebounce: "התעלם מלחיצות מקש כפולות בטעות",
        descClipboardHistory: "שמור היסטוריה מקומית של מה שאתה מעתיק",
        descPastePlain: "הדבק טקסט ללא עיצוב",
        descFinderCutPaste: "גזור והדבק קבצים ב-Finder",
        descShelf: "זרוק קבצים על שורת התפריט לאחסון זמני",
        descURLCleaner: "קישורים שהועתקו מאבדים את נתוני המעקב שלהם",
        descMixer: "מחוון עוצמה לכל אפליקציה",
        descSoundOutputSwitcher: "עבור בין יציאות קול עם קיצור דרך",
        descMicMute: "השתק את המיקרופון מכל מקום",
        descMusicBlock: "מנע מאפליקציית המוזיקה להיפתח מעצמה",
        descKeepAwake: "השאר את ה-Mac ער לפי דרישה",
        descExtraBrightness: "בהירות נוספת בתצוגות XDR",
        descQuickLauncher: "פאנל צף עם הכלים האהובים עליך",
        descColorPicker: "בחר כל צבע על המסך",
        descScreenOCR: "העתק טקסט או קודי QR מכל דבר על המסך",
        descCleaningMode: "נעל מקלדת ומסך לניקוי",
        descMediaTools: "דחוס סרטונים, תמונות ו-GIF",
        descCleaner: "נקה מטמונים וקבצים מיותרים",
        descUninstaller: "הסר אפליקציות ושאריות שלהן",
        descHomebrew: "שמור חבילות Homebrew מעודכנות",
        descMonitorCPU: "שימוש וטמפרטורת מעבד",
        descMonitorGPU: "שימוש וטמפרטורת גרפיקה",
        descMonitorMemory: "שימוש ולחץ זיכרון",
        ...
        installAllButton: "התקן הכל",
        uninstallAllButton: "הסר הכל",
        presetsTitle: "התחל עם חבילה",
        presetsCaption: "לחיצה אחת מגדירה את האפליקציה לפי איך שאתה משתמש ב-Mac. כל השאר נשאר במרחק לחיצה.",
        presetEssentialName: "יסודות",
        presetEssentialDesc: "מיקסר עוצמה, מוניטור מערכת ושמירה על ערנות.",
        presetWindowsName: "חלונות",
        presetWindowsDesc: "מחליף אפליקציות, סידור חלונות ותכונות ה-Dock.",
        presetBatteryName: "סוללה ושקט",
        presetBatteryDesc: "מוניטור רזה עם סוללה, זיכרון ומעבד. שום דבר לא מקשיב לקלט.",
        presetApplyButton: "החל",
        presetConfirmFormat: "להתקין את חבילת %1$@ ולהסיר את השאר? שום דבר לא נמחק, והכל חוזר בלחיצה אחת.",
        presetConfirmApply: "החל חבילה",
        presetConfirmCancel: "ביטול",
        energyIdle: "שום דבר במנוחה",
        energyMouse: "מקשיב לעכבר",
        energyPointer: "מקשיב לקלט מצביע",
        energyKeyboard: "מקשיב למקלדת",
        energyInputs: "מקשיב לעכבר ומקלדת",
        energyPeriodic: "בודק במרווחים",
        energyHelp: "מה התכונה מחזיקה בחיים בזמן שהיא פועלת. תכונות שהוסרו לא טוענות כלום.",
        explainAppManagement: "מאפשר לעדכונים להחליף או להסיר אפליקציות שהותקנו על ידי מנהל החבילות.",
