...
struct FeatureHubStrings {
    ...
    let titleAutoPauseMusic: String
    // Group headers
...
extension FeatureHubStrings {
    static let ko = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "음악 자동 일시정지",
        ...
        descAutoPauseMusic: "다른 소리가 재생되면 음악 플레이어를 자동으로 일시정지",
...
extension FeatureHubStrings {
    static let enUS = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Auto-pause music",
        ...
        descAutoPauseMusic: "Pauses your music player when something else plays audio",
    ...
    static let ptBR = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Pausar música automaticamente",
        ...
        descAutoPauseMusic: "Pausa seu player de música quando outro som toca",
    ...
    static let tr = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Müziği otomatik duraklat",
        ...
        descAutoPauseMusic: "Başka bir ses çalarken müzik çalarınızı otomatik duraklatır",
    ...
    static let ru = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Автопауза музыки",
        ...
        descAutoPauseMusic: "Ставит музыку на паузу, когда звучит другой звук",
    ...
    static let es = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Pausar música automáticamente",
        ...
        descAutoPauseMusic: "Pausa tu reproductor de música cuando algo más suena",
    ...
    static let de = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Musik automatisch pausieren",
        ...
        descAutoPauseMusic: "Pausiert deinen Musik-Player, wenn etwas anderes Ton wiedergibt",
    ...
    static let fr = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Pause automatique de la musique",
        ...
        descAutoPauseMusic: "Met votre lecteur de musique en pause quand un autre son est lu",
    ...
    static let it = FeatureHubStrings(
        ...
        titleAutoPauseMusic: "Pausa automatica della musica",
        ...
        descAutoPauseMusic: "Mette in pausa il lettore musicale quando riproduce qualcos'altro",
    ...
    static let ja = FeatureHubStrings(
        ...
        descAutoPauseMusic: "他の音声が再生されると音楽プレーヤーを自動的に一時停止",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        descAutoPauseMusic: "其他内容播放声音时自动暂停音乐播放器",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        descAutoPauseMusic: "其他內容播放聲音時自動暫停音樂播放器",
