...
extension FeatureHubStrings {
    static let ko = FeatureHubStrings(
        ...
        descSmoothScroll: "거리·속도·지속 시간으로 조절하는 부드러운 마우스 휠 스크롤",
...
extension FeatureHubStrings {
    ...
    static let ptBR = FeatureHubStrings(
        ...
        descSmoothScroll: "Rolagem suave da roda do mouse com passo, velocidade e duração",
    ...
    static let tr = FeatureHubStrings(
        ...
        descSmoothScroll: "Adım, hız ve süre ayarlı akıcı fare tekerleği kaydırması",
    ...
    static let ru = FeatureHubStrings(
        ...
        descSmoothScroll: "Плавная прокрутка колёсиком мыши с шагом, скоростью и длительностью",
    ...
    static let es = FeatureHubStrings(
        ...
        descSmoothScroll: "Desplazamiento suave de la rueda del ratón con paso, velocidad y duración",
    ...
    static let fr = FeatureHubStrings(
        ...
        descSmoothScroll: "Défilement fluide de la molette avec pas, vitesse et durée",
    ...
    static let it = FeatureHubStrings(
        ...
        descSmoothScroll: "Scorrimento fluido della rotella con passo, velocità e durata",
    ...
    static let ja = FeatureHubStrings(
        ...
        descSmoothScroll: "ステップ・速度・時間で調整できるなめらかなマウスホイールスクロール",
    ...
    static let zhHans = FeatureHubStrings(
        ...
        descSmoothScroll: "可调节步距、速度与时长的顺滑鼠标滚轮滚动",
    ...
    static let zhTW = FeatureHubStrings(
        ...
        descSmoothScroll: "可調整步距、速度與時長的順暢滑鼠滾輪捲動",
