...
extension Strings {
    static let it = Strings(
        ...
        statusItemContextMenuSection: "Menu del clic destro",
        statusItemContextMenuOrderHint: "Trascina per riordinare e usa l’occhio per mostrare o nascondere gli elementi. Impostazioni ed Esci sono sempre visibili.",
        statusItemContextMenuHideItem: "Nascondi dal menu del clic destro",
        statusItemContextMenuShowItem: "Mostra nel menu del clic destro",
        statusItemContextMenuAlwaysShown: "Sempre visibile",
        panelShowBrandMark: "Mostra il logo di Vorssaint",
        panelShowFooterActions: "Mostra i pulsanti Impostazioni ed Esci",
