...
extension Strings {
    static let it = Strings(
        ...
        monitorShowConnectedDevices: "Dispositivi collegati",
        usbExcludeChargers: "Escludi alimentatori e caricabatterie",
        usbExcludeHubs: "Escludi hub e dock USB",
        usbExcludeEthernet: "Escludi adattatori di rete ed Ethernet",
        usbExcludeStorage: "Escludi archiviazione esterna",
