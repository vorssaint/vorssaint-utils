...
extension Strings {
    static let ru = Strings(
        ...
        mediaPages: "Страницы",
        mediaRotation: "Поворот",
        mediaErrorPageSelection: "Указанные страницы отсутствуют в этом документе.",
        mediaPDFHint: "Страницы с изображением пережимаются, что удаляет невидимый слой OCR. Текстовые страницы остаются без изменений.",
        mediaStartCompressFormat: "Сжать %@",
        mediaStartConvertFormat: "Преобразовать в %@",
        mediaWidth: "Ширина",
        mediaFPS: "FPS",
