...
extension Strings {
    static let ru = Strings(
        ...
        clamshellExternalDisplayToggle: "Внешний дисплей",
        clamshellExternalDisplayCaption: "Режим с закрытой крышкой включается только пока выполняются выбранные условия (любое или все). «Не давать уснуть» остаётся как вы оставили.",
        clamshellGatePowerToggle: "От сети",
        clamshellGateNetworkToggle: "Есть сеть",
        clamshellGateModeAny: "Любое",
        clamshellGateModeAll: "Все",
        clamshellGateMatchLabel: "Условия",
