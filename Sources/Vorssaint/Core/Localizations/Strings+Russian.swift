...
extension Strings {
    static let ru = Strings(
        ...
        forwardDeleteTrash: "Перемещать в Корзину клавишей ⌦",
        forwardDeleteTrashCaption: "В Finder клавиша ⌦ перемещает выбранные объекты в Корзину, а ⌘⌫ продолжает работать. На клавиатурах без отдельной клавиши ⌦ она вводится как fn+⌫.",
