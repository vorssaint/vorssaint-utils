...
extension Strings {
    static let ru = Strings(
        ...
        menuBarIconStillHiddenBody: "macOS пока не показывает значок. Проверьте в Системных настройках, разрешено ли Vorssaint отображаться в строке меню. Ошибка сохранённого положения или нехватка места также может мешать отображению. Настройки Vorssaint остаются доступны.",
