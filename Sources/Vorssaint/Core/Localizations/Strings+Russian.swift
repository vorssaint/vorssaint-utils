...
extension Strings {
    static let ru = Strings(
        ...
        statusItemContextMenuSection: "Контекстное меню",
        statusItemContextMenuOrderHint: "Перетаскивайте, чтобы менять порядок, и используйте значок глаза, чтобы показывать или скрывать пункты. «Настройки» и «Выйти» отображаются всегда.",
        statusItemContextMenuHideItem: "Скрыть из контекстного меню",
        statusItemContextMenuShowItem: "Показать в контекстном меню",
        statusItemContextMenuAlwaysShown: "Отображается всегда",
        panelShowBrandMark: "Показывать логотип Vorssaint",
        panelShowFooterActions: "Показывать кнопки «Настройки» и «Выйти»",
