...
extension Strings {
    static let ru = Strings(
        ...
        switcherAppearanceDelayCaption: "Как долго нужно удерживать сочетание клавиш, прежде чем появится переключатель. Быстрое нажатие по-прежнему переключает без его показа.",
