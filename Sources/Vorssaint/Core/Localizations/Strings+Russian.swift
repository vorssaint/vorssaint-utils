...
extension Strings {
    static let ru = Strings(
        ...
        diskSpeedTest: "Тест скорости диска",
        diskSpeedQuick: "Быстрый · 1 ГБ",
        diskSpeedStandard: "Стандартный · 3×4 ГБ",
        diskSpeedDescription: "Записывает и удаляет временные файлы. Стандартный тест выполняет три прохода по 4 ГБ и показывает медиану; другая активность диска может повлиять на результат.",
        diskSpeedPreparing: "Подготовка…",
        diskSpeedFlushing: "Синхронизация с диском…",
        diskSpeedLastTest: "Последний тест",
        diskSpeedNeedsSpace: "Требуется не менее %@ свободного места.",
        diskSpeedReadOnly: "Этот диск доступен только для чтения.",
        diskSpeedUnavailable: "Диск недоступен или не удалось выполнить тест.",
