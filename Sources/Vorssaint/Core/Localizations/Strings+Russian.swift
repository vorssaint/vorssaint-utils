...
extension Strings {
    static let ru = Strings(
        ...
        autoPauseMusicSection: "Автопауза музыки",
        autoPauseMusicTitle: "Ставить музыку на паузу, когда звучит что-то ещё",
        autoPauseMusicCaption: "Когда другое приложение начинает воспроизводить звук или видео, Vorssaint ставит на паузу выбранный ниже музыкальный плеер и может возобновить его, как только другой звук прекратится. В первый раз macOS спросит разрешение для Vorssaint на управление вашим музыкальным плеером.",
        autoPauseMusicPlayerLabel: "Музыкальный плеер",
        autoPauseMusicPlayerNone: "Не задано",
        autoPauseMusicPlayerInheritedFormat: "Используется %@ из блокировщика приложения «Музыка»",
        autoPauseMusicChooseApp: "Выбрать приложение…",
        autoPauseMusicResumeTitle: "Возобновлять автоматически после остановки",
        cleanerName: "Очистка",
