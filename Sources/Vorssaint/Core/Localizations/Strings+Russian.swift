...
extension Strings {
    static let ru = Strings(
        ...
        monitorShowConnectedDevices: "Подключённые устройства",
        usbExcludeChargers: "Исключать блоки питания и зарядные устройства",
        usbExcludeHubs: "Исключать USB-концентраторы и док-станции",
        usbExcludeEthernet: "Исключать сетевые адаптеры и Ethernet",
        usbExcludeStorage: "Исключать внешние накопители",
