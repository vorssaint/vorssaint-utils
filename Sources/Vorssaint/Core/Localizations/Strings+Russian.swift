...
extension Strings {
    static let ru = Strings(
        ...
        audioPrioritySection: "Приоритет звука",
        audioPriorityOutputEnable: "Автоматически переключаться на выход с наивысшим приоритетом",
        audioPriorityInputEnable: "Автоматически переключаться на микрофон с наивысшим приоритетом",
        audioPriorityOutputList: "Приоритет выхода",
        audioPriorityInputList: "Приоритет микрофона",
        audioPriorityAddOutput: "Добавить выход",
        audioPriorityAddInput: "Добавить микрофон",
        audioPriorityMoveUp: "Вверх",
        audioPriorityMoveDown: "Вниз",
        audioPriorityRemove: "Удалить",
        audioPriorityUnavailable: "Недоступно",
        audioPriorityCurrent: "Текущий",
        audioPriorityEmpty: "Устройства не выбраны",
        audioPriorityCaption: "Устройства выбираются в порядке приоритета. При подключении устройства с более высоким приоритетом оно становится активным. При отключении активного устройства включается следующее доступное.",
