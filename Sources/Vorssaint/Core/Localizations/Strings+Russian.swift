...
extension Strings {
    static let ru = Strings(
        ...
        advancedClearFailed: "Не удалось удалить часть разрешений или правило закрытой крышки. Повторите попытку и разрешите запрос пароля, если он появится.",
        ...
        dimScreenOnLidCloseTitle: "Полностью затемнять экран",
        dimScreenOnLidCloseCaption: "Затемняет экран при закрытии крышки и восстанавливает яркость при её открытии.",
        ...
        micUnmutedHUD: "Отключение микрофона отменено",
        micMutePartialHUD: "Не все микрофоны удалось выключить",
        micUnmutePartialHUD: "Некоторые микрофоны всё ещё выключены",
        micMuteMenuBarToggle: "Показывать в строке меню, пока микрофон выключен",
        micMuteMenuBarCaption: "Пока эта функция отключает микрофон, рядом со значком приложения в строке меню появляется красный перечёркнутый микрофон.",
        ...
        mediaCompressionLowDescription: "Высокое качество, большой размер файла",
        mediaCompressionMediumDescription: "Баланс качества и размера файла",
        mediaCompressionHighDescription: "Низкое качество, маленький размер файла",
        mediaMaxSize: "Размер",
        ...
        shelfDropZoneCaptionTopCenter: "Пока вы перетаскиваете файл, полка появляется значком вверху по центру экрана. То, что вы отпустите, остаётся прямо там, в значке, который открывается одним щелчком и исчезает, когда полка пустеет.",
        shelfDropZoneLabel: "Отпустите здесь",
        shelfDockPlacement: "Расположение",
        shelfDockMenuBar: "Под значком в строке меню",
        shelfDockTopCenter: "Вверху по центру экрана",
        shelfDockIslandNote: "Пока Dynamic Island включён, верх по центру занят им.",
        ...
        audioPrioritySection: "Приоритет аудиоустройств",
        audioPriorityOutputEnable: "Автоматически переключаться на устройство вывода звука с самым высоким приоритетом",
        audioPriorityInputEnable: "Автоматически переключаться на микрофон с самым высоким приоритетом",
        audioPriorityOutputList: "Приоритет устройств вывода звука",
        audioPriorityInputList: "Приоритет микрофонов",
        audioPriorityMoveUp: "Вверх",
        ...
        diskMenuBarAvailableSpace: "Доступное место",
        ...
        musicBlockCaption: "Блокирует запуск музыкального приложения после обнаруженного нажатия медиаклавиши. Требуется доступ к Универсальному доступу. Команды наушников без обнаруженного нажатия не блокируются.",
        ...
        musicBlockPlayReplacement: "Воспроизводить после открытия приложения-замены",
        cleanerName: "Очистка",
        ...
        cleanerCatScreenshots: "Забытые снимки экрана",
        cleanerScreenshotsCaptionFormat: "Снимки экрана, которые вы не открывали %d дн. и у которых остались имя и папка от macOS. Переименованные или перемещённые здесь не появляются.",
        cleanerScreenshotsSettingCaption: "Проверка покажет снимки экрана, которые вы не открывали столько времени, без отметок и с общим размером.",
        ...
        scrollHorizontalName: "Горизонтальная прокрутка с зажатой клавишей",
        scrollHorizontalModifierLabel: "Клавиша-модификатор",
        scrollHorizontalCommandKey: "Command",
        scrollHorizontalCaption: "Удерживайте только выбранную клавишу, чтобы вертикальное колёсико мыши прокручивало по горизонтали. Другие сочетания клавиш не изменяются.",
