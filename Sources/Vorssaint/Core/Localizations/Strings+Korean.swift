...
extension Strings {
    static let ko = Strings(
        ...
        advancedClearFailed: "일부 권한 또는 덮개 닫힘 모드 규칙을 제거하지 못했습니다. 다시 시도하고 암호를 요청하면 허용하세요.",
        ...
        switcherWindowShortcutCaption: "맨 앞 앱의 윈도우 전환기를 엽니다. 전환기가 열려 있으면 선택한 앱의 윈도우를 차례로 전환합니다.",
        ...
        mediaCompressionLowDescription: "높은 화질, 큰 파일 크기",
        mediaCompressionMediumDescription: "화질과 파일 크기의 균형",
        mediaCompressionHighDescription: "낮은 화질, 작은 파일 크기",
        mediaMaxSize: "크기",
        ...
        shelfDropZoneCaptionTopCenter: "파일을 드래그하면 화면 상단 가운데에 선반이 배지로 나타납니다. 놓은 항목은 그대로 보관되고 클릭해 여는 배지에 들어가며, 선반이 비면 사라집니다.",
        shelfDropZoneLabel: "여기에 놓기",
        shelfDockPlacement: "위치",
        shelfDockMenuBar: "메뉴 막대 아이콘 아래",
        shelfDockTopCenter: "화면 상단 가운데",
        shelfDockIslandNote: "Dynamic Island가 켜져 있는 동안에는 상단 가운데를 사용합니다.",
        shelfCollapse: "접기",
        ...
        audioPrioritySection: "오디오 장치 우선순위",
        audioPriorityOutputEnable: "우선순위가 가장 높은 오디오 출력으로 자동 전환",
        audioPriorityInputEnable: "우선순위가 가장 높은 마이크로 자동 전환",
        audioPriorityOutputList: "오디오 출력 우선순위",
        audioPriorityInputList: "마이크 우선순위",
        audioPriorityMoveUp: "위로 이동",
        ...
        menuBarIconDisallowedBody: "macOS가 Vorssaint를 메뉴 막대에 표시하지 않고 있습니다. 시스템 설정 > 메뉴 막대를 열고 앱 목록에서 Vorssaint를 찾아 “메뉴 막대에서 허용”(Allow in the Menu Bar)을 켜세요. 스위치를 켜는 즉시 아이콘이 나타납니다.",
        ...
        musicBlockCaption: "감지된 미디어 키로 음악 앱이 열리는 것을 차단합니다. 손쉬운 사용 권한이 필요합니다. 키가 감지되지 않는 헤드폰 명령은 차단하지 않습니다.",
        ...
        musicBlockPlayReplacement: "대신 실행할 앱을 연 후 재생",
        cleanerName: "정리",
        ...
        cleanerCatScreenshots: "잊힌 스크린샷",
        cleanerScreenshotsCaptionFormat: "%d일 동안 열지 않았고 macOS가 붙인 이름과 폴더 그대로인 스크린샷입니다. 이름을 바꾸거나 옮긴 스크린샷은 여기에 나타나지 않습니다.",
        cleanerScreenshotsSettingCaption: "검사하면 이 기간 동안 열지 않은 스크린샷을 선택하지 않은 상태로 전체 크기와 함께 보여 줍니다.",
        cleanerScreenshotsAfterFormat: "%d일 후",
        ...
        scrollHorizontalName: "키를 눌러 가로 스크롤",
        scrollHorizontalModifierLabel: "전환 키",
        scrollHorizontalCommandKey: "Command",
        scrollHorizontalCaption: "선택한 보조 키만 누른 채 마우스 휠을 굴리면 가로로 스크롤합니다. 다른 키 조합은 변경하지 않습니다.",
