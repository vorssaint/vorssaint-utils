...
extension Strings {
    static let ko = Strings(
        ...
        diskSpeedTest: "디스크 속도 테스트",
        diskSpeedQuick: "빠르게 · 1 GB",
        diskSpeedStandard: "표준 · 3×4 GB",
        diskSpeedDescription: "임시 파일을 쓰고 삭제합니다. 표준 테스트는 4 GB를 세 번 측정해 중앙값을 표시하며, 다른 디스크 작업이 결과에 영향을 줄 수 있습니다.",
        diskSpeedPreparing: "준비 중…",
        diskSpeedFlushing: "디스크에 동기화 중…",
        diskSpeedLastTest: "마지막 테스트",
        diskSpeedNeedsSpace: "최소 %@의 여유 공간이 필요합니다.",
        diskSpeedReadOnly: "이 디스크는 읽기 전용입니다.",
        diskSpeedUnavailable: "디스크를 사용할 수 없거나 테스트하지 못했습니다.",
