...
extension Strings {
    static let ko = Strings(
        ...
        audioPrioritySection: "오디오 우선순위",
        audioPriorityOutputEnable: "우선순위가 가장 높은 출력으로 자동 전환",
        audioPriorityInputEnable: "우선순위가 가장 높은 마이크로 자동 전환",
        audioPriorityOutputList: "출력 우선순위",
        audioPriorityInputList: "마이크 우선순위",
        audioPriorityAddOutput: "출력 추가",
        audioPriorityAddInput: "마이크 추가",
        audioPriorityMoveUp: "위로 이동",
        audioPriorityMoveDown: "아래로 이동",
        audioPriorityRemove: "제거",
        audioPriorityUnavailable: "사용 불가",
        audioPriorityCurrent: "현재",
        audioPriorityEmpty: "선택된 장치가 없습니다",
        audioPriorityCaption: "장치는 우선순위 순서대로 선택됩니다. 우선순위가 더 높은 장치가 연결되면 활성화됩니다. 활성 장치의 연결이 끊기면 다음 사용 가능한 장치가 인계합니다.",
