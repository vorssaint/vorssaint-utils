...
extension Strings {
    static let ko = Strings(
        ...
        autoPauseMusicSection: "음악 자동 일시정지",
        autoPauseMusicTitle: "다른 소리가 재생되면 음악 일시정지",
        autoPauseMusicCaption: "다른 앱이 소리나 동영상을 재생하기 시작하면 Vorssaint가 아래에서 선택한 음악 플레이어를 자동으로 일시정지하고, 다른 오디오가 멈추면 다시 재생할 수 있습니다. 처음에는 macOS가 Vorssaint의 음악 플레이어 제어를 허용할지 물어봅니다.",
        autoPauseMusicPlayerLabel: "음악 플레이어",
        autoPauseMusicPlayerNone: "설정 안 됨",
        autoPauseMusicPlayerInheritedFormat: "음악 앱 차단기의 %@ 사용 중",
        autoPauseMusicChooseApp: "앱 선택…",
        autoPauseMusicResumeTitle: "멈추면 자동으로 다시 재생",
        cleanerName: "정리",
