...
extension Strings {
    static let ko = Strings(
        ...
        statusItemContextMenuSection: "오른쪽 클릭 메뉴",
        statusItemContextMenuOrderHint: "드래그하여 순서를 바꾸고 눈 아이콘으로 항목을 표시하거나 숨길 수 있습니다. 설정과 종료는 항상 표시됩니다.",
        statusItemContextMenuHideItem: "오른쪽 클릭 메뉴에서 숨기기",
        statusItemContextMenuShowItem: "오른쪽 클릭 메뉴에 표시",
        statusItemContextMenuAlwaysShown: "항상 표시",
