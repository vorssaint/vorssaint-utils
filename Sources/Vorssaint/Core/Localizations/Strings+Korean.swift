...
extension Strings {
    static let ko = Strings(
        ...
        mediaPages: "페이지",
        mediaRotation: "회전",
        mediaErrorPageSelection: "지정한 페이지가 이 문서에 없습니다.",
        mediaPDFHint: "이미지가 있는 페이지는 다시 인코딩되며 보이지 않는 OCR 레이어가 사라집니다. 텍스트 페이지는 그대로 유지됩니다.",
        mediaStartCompressFormat: "%@ 압축",
        mediaStartConvertFormat: "%@(으)로 변환",
        mediaWidth: "너비",
        mediaFPS: "FPS",
