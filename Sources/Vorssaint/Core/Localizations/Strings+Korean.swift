...
extension Strings {
    static let ko = Strings(
        ...
        monitorShowConnectedDevices: "연결된 기기",
        usbExcludeChargers: "전원 공급 장치 및 충전기 제외",
        usbExcludeHubs: "USB 허브 및 독 제외",
        usbExcludeEthernet: "네트워크 및 이더넷 어댑터 제외",
        usbExcludeStorage: "외부 저장 장치 제외",
