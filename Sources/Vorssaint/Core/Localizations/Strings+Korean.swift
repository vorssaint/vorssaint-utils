...
extension Strings {
    static let ko = Strings(
        ...
        smoothScrollCaption: "마우스 휠을 트랙패드처럼 부드럽게 만듭니다. 단계, 속도, 지속 시간은 각각 독립적입니다. 트랙패드는 변경되지 않습니다.",
        smoothScrollVerticalLabel: "세로 축 부드럽게",
        smoothScrollHorizontalLabel: "가로 축 부드럽게",
        smoothScrollStepLabel: "단계",
        smoothScrollStepCaption: "최소 스크롤 거리를 설정합니다",
        smoothScrollSpeedLabel: "속도",
