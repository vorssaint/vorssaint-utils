...
extension Strings {
    static let fr = Strings(
        ...
        mediaErrorPageSelection: "Cette sélection de pages ne correspond à aucune page du document.",
        mediaPDFHint: "Les pages contenant une image sont ré-encodées, ce qui supprime la couche OCR invisible. Les pages de texte restent intactes.",
        mediaStartCompressFormat: "Compresser le %@",
        mediaStartConvertFormat: "Convertir en %@",
        mediaWidth: "Largeur",
        mediaFPS: "FPS",
