...
extension Strings {
    static let fr = Strings(
        ...
        micUnmutedHUD: "Coupure du micro levée",
        ...
        micMuteMenuBarCaption: "Un micro barré en rouge apparaît à côté de l’icône de l’app dans la barre des menus tant que cette fonction le coupe.",
