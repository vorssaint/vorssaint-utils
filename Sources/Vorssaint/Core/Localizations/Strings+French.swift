...
extension Strings {
    static let fr = Strings(
        ...
        monitorShowConnectedDevices: "Appareils connectés",
        usbExcludeChargers: "Exclure les alimentations et chargeurs",
        usbExcludeHubs: "Exclure les hubs et stations d’accueil USB",
        usbExcludeEthernet: "Exclure les adaptateurs réseau et Ethernet",
        usbExcludeStorage: "Exclure le stockage externe",
