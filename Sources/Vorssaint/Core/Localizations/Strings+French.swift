...
extension Strings {
    static let fr = Strings(
        ...
        diskSpeedStandard: "Standard · 4 Go",
        diskSpeedDescription: "Écrit puis supprime un fichier temporaire. Une autre activité du disque peut affecter les résultats.",
