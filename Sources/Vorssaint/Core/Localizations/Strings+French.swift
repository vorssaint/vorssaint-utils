...
extension Strings {
    static let fr = Strings(
        ...
        autoPauseMusicSection: "Pause automatique de la musique",
        autoPauseMusicTitle: "Mettre la musique en pause quand un autre son est lu",
        autoPauseMusicCaption: "Lorsqu'une autre app commence à lire un son ou une vidéo, Vorssaint met en pause le lecteur de musique choisi ci-dessous et peut le relancer dès que l'autre son s'arrête. La première fois, macOS vous demandera d'autoriser Vorssaint à contrôler votre lecteur de musique.",
        autoPauseMusicPlayerLabel: "Lecteur de musique",
        autoPauseMusicPlayerNone: "Non défini",
        autoPauseMusicPlayerInheritedFormat: "Utilise %@ depuis le bloqueur de l’app Musique",
        autoPauseMusicChooseApp: "Choisir une app…",
        autoPauseMusicResumeTitle: "Reprendre automatiquement à l'arrêt",
