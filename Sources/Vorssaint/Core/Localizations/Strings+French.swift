...
extension Strings {
    static let fr = Strings(
        ...
        audioPriorityInputEnable: "Basculer automatiquement vers le microphone ayant la priorité la plus élevée",
        audioPriorityOutputList: "Priorité des sorties audio",
        audioPriorityInputList: "Priorité des microphones",
        audioPriorityAddOutput: "Ajouter une sortie audio",
        audioPriorityAddInput: "Ajouter un microphone",
        audioPriorityMoveUp: "Monter",
        audioPriorityMoveDown: "Descendre",
        audioPriorityRemove: "Retirer",
        audioPriorityUnavailable: "Indisponible",
        audioPriorityCurrent: "Actif",
        audioPriorityEmpty: "Aucun appareil sélectionné",
