...
extension Strings {
    static let fr = Strings(
        ...
        keepAwakeUntilLabel: "Jusqu’à",
        keepAwakeUntilStart: "Démarrer",
        ...
        advancedClearFailed: "Certaines autorisations ou la règle d’écran rabattu n’ont pas pu être retirées. Réessayez et autorisez la demande de mot de passe si elle apparaît.",
        ...
        micMutePartialHUD: "Certains micros n’ont pas pu être coupés",
        micUnmutePartialHUD: "Certains micros sont encore coupés",
        ...
        switcherSection: "Sélecteur de fenêtres",
        ...
        switcherWindowShortcutCaption: "Ouvre un sélecteur pour les fenêtres de l’app au premier plan. Sélecteur ouvert, passe d’une fenêtre à l’autre de l’app sélectionnée.",
        ...
        mediaCompressionLowDescription: "Qualité élevée, fichier volumineux",
        mediaCompressionMediumDescription: "Équilibre entre qualité et taille du fichier",
        mediaCompressionHighDescription: "Qualité faible, fichier plus petit",
        mediaMaxSize: "Taille",
        ...
        shelfDropZoneCaptionTopCenter: "Pendant que vous faites glisser un fichier, l’étagère apparaît sous forme de badge en haut, au centre de l’écran. Ce que vous déposez y reste, dans un badge que vous ouvrez d’un clic et qui disparaît une fois l’étagère vide.",
        shelfDropZoneLabel: "Déposez ici",
        shelfDockPlacement: "Position",
        shelfDockMenuBar: "Sous l’icône de la barre des menus",
        shelfDockTopCenter: "En haut, au centre de l’écran",
        shelfDockIslandNote: "Tant que le Dynamic Island est activé, il occupe le haut au centre.",
        ...
        audioPrioritySection: "Priorité des périphériques audio",
        audioPriorityOutputEnable: "Basculer automatiquement vers la sortie audio ayant la priorité la plus élevée",
        audioPriorityInputEnable: "Basculer automatiquement vers le micro ayant la priorité la plus élevée",
        audioPriorityOutputList: "Priorité des sorties audio",
        audioPriorityInputList: "Priorité des micros",
        audioPriorityMoveUp: "Monter",
        audioPriorityMoveDown: "Descendre",
        audioPriorityUnavailable: "Indisponible",
        audioPriorityCurrent: "Actif",
        audioPriorityCaption: "Les périphériques sont sélectionnés par ordre de priorité. Lorsqu’un périphérique de priorité plus élevée est connecté, le système bascule vers celui-ci. Lorsque le périphérique actif est déconnecté, le suivant disponible est sélectionné.",
        ...
        networkIPAddresses: "Adresses IP",
        ...
        diskUsed: "utilisé",
        diskFree: "libre",
        diskMenuBarStyleLabel: "Affichage du disque",
        diskMenuBarUsedPercentage: "Pourcentage utilisé",
        diskMenuBarAvailableSpace: "Espace disponible",
        diskMenuBarUsedSpace: "Espace utilisé",
        ...
        menuBarIconDisallowedBody: "macOS empêche Vorssaint d’apparaître dans la barre des menus. Ouvrez Réglages Système > Barre des menus, trouvez Vorssaint dans la liste des apps et activez « Autoriser dans la barre des menus » (Allow in the Menu Bar). L’icône apparaît dès que l’option est activée.",
        ...
        musicBlockCaption: "Bloque l’ouverture de l’app de musique après une touche multimédia détectée. Nécessite l’accès à l’accessibilité. Les commandes du casque sans touche détectée sont autorisées.",
        ...
        musicBlockPlayReplacement: "Lire après l’ouverture de l’app de remplacement",
        ...
        cleanerCatScreenshots: "Captures d’écran oubliées",
        cleanerScreenshotsCaptionFormat: "Captures d’écran que vous n’avez pas ouvertes depuis %d jours et qui gardent le nom et le dossier donnés par macOS. Celles renommées ou déplacées n’apparaissent jamais ici.",
        cleanerScreenshotsSettingCaption: "L’analyse liste, non cochées et avec leur taille totale, les captures que vous n’avez pas ouvertes depuis ce délai.",
        cleanerScreenshotsAfterFormat: "Après %d jours",
        ...
        scrollHorizontalCommandKey: "Commande",
