...
extension Strings {
    static let fr = Strings(
        ...
        statusItemContextMenuSection: "Menu du clic droit",
        statusItemContextMenuOrderHint: "Faites glisser pour réordonner et utilisez l’œil pour afficher ou masquer des éléments. Réglages et Quitter sont toujours affichés.",
        statusItemContextMenuHideItem: "Masquer du menu du clic droit",
        statusItemContextMenuShowItem: "Afficher dans le menu du clic droit",
        statusItemContextMenuAlwaysShown: "Toujours affiché",
        panelShowBrandMark: "Afficher le logo de Vorssaint",
        panelShowFooterActions: "Afficher les boutons Réglages et Quitter",
