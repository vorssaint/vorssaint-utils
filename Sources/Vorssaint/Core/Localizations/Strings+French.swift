...
extension Strings {
    static let fr = Strings(
        ...
        diskSpeedTest: "Test de vitesse du disque",
        diskSpeedQuick: "Rapide · 1 Go",
        diskSpeedStandard: "Standard · 3×4 Go",
        diskSpeedDescription: "Écrit puis supprime des fichiers temporaires. Le test standard effectue trois passes de 4 Go et affiche la médiane ; une autre activité du disque peut affecter le résultat.",
        diskSpeedPreparing: "Préparation…",
        diskSpeedFlushing: "Synchronisation avec le disque…",
        diskSpeedLastTest: "Dernier test",
        diskSpeedNeedsSpace: "Au moins %@ d’espace disponible est nécessaire.",
        diskSpeedReadOnly: "Ce disque est en lecture seule.",
        diskSpeedUnavailable: "Le disque est indisponible ou n’a pas pu être testé.",
