...
extension Strings {
    static let fr = Strings(
        ...
        audioPrioritySection: "Priorité audio",
        audioPriorityOutputEnable: "Basculer automatiquement vers la sortie la plus prioritaire",
        audioPriorityInputEnable: "Basculer automatiquement vers le microphone le plus prioritaire",
        audioPriorityOutputList: "Priorité de sortie",
        audioPriorityInputList: "Priorité de microphone",
        audioPriorityAddOutput: "Ajouter une sortie",
        ...
        audioPriorityCurrent: "Actuel",
        audioPriorityEmpty: "Aucun appareil sélectionné",
        audioPriorityCaption: "Les périphériques sont sélectionnés par ordre de priorité. Lorsqu'un périphérique de priorité plus élevée se connecte, il devient actif. Lorsque l'actif se déconnecte, le suivant disponible prend le relais.",
