...
extension Strings {
    static let ja = Strings(
        ...
        monitorShowConnectedDevices: "接続中のデバイス",
        usbExcludeChargers: "電源アダプタと充電器を除外",
        usbExcludeHubs: "USBハブとドックを除外",
        usbExcludeEthernet: "ネットワークおよびEthernetアダプタを除外",
        usbExcludeStorage: "外部ストレージを除外",
