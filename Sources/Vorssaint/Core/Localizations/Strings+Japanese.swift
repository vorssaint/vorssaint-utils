...
extension Strings {
    static let ja = Strings(
        ...
        menuBarIconStillHiddenBody: "macOS はまだアイコンを表示していません。システム設定で Vorssaint のメニューバーへの表示が許可されているか確認してください。保存された位置の問題や空きスペースの不足で表示されない場合もあります。Vorssaint の設定は引き続き利用できます。",
