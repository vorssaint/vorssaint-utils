...
extension Strings {
    static let ja = Strings(
        ...
        mediaStartPDF: "PDF を圧縮",
        mediaPages: "ページ",
        mediaRotation: "回転",
        mediaErrorPageSelection: "指定されたページはこの書類に存在しません。",
        mediaPDFHint: "スキャンされたページは再エンコードされ、テキストを含むページはそのまま保持されます。",
        mediaStartCompressFormat: "%@ を圧縮",
        mediaStartConvertFormat: "%@ に変換",
        mediaWidth: "幅",
        mediaFPS: "FPS",
