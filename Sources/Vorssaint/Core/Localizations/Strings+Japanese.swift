...
extension Strings {
    static let ja = Strings(
        ...
        scrollSection: "スクロール",
        mouseScrollingSection: "マウスのスクロール",
        ...
        smoothScrollCaption: "マウスホイールをトラックパッドのようになめらかにします。ステップ・速度・時間はそれぞれ独立です。トラックパッドは変わりません。",
        smoothScrollVerticalLabel: "縦軸をスムーズに",
        smoothScrollHorizontalLabel: "横軸をスムーズに",
        smoothScrollStepLabel: "ステップ",
        smoothScrollStepCaption: "最小のスクロール距離を設定します",
