...
extension Strings {
    static let ja = Strings(
        ...
        statusItemContextMenuSection: "右クリックメニュー",
        statusItemContextMenuOrderHint: "ドラッグして並べ替え、目のアイコンで項目の表示／非表示を切り替えます。「設定」と「終了」は常に表示されます。",
        statusItemContextMenuHideItem: "右クリックメニューで非表示",
        statusItemContextMenuShowItem: "右クリックメニューに表示",
        statusItemContextMenuAlwaysShown: "常に表示",
