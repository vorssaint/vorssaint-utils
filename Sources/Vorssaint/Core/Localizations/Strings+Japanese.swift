...
extension Strings {
    static let ja = Strings(
        ...
        audioPrioritySection: "オーディオの優先順位",
        audioPriorityOutputEnable: "最も優先度の高い出力に自動的に切り替える",
        audioPriorityInputEnable: "最も優先度の高いマイクに自動的に切り替える",
        audioPriorityOutputList: "出力の優先順位",
        audioPriorityInputList: "マイクの優先順位",
        audioPriorityAddOutput: "出力を追加",
        audioPriorityAddInput: "マイクを追加",
        audioPriorityMoveUp: "上へ移動",
        audioPriorityMoveDown: "下へ移動",
        audioPriorityRemove: "削除",
        audioPriorityUnavailable: "利用不可",
        audioPriorityCurrent: "現在",
        audioPriorityEmpty: "デバイスが選択されていません",
        audioPriorityCaption: "デバイスは優先順位に従って選択されます。優先度の高いデバイスが接続されるとアクティブになります。アクティブなデバイスが切断されると、次に利用可能なデバイスが引き継ぎます。",
