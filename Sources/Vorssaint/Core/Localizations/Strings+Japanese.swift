...
extension Strings {
    static let ja = Strings(
        ...
        advancedClearFailed: "一部のアクセス権、またはふたを閉じたモードのルールを削除できませんでした。もう一度試して、パスワードの入力を求められたら許可してください。",
        ...
        micMutePartialHUD: "一部のマイクを消音できませんでした",
        micUnmutePartialHUD: "一部のマイクはまだ消音中です",
        ...
        switcherWindowShortcutCaption: "最前面のアプリのウインドウ用スイッチャーを開きます。スイッチャー表示中は、選択中のアプリのウインドウを順に切り替えます。",
        ...
        mediaCompressionLowDescription: "高画質、大きいファイルサイズ",
        mediaCompressionMediumDescription: "画質とファイルサイズのバランス",
        mediaCompressionHighDescription: "低画質、小さいファイルサイズ",
        mediaMaxSize: "サイズ",
        ...
        shelfDropZoneCaptionTopCenter: "ファイルをドラッグすると、画面上部の中央にシェルフがバッジとして表示されます。ドロップしたものはそのままそこに保存され、クリックで開けるバッジに収まり、シェルフが空になると消えます。",
        shelfDropZoneLabel: "ここにドロップ",
        shelfDockPlacement: "位置",
        shelfDockMenuBar: "メニューバーアイコンの下",
        shelfDockTopCenter: "画面上部の中央",
        shelfDockIslandNote: "Dynamic Islandがオンの間は画面上部の中央を使います。",
        shelfCollapse: "折りたたむ",
        ...
        audioPrioritySection: "オーディオデバイスの優先順位",
        audioPriorityOutputEnable: "最も優先度の高いオーディオ出力に自動的に切り替える",
        audioPriorityInputEnable: "最も優先度の高いマイクに自動的に切り替える",
        audioPriorityOutputList: "オーディオ出力の優先順位",
        audioPriorityInputList: "マイクの優先順位",
        audioPriorityMoveUp: "上へ移動",
        ...
        diskMenuBarAvailableSpace: "利用可能な容量",
        ...
        musicBlockCaption: "検出したメディアキーによる音楽アプリの起動を防ぎます。アクセシビリティの許可が必要です。キーを検出できないヘッドフォンの操作はブロックしません。",
        ...
        musicBlockPlayReplacement: "代わりのアプリを開いた後に再生",
        cleanerName: "クリーンアップ",
        ...
        cleanerCatScreenshots: "忘れられたスクリーンショット",
        cleanerScreenshotsCaptionFormat: "%d日間開いておらず、macOSが付けた名前とフォルダのままのスクリーンショットです。名前を変えたり移動したりしたものは表示されません。",
        cleanerScreenshotsSettingCaption: "スキャンでは、この期間開いていないスクリーンショットをチェックなしで合計サイズとともに表示します。",
        cleanerScreenshotsAfterFormat: "%d日後",
        ...
        scrollHorizontalName: "キーを押して横スクロール",
        scrollHorizontalModifierLabel: "修飾キー",
        scrollHorizontalCommandKey: "Command",
        scrollHorizontalCaption: "選択した修飾キーだけを押しながらマウスの縦ホイールを回すと、横にスクロールします。他のキーの組み合わせは変更しません。",
