...
extension Strings {
    static let ja = Strings(
        ...
        autoRaiseName: "マウス追従フォーカス",
        autoRaiseCaption: "短い停止後、ポインタの下にあるウインドウをフォーカスして手前に表示します。",
        autoRaiseDelay: "ホバー遅延",
        autoRaisePollInterval: "検出間隔",
        autoRaiseRequireStop: "ポインタの停止を必須にする",
        autoRaiseSensitivity: "移動感度",
        autoRaiseAdvanced: "詳細オプション",
        autoRaisePauseKey: "一時停止キー",
        autoRaiseInvertPause: "キーを押していない間は一時停止",
        autoRaiseIgnoreSpace: "デスクトップ切り替え後に待機",
        autoRaiseIncludeOnly: "Appリストを許可リストとして使用",
        autoRaiseApps: "App",
        autoRaiseAppsCaption: "標準ではこれらのAppを無視します。許可リストモードでは、これらのAppだけをフォーカスします。",
        autoRaiseTitlePatterns: "無視するウインドウタイトル（1行に1つの正規表現）",
        autoRaiseStayFocusedApps: "フォーカスを維持するApp",
        autoRaiseWarp: "Command-TabまたはCommand-`後にポインタを移動",
        autoRaiseHorizontal: "水平位置",
        autoRaiseVertical: "垂直位置",
        autoRaiseInvalidPatterns: "1つ以上の正規表現が無効です。",
        autoRaiseControlKey: "Control",
        autoRaiseOptionKey: "Option",
        autoRaiseDisabled: "無効",
        autoRaiseAddApp: "Appを追加",
        autoRaiseRemoveApp: "Appを削除",
