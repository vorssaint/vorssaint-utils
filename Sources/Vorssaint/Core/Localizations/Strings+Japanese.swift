...
extension Strings {
    static let ja = Strings(
        ...
        adminPromptQuarantine: "選択した項目の隔離を解除するには、Vorssaint がパスワードを必要とします。",
        ...
        quarantineManagerIntroTitle: "「インターネットからダウンロード」の警告を解除",
        quarantineManagerIntroBody: "macOSはApp Store以外からダウンロードしたファイルに隔離フラグを付け、開くときにGatekeeperの警告が表示されます。ファイルやAppを選んで確認し、フラグを解除できます。",
        quarantineManagerPick: "Appまたはファイルを選択",
        quarantineManagerScanApplications: "アプリケーションをスキャン",
        quarantineManagerDropTitle: "ファイルやAppをここにドロップ",
        quarantineManagerDropHint: "または下でAppやファイルを選択",
        quarantineManagerFDANote: "一般的なフォルダ以外のファイルを確認するには、フルディスクアクセスを許可してください。",
        quarantineManagerScanning: "隔離された項目を検索中…",
        quarantineManagerEmptyTitle: "隔離された項目は見つかりませんでした",
        quarantineManagerFoundTitle: "隔離された項目",
        quarantineManagerSelectedFormat: "%d / %d 件選択中",
        quarantineManagerSelectAll: "すべて選択",
        quarantineManagerClearSelection: "選択を解除",
        quarantineManagerRemoveSelected: "隔離を解除",
        quarantineManagerRemoving: "隔離を解除中…",
        quarantineManagerDoneTitle: "隔離を解除しました",
        quarantineManagerClearedFormat: "%d 件を解除しました",
        quarantineManagerSomeFailed: "一部の項目は解除できませんでした。",
        quarantineManagerContinue: "続ける",
        quarantineManagerDetailTitle: "隔離の詳細",
        quarantineManagerSource: "取得元",
        quarantineManagerDownloadDate: "ダウンロード日時",
        quarantineManagerFlags: "フラグ",
        quarantineManagerRawValue: "生の値",
        quarantineManagerCopyPath: "パスをコピー",
        quarantineManagerCopyCommand: "xattrコマンドをコピー",
        quarantineManagerAllAttributesTitle: "すべての属性",
        quarantineManagerRemoveAllAttributes: "すべての属性を削除",
        quarantineManagerRemoveAllConfirmTitle: "すべての属性を削除しますか？",
        quarantineManagerRemoveAllConfirmBody: "隔離だけでなく、このファイルのすべての拡張属性が削除されます。元に戻せません。",
        quarantineManagerAttributeProtected: "macOS によって保護されており削除できません",
        quarantineManagerBinaryValueHint: "バイナリ値（16進数で表示）",
        quarantineManagerCommandBarToggle: "コマンドバーに表示",
        quarantineManagerCommandBarCaption: "Finder で選択した項目の隔離を解除するアクションを追加します。",
