...
extension Strings {
    static let ja = Strings(
        ...
        autoPauseMusicSection: "音楽の自動一時停止",
        autoPauseMusicTitle: "他の音声が再生されたら音楽を一時停止",
        autoPauseMusicCaption: "別のアプリが音声や動画の再生を始めると、Vorssaintは以下で選んだ音楽プレーヤーを自動的に一時停止し、他の音声が止まると再開できます。初回はmacOSがVorssaintに音楽プレーヤーの操作を許可するか確認します。",
        autoPauseMusicPlayerLabel: "音楽プレーヤー",
        autoPauseMusicPlayerNone: "未設定",
        autoPauseMusicPlayerInheritedFormat: "ミュージックAppブロッカーの%@を使用中",
        autoPauseMusicChooseApp: "アプリを選択…",
        autoPauseMusicResumeTitle: "停止したら自動的に再開",
        cleanerName: "クリーンアップ",
