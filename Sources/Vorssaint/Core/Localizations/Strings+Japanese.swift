...
extension Strings {
    static let ja = Strings(
        ...
        homebrewPreferredTerminalTitle: "優先するターミナル",
        homebrewPreferredTerminalCaption: "Homebrew のコマンド、インストーラ、パスワード入力を開く場所を選択します。",
        homebrewAlacrittyWarning: "Homebrew の Alacritty cask は非推奨で、Gatekeeper にブロックされる場合があります。ウインドウが開かない場合は「プライバシーとセキュリティ」を確認してください。",
        homebrewTerminalLaunchFailedFormat: "%@ がコマンドを開いたことを確認できませんでした。",
        homebrewEnableCaption: "formula と cask を検索、インストール、削除します。",
        homebrewMissingTitle: "Homebrew が見つかりません",
        homebrewMissingBody: "Vorssaint は公式 Homebrew インストーラを %@ で開けます。%@ に手順が表示され、必要ならパスワードを求められます。",
        homebrewInstallHomebrew: "Homebrew をインストール",
        homebrewInstallHomebrewCaption: "%@ が終わったら、ここに戻って更新をクリックしてください。",
        homebrewInstallHomebrewOpened: "インストーラを %@ で開きました。",
        homebrewShellSetupTitle: "%@ の設定を完了",
        homebrewShellSetupBody: "Homebrew はインストールされていますが、%@ がまだ brew コマンドを見つけられない場合があります。Vorssaint は設定コマンドを %@ で開けます。",
        homebrewShellSetupButton: "%@ を設定",
        homebrewShellSetupOpened: "コマンドを %@ で開きました。終わったら戻って更新をクリックしてください。",
        homebrewRefresh: "更新",
        ...
        homebrewTerminalFallback: "この操作では管理者パスワードを求めるために %@ が必要です。Vorssaint はパスワードを取得しません。",
        ...
        homebrewOperationTerminal: "%@ で続行してください。",
