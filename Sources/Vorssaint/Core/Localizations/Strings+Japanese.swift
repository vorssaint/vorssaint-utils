...
extension Strings {
    static let ja = Strings(
        ...
        diskSpeedTest: "ディスク速度テスト",
        diskSpeedQuick: "クイック · 1 GB",
        diskSpeedStandard: "標準 · 3×4 GB",
        diskSpeedDescription: "一時ファイルを書き込んで削除します。標準テストは4 GBを3回測定して中央値を表示します。ほかのディスク処理が結果に影響する場合があります。",
        diskSpeedPreparing: "準備中…",
        diskSpeedFlushing: "ディスクに同期中…",
        diskSpeedLastTest: "前回のテスト",
        diskSpeedNeedsSpace: "少なくとも%@の空き容量が必要です。",
        diskSpeedReadOnly: "このディスクは読み取り専用です。",
        diskSpeedUnavailable: "ディスクを利用できないか、テストできませんでした。",
