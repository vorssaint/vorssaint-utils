...
extension Strings {
    static let ja = Strings(
        ...
        homebrewConfirmCleanupTitle: "Homebrew でクリーンアップしますか？",
        homebrewConfirmCleanupBody: "Homebrew は古いダウンロードとインストール済みパッケージの旧バージョンを削除します。",
        ...
        homebrewOperationCleanup: "Homebrew をクリーンアップ中",
        homebrewOperationCleaned: "Homebrew をクリーンアップしました。",
