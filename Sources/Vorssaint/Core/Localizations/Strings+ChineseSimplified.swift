...
extension Strings {
    static let zhHans = Strings(
        ...
        clamshellExternalDisplayToggle: "外接显示器",
        clamshellExternalDisplayCaption: "仅在所选条件满足时启用合盖模式（满足任一或全部）。“保持唤醒”保持你设定的状态。",
        clamshellGatePowerToggle: "接上电源",
        clamshellGateNetworkToggle: "网络可用",
        clamshellGateModeAny: "任一",
        clamshellGateModeAll: "全部",
        clamshellGateMatchLabel: "匹配条件",
