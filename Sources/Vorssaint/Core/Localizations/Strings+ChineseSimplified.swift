...
extension Strings {
    static let zhHans = Strings(
        ...
        statusItemContextMenuSection: "右键菜单",
        statusItemContextMenuOrderHint: "拖动以重新排序，并使用眼睛图标显示或隐藏项目。“设置”和“退出”始终显示。",
        statusItemContextMenuHideItem: "从右键菜单中隐藏",
        statusItemContextMenuShowItem: "在右键菜单中显示",
        statusItemContextMenuAlwaysShown: "始终显示",
        panelShowBrandMark: "显示 Vorssaint 标志",
        panelShowFooterActions: "显示“设置”和“退出”按钮",
