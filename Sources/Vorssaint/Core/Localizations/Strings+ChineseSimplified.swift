...
extension Strings {
    static let zhHans = Strings(
        ...
        autoPauseMusicSection: "自动暂停音乐",
        autoPauseMusicTitle: "其他内容播放声音时暂停音乐",
        autoPauseMusicCaption: "当其他应用开始播放声音或视频时，Vorssaint 会自动暂停你在下方选择的音乐播放器，并可在其他声音停止后自动恢复播放。首次使用时，macOS 会询问是否允许 Vorssaint 控制你的音乐播放器。",
        autoPauseMusicPlayerLabel: "音乐播放器",
        autoPauseMusicPlayerNone: "未设置",
        autoPauseMusicPlayerInheritedFormat: "正在使用“音乐”App 阻止器中的 %@",
        autoPauseMusicChooseApp: "选择 App…",
        autoPauseMusicResumeTitle: "停止后自动恢复",
        cleanerName: "清理",
