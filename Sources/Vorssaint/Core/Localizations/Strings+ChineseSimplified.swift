...
extension Strings {
    static let zhHans = Strings(
        ...
        audioPrioritySection: "音频优先级",
        audioPriorityOutputEnable: "自动切换到最高优先级的输出",
        audioPriorityInputEnable: "自动切换到最高优先级的麦克风",
        audioPriorityOutputList: "输出优先级",
        audioPriorityInputList: "麦克风优先级",
        audioPriorityAddOutput: "添加输出",
        audioPriorityAddInput: "添加麦克风",
        audioPriorityMoveUp: "上移",
        audioPriorityMoveDown: "下移",
        audioPriorityRemove: "移除",
        audioPriorityUnavailable: "不可用",
        audioPriorityCurrent: "当前",
        audioPriorityEmpty: "未选择设备",
        audioPriorityCaption: "设备按优先级顺序选择。当更高优先级的设备连接时，它会变为活动状态。当活动设备断开时，下一个可用的设备会接管。",
