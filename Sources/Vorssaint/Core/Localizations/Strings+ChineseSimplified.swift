...
extension Strings {
    static let zhHans = Strings(
        ...
        smoothScrollCaption: "让鼠标滚轮像触控板一样顺滑。步长、速度和时长相互独立。触控板不受影响。",
        smoothScrollVerticalLabel: "平滑纵轴",
        smoothScrollHorizontalLabel: "平滑横轴",
        smoothScrollStepLabel: "步长",
        smoothScrollStepCaption: "设置最小滚动距离",
