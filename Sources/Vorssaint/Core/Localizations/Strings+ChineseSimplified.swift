...
extension Strings {
    static let zhHans = Strings(
        ...
        diskSpeedTest: "磁盘速度测试",
        diskSpeedQuick: "快速 · 1 GB",
        diskSpeedStandard: "标准 · 3×4 GB",
        diskSpeedDescription: "写入并删除临时文件。标准测试进行三轮 4 GB 测量并显示中位数；其他磁盘活动可能会影响结果。",
        diskSpeedPreparing: "正在准备…",
        diskSpeedFlushing: "正在同步到磁盘…",
        diskSpeedLastTest: "上次测试",
        diskSpeedNeedsSpace: "至少需要 %@ 可用空间。",
        diskSpeedReadOnly: "此磁盘为只读。",
        diskSpeedUnavailable: "磁盘不可用或无法测试。",
