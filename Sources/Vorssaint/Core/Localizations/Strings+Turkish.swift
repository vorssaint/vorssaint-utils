...
extension Strings {
    static let tr = Strings(
        ...
        mediaPages: "Sayfalar",
        mediaRotation: "Döndürme",
        mediaErrorPageSelection: "Bu sayfa seçimi belgedeki hiçbir sayfayla eşleşmiyor.",
        mediaPDFHint: "Görsel içeren sayfalar yeniden kodlanır ve görünmez OCR katmanı kaybolur. Metin sayfaları olduğu gibi kalır.",
        mediaStartCompressFormat: "%@ dosyasını sıkıştır",
        mediaStartConvertFormat: "%@ biçimine dönüştür",
        mediaWidth: "Genişlik",
        mediaFPS: "FPS",
