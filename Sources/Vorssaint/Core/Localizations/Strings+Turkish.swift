...
extension Strings {
    static let tr = Strings(
        ...
        monitorShowConnectedDevices: "Bağlı cihazlar",
        usbExcludeChargers: "Güç kaynaklarını ve şarj cihazlarını hariç tut",
        usbExcludeHubs: "USB hub’larını ve dock’ları hariç tut",
        usbExcludeEthernet: "Ağ ve Ethernet bağdaştırıcılarını hariç tut",
        usbExcludeStorage: "Harici depolamayı hariç tut",
