...
extension Strings {
    static let tr = Strings(
        ...
        audioPrioritySection: "Ses önceliği",
        audioPriorityOutputEnable: "En yüksek öncelikli çıkışa otomatik geç",
        audioPriorityInputEnable: "En yüksek öncelikli mikrofona otomatik geç",
        audioPriorityOutputList: "Çıkış önceliği",
        audioPriorityInputList: "Mikrofon önceliği",
        audioPriorityAddOutput: "Çıkış ekle",
        audioPriorityAddInput: "Mikrofon ekle",
        audioPriorityMoveUp: "Yukarı taşı",
        audioPriorityMoveDown: "Aşağı taşı",
        audioPriorityRemove: "Kaldır",
        audioPriorityUnavailable: "Kullanılamıyor",
        audioPriorityCurrent: "Geçerli",
        audioPriorityEmpty: "Cihaz seçilmedi",
        audioPriorityCaption: "Cihazlar öncelik sırasına göre seçilir. Daha yüksek öncelikli bir cihaz bağlandığında aktif olur. Aktif cihazın bağlantısı kesildiğinde sonraki kullanılabilir cihaz devralır.",
