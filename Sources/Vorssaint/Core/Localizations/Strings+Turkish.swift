...
extension Strings {
    static let tr = Strings(
        ...
        mouseScrollingSection: "Fare kaydırma",
        ...
        smoothScrollCaption: "Fare tekerleğini izleme dörtgeni gibi yumuşatır. Adım, hız ve süre birbirinden bağımsızdır. İzleme dörtgeni değişmez.",
        smoothScrollVerticalLabel: "Dikey ekseni yumuşat",
        smoothScrollHorizontalLabel: "Yatay ekseni yumuşat",
        smoothScrollStepLabel: "Adım",
        smoothScrollStepCaption: "Minimum kaydırma mesafesini ayarlar",
        smoothScrollSpeedLabel: "Hız",
