...
extension Strings {
    static let tr = Strings(
        ...
        diskSpeedTest: "Disk hız testi",
        diskSpeedQuick: "Hızlı · 1 GB",
        diskSpeedStandard: "Standart · 3×4 GB",
        diskSpeedDescription: "Geçici dosyalar yazıp siler. Standart test üç 4 GB turunun ortanca sonucunu gösterir; diğer disk etkinlikleri sonucu etkileyebilir.",
        diskSpeedPreparing: "Hazırlanıyor…",
        diskSpeedFlushing: "Diske aktarılıyor…",
        diskSpeedLastTest: "Son test",
        diskSpeedNeedsSpace: "En az %@ kullanılabilir alan gerekiyor.",
        diskSpeedReadOnly: "Bu disk salt okunur.",
        diskSpeedUnavailable: "Disk kullanılamıyor veya test edilemedi.",
