...
extension Strings {
    static let tr = Strings(
        ...
        autoPauseMusicSection: "Müziği otomatik duraklat",
        autoPauseMusicTitle: "Başka bir ses çalarken müziği duraklat",
        autoPauseMusicCaption: "Başka bir uygulama ses veya video oynatmaya başladığında Vorssaint aşağıda seçtiğiniz müzik çaları duraklatır ve diğer ses durduğunda otomatik olarak devam ettirebilir. İlk seferinde macOS, Vorssaint'in müzik çalarınızı kontrol etmesine izin vermenizi ister.",
        autoPauseMusicPlayerLabel: "Müzik çalar",
        autoPauseMusicPlayerNone: "Ayarlanmadı",
        autoPauseMusicPlayerInheritedFormat: "Müzik uygulaması engelleyicisindeki %@ kullanılıyor",
        autoPauseMusicChooseApp: "Uygulama seç…",
        autoPauseMusicResumeTitle: "Durduğunda otomatik devam et",
