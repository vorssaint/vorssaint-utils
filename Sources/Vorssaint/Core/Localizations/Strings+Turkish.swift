...
extension Strings {
    static let tr = Strings(
        ...
        advancedClearFailed: "Bazı izinler veya kapak kapalı kuralı kaldırılamadı. Yeniden deneyin ve parola istenirse izin verin.",
        ...
        micMutePartialHUD: "Bazı mikrofonlar sessize alınamadı",
        micUnmutePartialHUD: "Bazı mikrofonlar hâlâ sessiz",
        ...
        switcherSection: "Pencere değiştirici",
        ...
        switcherWindowShortcutCaption: "Ön plandaki uygulamanın pencereleri için bir değiştirici açar. Değiştirici açıkken seçili uygulamanın pencereleri arasında geçiş yapar.",
        ...
        mediaCompressionLowDescription: "Yüksek kalite, büyük dosya boyutu",
        mediaCompressionMediumDescription: "Dengeli kalite ve dosya boyutu",
        mediaCompressionHighDescription: "Düşük kalite, küçük dosya boyutu",
        mediaMaxSize: "Boyut",
        ...
        shelfDropZoneCaptionTopCenter: "Bir dosyayı sürüklerken raf, ekranın üst ortasında bir rozet olarak belirir. Bıraktıkların tam orada, tek tıkla açtığın bir rozette kalır ve raf boşaldığında kaybolur.",
        shelfDropZoneLabel: "Buraya bırak",
        shelfDockPlacement: "Konum",
        shelfDockMenuBar: "Menü çubuğu simgesinin altında",
        shelfDockTopCenter: "Ekranın üst ortasında",
        shelfDockIslandNote: "Dynamic Island açıkken üst orta onundur.",
        ...
        audioPrioritySection: "Ses cihazı önceliği",
        audioPriorityOutputEnable: "En yüksek öncelikli ses çıkışına otomatik geç",
        audioPriorityInputEnable: "En yüksek öncelikli mikrofona otomatik geç",
        audioPriorityOutputList: "Ses çıkışı önceliği",
        audioPriorityInputList: "Mikrofon önceliği",
        audioPriorityMoveUp: "Yukarı taşı",
        ...
        diskMenuBarAvailableSpace: "Kullanılabilir alan",
        ...
        musicBlockCaption: "Algılanan bir medya tuşundan sonra müzik uygulamasının açılmasını engeller. Erişilebilirlik izni gerektirir. Tuş algılanmayan kulaklık komutlarına izin verilir.",
        ...
        musicBlockPlayReplacement: "Yerine açılan uygulama açıldığında çal",
        ...
        cleanerCatScreenshots: "Unutulan ekran görüntüleri",
        cleanerScreenshotsCaptionFormat: "%d gündür açmadığınız ve macOS’un verdiği ad ile klasörde duran ekran görüntüleri. Yeniden adlandırdıklarınız veya taşıdıklarınız burada hiç görünmez.",
        cleanerScreenshotsSettingCaption: "Tarama, bu süredir açmadığınız ekran görüntülerini işaretsiz ve toplam boyutuyla listeler.",
        cleanerScreenshotsAfterFormat: "%d gün sonra",
        ...
        scrollHorizontalName: "Tuş basılıyken yatay kaydırma",
