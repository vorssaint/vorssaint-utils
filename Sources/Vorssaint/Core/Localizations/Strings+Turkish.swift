...
extension Strings {
    static let tr = Strings(
        ...
        adminPromptQuarantine: "Vorssaint, seçili öğelerin karantinasını kaldırmak için parolanıza ihtiyaç duyuyor.",
        ...
        quarantineManagerName: "Karantina Yöneticisi",
        quarantineManagerMenuItem: "Karantina Yöneticisi",
        quarantineManagerIntroTitle: "“İnternetten indirildi” uyarısını kaldır",
        quarantineManagerIntroBody: "macOS, App Store dışında indirilen dosyaları, açarken Gatekeeper uyarısını tetikleyen bir karantina bayrağıyla işaretler. İncelemek ve bayrağı kaldırmak için dosya veya uygulama seçin.",
        quarantineManagerPick: "Uygulama veya dosya seç",
        quarantineManagerScanApplications: "Applications’ı Tara",
        quarantineManagerDropTitle: "Dosya veya uygulamaları buraya bırakın",
        quarantineManagerDropHint: "veya aşağıdan uygulama ya da dosya seçin",
        quarantineManagerFDANote: "Yaygın klasörler dışındaki dosyaları incelemek için Tam Disk Erişimi verin.",
        quarantineManagerScanning: "Karantinadaki öğeler aranıyor…",
        quarantineManagerEmptyTitle: "Karantinada öğe bulunamadı",
        quarantineManagerFoundTitle: "Karantinadaki öğeler",
        quarantineManagerSelectedFormat: "%d / %d seçildi",
        quarantineManagerSelectAll: "Tümünü Seç",
        quarantineManagerClearSelection: "Seçimi Temizle",
        quarantineManagerRemoveSelected: "Karantinayı Kaldır",
        quarantineManagerRemoving: "Karantina kaldırılıyor…",
        quarantineManagerDoneTitle: "Karantina kaldırıldı",
        quarantineManagerClearedFormat: "%d öğe temizlendi",
        quarantineManagerSomeFailed: "Bazı öğeler temizlenemedi.",
        quarantineManagerContinue: "Devam Et",
        quarantineManagerDetailTitle: "Karantina Ayrıntıları",
        quarantineManagerSource: "Kaynak",
        quarantineManagerDownloadDate: "İndirme Tarihi",
        quarantineManagerFlags: "Bayraklar",
        quarantineManagerRawValue: "Ham Değer",
        quarantineManagerCopyPath: "Yolu Kopyala",
        quarantineManagerCopyCommand: "xattr Komutunu Kopyala",
        quarantineManagerAllAttributesTitle: "Tüm Öznitelikler",
        quarantineManagerRemoveAllAttributes: "Tüm Öznitelikleri Kaldır",
        quarantineManagerRemoveAllConfirmTitle: "Tüm öznitelikler kaldırılsın mı?",
        quarantineManagerRemoveAllConfirmBody: "Bu, yalnızca karantinayı değil, bu dosyadaki tüm genişletilmiş öznitelikleri temizler. Geri alınamaz.",
        quarantineManagerAttributeProtected: "macOS tarafından korunuyor - kaldırılamaz",
        quarantineManagerBinaryValueHint: "İkili değer, onaltılık olarak gösterilir",
        quarantineManagerCommandBarToggle: "Komut Çubuğunda Göster",
        quarantineManagerCommandBarCaption: "Finder'da seçili olan öğelerin karantinasını kaldıran bir eylem ekler.",
