...
extension Strings {
    static let tr = Strings(
        ...
        autoRaiseName: "Odak fareyi takip etsin",
        autoRaiseCaption: "Kısa bir beklemeden sonra işaretçinin altındaki pencereye odaklanır ve öne getirir.",
        autoRaiseDelay: "Üzerinde bekleme gecikmesi",
        autoRaisePollInterval: "Algılama aralığı",
        autoRaiseRequireStop: "İşaretçinin durmasını zorunlu kıl",
        autoRaiseSensitivity: "Hareket hassasiyeti",
        autoRaiseAdvanced: "Gelişmiş seçenekler",
        autoRaisePauseKey: "Duraklatma tuşu",
        autoRaiseInvertPause: "Tuş basılı değilken duraklat",
        autoRaiseIgnoreSpace: "Masaüstü değişiminden sonra bekle",
        autoRaiseIncludeOnly: "Uygulama listesini izin listesi olarak kullan",
        autoRaiseApps: "Uygulamalar",
        autoRaiseAppsCaption: "Bu uygulamalar varsayılan olarak yok sayılır. İzin listesi modunda yalnızca bunlara odaklanılır.",
        autoRaiseTitlePatterns: "Yok sayılan pencere başlıkları (satır başına bir düzenli ifade)",
        autoRaiseStayFocusedApps: "Odakta kalması gereken uygulamalar",
        autoRaiseWarp: "Command-Tab veya Command-` sonrası işaretçiyi taşı",
        autoRaiseHorizontal: "Yatay konum",
        autoRaiseVertical: "Dikey konum",
        autoRaiseInvalidPatterns: "Bir veya daha fazla düzenli ifade geçersiz.",
        autoRaiseControlKey: "Control",
        autoRaiseOptionKey: "Option",
        autoRaiseDisabled: "Devre dışı",
        autoRaiseAddApp: "Uygulama ekle",
        autoRaiseRemoveApp: "Uygulamayı kaldır",
