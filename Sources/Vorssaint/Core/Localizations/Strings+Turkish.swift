...
extension Strings {
    static let tr = Strings(
        ...
        homebrewPreferredTerminalTitle: "Tercih edilen terminal",
        homebrewPreferredTerminalCaption: "Homebrew komutlarının, yükleyicilerin ve parola istemlerinin nerede açılacağını seçin.",
        homebrewAlacrittyWarning: "Homebrew Alacritty cask'i kullanımdan kaldırılmıştır ve Gatekeeper tarafından engellenebilir. Pencere açılmazsa Gizlilik ve Güvenlik'i kontrol edin.",
        homebrewTerminalLaunchFailedFormat: "%@ uygulamasının komutu açtığı doğrulanamadı.",
        homebrewEnableCaption: "Formülleri ve cask'leri ara, yükle ve kaldır.",
        homebrewMissingTitle: "Homebrew bulunamadı",
        homebrewMissingBody: "Vorssaint, resmi Homebrew yükleyicisiyle %@ uygulamasını açabilir. %@ adımları gösterir ve gerekirse parolanı ister.",
        homebrewInstallHomebrew: "Homebrew yükle",
        homebrewInstallHomebrewCaption: "%@ tamamladığında buraya dön ve Yenile'ye tıkla.",
        homebrewInstallHomebrewOpened: "Yükleyici %@ içinde açıldı.",
        homebrewShellSetupTitle: "%@ kurulumunu tamamla",
        homebrewShellSetupBody: "Homebrew yüklü, ancak %@ brew komutunu henüz bulamayabilir. Vorssaint, kurulum komutuyla %@ uygulamasını açabilir.",
        homebrewShellSetupButton: "%@ uygulamasını ayarla",
        homebrewShellSetupOpened: "Komut %@ içinde açıldı. Sonra buraya dön ve Yenile'ye tıkla.",
        ...
        homebrewOpenTerminal: "%@ uygulamasını aç",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için %@ uygulamasına ihtiyaç duyar. Vorssaint parolaları yakalamaz.",
        ...
        homebrewOperationTerminal: "%@ içinde devam et.",
