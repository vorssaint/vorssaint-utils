...
extension Strings {
    static let es = Strings(
        ...
        homebrewConfirmCleanupTitle: "¿Limpiar con Homebrew?",
        homebrewConfirmCleanupBody: "Homebrew eliminará descargas obsoletas y versiones antiguas de paquetes instalados.",
        ...
        homebrewOperationCleanup: "Limpiando Homebrew",
        homebrewOperationCleaned: "Homebrew limpiado.",
