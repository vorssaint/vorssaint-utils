...
extension Strings {
    static let es = Strings(
        ...
        micUnmutedHUD: "Silencio desactivado",
        ...
        micMuteMenuBarCaption: "Un micrófono tachado en rojo aparece junto al icono de la app en la barra de menús mientras esta función lo silencia.",
