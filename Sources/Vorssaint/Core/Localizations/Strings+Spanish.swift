...
extension Strings {
    static let es = Strings(
        ...
        switcherCurrentSpaceOnly: "Mostrar solo ventanas del escritorio actual",
        switcherCurrentSpaceOnlyCaption: "Oculta las ventanas de otros Espacios. Las ventanas minimizadas tampoco se muestran con esta opción activa.",
        switcherCurrentMonitorOnly: "Mostrar solo ventanas del monitor actual",
        switcherCurrentMonitorOnlyCaption: "Limita el selector a las ventanas cuyo marco está en la misma pantalla que el cursor.",
        switcherHideMinimized: "Ocultar ventanas minimizadas",
        switcherHideMinimizedCaption: "Elimina las ventanas minimizadas del selector. Requiere Accesibilidad.",
        switcherHideFinder: "Ocultar el Finder",
        switcherHideFinderCaption: "Elimina el Finder del selector, incluso cuando no hay ventanas abiertas.",
        switcherIconsOnly: "Mostrar solo iconos de apps, sin miniaturas en vivo",
        switcherIconsOnlyCaption: "Desactiva el uso de Grabación de pantalla por el selector. Cada tarjeta muestra el icono de la app en lugar de una captura en vivo.",
