...
extension Strings {
    static let es = Strings(
        ...
        homebrewPreferredTerminalCaption: "Elige dónde abrir los comandos de Homebrew, instaladores y solicitudes de contraseña.",
        homebrewAlacrittyWarning: "El cask Alacritty de Homebrew está obsoleto y Gatekeeper puede bloquearlo. Si no se abre ninguna ventana, revisa Privacidad y seguridad.",
        homebrewTerminalLaunchFailedFormat: "No se pudo confirmar que %@ abriera el comando.",
        homebrewEnableCaption: "Busca, instala y elimina fórmulas y casks.",
        homebrewMissingTitle: "No se encontró Homebrew",
        homebrewMissingBody: "Vorssaint puede abrir %@ con el instalador oficial de Homebrew. %@ muestra los pasos y pide tu contraseña si hace falta.",
        homebrewInstallHomebrew: "Instalar Homebrew",
        homebrewInstallHomebrewCaption: "Cuando termine en %@, vuelve aquí y pulsa Actualizar.",
        homebrewInstallHomebrewOpened: "Instalador abierto en %@.",
        homebrewShellSetupTitle: "Finalizar configuración de %@",
        homebrewShellSetupBody: "Homebrew está instalado, pero %@ quizá aún no encuentre el comando brew. Vorssaint puede abrir %@ con el comando de configuración.",
        homebrewShellSetupButton: "Configurar %@",
        homebrewShellSetupOpened: "Comando abierto en %@. Luego vuelve aquí y pulsa Actualizar.",
        ...
        homebrewTerminalFallback: "Esta operación necesita %@ para pedir la contraseña de administrador. Vorssaint no captura contraseñas.",
        ...
        homebrewOperationTerminal: "Continúa en %@.",
