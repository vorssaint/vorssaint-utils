...
extension Strings {
    static let es = Strings(
        ...
        mouseScrollingSection: "Desplazamiento del ratón",
        ...
        smoothScrollCaption: "Suaviza la rueda del ratón como un trackpad. Paso, velocidad y duración son independientes. El trackpad no cambia.",
        smoothScrollVerticalLabel: "Suavizar eje vertical",
        smoothScrollHorizontalLabel: "Suavizar eje horizontal",
        smoothScrollStepLabel: "Paso",
        smoothScrollStepCaption: "Define la distancia mínima de desplazamiento",
        smoothScrollSpeedLabel: "Velocidad",
