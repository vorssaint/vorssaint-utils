...
extension Strings {
    static let es = Strings(
        ...
        micMutePartialHUD: "Algunos micrófonos no se pudieron silenciar",
        micUnmutePartialHUD: "Algunos micrófonos siguen silenciados",
        ...
        switcherSection: "Selector de ventanas",
        ...
        switcherWindowShortcutCaption: "Abre un selector de las ventanas de la app en primer plano. Con el selector abierto, salta entre las ventanas de la app seleccionada.",
        ...
        dockPreviewKeepDockVisible: "Mantener el Dock visible (experimental)",
        dockPreviewKeepDockVisibleCaption: "Pausa la ocultación automática mientras la vista previa está abierta y la restaura al salir. Puede redimensionar ventanas. Si la app se interrumpe, vuelve a abrirla para restaurar el Dock.",
        ...
        mediaCompressionLowDescription: "Alta calidad, archivo grande",
        mediaCompressionMediumDescription: "Equilibrio entre calidad y tamaño del archivo",
        mediaCompressionHighDescription: "Baja calidad, archivo pequeño",
        mediaMaxSize: "Tamaño",
        ...
        shelfDropZoneCaptionTopCenter: "Mientras arrastras un archivo, el estante aparece como una insignia arriba, en el centro de la pantalla. Lo que sueltes se guarda ahí mismo, en una insignia que abres con un clic y que desaparece cuando el estante se vacía.",
        shelfDropZoneLabel: "Suelta aquí",
        shelfDockPlacement: "Posición",
        shelfDockMenuBar: "Debajo del icono de la barra de menús",
        shelfDockTopCenter: "Arriba, en el centro de la pantalla",
        shelfDockIslandNote: "Mientras el Dynamic Island está activado ocupa el centro superior.",
        ...
        audioPrioritySection: "Prioridad de dispositivos de audio",
        audioPriorityOutputEnable: "Cambiar automáticamente a la salida de audio con mayor prioridad",
        audioPriorityInputEnable: "Cambiar automáticamente al micrófono de mayor prioridad",
        audioPriorityOutputList: "Prioridad de las salidas de audio",
        audioPriorityInputList: "Prioridad de los micrófonos",
        audioPriorityMoveUp: "Subir",
        audioPriorityMoveDown: "Bajar",
        audioPriorityUnavailable: "No disponible",
        audioPriorityCurrent: "En uso",
        audioPriorityCaption: "Los dispositivos se seleccionan por orden de prioridad. Cuando se conecta uno con mayor prioridad, el sistema cambia a ese dispositivo. Cuando el dispositivo activo se desconecta, se selecciona el siguiente disponible.",
        ...
        diskMenuBarAvailableSpace: "Espacio disponible",
        ...
        musicBlockCaption: "Bloquea la apertura de la app de música tras detectar una tecla multimedia. Requiere acceso de Accesibilidad. Los comandos de auriculares sin una tecla detectada se permiten.",
        musicBlockUnavailable: "Esta protección no está disponible ahora. Desactívala y vuelve a activarla para reintentar.",
        musicBlockReplacementLabel: "Abrir en su lugar",
        musicBlockReplacementNone: "Ninguna",
        musicBlockReplacementBlocked: "Música e iTunes son las apps bloqueadas, así que no pueden abrirse en su lugar. Elige otra app.",
        musicBlockChooseApp: "Elegir app…",
        musicBlockPlayReplacement: "Reproducir tras abrir la app sustituta",
        ...
        cleanerCatScreenshots: "Capturas olvidadas",
        cleanerScreenshotsCaptionFormat: "Capturas de pantalla que no abres desde hace %d días y que aún tienen el nombre y la carpeta que les dio macOS. Las que renombraste o moviste nunca aparecen aquí.",
        cleanerScreenshotsSettingCaption: "El análisis muestra, sin marcar y con su tamaño total, las capturas que no abres desde hace ese tiempo.",
        cleanerScreenshotsAfterFormat: "Tras %d días",
        ...
        scrollHorizontalName: "Desplazamiento horizontal al mantener una tecla",
        scrollHorizontalModifierLabel: "Tecla modificadora",
        scrollHorizontalCommandKey: "Comando",
