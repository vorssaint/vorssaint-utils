...
extension Strings {
    static let es = Strings(
        ...
        diskSpeedTest: "Prueba de velocidad del disco",
        diskSpeedQuick: "Rápida · 1 GB",
        diskSpeedStandard: "Estándar · 3×4 GB",
        diskSpeedDescription: "Escribe y elimina archivos temporales. La prueba estándar realiza tres pasadas de 4 GB y muestra la mediana; otra actividad del disco puede afectar el resultado.",
        diskSpeedPreparing: "Preparando…",
        diskSpeedFlushing: "Sincronizando con el disco…",
        diskSpeedLastTest: "Última prueba",
        diskSpeedNeedsSpace: "Se requieren al menos %@ disponibles.",
        diskSpeedReadOnly: "Este disco es de solo lectura.",
        diskSpeedUnavailable: "El disco no está disponible o no se pudo probar.",
