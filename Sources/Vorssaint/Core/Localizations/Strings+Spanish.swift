...
extension Strings {
    static let es = Strings(
        ...
        audioPrioritySection: "Prioridad de audio",
        audioPriorityOutputEnable: "Cambiar automáticamente a la salida de mayor prioridad",
        audioPriorityInputEnable: "Cambiar automáticamente al micrófono de mayor prioridad",
        audioPriorityOutputList: "Prioridad de salida",
        audioPriorityInputList: "Prioridad de micrófono",
        audioPriorityAddOutput: "Añadir salida",
        ...
        audioPriorityCurrent: "Actual",
        audioPriorityEmpty: "Sin dispositivos seleccionados",
        audioPriorityCaption: "Los dispositivos se seleccionan por orden de prioridad. Al conectar uno de mayor prioridad, pasa a estar activo. Al desconectarse el activo, el siguiente disponible toma el relevo.",
