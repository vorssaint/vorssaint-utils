...
extension Strings {
    static let es = Strings(
        ...
        autoPauseMusicSection: "Pausar música automáticamente",
        autoPauseMusicTitle: "Pausar la música cuando algo más reproduzca audio",
        autoPauseMusicCaption: "Cuando otra app empiece a reproducir sonido o video, Vorssaint pausa el reproductor de música elegido abajo y puede reanudarlo cuando el otro audio se detenga. La primera vez, macOS te pedirá permiso para que Vorssaint controle tu reproductor de música.",
        autoPauseMusicPlayerLabel: "Reproductor de música",
        autoPauseMusicPlayerNone: "No establecido",
        autoPauseMusicPlayerInheritedFormat: "Usando %@ del bloqueador de la app Música",
        autoPauseMusicChooseApp: "Elegir app…",
        autoPauseMusicResumeTitle: "Reanudar automáticamente al detenerse",
