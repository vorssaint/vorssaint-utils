...
extension Strings {
    static let es = Strings(
        ...
        switcherAppearanceDelayCaption: "Cuánto tiempo debe mantenerse pulsado el atajo antes de que aparezca el selector. Las pulsaciones rápidas siguen cambiando sin mostrarlo.",
