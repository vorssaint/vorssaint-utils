...
extension Strings {
    static let es = Strings(
        ...
        mediaPages: "Páginas",
        mediaRotation: "Rotación",
        mediaErrorPageSelection: "Esa selección de páginas no corresponde a ninguna página del documento.",
        mediaPDFHint: "Las páginas con imagen se recodifican, lo que elimina la capa de OCR invisible. Las páginas de texto se conservan.",
        mediaStartCompressFormat: "Comprimir el %@",
        mediaStartConvertFormat: "Convertir a %@",
        mediaWidth: "Ancho",
        mediaFPS: "FPS",
