...
extension Strings {
    static let es = Strings(
        ...
        usbExcludeChargers: "Excluir fuentes de alimentación y cargadores",
        usbExcludeHubs: "Excluir hubs y docks USB",
        usbExcludeEthernet: "Excluir adaptadores de red y Ethernet",
        usbExcludeStorage: "Excluir almacenamiento externo",
