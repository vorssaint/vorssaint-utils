...
extension Strings {
    static let es = Strings(
        ...
        communityIntroMessage: "Vorssaint ahora se actualiza una vez por semana, para que cada novedad llegue sólida y bien probada. Los arreglos urgentes siguen saliendo al momento. Pero no hace falta esperar. En X publico avances antes de lanzar nada, puedes comentar, pedirme funciones por DM, y lo que digas puede cambiar la app. Elegí X porque traduce cada publicación a tu idioma automáticamente. ¡Pásate!",
