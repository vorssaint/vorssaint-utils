...
extension Strings {
    static let es = Strings(
        ...
        autoRaiseName: "El foco sigue al ratón",
        autoRaiseCaption: "Enfoca y trae al frente la ventana bajo el puntero tras una breve pausa.",
        autoRaiseDelay: "Retraso al pasar",
        autoRaisePollInterval: "Intervalo de detección",
        autoRaiseRequireStop: "Exigir que el puntero se detenga",
        autoRaiseSensitivity: "Sensibilidad al movimiento",
        autoRaiseAdvanced: "Opciones avanzadas",
        autoRaisePauseKey: "Tecla de pausa",
        autoRaiseInvertPause: "Pausar mientras no se mantenga pulsada",
        autoRaiseIgnoreSpace: "Esperar tras cambiar de escritorio",
        autoRaiseIncludeOnly: "Usar la lista de apps como permitidas",
        autoRaiseApps: "Apps",
        autoRaiseAppsCaption: "Estas apps se ignoran por defecto. En modo permitido, solo ellas reciben el foco.",
        autoRaiseTitlePatterns: "Títulos ignorados (una expresión regular por línea)",
        autoRaiseStayFocusedApps: "Apps que deben conservar el foco",
        autoRaiseWarp: "Mover el puntero tras Command-Tab o Command-`",
        autoRaiseHorizontal: "Posición horizontal",
        autoRaiseVertical: "Posición vertical",
        autoRaiseInvalidPatterns: "Una o más expresiones regulares no son válidas.",
        autoRaiseControlKey: "Control",
        autoRaiseOptionKey: "Option",
        autoRaiseDisabled: "Desactivado",
        autoRaiseAddApp: "Añadir app",
        autoRaiseRemoveApp: "Eliminar app",
