...
extension Strings {
    static let es = Strings(
        ...
        statusItemContextMenuSection: "Menú del clic derecho",
        statusItemContextMenuOrderHint: "Arrastra para reordenar y usa el ojo para mostrar u ocultar elementos. Ajustes y Salir siempre se muestran.",
        statusItemContextMenuHideItem: "Ocultar del menú del clic derecho",
        statusItemContextMenuShowItem: "Mostrar en el menú del clic derecho",
        statusItemContextMenuAlwaysShown: "Siempre visible",
