...
extension Strings {
    static let es = Strings(
        ...
        adminPromptQuarantine: "Vorssaint necesita tu contraseña para quitar la cuarentena de los elementos seleccionados.",
        ...
        uninstallerCommandBarCaption: "Añade una fila de desinstalación por cada app a la Barra de Comandos, además de un acceso directo para la app seleccionada en Finder.",

        quarantineManagerName: "Gestor de cuarentena",
        quarantineManagerMenuItem: "Gestor de cuarentena",
        quarantineManagerIntroTitle: "Quitar el aviso de “descargado de Internet”",
        quarantineManagerIntroBody: "macOS marca los archivos descargados fuera de la App Store con un indicador de cuarentena, que activa el aviso de Gatekeeper al abrirlos. Elige archivos o apps para inspeccionar y quitar el indicador.",
        quarantineManagerPick: "Elegir apps o archivos",
        quarantineManagerScanApplications: "Examinar Aplicaciones",
        quarantineManagerDropTitle: "Suelta archivos o apps aquí",
        quarantineManagerDropHint: "o elige apps o archivos abajo",
        quarantineManagerFDANote: "Concede acceso total al disco para inspeccionar archivos fuera de las carpetas habituales.",
        quarantineManagerScanning: "Buscando elementos en cuarentena…",
        quarantineManagerEmptyTitle: "No se encontraron elementos en cuarentena",
        quarantineManagerFoundTitle: "Elementos en cuarentena",
        quarantineManagerSelectedFormat: "%d de %d seleccionados",
        quarantineManagerSelectAll: "Seleccionar todo",
        quarantineManagerClearSelection: "Borrar selección",
        quarantineManagerRemoveSelected: "Quitar cuarentena",
        quarantineManagerRemoving: "Quitando cuarentena…",
        quarantineManagerDoneTitle: "Cuarentena eliminada",
        quarantineManagerClearedFormat: "%d elemento(s) limpiado(s)",
        quarantineManagerSomeFailed: "Algunos elementos no se pudieron limpiar.",
        quarantineManagerContinue: "Continuar",
        quarantineManagerDetailTitle: "Detalles de la cuarentena",
        quarantineManagerSource: "Origen",
        quarantineManagerDownloadDate: "Fecha de descarga",
        quarantineManagerFlags: "Indicadores",
        quarantineManagerRawValue: "Valor sin procesar",
        quarantineManagerCopyPath: "Copiar ruta",
        quarantineManagerCopyCommand: "Copiar comando xattr",
        quarantineManagerAllAttributesTitle: "Todos los atributos",
        quarantineManagerRemoveAllAttributes: "Eliminar todos los atributos",
        quarantineManagerRemoveAllConfirmTitle: "¿Eliminar todos los atributos?",
        quarantineManagerRemoveAllConfirmBody: "Esto borra todos los atributos extendidos de este archivo, no solo la cuarentena. No se puede deshacer.",
        quarantineManagerAttributeProtected: "Protegido por macOS - no se puede eliminar",
        quarantineManagerBinaryValueHint: "Valor binario, mostrado en hexadecimal",
        quarantineManagerCommandBarToggle: "Mostrar en la Barra de Comandos",
        quarantineManagerCommandBarCaption: "Añade una acción para quitar la cuarentena de lo seleccionado en Finder.",
