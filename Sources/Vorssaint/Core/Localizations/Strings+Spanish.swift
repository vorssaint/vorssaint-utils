...
extension Strings {
    static let es = Strings(
        ...
        advancedUninstallDescription: "Borra los permisos y el estado propio de Vorssaint, elimina el ítem de inicio y la regla de tapa cerrada, y mueve solo la app a la Papelera. No borra vídeos, descargas ni archivos de las carpetas que hayas elegido. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar Vorssaint por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar Vorssaint?",
        advancedUninstallConfirmBody: "Vorssaint borrará sus permisos y su propio estado, moverá la app a la Papelera y después se cerrará. No borrará los medios descargados ni los archivos de las carpetas que hayas elegido. Esto no se puede deshacer desde la app, pero la app permanece en la Papelera hasta que la vacíes.",
        ...
        donateMessage: "Todos mis proyectos públicos son, y siempre serán, totalmente gratuitos: sin suscripción, sin anuncios. El apoyo de la comunidad es lo único que los mantiene vivos. Si Vorssaint te ayuda, apoyarlo en GitHub marca una diferencia de verdad.",
        donateButton: "Apoyar en GitHub",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Vorssaint es 100% gratis y siempre lo será",
        supportIntroMessage: "Sigo cuidando la app en mi tiempo libre. Si te ayuda, puedes ayudarme de una forma sencilla compartiéndola, dejando una estrella en GitHub o apoyándome allí. Me ayuda muchísimo a seguir mejorándola.",
        supportIntroStarButton: "Dejar una estrella",
        supportIntroSponsorButton: "Apoyar en GitHub",
        ...
        videoDownloaderUrlPlaceholder: "Pega un enlace multimedia HTTP o HTTPS",
        videoDownloaderUrlHelp: "La URL solo se inspecciona cuando es válida; no se guarda ni se incluye en argumentos del proceso.",
        videoDownloaderPaste: "Pegar",
        videoDownloaderInspecting: "Inspeccionando…",
        videoDownloaderVideo: "Vídeo",
        videoDownloaderAudio: "Audio",
        videoDownloaderQuality: "Calidad de vídeo",
        videoDownloaderHeightFormat: "%dp",
        videoDownloaderQualityFallbackFormat: "%dp no estaba disponible; se seleccionó %dp.",
        videoDownloaderSubtitles: "Subtítulos",
        videoDownloaderNone: "Ninguno",
        videoDownloaderManual: "Manual",
        videoDownloaderAutomatic: "Automático",
        videoDownloaderDestination: "Carpeta de descargas",
        videoDownloaderChoose: "Elegir…",
        videoDownloaderShowInPanel: "Mostrar en el panel del menú",
        videoDownloaderSettingsCaption: "La descarga se prepara en privado y solo el MP4/MKV o M4A terminado se coloca en tu carpeta.",
        videoDownloaderUsageNotice: "Descarga solo contenido que tengas permiso para usar.",
        videoDownloaderDefaultLocation: "Ubicación predeterminada",
        videoDownloaderResetDownloads: "Restablecer a Descargas",
        videoDownloaderEmbedThumbnail: "Incrustar miniatura en MP4/MKV / portada en M4A",
        videoDownloaderEmbedMetadata: "Incrustar metadatos",
        videoDownloaderEmbedChapters: "Incrustar capítulos en MP4/MKV",
        videoDownloaderUseCookies: "Usar cookies del navegador",
        videoDownloaderCookiesBrowser: "Navegador",
        videoDownloaderCookiesNote: "Permite que yt-dlp use las cookies de inicio de sesión de tu navegador para descargar vídeos con restricción de edad o solo para miembros. Las cookies se leen solo durante la inspección y la descarga y Vorssaint nunca las guarda.",
        videoDownloaderFAQ: "Preguntas frecuentes de yt-dlp",
        videoDownloaderCookiesDiskAccessNote: "Leer los archivos de cookies del navegador requiere Acceso total al disco. Activa Vorssaint en Ajustes del Sistema > Privacidad y seguridad > Acceso total al disco y vuelve a intentarlo.",
        videoDownloaderErrorExtractorFormat: "yt-dlp informó: %@",
        videoDownloaderDependencies: "Herramientas de descarga",
        videoDownloaderMissingToolsFormat: "Faltan: %@",
        videoDownloaderInstallMissingTools: "Instalar herramientas que faltan",
        videoDownloaderSetUpDownloader: "Configurar descargador",
        videoDownloaderBrewSetupNote: "Homebrew instala solo los componentes que falten: yt-dlp, FFmpeg (incluido ffprobe) y Deno.",
        videoDownloaderTerminalSetupNote: "Terminal abrirá la instalación oficial de Homebrew y puede pedir confirmación o contraseña; después instalará yt-dlp, FFmpeg (incluido ffprobe) y Deno.",
        videoDownloaderCheckingTools: "Comprobando herramientas…",
        videoDownloaderDownloadVideo: "Descargar vídeo",
        videoDownloaderDownloadAudio: "Descargar audio",
        videoDownloaderDownloading: "Descargando…",
        videoDownloaderPercentFormat: "%.0f%%",
        videoDownloaderSpeedFormat: "%@/s",
        videoDownloaderEtaFormat: "Quedan %@",
        videoDownloaderFinalizing: "Finalizando…",
        videoDownloaderCancel: "Cancelar",
        videoDownloaderCancelling: "Cancelando…",
        videoDownloaderComplete: "Descarga completada",
        videoDownloaderDownloadAnother: "Descargar otro",
        videoDownloaderRevealFinder: "Mostrar en Finder",
        videoDownloaderRetry: "Reintentar",
        videoDownloaderCancelled: "Descarga cancelada",
        videoDownloaderFailureTitle: "No se pudo completar la descarga",
        videoDownloaderUploader: "Autor",
        videoDownloaderDuration: "Duración",
        videoDownloaderThumbnail: "Miniatura del contenido",
        videoDownloaderErrorURLInvalid: "Introduce un enlace multimedia HTTP o HTTPS completo.",
        videoDownloaderErrorURLTooLong: "Esta URL es demasiado larga para inspeccionarla con seguridad.",
        videoDownloaderErrorURLControl: "La URL contiene un salto de línea o carácter de control.",
        videoDownloaderErrorURLCredentials: "No se admiten URL con usuario o contraseña.",
        videoDownloaderErrorInspectionTimeout: "La inspección tardó demasiado. Comprueba el enlace e inténtalo de nuevo.",
        videoDownloaderErrorInspectionFailed: "No se pudo inspeccionar. Comprueba que esté disponible y accesible.",
        videoDownloaderErrorInspectionTooLarge: "El sitio devolvió demasiada información para procesarla con seguridad.",
        videoDownloaderErrorInspectionMalformed: "La información devuelta por yt-dlp no se pudo usar.",
        videoDownloaderInspectionFailedNotice: "La inspección falló — las opciones de calidad y la miniatura no están disponibles, pero aún puedes intentar descargar.",
        videoDownloaderErrorPlaylist: "No se admiten listas, canales ni colecciones. Pega un solo elemento.",
        ...
        videoDownloaderErrorSetupFailed: "No se pudieron instalar las herramientas. Comprueba Homebrew.",
        videoDownloaderErrorTerminalPermission: "No se pudo abrir Terminal. Permite Automatización de Terminal en Ajustes del Sistema.",
        videoDownloaderErrorDownloadFailed: "La descarga falló. Comprueba que el enlace siga disponible y accesible.",
        videoDownloaderErrorCookiesPermission: "Vorssaint no pudo leer las cookies del navegador seleccionado. macOS denegó el acceso a los archivos de cookies. Concede Acceso total al disco en Ajustes del Sistema > Privacidad y seguridad > Acceso total al disco y vuelve a intentarlo.",
        videoDownloaderErrorRemux: "Los flujos elegidos no pueden combinarse o remultiplexarse a MP4/MKV sin transcodificar. Elige otra calidad.",
        videoDownloaderErrorSubtitle: "No se pudo descargar e integrar el subtítulo elegido. Si requiere iniciar sesión, activa las cookies del navegador y vuelve a intentarlo.",
        videoDownloaderErrorSubtitleRateLimited: "Se realizaron demasiadas solicitudes de subtítulos (HTTP 429). El sitio de vídeo rechazó temporalmente el subtítulo elegido. Inténtalo de nuevo más tarde o elige el subtítulo en el idioma original.",
        videoDownloaderErrorOptionalData: "No se pudo integrar la portada, los metadatos o los capítulos solicitados.",
        videoDownloaderErrorFileSafety: "No se pudo verificar o colocar con seguridad el archivo final en la carpeta elegida.",
    )
}
