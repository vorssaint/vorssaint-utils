...
extension Strings {
    static let zhHK = Strings(
        ...
        advancedClearFailed: "部分權限或合上機蓋規則未能移除。請再試一次，並在出現密碼要求時允許。",
        ...
        shelfDropZoneCaptionTopCenter: "拖移檔案時，暫存架會以徽章形式出現在螢幕頂部中間。放下的內容就保存在那裡，收進一個點按即可打開的徽章，暫存架清空後徽章便會消失。",
        ...
        audioPriorityOutputEnable: "自動切換到最高優先順序嘅音訊輸出",
        audioPriorityInputEnable: "自動切換到最高優先順序嘅麥克風",
        ...
        scrollHorizontalCaption: "只按住所選輔助鍵，即可用滑鼠的垂直滾輪水平捲動。其他組合鍵維持不變。",
