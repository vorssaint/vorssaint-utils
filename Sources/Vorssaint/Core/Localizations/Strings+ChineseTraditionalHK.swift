...
extension Strings {
    static let zhHK = Strings(
        ...
        statusItemContextMenuSection: "右鍵選單",
        statusItemContextMenuOrderHint: "拖曳以重新排列，並使用眼睛圖示顯示或隱藏項目。「設定」與「結束」會一直顯示。",
        statusItemContextMenuHideItem: "從右鍵選單隱藏",
        statusItemContextMenuShowItem: "在右鍵選單中顯示",
        statusItemContextMenuAlwaysShown: "一直顯示",
