...
extension Strings {
    static let de = Strings(
        ...
        advancedClearFailed: "Einige Berechtigungen oder die Regel für das geschlossene Display konnten nicht entfernt werden. Versuche es erneut und erlaube die Kennwortabfrage, falls sie erscheint.",
        ...
        micMutePartialHUD: "Einige Mikrofone konnten nicht stummgeschaltet werden",
        micUnmutePartialHUD: "Einige Mikrofone sind noch stumm",
        ...
        switcherSection: "Fensterumschalter",
        ...
        switcherWindowShortcutCaption: "Öffnet einen Umschalter für die Fenster der vordersten App. Bei geöffnetem Umschalter springt er zwischen den Fenstern der ausgewählten App.",
        ...
        mediaCompressionLowDescription: "Hohe Qualität, große Datei",
        mediaCompressionMediumDescription: "Ausgewogene Qualität und Dateigröße",
        mediaCompressionHighDescription: "Niedrige Qualität, kleine Datei",
        mediaMaxSize: "Größe",
        ...
        shelfDropZoneCaptionTopCenter: "Während du eine Datei ziehst, erscheint die Ablage als Plakette oben in der Bildschirmmitte. Was du ablegst, bleibt gleich dort, in einer Plakette, die du mit einem Klick öffnest und die verschwindet, sobald die Ablage leer ist.",
        shelfDropZoneLabel: "Hier loslassen",
        shelfDockPlacement: "Position",
        shelfDockMenuBar: "Unter dem Menüleistensymbol",
        shelfDockTopCenter: "Oben in der Bildschirmmitte",
        shelfDockIslandNote: "Solange die Dynamic Island aktiv ist, gehört ihr die Mitte oben.",
        ...
        shelfRemoveAfterDropCaption: "Von einer anderen App angenommene Objekte verlassen die Ablage. Ausschalten, um eine Kopie zu behalten. Angeheftete Objekte bleiben immer.",
        ...
        shelfActionPin: "Anheften",
        shelfActionUnpin: "Loslösen",
        ...
        audioPrioritySection: "Priorität der Audiogeräte",
        audioPriorityOutputEnable: "Automatisch zum Ausgabegerät mit der höchsten Priorität wechseln",
        audioPriorityInputEnable: "Automatisch zum Mikrofon mit der höchsten Priorität wechseln",
        audioPriorityOutputList: "Priorität der Ausgabegeräte",
        audioPriorityInputList: "Priorität der Mikrofone",
        audioPriorityMoveUp: "Nach oben",
        ...
        networkIPAddresses: "IP-Adressen",
        networkLocalIP: "Lokales IPv4",
        ...
        musicBlockCaption: "Blockiert den Start der Musik-App nach einer erkannten Medientaste. Benötigt Bedienungshilfen. Kopfhörerbefehle ohne erkannte Taste werden zugelassen.",
        musicBlockUnavailable: "Dieser Schutz ist gerade nicht verfügbar. Schalte ihn aus und wieder ein, um es erneut zu versuchen.",
        musicBlockReplacementLabel: "Stattdessen öffnen",
        musicBlockReplacementNone: "Keine",
        musicBlockReplacementBlocked: "Musik und iTunes sind die blockierten Apps und können daher nicht stattdessen öffnen. Wähle eine andere App.",
        musicBlockChooseApp: "App wählen…",
        musicBlockPlayReplacement: "Nach dem Öffnen der Ersatz-App abspielen",
        ...
        cleanerCatScreenshots: "Vergessene Bildschirmfotos",
        cleanerScreenshotsCaptionFormat: "Bildschirmfotos, die du seit %d Tagen nicht geöffnet hast und die noch den Namen und Ordner von macOS tragen. Umbenannte oder verschobene erscheinen hier nie.",
        cleanerScreenshotsSettingCaption: "Die Suche listet Bildschirmfotos, die du so lange nicht geöffnet hast, nicht ausgewählt und mit ihrer Gesamtgröße.",
        cleanerScreenshotsAfterFormat: "Nach %d Tagen",
        ...
        scrollHorizontalName: "Mit gedrückter Taste horizontal scrollen",
        scrollHorizontalModifierLabel: "Zusatztaste",
        scrollHorizontalCommandKey: "Befehlstaste",
