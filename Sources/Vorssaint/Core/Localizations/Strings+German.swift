...
extension Strings {
    static let de = Strings(
        ...
        statusItemContextMenuSection: "Rechtsklickmenü",
        statusItemContextMenuOrderHint: "Zum Neuanordnen ziehen und das Auge verwenden, um Einträge ein- oder auszublenden. Einstellungen und Beenden werden immer angezeigt.",
        statusItemContextMenuHideItem: "Im Rechtsklickmenü ausblenden",
        statusItemContextMenuShowItem: "Im Rechtsklickmenü anzeigen",
        statusItemContextMenuAlwaysShown: "Immer angezeigt",
