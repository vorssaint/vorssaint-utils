...
extension Strings {
    static let de = Strings(
        ...
        mediaPages: "Seiten",
        mediaRotation: "Drehung",
        mediaErrorPageSelection: "Diese Seitenauswahl trifft auf keine Seite dieses Dokuments zu.",
        mediaPDFHint: "Seiten mit Bild werden neu codiert, wodurch eine unsichtbare OCR-Ebene verloren geht. Textseiten bleiben unverändert.",
        mediaStartCompressFormat: "%@ komprimieren",
        mediaStartConvertFormat: "In %@ umwandeln",
        mediaWidth: "Breite",
        mediaFPS: "FPS",
