...
extension Strings {
    static let de = Strings(
        ...
        focusFollowsMouseCaption: "Fokussiert das Fenster unter dem Zeiger nach kurzer Pause.",
        focusFollowsMouseDelay: "Verzögerung",
        focusFollowsMouseRaise: "Fenster nach vorn bringen",
        switcherMinimizedPlacementLabel: "Minimierte Fenster und ausgeblendete Apps",
