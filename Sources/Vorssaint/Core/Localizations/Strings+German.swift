...
extension Strings {
    static let de = Strings(
        ...
        monitorShowConnectedDevices: "Verbundene Geräte",
        usbExcludeChargers: "Netzteile und Ladegeräte ausschließen",
        usbExcludeHubs: "USB-Hubs und Docks ausschließen",
        usbExcludeEthernet: "Netzwerk- und Ethernet-Adapter ausschließen",
        usbExcludeStorage: "Externen Speicher ausschließen",
