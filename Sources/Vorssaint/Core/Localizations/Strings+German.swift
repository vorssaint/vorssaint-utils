...
extension Strings {
    static let de = Strings(
        ...
        autoRaiseName: "Fokus folgt Maus",
        autoRaiseCaption: "Fokussiert das Fenster unter dem Zeiger und bringt es nach kurzer Pause nach vorn.",
        autoRaiseDelay: "Verzögerung",
        autoRaisePollInterval: "Erkennungsintervall",
        autoRaiseRequireStop: "Stillstand des Zeigers verlangen",
        autoRaiseSensitivity: "Bewegungsempfindlichkeit",
        autoRaiseAdvanced: "Erweiterte Optionen",
        autoRaisePauseKey: "Pausentaste",
        autoRaiseInvertPause: "Pausieren, solange die Taste nicht gedrückt wird",
        autoRaiseIgnoreSpace: "Nach Space-Wechsel warten",
        autoRaiseIncludeOnly: "App-Liste als Positivliste verwenden",
        autoRaiseApps: "Apps",
        autoRaiseAppsCaption: "Diese Apps werden standardmäßig ignoriert. Im Positivlistenmodus erhalten nur sie den Fokus.",
        autoRaiseTitlePatterns: "Ignorierte Fenstertitel (ein regulärer Ausdruck pro Zeile)",
        autoRaiseStayFocusedApps: "Apps, die fokussiert bleiben sollen",
        autoRaiseWarp: "Zeiger nach Command-Tab oder Command-` bewegen",
        autoRaiseHorizontal: "Horizontale Position",
        autoRaiseVertical: "Vertikale Position",
        autoRaiseInvalidPatterns: "Mindestens ein regulärer Ausdruck ist ungültig.",
        autoRaiseControlKey: "Control",
        autoRaiseOptionKey: "Option",
        autoRaiseDisabled: "Deaktiviert",
        autoRaiseAddApp: "App hinzufügen",
        autoRaiseRemoveApp: "App entfernen",
