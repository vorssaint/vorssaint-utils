...
extension Strings {
    static let de = Strings(
        ...
        autoPauseMusicSection: "Musik automatisch pausieren",
        autoPauseMusicTitle: "Musik pausieren, wenn etwas anderes Ton wiedergibt",
        autoPauseMusicCaption: "Wenn eine andere App Ton oder Video wiedergibt, pausiert Vorssaint den unten gewählten Musik-Player und kann ihn fortsetzen, sobald der andere Ton endet. Beim ersten Mal fragt macOS, ob Vorssaint deinen Musik-Player steuern darf.",
        autoPauseMusicPlayerLabel: "Musik-Player",
        autoPauseMusicPlayerNone: "Nicht festgelegt",
        autoPauseMusicPlayerInheritedFormat: "Verwendet %@ aus dem Musik-App-Blocker",
        autoPauseMusicChooseApp: "App wählen…",
        autoPauseMusicResumeTitle: "Automatisch fortsetzen, wenn es endet",
