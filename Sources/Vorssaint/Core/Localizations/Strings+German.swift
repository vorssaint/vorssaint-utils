...
extension Strings {
    static let de = Strings(
        ...
        mouseScrollingSection: "Maus-Scrollen",
        ...
        smoothScrollCaption: "Glättet das Mausrad wie ein Trackpad. Schritt, Geschwindigkeit und Dauer sind unabhängig. Das Trackpad bleibt unverändert.",
        smoothScrollVerticalLabel: "Vertikale Achse glätten",
        smoothScrollHorizontalLabel: "Horizontale Achse glätten",
        smoothScrollStepLabel: "Schritt",
        smoothScrollStepCaption: "Legt den minimalen Bildlaufabstand fest",
        smoothScrollSpeedLabel: "Geschwindigkeit",
