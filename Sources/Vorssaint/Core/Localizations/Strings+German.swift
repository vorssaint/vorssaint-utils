...
extension Strings {
    static let de = Strings(
        ...
        homebrewPreferredTerminalTitle: "Bevorzugtes Terminal",
        homebrewPreferredTerminalCaption: "Wähle aus, wo Homebrew-Befehle, Installer und Passwortabfragen geöffnet werden.",
        homebrewAlacrittyWarning: "Homebrews Alacritty-Cask ist veraltet und kann von Gatekeeper blockiert werden. Wenn sich kein Fenster öffnet, prüfe Datenschutz & Sicherheit.",
        homebrewTerminalLaunchFailedFormat: "Es konnte nicht bestätigt werden, dass %@ den Befehl geöffnet hat.",
        homebrewEnableCaption: "Suche, installiere und entferne Formeln und Casks.",
        homebrewMissingTitle: "Homebrew nicht gefunden",
        homebrewMissingBody: "Vorssaint kann %@ mit dem offiziellen Homebrew-Installer öffnen. %@ zeigt die Schritte und fragt bei Bedarf nach deinem Passwort.",
        homebrewInstallHomebrew: "Homebrew installieren",
        homebrewInstallHomebrewCaption: "Wenn %@ fertig ist, komm zurück und klicke auf Aktualisieren.",
        homebrewInstallHomebrewOpened: "Installer in %@ geöffnet.",
        homebrewShellSetupTitle: "%@-Konfiguration abschließen",
        homebrewShellSetupBody: "Homebrew ist installiert, aber %@ findet den Befehl brew vielleicht noch nicht. Vorssaint kann %@ mit dem Konfigurationsbefehl öffnen.",
        homebrewShellSetupButton: "%@ konfigurieren",
        homebrewShellSetupOpened: "Befehl in %@ geöffnet. Komm danach zurück und klicke auf Aktualisieren.",
        ...
        homebrewTerminalFallback: "Diese Aktion benötigt %@, um nach dem Administratorpasswort zu fragen. Vorssaint erfasst keine Passwörter.",
        ...
        homebrewOperationTerminal: "In %@ fortfahren.",
