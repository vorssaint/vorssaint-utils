...
extension Strings {
    static let de = Strings(
        ...
        clamshellExternalDisplayToggle: "Externes Display",
        clamshellExternalDisplayCaption: "Aktiviert den zugeklappten Modus nur, solange die gewählten Bedingungen gelten (eine oder alle). „Wachhalten“ bleibt unverändert.",
        clamshellGatePowerToggle: "Netzteil verbunden",
        clamshellGateNetworkToggle: "Netzwerk verfügbar",
        clamshellGateModeAny: "Eine",
        clamshellGateModeAll: "Alle",
        clamshellGateMatchLabel: "Bedingungen",
