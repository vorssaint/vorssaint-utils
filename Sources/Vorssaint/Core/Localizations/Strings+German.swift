...
extension Strings {
    static let de = Strings(
        ...
        adminPromptQuarantine: "Vorssaint benötigt Ihr Passwort, um die Quarantäne der ausgewählten Elemente zu entfernen.",
        ...
        quarantineManagerIntroTitle: "Hinweis „aus dem Internet geladen“ entfernen",
        quarantineManagerIntroBody: "macOS markiert außerhalb des App Store heruntergeladene Dateien mit einem Quarantäne-Flag, das beim Öffnen die Gatekeeper-Warnung auslöst. Wählen Sie Dateien oder Apps, um sie zu prüfen und das Flag zu entfernen.",
        quarantineManagerPick: "Apps oder Dateien auswählen",
        quarantineManagerScanApplications: "Programme durchsuchen",
        quarantineManagerDropTitle: "Dateien oder Apps hierher ziehen",
        quarantineManagerDropHint: "oder unten Apps oder Dateien auswählen",
        quarantineManagerFDANote: "Gewähren Sie Vollzugriff auf die Festplatte, um Dateien außerhalb der üblichen Ordner zu prüfen.",
        quarantineManagerScanning: "Suche nach Quarantäne-Elementen…",
        quarantineManagerEmptyTitle: "Keine Elemente in Quarantäne gefunden",
        quarantineManagerFoundTitle: "Elemente in Quarantäne",
        quarantineManagerSelectedFormat: "%d von %d ausgewählt",
        quarantineManagerSelectAll: "Alle auswählen",
        quarantineManagerClearSelection: "Auswahl aufheben",
        quarantineManagerRemoveSelected: "Quarantäne entfernen",
        quarantineManagerRemoving: "Quarantäne wird entfernt…",
        quarantineManagerDoneTitle: "Quarantäne entfernt",
        quarantineManagerClearedFormat: "%d Element(e) bereinigt",
        quarantineManagerSomeFailed: "Einige Elemente konnten nicht bereinigt werden.",
        quarantineManagerContinue: "Weiter",
        quarantineManagerDetailTitle: "Quarantäne-Details",
        quarantineManagerSource: "Quelle",
        quarantineManagerDownloadDate: "Downloaddatum",
        quarantineManagerFlags: "Flags",
        quarantineManagerRawValue: "Rohwert",
        quarantineManagerCopyPath: "Pfad kopieren",
        quarantineManagerCopyCommand: "xattr-Befehl kopieren",
        quarantineManagerAllAttributesTitle: "Alle Attribute",
        quarantineManagerRemoveAllAttributes: "Alle Attribute entfernen",
        quarantineManagerRemoveAllConfirmTitle: "Alle Attribute entfernen?",
        quarantineManagerRemoveAllConfirmBody: "Dadurch werden alle erweiterten Attribute dieser Datei gelöscht, nicht nur die Quarantäne. Das kann nicht rückgängig gemacht werden.",
        quarantineManagerAttributeProtected: "Von macOS geschützt - kann nicht entfernt werden",
        quarantineManagerBinaryValueHint: "Binärer Wert, als Hex angezeigt",
        quarantineManagerCommandBarToggle: "In der Befehlsleiste anzeigen",
        quarantineManagerCommandBarCaption: "Fügt eine Aktion hinzu, um die Quarantäne von der aktuellen Finder-Auswahl zu entfernen.",
