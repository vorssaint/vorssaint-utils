...
extension Strings {
    static let de = Strings(
        ...
        diskSpeedTest: "Festplatten-Geschwindigkeitstest",
        diskSpeedQuick: "Schnell · 1 GB",
        diskSpeedStandard: "Standard · 3×4 GB",
        diskSpeedDescription: "Schreibt und entfernt temporäre Dateien. Der Standardtest führt drei 4-GB-Durchläufe aus und zeigt den Median; andere Festplattenaktivitäten können das Ergebnis beeinflussen.",
        diskSpeedPreparing: "Vorbereitung…",
        diskSpeedFlushing: "Mit Festplatte synchronisieren…",
        diskSpeedLastTest: "Letzter Test",
        diskSpeedNeedsSpace: "Mindestens %@ freier Speicher ist erforderlich.",
        diskSpeedReadOnly: "Diese Festplatte ist schreibgeschützt.",
        diskSpeedUnavailable: "Die Festplatte ist nicht verfügbar oder konnte nicht getestet werden.",
