...
extension Strings {
    static let de = Strings(
        ...
        audioPrioritySection: "Audio-Priorität",
        audioPriorityOutputEnable: "Automatisch zur Ausgabe mit höchster Priorität wechseln",
        audioPriorityInputEnable: "Automatisch zum Mikrofon mit höchster Priorität wechseln",
        audioPriorityOutputList: "Ausgabe-Priorität",
        audioPriorityInputList: "Mikrofon-Priorität",
        audioPriorityAddOutput: "Ausgabe hinzufügen",
        audioPriorityAddInput: "Mikrofon hinzufügen",
        audioPriorityMoveUp: "Nach oben",
        audioPriorityMoveDown: "Nach unten",
        audioPriorityRemove: "Entfernen",
        audioPriorityUnavailable: "Nicht verfügbar",
        audioPriorityCurrent: "Aktuell",
        audioPriorityEmpty: "Keine Geräte ausgewählt",
        audioPriorityCaption: "Geräte werden in Prioritätsreihenfolge ausgewählt. Beim Verbinden eines Geräts mit höherer Priorität wird es aktiv. Trennt sich das aktive Gerät, übernimmt das nächste verfügbare.",
