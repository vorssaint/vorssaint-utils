...
extension Strings {
    static let ptBR = Strings(
        ...
        audioPrioritySection: "Prioridade de áudio",
        audioPriorityOutputEnable: "Trocar automaticamente para a saída de maior prioridade",
        audioPriorityInputEnable: "Trocar automaticamente para o microfone de maior prioridade",
        audioPriorityOutputList: "Prioridade de saída",
        audioPriorityInputList: "Prioridade de microfone",
        audioPriorityAddOutput: "Adicionar saída",
        ...
        audioPriorityCurrent: "Atual",
        audioPriorityEmpty: "Nenhum dispositivo selecionado",
        audioPriorityCaption: "Dispositivos são selecionados por ordem de prioridade. Quando um de maior prioridade conecta, ele passa a ser usado. Quando o ativo desconecta, o próximo disponível assume.",
