...
extension Strings {
    static let ptBR = Strings(
        ...
        menuBarIconStillHiddenBody: "O macOS ainda não mostrou o ícone. Confira nos Ajustes do Sistema se o Vorssaint está permitido na barra de menus. Uma falha na posição salva ou a falta de espaço também pode impedir que ele apareça. Os Ajustes do Vorssaint continuam disponíveis.",
...
extension Strings {
    static let enUS = Strings(
        ...
        menuBarIconStillHiddenBody: "macOS still has not shown the icon. Check in System Settings that Vorssaint is allowed in the menu bar. A saved placement problem or limited space can also prevent it from appearing. Vorssaint Settings remain available.",
