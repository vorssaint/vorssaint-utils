...
extension Strings {
    static let ptBR = Strings(
        ...
        extraBrightnessUnsupported: "Disponível apenas em telas com reserva HDR: as telas XDR dos MacBook Pro de 14 e 16 polegadas e monitores HDR externos.",
...
extension Strings {
    static let enUS = Strings(
        ...
        extraBrightnessUnsupported: "Available only on displays with HDR headroom: the XDR screens of the 14 and 16 inch MacBook Pro, and external HDR monitors.",
