...
extension Strings {
    static let ptBR = Strings(
        ...
        mediaCompressionLow: "Baixa (alta qualidade)",
        mediaCompressionMedium: "Média (equilibrada)",
        mediaCompressionHigh: "Alta (arquivo pequeno)",
...
extension Strings {
    static let enUS = Strings(
        ...
        mediaCompressionLow: "Low (high quality)",
        mediaCompressionMedium: "Medium (balanced)",
        mediaCompressionHigh: "High (small file)",
        mediaMaxSize: "Size",
