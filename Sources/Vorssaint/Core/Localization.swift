...
struct Strings {
    ...
    let videoDownloaderDestination: String
    ...
    let videoDownloaderDefaultLocation: String
    let videoDownloaderResetDownloads: String
    let videoDownloaderEmbedThumbnail: String
    let videoDownloaderEmbedMetadata: String
    let videoDownloaderEmbedChapters: String
