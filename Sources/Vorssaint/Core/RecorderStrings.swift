...
extension RecorderFeatureStrings {
    ...
    static let nl = RecorderFeatureStrings(
        pageTitle: "Schermopname",
        hubDescription: "Neemt een gebied, venster of scherm op en je bewerkt het achteraf",
        panelCaption: "Neem een gebied, venster of het hele scherm op",
        startButton: "Nu opnemen",
        stopButton: "Opname stoppen",
        fileNamePrefix: "Opname",
        selectionPurpose: "Kies wat je wilt opnemen",
        indicatorTooltip: "Opnamebediening",
        ...
        qualityHigh: "Hoog",
        qualityCaption: "Gebalanceerd is geschikt voor de meeste doeleinden. Hoog behoudt elk detail en maakt grotere bestanden.",
        frameRateLabel: "Frames per seconde",
        frameRateFormat: "%d fps",
        systemAudioToggle: "Neem het geluid van de Mac op",
        systemAudioCaption: "Alles wat je hoort komt in de opname, op een eigen spoor, zodat je het later kunt dempen.",
        folderLabel: "Bewaren in",
        folderChoose: "Kies…",
        moreOptions: "Meer opties",
        copyButton: "Kopieer",
        saveButton: "Bewaar",
        discardButton: "Verwijder",
        copiedHUD: "Opname gekopieerd",
        savedHUDFormat: "Bewaard in %@",
        recordFailed: "Het scherm kon niet worden opgenomen",
        noSpaceTitle: "Niet genoeg ruimte om op te nemen",
        noSpaceMessage: "Maak wat ruimte vrij op de schijf en probeer het opnieuw.",
        stoppedNoSpaceHUD: "Opname gestopt, de schijf is bijna vol",
        shortcutLabel: "Sneltoets",
        editorTitle: "Opname",
        saveVideoButton: "Bewaar",
        saveGIFButton: "Bewaar als GIF",
        exportingLabel: "Bezig met bewaren…",
        cancelButton: "Annuleer",
        exportFailed: "De opname kon niet worden bewaard",
        gifTooLongFormat: "Een GIF kan maximaal %d seconden lang zijn",
        gifSizeLabel: "GIF-grootte",
        gifSizeSmall: "Klein",
        gifSizeMedium: "Gemiddeld",
        gifSizeLarge: "Groot",
        gifFrameRateLabel: "GIF-vloeiendheid",
        discardTitle: "Deze opname verwijderen?",
        discardMessage: "Hij is nog nergens bewaard.",
        openEditorToggle: "Open de editor na het opnemen",
        openEditorCaption: "De opname opent klaar om te trimmen, te dempen en te bewaren. Schakel dit uit om het bestand meteen te krijgen.",
        lookLabel: "Stijl",
        lookRaw: "Origineel",
        lookClean: "Vloeiend",
        lookStudio: "Studio",
        lookCaption: "Een startpunt. Wat je hieronder verandert, blijft veranderd.",
        pointerSectionLabel: "Aanwijzer",
        pointerShowToggle: "Teken de aanwijzer",
        pointerSmoothingLabel: "Vloeiend maken",
        pointerSmoothingOff: "Geen",
        pointerSmoothingLight: "Licht",
        pointerSmoothingSmooth: "Vloeiend",
        pointerSmoothingCinematic: "Cinematisch",
        pointerSizeLabel: "Grootte",
        clickRingToggle: "Markeer waar je klikt",
        zoomSectionLabel: "Zoom",
        zoomToggle: "Zoom in bij elke klik",
        zoomAmountLabel: "Hoe dichtbij",
        backgroundSectionLabel: "Achtergrond",
        shapeLabel: "Vorm",
        shapeOriginal: "Origineel",
        shapeWide: "Breed",
        ...
        zoomFollowsPointer: "Volgt de aanwijzer",
        zoomPickSpot: "Kies een plek",
        zoomPickSpotHint: "Klik op de afbeelding om te richten",
        regenerateZooms: "Terug naar één per klik",
        backToOptions: "Alle opties",
        cutOutButton: "Knip eruit",
        cutHint: "Sleep over de film om een deel te kiezen om te verwijderen",
        addTextButton: "Tekst toevoegen",
        textLaneEmptyHint: "Klik hier om tekst toe te voegen",
        thisTextLabel: "Deze tekst",
        textPlaceholder: "Jouw tekst hier",
        textContentLabel: "Tekst",
        textSizeLabel: "Grootte",
        textPositionLabel: "Positie",
        textColorLabel: "Kleur",
        removeText: "Verwijder",
        copyAndDeleteButton: "Kopieer en verwijder",
        saveAsButton: "Bewaar als…",
        discardSavedMessage: "Bewaarde en gekopieerde bestanden blijven waar ze zijn.",
        presetsButton: "Voorinstellingen",
        savePreset: "Huidige voorinstelling bewaren…",
        presetNamePlaceholder: "Naam voorinstelling",
        removePreset: "Voorinstelling verwijderen",
        zoomEmptyTitle: "Nog geen zooms",
        zoomEmptyCaption: "Maak ze op basis van je klikken of voeg er een toe op de tijdlijn.",
        createAutomaticZooms: "Automatische zooms maken",
        typingZoomToggle: "Blijf ingezoomd tijdens het typen",
        typingZoomCaption: "Na een klik houdt typen de automatische zoom op die plek.",
        microphoneToggle: "Neem de microfoon op",
        microphoneCaption: "Jouw stem komt op een eigen spoor en blijft aanpasbaar in de editor.",
        systemAudioTrackLabel: "Geluid van Mac",
        microphoneTrackLabel: "Microfoon",
        audioVolumeLabel: "Volume",
        removeAudio: "Verwijder",
        restoreAudio: "Herstel",
        microphoneUnavailableHUD: "Microfoon niet beschikbaar",
        microphonePermissionName: "Microfoon",
        microphonePermissionExplain: "Laat schermopnames jouw stem opnemen wanneer je dit inschakelt.",
