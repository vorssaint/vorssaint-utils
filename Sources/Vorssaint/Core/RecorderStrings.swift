...
extension RecorderFeatureStrings {
    ...
    static let vi = RecorderFeatureStrings(
        pageTitle: "Ghi màn hình",
        hubDescription: "Ghi lại một vùng, cửa sổ hoặc toàn màn hình, rồi chỉnh sửa sau đó",
        panelCaption: "Ghi lại một vùng, cửa sổ hoặc toàn bộ màn hình",
        startButton: "Ghi ngay",
        stopButton: "Dừng ghi",
        fileNamePrefix: "Bản ghi",
        selectionPurpose: "Chọn nội dung cần ghi",
        indicatorTooltip: "Điều khiển ghi màn hình",
        countdownLabel: "Đếm ngược",
        countdownOff: "Tắt",
        countdownSecondsFormat: "%d giây",
        qualityLabel: "Chất lượng",
        qualitySmall: "Tệp nhỏ",
        qualityBalanced: "Cân bằng",
        qualityHigh: "Cao",
        qualityCaption: "Cân bằng phù hợp với hầu hết nhu cầu. Cao giữ lại mọi chi tiết nhưng tạo ra tệp lớn hơn.",
        frameRateLabel: "Số khung hình mỗi giây",
        frameRateFormat: "%d fps",
        systemAudioToggle: "Ghi âm thanh của Mac",
        systemAudioCaption: "Mọi âm thanh nghe được sẽ được ghi vào một track riêng, nhờ đó có thể tắt tiếng sau này.",
        folderLabel: "Lưu vào",
        folderChoose: "Chọn…",
        ...
        saveButton: "Lưu",
        discardButton: "Xóa",
        copiedHUD: "Đã sao chép bản ghi",
        savedHUDFormat: "Đã lưu vào %@",
        recordFailed: "Không thể ghi màn hình",
        noSpaceTitle: "Không đủ dung lượng để ghi",
        noSpaceMessage: "Giải phóng bớt dung lượng ổ đĩa rồi thử lại.",
        stoppedNoSpaceHUD: "Đã dừng ghi, ổ đĩa gần đầy",
        shortcutLabel: "Phím tắt",
        editorTitle: "Bản ghi",
        saveVideoButton: "Lưu",
        saveGIFButton: "Lưu dưới dạng GIF",
        exportingLabel: "Đang lưu…",
        cancelButton: "Hủy",
        exportFailed: "Không thể lưu bản ghi",
        gifTooLongFormat: "GIF có thể dài tối đa %d giây",
        gifSizeLabel: "Kích thước GIF",
        gifSizeSmall: "Nhỏ",
        gifSizeMedium: "Vừa",
        gifSizeLarge: "Lớn",
        gifFrameRateLabel: "Độ mượt của GIF",
        discardTitle: "Xóa bản ghi này?",
        discardMessage: "Bản ghi này chưa được lưu ở đâu cả.",
        openEditorToggle: "Mở trình chỉnh sửa sau khi ghi",
        openEditorCaption: "Bản ghi sẽ mở sẵn để cắt, tắt tiếng và lưu. Tắt tùy chọn này để nhận tệp ngay lập tức.",
        lookLabel: "Phong cách",
        lookRaw: "Gốc",
        lookClean: "Mượt",
        lookStudio: "Studio",
        lookCaption: "Đây là điểm khởi đầu. Mọi thay đổi bên dưới sẽ được giữ nguyên.",
        pointerSectionLabel: "Con trỏ",
        pointerShowToggle: "Hiển thị con trỏ",
        pointerSmoothingLabel: "Làm mượt",
        pointerSmoothingOff: "Không",
        pointerSmoothingLight: "Nhẹ",
        pointerSmoothingSmooth: "Mượt",
        pointerSmoothingCinematic: "Điện ảnh",
        pointerSizeLabel: "Kích thước",
        clickRingToggle: "Đánh dấu vị trí nhấp chuột",
        zoomSectionLabel: "Thu phóng",
        zoomToggle: "Phóng to ở mỗi lần nhấp",
        zoomAmountLabel: "Mức độ phóng to",
        backgroundSectionLabel: "Nền",
        shapeLabel: "Hình dạng",
        shapeOriginal: "Gốc",
        shapeWide: "Rộng",
        shapeSquare: "Vuông",
        shapeVertical: "Dọc",
        noPointerNote: "Bản ghi này không có track con trỏ nên không có gì để làm mượt. Các điểm thu phóng đặt thủ công vẫn hoạt động bình thường.",
        zoomLaneEmptyHint: "Nhấp vào đây để thêm điểm thu phóng",
        addZoomButton: "Thêm điểm thu phóng",
        removeZoom: "Xóa",
        thisZoomLabel: "Điểm thu phóng này",
        zoomWhereLabel: "Hướng nhìn",
        zoomFollowsPointer: "Theo con trỏ",
        zoomPickSpot: "Chọn một điểm",
        zoomPickSpotHint: "Nhấp vào hình ảnh để chọn điểm nhắm",
        regenerateZooms: "Quay lại một điểm thu phóng cho mỗi lần nhấp",
        backToOptions: "Tất cả tùy chọn",
        cutOutButton: "Cắt bỏ",
        cutHint: "Kéo trên dải phim để chọn đoạn cần xóa",
        addTextButton: "Thêm văn bản",
        textLaneEmptyHint: "Nhấp vào đây để thêm văn bản",
        thisTextLabel: "Văn bản này",
        textPlaceholder: "Nhập văn bản ở đây",
        textContentLabel: "Văn bản",
        textSizeLabel: "Kích thước",
        textPositionLabel: "Vị trí",
        textColorLabel: "Màu sắc",
        removeText: "Xóa",
        copyAndDeleteButton: "Sao chép và xóa",
        saveAsButton: "Lưu thành…",
        discardSavedMessage: "Các tệp đã lưu hoặc sao chép sẽ vẫn giữ nguyên vị trí.",
        presetsButton: "Cài đặt sẵn",
        savePreset: "Lưu cài đặt sẵn hiện tại…",
        presetNamePlaceholder: "Tên cài đặt sẵn",
        removePreset: "Xóa cài đặt sẵn",
        zoomEmptyTitle: "Chưa có điểm thu phóng nào",
        zoomEmptyCaption: "Tạo từ các lần nhấp chuột hoặc thêm trực tiếp trên dòng thời gian.",
        createAutomaticZooms: "Tạo điểm thu phóng tự động",
        typingZoomToggle: "Giữ phóng to khi đang gõ",
        typingZoomCaption: "Sau khi nhấp chuột, việc gõ phím sẽ giữ điểm thu phóng tự động tại vị trí đó.",
        microphoneToggle: "Ghi âm từ micrô",
        microphoneCaption: "Giọng nói sẽ được ghi vào một track riêng và có thể điều chỉnh trong trình chỉnh sửa.",
        systemAudioTrackLabel: "Âm thanh Mac",
        microphoneTrackLabel: "Micrô",
        audioVolumeLabel: "Âm lượng",
        removeAudio: "Xóa",
        restoreAudio: "Khôi phục",
        microphoneUnavailableHUD: "Micrô không khả dụng",
        microphonePermissionName: "Micrô",
        microphonePermissionExplain: "Cho phép bản ghi màn hình có kèm giọng nói khi được bật.",
        automaticZoomToggle: "Tự động thêm điểm thu phóng",
        automaticZoomCaption: "Tắt tùy chọn này để bắt đầu bản ghi mới không có điểm thu phóng. Vẫn có thể thêm sau trong trình chỉnh sửa.",
        pauseButton: "Tạm dừng ghi",
        resumeButton: "Tiếp tục ghi",
        blurLaneLabel: "Làm mờ",
        addBlurButton: "Làm mờ một vùng",
        blurLaneEmptyHint: "Nhấp vào đây để thêm vùng làm mờ",
        thisBlurLabel: "Vùng làm mờ này",
        blurPickArea: "Chọn vùng",
        blurPickAreaHint: "Kéo qua phần cần ẩn",
        blurCaption: "Được ẩn trong suốt thời lượng khối này trên dòng thời gian.",
        addImageButton: "Thêm hình ảnh",
        imageLaneLabel: "Hình ảnh",
        imageLaneEmptyHint: "Nhấp vào đây để thêm hình ảnh",
        thisImageLabel: "Hình ảnh này",
        imageSizeLabel: "Kích thước",
        imageOpacityLabel: "Độ mờ",
        imagePositionLabel: "Vị trí",
        imageImportFailed: "Không thể thêm hình ảnh này."
    )
}
