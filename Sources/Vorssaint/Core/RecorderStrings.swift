...
extension RecorderFeatureStrings {
    ...
    static let he = RecorderFeatureStrings(
        pageTitle: "הקלטת מסך",
        hubDescription: "מקליט אזור, חלון או מסך ומאפשר עריכה לאחר מכן",
        panelCaption: "הקלט אזור, חלון או את כל המסך",
        startButton: "התחל הקלטה",
        stopButton: "עצור הקלטה",
        fileNamePrefix: "הקלטה",
        selectionPurpose: "בחר מה להקליט",
        indicatorTooltip: "פקדי הקלטה",
        countdownLabel: "ספירה לאחור",
        countdownOff: "כבוי",
        countdownSecondsFormat: "%d שנ׳",
        qualityLabel: "איכות",
        qualitySmall: "קובץ קטן",
        qualityBalanced: "מאוזן",
        qualityHigh: "גבוהה",
        qualityCaption: "מאוזן מתאים לרוב השימושים. גבוהה שומר על כל הפרטים ויוצר קבצים גדולים יותר.",
        frameRateLabel: "פריימים לשנייה",
        frameRateFormat: "%d fps",
        systemAudioToggle: "הקלט את הקול של ה-Mac",
        systemAudioCaption: "כל מה שאתה שומע נכנס להקלטה ברצועה נפרדת, כך שתוכל להשתיק אותו אחר כך.",
        folderLabel: "שמור ב",
        folderChoose: "בחר…",
        ...
        saveButton: "שמור",
        discardButton: "מחק",
        copiedHUD: "ההקלטה הועתקה",
        savedHUDFormat: "נשמר ב-%@",
        recordFailed: "לא ניתן להקליט את המסך",
        noSpaceTitle: "אין מספיק מקום להקלטה",
        noSpaceMessage: "פנה מקום בדיסק ונסה שוב.",
        stoppedNoSpaceHUD: "ההקלטה נעצרה, הדיסך כמעט מלא",
        shortcutLabel: "קיצור דרך",
        editorTitle: "הקלטה",
        saveVideoButton: "שמור",
        saveGIFButton: "שמור כ-GIF",
        exportingLabel: "שומר…",
        cancelButton: "ביטול",
        exportFailed: "לא ניתן לשמור את ההקלטה",
        gifTooLongFormat: "GIF יכול להיות עד %d שניות",
        gifSizeLabel: "גודל GIF",
        gifSizeSmall: "קטן",
        gifSizeMedium: "בינוני",
        gifSizeLarge: "גדול",
        gifFrameRateLabel: "חלקות ה-GIF",
        discardTitle: "למחוק הקלטה זו?",
        discardMessage: "היא טרם נשמרה בשום מקום.",
        openEditorToggle: "פתח את העורך לאחר ההקלטה",
        openEditorCaption: "ההקלטה נפתחת מוכנה לחיתוך, השתקה ושמירה. כבה כדי לקבל את הקובץ ישירות.",
        lookLabel: "סגנון",
        lookRaw: "מקורי",
        lookClean: "חלק",
        lookStudio: "סטודיו",
        lookCaption: "נקודת התחלה. מה שתשנה למטה יישאר.",
        pointerSectionLabel: "סמן",
        pointerShowToggle: "הצג את הסמן",
        pointerSmoothingLabel: "החלקה",
        pointerSmoothingOff: "ללא",
        pointerSmoothingLight: "קלה",
        pointerSmoothingSmooth: "חלקה",
        pointerSmoothingCinematic: "קולנועית",
        pointerSizeLabel: "גודל",
        clickRingToggle: "סמן היכן לוחצים",
        zoomSectionLabel: "זום",
        zoomToggle: "התקרב בכל לחיצה",
        zoomAmountLabel: "כמה קרוב",
        backgroundSectionLabel: "רקע",
        shapeLabel: "צורה",
        shapeOriginal: "מקורית",
        shapeWide: "רחבה",
        shapeSquare: "ריבועית",
        shapeVertical: "גבוהה",
        ...
        zoomFollowsPointer: "עוקב אחר הסמן",
        zoomPickSpot: "בחר נקודה",
        zoomPickSpotHint: "לחץ על התמונה לכיוון",
        regenerateZooms: "חזרה לאחד לכל לחיצה",
        backToOptions: "כל האפשרויות",
        cutOutButton: "חתוך החוצה",
        cutHint: "גרור על פני הסרט לבחירת חלק להסרה",
        addTextButton: "הוסף טקסט",
        textLaneEmptyHint: "לחץ כאן להוספת טקסט",
        thisTextLabel: "טקסט זה",
        textPlaceholder: "הטקסט שלך כאן",
        textContentLabel: "טקסט",
        textSizeLabel: "גודל",
        textPositionLabel: "מיקום",
        textColorLabel: "צבע",
        removeText: "הסר",
        copyAndDeleteButton: "העתק ומחק",
        saveAsButton: "שמור בשם…",
        discardSavedMessage: "קבצים שנשמרו והועתקו יישארו במקומם.",
        presetsButton: "פריסטים",
        savePreset: "שמור פריסט נוכחי…",
        presetNamePlaceholder: "שם הפריסט",
        removePreset: "הסר פריסט",
        zoomEmptyTitle: "אין זומים עדיין",
        zoomEmptyCaption: "צור אותם מהלחיצות שלך או הוסף אחד בציר הזמן.",
        createAutomaticZooms: "צור זומים אוטומטיים",
        typingZoomToggle: "שמור על הזום בזמן הקלדה",
        typingZoomCaption: "לאחר לחיצה, הקלדה שומרת על הזום האוטומטי בנקודה זו.",
        microphoneToggle: "הקלט את המיקרופון",
        microphoneCaption: "הקול שלך נכנס לרצועה נפרדת ונשאר ניתן להתאמה בעורך.",
        systemAudioTrackLabel: "קול ה-Mac",
        microphoneTrackLabel: "מיקרופון",
        audioVolumeLabel: "עוצמה",
        removeAudio: "הסר",
        restoreAudio: "שחזר",
        microphoneUnavailableHUD: "מיקרופון לא זמין",
        microphonePermissionName: "מיקרופון",
        microphonePermissionExplain: "מאפשר לכלול את הקול שלך בהקלטות מסך כשאתה מפעיל את זה.",
