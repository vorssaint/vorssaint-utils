...
extension RecorderFeatureStrings {
    ...
    static let ar = RecorderFeatureStrings(
        pageTitle: "تسجيل الشاشة",
        hubDescription: "يسجّل منطقة أو نافذة أو الشاشة ويحررها بعد ذلك",
        panelCaption: "سجّل منطقة أو نافذة أو الشاشة بأكملها",
        startButton: "التسجيل الآن",
        stopButton: "إيقاف التسجيل",
        fileNamePrefix: "تسجيل",
        selectionPurpose: "اختر ما تريد تسجيله",
        indicatorTooltip: "عناصر التحكم بالتسجيل",
        countdownLabel: "العد التنازلي",
        countdownOff: "متوقف",
        countdownSecondsFormat: "%d ث",
        qualityLabel: "الجودة",
        qualitySmall: "ملف صغير",
        qualityBalanced: "متوازنة",
        qualityHigh: "عالية",
        qualityCaption: "الجودة المتوازنة تناسب معظم الاستخدامات. أما العالية فتحفظ كل التفاصيل وتنتج ملفات أكبر.",
        frameRateLabel: "الإطارات في الثانية",
        frameRateFormat: "%d إطار/ث",
        systemAudioToggle: "تسجيل صوت الـ Mac",
        systemAudioCaption: "ينتقل كل ما تسمعه إلى التسجيل على مسار مستقل، لتتمكن من كتمه لاحقًا.",
        ...
        recordFailed: "تعذّر تسجيل الشاشة",
        noSpaceTitle: "لا توجد مساحة كافية للتسجيل",
        noSpaceMessage: "أفرِغ بعض المساحة على القرص وحاول مجددًا.",
        stoppedNoSpaceHUD: "توقف التسجيل، القرص شبه ممتلئ",
        shortcutLabel: "الاختصار",
        editorTitle: "التسجيل",
        saveVideoButton: "حفظ",
        saveGIFButton: "الحفظ كـ GIF",
        ...
        gifSizeMedium: "متوسط",
        gifSizeLarge: "كبير",
        gifFrameRateLabel: "سلاسة GIF",
        discardTitle: "حذف هذا التسجيل؟",
        discardMessage: "لم يُحفظ في أي مكان بعد.",
        openEditorToggle: "فتح المحرر بعد التسجيل",
        openEditorCaption: "يُفتح التسجيل جاهزًا للاقتصاص والكتم والحفظ. أوقف هذا للحصول على الملف مباشرةً.",
        lookLabel: "المظهر",
        lookRaw: "الأصلي",
        lookClean: "سلس",
        lookStudio: "استوديو",
        lookCaption: "نقطة انطلاق. غيّر أي شيء أدناه وسيبقى كما غيّرته.",
        pointerSectionLabel: "المؤشر",
        pointerShowToggle: "رسم المؤشر",
        pointerSmoothingLabel: "التنعيم",
        pointerSmoothingOff: "بلا",
        pointerSmoothingLight: "خفيف",
        pointerSmoothingSmooth: "سلس",
        pointerSmoothingCinematic: "سينمائي",
        pointerSizeLabel: "الحجم",
        clickRingToggle: "تمييز موضع النقر",
        zoomSectionLabel: "التقريب",
        zoomToggle: "التقريب عند كل نقرة",
        zoomAmountLabel: "مقدار القرب",
        backgroundSectionLabel: "الخلفية",
        shapeLabel: "الشكل",
        shapeOriginal: "الأصلي",
        shapeWide: "عريض",
        shapeSquare: "مربع",
        shapeVertical: "طولي",
        ...
        zoomFollowsPointer: "يتبع المؤشر",
        zoomPickSpot: "اختر موضعًا",
        zoomPickSpotHint: "انقر الصورة لتوجيهه",
        regenerateZooms: "العودة إلى واحد لكل نقرة",
        backToOptions: "كل الخيارات",
        cutOutButton: "قص",
        cutHint: "اسحب على الشريط لاختيار جزء تريد إزالته",
        addTextButton: "إضافة نص",
        textLaneEmptyHint: "انقر هنا لإضافة نص",
        thisTextLabel: "هذا النص",
        textPlaceholder: "اكتب نصك هنا",
        textContentLabel: "النص",
        textSizeLabel: "الحجم",
        textPositionLabel: "الموضع",
        textColorLabel: "اللون",
        removeText: "إزالة",
        copyAndDeleteButton: "نسخ وحذف",
        saveAsButton: "حفظ باسم…",
        discardSavedMessage: "ستبقى الملفات المحفوظة والمنسوخة في أماكنها.",
        presetsButton: "الإعدادات الجاهزة",
        savePreset: "حفظ الإعداد الحالي…",
        presetNamePlaceholder: "اسم الإعداد",
        removePreset: "إزالة الإعداد",
        zoomEmptyTitle: "لا يوجد تقريب بعد",
        zoomEmptyCaption: "أنشئها من نقراتك أو أضِف واحدة على الشريط الزمني.",
        createAutomaticZooms: "إنشاء تقريب تلقائي",
        typingZoomToggle: "الإبقاء على التقريب أثناء الكتابة",
        typingZoomCaption: "بعد النقر، تُبقي الكتابة التقريب التلقائي على ذلك الموضع.",
        microphoneToggle: "تسجيل الميكروفون",
        microphoneCaption: "ينتقل صوتك إلى مسار خاص به ويبقى قابلًا للضبط في المحرر.",
        systemAudioTrackLabel: "صوت الـ Mac",
        microphoneTrackLabel: "الميكروفون",
        audioVolumeLabel: "مستوى الصوت",
        removeAudio: "إزالة",
        restoreAudio: "استعادة",
        microphoneUnavailableHUD: "الميكروفون غير متاح",
        microphonePermissionName: "الميكروفون",
        microphonePermissionExplain: "يتيح لتسجيلات الشاشة تضمين صوتك عند تفعيله.",
