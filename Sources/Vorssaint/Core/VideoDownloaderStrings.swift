...
struct VideoDownloaderStrings {
    ...
    var moreQualities: String {
        switch language {
        case .enUS: return "More"
        case .ptBR: return "Mais"
        case .tr: return "Daha fazla"
        case .ru: return "Ещё"
        case .es: return "Más"
        case .de: return "Mehr"
        case .fr: return "Plus"
        case .it: return "Altro"
        case .ja: return "さらに表示"
        case .ko: return "더 보기"
        case .zhHans: return "更多"
        case .zhTW, .zhHK: return "更多"
        }
    }
    var fewerQualities: String {
        switch language {
        case .enUS: return "Less"
        case .ptBR: return "Menos"
        case .tr: return "Daha az"
        case .ru: return "Скрыть"
        case .es: return "Menos"
        case .de: return "Weniger"
        case .fr: return "Moins"
        case .it: return "Meno"
        case .ja: return "表示を減らす"
        case .ko: return "간단히 보기"
        case .zhHans: return "收起"
        case .zhTW, .zhHK: return "收合"
        }
    }
    var configureBrowserCookies: String {
        switch language {
        case .enUS: return "Configure Browser Cookies"
        case .ptBR: return "Configurar cookies do navegador"
        case .tr: return "Tarayıcı Çerezlerini Ayarla"
        case .ru: return "Настроить cookies браузера"
        case .es: return "Configurar cookies del navegador"
        case .de: return "Browser-Cookies konfigurieren"
        case .fr: return "Configurer les cookies du navigateur"
        case .it: return "Configura cookie del browser"
        case .ja: return "ブラウザCookieを設定"
        case .ko: return "브라우저 쿠키 설정"
        case .zhHans: return "配置浏览器 Cookie"
        case .zhTW, .zhHK: return "設定瀏覽器 Cookie"
        }
    }
    var openSystemSettings: String { strings.permissionOpenSettings }
    var copyErrorDetails: String {
        switch language {
        case .enUS: return "Copy Error Details"
        case .ptBR: return "Copiar detalhes do erro"
        case .tr: return "Hata Ayrıntılarını Kopyala"
        case .ru: return "Копировать сведения об ошибке"
        case .es: return "Copiar detalles del error"
        case .de: return "Fehlerdetails kopieren"
        case .fr: return "Copier les détails de l’erreur"
        case .it: return "Copia dettagli errore"
        case .ja: return "エラーの詳細をコピー"
        case .ko: return "오류 세부 정보 복사"
        case .zhHans: return "复制错误详情"
        case .zhTW: return "複製錯誤詳細資料"
        case .zhHK: return "複製錯誤詳情"
        }
    }
    var errorDetailsCopied: String {
        switch language {
        case .enUS: return "Error details copied"
        case .ptBR: return "Detalhes do erro copiados"
        case .tr: return "Hata ayrıntıları kopyalandı"
        case .ru: return "Сведения об ошибке скопированы"
        case .es: return "Detalles del error copiados"
        case .de: return "Fehlerdetails kopiert"
        case .fr: return "Détails de l’erreur copiés"
        case .it: return "Dettagli errore copiati"
        case .ja: return "エラーの詳細をコピーしました"
        case .ko: return "오류 세부 정보를 복사했습니다"
        case .zhHans: return "已复制错误详情"
        case .zhTW: return "已複製錯誤詳細資料"
        case .zhHK: return "已複製錯誤詳情"
        }
    }
    var viewHelp: String {
        switch language {
        case .enUS: return "View Help"
        case .ptBR: return "Ver ajuda"
        case .tr: return "Yardımı Gör"
        case .ru: return "Показать справку"
        case .es: return "Ver ayuda"
        case .de: return "Hilfe anzeigen"
        case .fr: return "Afficher l’aide"
        case .it: return "Mostra aiuto"
        case .ja: return "ヘルプを表示"
        case .ko: return "도움말 보기"
        case .zhHans: return "查看帮助"
        case .zhTW, .zhHK: return "檢視說明"
        }
    }
    var hideHelp: String {
        switch language {
        case .enUS: return "Hide Help"
        case .ptBR: return "Ocultar ajuda"
        case .tr: return "Yardımı Gizle"
        case .ru: return "Скрыть справку"
        case .es: return "Ocultar ayuda"
        case .de: return "Hilfe ausblenden"
        case .fr: return "Masquer l’aide"
        case .it: return "Nascondi aiuto"
        case .ja: return "ヘルプを隠す"
        case .ko: return "도움말 숨기기"
        case .zhHans: return "隐藏帮助"
        case .zhTW, .zhHK: return "隱藏說明"
        }
    }
    var openFile: String {
        switch language {
        case .enUS: return "Open File"
        case .ptBR: return "Abrir arquivo"
        case .tr: return "Dosyayı Aç"
        case .ru: return "Открыть файл"
        case .es: return "Abrir archivo"
        case .de: return "Datei öffnen"
        case .fr: return "Ouvrir le fichier"
        case .it: return "Apri file"
        case .ja: return "ファイルを開く"
        case .ko: return "파일 열기"
        case .zhHans: return "打开文件"
        case .zhTW, .zhHK: return "開啟檔案"
        }
    }
    ...
    var settingsGeneral: String { strings.tabGeneral }
    var browserAccess: String {
        switch language {
        case .enUS: return "Browser access"
        case .ptBR: return "Acesso pelo navegador"
        case .tr: return "Tarayıcı erişimi"
        case .ru: return "Доступ через браузер"
        case .es: return "Acceso del navegador"
        case .de: return "Browserzugriff"
        case .fr: return "Accès via le navigateur"
        case .it: return "Accesso dal browser"
        case .ja: return "ブラウザアクセス"
        case .ko: return "브라우저 접근"
        case .zhHans: return "浏览器访问"
        case .zhTW, .zhHK: return "瀏覽器存取"
        }
    }
    var usageNotice: String { strings.videoDownloaderUsageNotice }
    var downloadLocation: String { strings.videoDownloaderDownloadLocation }
    ...
    var errorRestricted: String {
        switch language {
        case .enUS: return "This media requires access from a signed-in browser session."
        case .ptBR: return "Esta mídia exige acesso de uma sessão iniciada no navegador."
        case .tr: return "Bu medya, tarayıcıda oturum açılmış bir oturumdan erişim gerektiriyor."
        case .ru: return "Для этого медиа требуется сеанс браузера с выполненным входом."
        case .es: return "Este contenido requiere una sesión iniciada en el navegador."
        case .de: return "Dieses Medium erfordert eine angemeldete Browsersitzung."
        case .fr: return "Ce média nécessite une session connectée dans le navigateur."
        case .it: return "Questo contenuto richiede una sessione del browser con accesso effettuato."
        case .ja: return "このメディアにアクセスするには、ブラウザでログイン済みのセッションが必要です。"
        case .ko: return "이 미디어에 접근하려면 브라우저에 로그인된 세션이 필요합니다."
        case .zhHans: return "此媒体需要已登录的浏览器会话才能访问。"
        case .zhTW, .zhHK: return "此媒體需要已登入的瀏覽器工作階段才能存取。"
        }
    }
    ...
    var allValues: [String] {
        [
            ...
            strings.videoDownloaderDownloadLocation,
