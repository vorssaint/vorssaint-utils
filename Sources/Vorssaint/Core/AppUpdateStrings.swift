...
struct AppUpdateStrings {
    ...
    let availableTab: String
    let ignoredTab: String
    let restoreVersion: String
    let noIgnoredUpdates: String
    let ignoreVersion: String
    let ignoreVersionHintFormat: String
...
extension AppUpdateStrings {
    static let enUS = AppUpdateStrings(
        ...
        noIgnoredUpdates: "No ignored updates",
        ignoreVersion: "Ignore",
        ignoreVersionHintFormat: "Hides %@ until you restore it from Ignored",
    ...
    static let ptBR = AppUpdateStrings(
        ...
        updateOne: "Atualizar",
        availableTab: "Disponíveis",
        ignoredTab: "Ignoradas",
        restoreVersion: "Restaurar",
        noIgnoredUpdates: "Nenhuma atualização ignorada",
        ignoreVersion: "Ignorar",
        ignoreVersionHintFormat: "Oculta %@ até você restaurar em Ignoradas",
    ...
    static let tr = AppUpdateStrings(
        ...
        updateOne: "Güncelle",
        availableTab: "Mevcut",
        ignoredTab: "Yoksayılan",
        restoreVersion: "Geri al",
        noIgnoredUpdates: "Yoksayılan güncelleme yok",
        ignoreVersion: "Yoksay",
        ignoreVersionHintFormat: "%@ uygulamasını Yoksayılan bölümünden geri alana kadar gizler",
    ...
    static let ru = AppUpdateStrings(
        ...
        restoreVersion: "Вернуть",
        noIgnoredUpdates: "Нет игнорируемых обновлений",
        ignoreVersion: "Игнорировать",
        ignoreVersionHintFormat: "Скрывает %@, пока вы не вернёте приложение из «Игнорируемых»",
    ...
    static let es = AppUpdateStrings(
        ...
        availableTab: "Disponibles",
        ignoredTab: "Ignoradas",
        restoreVersion: "Restaurar",
        noIgnoredUpdates: "No hay actualizaciones ignoradas",
        ignoreVersion: "Ignorar",
        ignoreVersionHintFormat: "Oculta %@ hasta que lo restaures desde Ignoradas",
    ...
    static let de = AppUpdateStrings(
        ...
        noIgnoredUpdates: "Keine ignorierten Updates",
        ignoreVersion: "Ignorieren",
        ignoreVersionHintFormat: "Blendet %@ aus, bis du die App unter Ignoriert wiederherstellst",
    ...
    static let fr = AppUpdateStrings(
        ...
        noIgnoredUpdates: "Aucune mise à jour ignorée",
        ignoreVersion: "Ignorer",
        ignoreVersionHintFormat: "Masque %@ jusqu’à sa restauration depuis Ignorées",
    ...
    static let it = AppUpdateStrings(
        ...
        updateOne: "Aggiorna",
        availableTab: "Disponibili",
        ignoredTab: "Ignorati",
        restoreVersion: "Ripristina",
        noIgnoredUpdates: "Nessun aggiornamento ignorato",
        ignoreVersion: "Ignora",
        ignoreVersionHintFormat: "Nasconde %@ finché non ripristini l’app da Ignorati",
    ...
    static let ja = AppUpdateStrings(
        ...
        ignoredTab: "無視した更新",
        restoreVersion: "戻す",
        noIgnoredUpdates: "無視した更新はありません",
        ignoreVersion: "無視",
        ignoreVersionHintFormat: "「無視した更新」から戻すまで %@ を非表示にします",
    ...
    static let ko = AppUpdateStrings(
        ...
        ignoredTab: "무시한 업데이트",
        restoreVersion: "복원",
        noIgnoredUpdates: "무시한 업데이트가 없습니다",
        ignoreVersion: "무시",
        ignoreVersionHintFormat: "무시한 업데이트에서 복원할 때까지 %@ 앱을 숨깁니다",
    ...
    static let zhHans = AppUpdateStrings(
        ...
        ignoredTab: "已忽略",
        restoreVersion: "恢复",
        noIgnoredUpdates: "没有已忽略的更新",
        ignoreVersion: "忽略",
        ignoreVersionHintFormat: "隐藏 %@，直到你从“已忽略”中恢复",
    ...
    static let zhTW = AppUpdateStrings(
        ...
        ignoredTab: "已忽略",
        restoreVersion: "恢復",
        noIgnoredUpdates: "沒有已忽略的更新",
        ignoreVersion: "忽略",
        ignoreVersionHintFormat: "隱藏 %@，直到你從「已忽略」中恢復",
    ...
    static let zhHK = AppUpdateStrings(
        ...
        ignoredTab: "已忽略",
        restoreVersion: "恢復",
        noIgnoredUpdates: "冇已忽略嘅更新",
        ignoreVersion: "忽略",
        ignoreVersionHintFormat: "隱藏 %@，直到你喺「已忽略」中恢復",
        openAppStore: "打開 App Store",
        appStoreBadge: "App Store",
