...
extension RadialMenuFeatureStrings {
    ...
    static let vi = RadialMenuFeatureStrings(
        ...
        profilesHeader: "Hồ sơ",
        profilePickerLabel: "Hồ sơ",
        addProfileButton: "Thêm hồ sơ",
        duplicateProfileButton: "Nhân bản hồ sơ",
        deleteProfileButton: "Xóa hồ sơ",
        profileNameLabel: "Tên hồ sơ",
        profileColorLabel: "Màu",
        profileShortcutLabel: "Phím tắt",
        profileMouseTriggerLabel: "Nút chuột",
        presetGeneral: "Chung",
        presetMedia: "Phương tiện",
        presetTools: "Công cụ",
        presetWindowLayout: "Bố cục cửa sổ",
        presetQuickToggles: "Bật/tắt nhanh",
        presetBlank: "Trống",
        ...
        colorCyan: "Xanh lơ",
        colorIndigo: "Chàm",
        colorGraphite: "Xám than",
        fetchFaviconButton: "Lấy biểu tượng trang web",
        fetchFaviconDisclaimer: "Kết nối đến trang web một lần để tải biểu tượng. Chỉ lưu trên máy.",
        fetchFaviconLoading: "Đang lấy biểu tượng…",
        fetchFaviconSuccess: "Đã tải biểu tượng",
        fetchFaviconError: "Không tìm thấy biểu tượng trang web",
        mouseTriggerRequirement: "Chỉ nút chuột phụ mới dùng được ở đây. Nếu dùng trackpad hoặc chuột không có nút phụ, hãy dùng phím tắt ở trên.",
        canvasHint: "Nhấn vào một nút để chọn hành động khởi chạy hoặc để xóa nút đó. Kéo nút để di chuyển.",
        resetActionsButton: "Đặt lại",
        resetActionsConfirm: "Đặt lại hành động",
        resetActionsConfirmMessage: "Khôi phục các hành động mặc định cho hồ sơ này? Các hành động tùy chỉnh sẽ bị thay thế.",
        showListButton: "Hiển thị dạng danh sách",
        hideListButton: "Ẩn danh sách"
    )
}
