...
extension RadialMenuFeatureStrings {
    ...
    static let ar = RadialMenuFeatureStrings(
        pageTitle: "القائمة الدائرية",
        hubDescription: "تفتح عجلة بإجراءاتك المفضلة حول المؤشر",
        enableLabel: "استخدام القائمة الدائرية",
        enableCaption: "استمر بالضغط على الاختصار، وأشِر إلى إجراء ثم أفلته. والضغطة السريعة تُبقي العجلة مفتوحة.",
        positionLabel: "تُفتح",
        positionPointer: "عند المؤشر",
        positionCenter: "في وسط الشاشة",
        tryButton: "جرّبها",
        actionsHeader: "الإجراءات",
        addButton: "إضافة إجراء",
        limitCaption: "تتسع العجلة حتى 12 إجراءً.",
        emptyCaption: "لا توجد إجراءات هنا بعد.",
        backButton: "رجوع",
        editActionsButton: "تحرير الإجراءات",
        nameLabel: "الاسم",
        automaticLabel: "تلقائي",
        iconLabel: "الأيقونة",
        actionLabel: "الإجراء",
        kindApp: "فتح تطبيق",
        kindFile: "فتح ملف أو مجلد",
        kindURL: "فتح رابط",
        kindShortcut: "ضغط اختصار",
        kindTool: "أداة Vorssaint",
        kindMedia: "التحكم بالوسائط",
        kindSubmenu: "قائمة فرعية",
        chooseButton: "اختيار…",
        urlPlaceholder: "example.com",
        urlInvalid: "أدخل رابطًا صالحًا.",
        toolLabel: "الأداة",
        mediaLabel: "التحكم",
        mediaPlayPause: "تشغيل أو إيقاف مؤقت",
        mediaPrevious: "المقطع السابق",
        mediaNext: "المقطع التالي",
        mediaNowPlaying: "قيد التشغيل",
        mediaNothingPlaying: "لا شيء قيد التشغيل",
        mediaOpenAppFormat: "فتح %@",
        submenuCaption: "تفتح عجلة ثانية بإجراءاتها الخاصة.",
        saveButton: "حفظ",
        deleteButton: "إزالة",
        permissionCaption: "تحتاج إجراءات المفاتيح ومُشغِّل زر الماوس الجانبي إلى إذن إمكانية الوصول.",
        manageButton: "إدارة القائمة",
        panelCaption: "إجراءاتك المفضلة على عجلة",
        mouseTriggerLabel: "زر الماوس",
        mouseTriggerOff: "متوقف",
        mouseTriggerBack: "الزر الجانبي للخلف",
        mouseTriggerForward: "الزر الجانبي للأمام",
        mouseTriggerWarning: "ما دام هذا مفعّلًا، لن يعود هذا الزر للخلف أو للأمام في التطبيقات. فإن كنت تتنقل به، فاتركه متوقفًا.",
        buttonTestLabel: "اختبار الزر",
        buttonTestWaiting: "اضغط الزر الآن",
        buttonTestSeen: "يرى Vorssaint هذا الزر",
        buttonTestOther: "كان ذلك زرًا مختلفًا",
        buttonTestBlind: "لا يستطيع Vorssaint مراقبة الماوس في الوقت الحالي",
        buttonTestHint: "إذا لم يُضِئ شيء، فإن macOS لا يرسل هذا الزر إلى التطبيقات. فالفئران التي تأتي ببرامجها الخاصة كثيرًا ما تحوّل الأزرار الجانبية إلى وظائف أخرى. أعِد ضبطها هناك، أو امنح الزر مجموعة مفاتيح واستخدم تلك المجموعة أعلاه.",
        activationModeLabel: "سلوك الفتح",
        ...
        profileMouseTriggerLabel: "زر الماوس",
        presetGeneral: "عام",
        presetMedia: "الوسائط",
        presetTools: "الأدوات",
        presetWindowLayout: "تخطيط النوافذ",
        presetQuickToggles: "التبديلات السريعة",
        presetBlank: "فارغ",
        colorAccent: "لون التمييز",
        colorBlue: "أزرق",
        colorPurple: "بنفسجي",
        colorPink: "وردي",
        colorRed: "أحمر",
        ...
        colorCyan: "سماوي",
        colorIndigo: "نيلي",
        colorGraphite: "غرافيتي",
        fetchFaviconButton: "جلب أيقونة الموقع",
