...
extension RadialMenuFeatureStrings {
    ...
    static let nl = RadialMenuFeatureStrings(
        pageTitle: "Radiaal menu",
        hubDescription: "Opent een wiel met je favoriete acties rond de aanwijzer",
        enableLabel: "Gebruik het radiaal menu",
        enableCaption: "Houd de sneltoets ingedrukt, wijs naar een actie en laat los. Een korte druk houdt het wiel open.",
        positionLabel: "Opent",
        positionPointer: "Bij de aanwijzer",
        positionCenter: "In het midden van het scherm",
        tryButton: "Proberen",
        actionsHeader: "Acties",
        addButton: "Actie toevoegen",
        limitCaption: "Een wiel biedt plaats aan maximaal 12 acties.",
        emptyCaption: "Hier nog geen acties.",
        backButton: "Terug",
        editActionsButton: "Acties bewerken",
        nameLabel: "Naam",
        automaticLabel: "Automatisch",
        iconLabel: "Symbool",
        actionLabel: "Actie",
        kindApp: "Open een app",
        kindFile: "Open een bestand of map",
        kindURL: "Open een link",
        kindShortcut: "Druk op een sneltoets",
        kindTool: "Vorssaint-hulpprogramma",
        kindMedia: "Mediabediening",
        kindSubmenu: "Submenu",
        chooseButton: "Kiezen…",
        urlPlaceholder: "voorbeeld.nl",
        urlInvalid: "Voer een geldige link in.",
        toolLabel: "Hulpprogramma",
        mediaLabel: "Bediening",
        mediaPlayPause: "Afspelen of pauzeren",
        mediaPrevious: "Vorig nummer",
        mediaNext: "Volgend nummer",
        mediaNowPlaying: "Nu speelt",
        mediaNothingPlaying: "Er wordt niets afgespeeld",
        mediaOpenAppFormat: "Open %@",
        submenuCaption: "Opent een tweede wiel met eigen acties.",
        saveButton: "Bewaren",
        deleteButton: "Verwijderen",
        permissionCaption: "Toetsacties en de trigger met de zijknop van de muis vereisen toestemming voor Toegankelijkheid.",
        manageButton: "Menu beheren",
        panelCaption: "Je favoriete acties op een wiel",
        mouseTriggerLabel: "Muisknop",
        mouseTriggerOff: "Uit",
        mouseTriggerBack: "Zijknop terug",
        mouseTriggerForward: "Zijknop vooruit",
        mouseTriggerWarning: "Zolang dit aan staat, gaat die knop in apps niet meer terug of vooruit. Navigeer je ermee, laat dit dan uit.",
        buttonTestLabel: "Knoptest",
        buttonTestWaiting: "Druk nu op de knop",
        buttonTestSeen: "Vorssaint ziet deze knop",
        buttonTestOther: "Dat was een andere knop",
        buttonTestBlind: "Vorssaint kan de muis nu niet observeren",
        buttonTestHint: "Als er niets oplicht, stuurt macOS die knop niet door naar apps. Muizen met eigen software geven de zijknoppen vaak een andere functie. Zet dat daar terug, of geef de knop een toetscombinatie en gebruik die combinatie hierboven.",
        activationModeLabel: "Openingsgedrag",
        activationModePressOrHold: "Druk of houd ingedrukt",
        activationModePress: "Druk om te openen",
        activationModeHold: "Houd ingedrukt om te selecteren",
        activationModeCaption: "Druk of houd ingedrukt behoudt het huidige adaptieve gebaar. Druk houdt het menu open; houd ingedrukt voert de gemarkeerde actie uit bij het loslaten.",
        profilesHeader: "Profielen",
        profilePickerLabel: "Profiel",
        addProfileButton: "Profiel toevoegen",
        duplicateProfileButton: "Profiel dupliceren",
        deleteProfileButton: "Profiel verwijderen",
        profileNameLabel: "Profielnaam",
        profileColorLabel: "Kleur",
        profileShortcutLabel: "Sneltoets",
        ...
        colorCyan: "Cyaan",
        colorIndigo: "Indigo",
        colorGraphite: "Grafiet",
        fetchFaviconButton: "Websitesymbool ophalen",
