...
extension RadialMenuFeatureStrings {
    ...
    static let fr = RadialMenuFeatureStrings(
        ...
        resetActionsConfirmMessage: "Restaurer les actions par défaut de ce profil ? Les actions personnalisées seront remplacées.",
    ...
    static let he = RadialMenuFeatureStrings(
        pageTitle: "תפריט מעגלי",
        hubDescription: "פותח גלגל של הפעולות המועדפות עליך סביב הסמן",
        enableLabel: "השתמש בתפריט המעגלי",
        enableCaption: "החזק את קיצור המקלדת, הצבע על פעולה ושחרר. לחיצה קצרה משאירה את הגלגל פתוח.",
        positionLabel: "נפתח",
        positionPointer: "בסמן",
        positionCenter: "במרכז המסך",
        tryButton: "נסה",
        actionsHeader: "פעולות",
        addButton: "הוסף פעולה",
        limitCaption: "גלגל אחד מכיל עד 12 פעולות.",
        emptyCaption: "אין פעולות כאן עדיין.",
        backButton: "חזור",
        editActionsButton: "ערוך פעולות",
        nameLabel: "שם",
        automaticLabel: "אוטומטי",
        iconLabel: "סמל",
        actionLabel: "פעולה",
        kindApp: "פתח אפליקציה",
        kindFile: "פתח קובץ או תיקייה",
        kindURL: "פתח קישור",
        kindShortcut: "לחץ קיצור מקלדת",
        kindTool: "כלי Vorssaint",
        kindMedia: "שליטת מדיה",
        kindSubmenu: "תת-תפריט",
        chooseButton: "בחר…",
        urlPlaceholder: "example.com",
        urlInvalid: "הזן קישור חוקי.",
        toolLabel: "כלי",
        mediaLabel: "שליטה",
        mediaPlayPause: "נגן או השהה",
        mediaPrevious: "רצועה קודמת",
        mediaNext: "רצועה הבאה",
        mediaNowPlaying: "מנגן עכשיו",
        mediaNothingPlaying: "שום דבר לא מנגן",
        mediaOpenAppFormat: "פתח את %@",
        ...
        mouseTriggerOff: "כבוי",
        mouseTriggerBack: "כפתור צד אחורה",
        mouseTriggerForward: "כפתור צד קדמי",
        mouseTriggerWarning: "כשזה פועל, הכפתור לא חוזר או מתקדם באפליקציות. אם אתה מנווט איתו, השאר כבוי.",
        buttonTestLabel: "בדיקת כפתור",
        buttonTestWaiting: "לחץ על הכפתור עכשיו",
        buttonTestSeen: "Vorssaint רואה את הכפתור הזה",
        buttonTestOther: "זה היה כפתור אחר",
        buttonTestBlind: "Vorssaint לא יכול לצפות בעכבר כרגע",
        buttonTestHint: "אם שום דבר לא נדלק, macOS לא שולח את הכפתור לאפליקציות. עכברים שמגיעים עם תוכנה משלהם לעתים הופכים את כפתורי הצד למשהו אחר. שנה זאת בחזרה שם, או תן לכפתור שילוב מקשים והשתמש בו למעלה.",
        activationModeLabel: "התנהגות פתיחה",
        activationModePressOrHold: "לחץ או החזק",
        activationModePress: "לחץ לפתיחה",
        activationModeHold: "החזק לבחירה",
        activationModeCaption: "לחץ או החזק שומר על המחווה האדפטיבית הנוכחית. לחיצה משאירה פתוח; החזק מפעיל את הפעולה המודגשת בשחרור.",
        profilesHeader: "פרופילים",
        profilePickerLabel: "פרופיל",
        addProfileButton: "הוסף פרופיל",
        duplicateProfileButton: "שכפל פרופיל",
        deleteProfileButton: "מחק פרופיל",
        profileNameLabel: "שם פרופיל",
        profileColorLabel: "צבע",
        profileShortcutLabel: "קיצור מקלדת",
        profileMouseTriggerLabel: "כפתור עכבר",
        presetGeneral: "כללי",
        presetMedia: "מדיה",
        presetTools: "כלים",
        ...
        colorIndigo: "אינדיגו",
        colorGraphite: "גרפיט",
        fetchFaviconButton: "הבא סמל אתר",
