...
struct BrightnessFeatureStrings {
    ...
    let linkDisplaysToggle: String
    let linkDisplaysCaption: String
...
extension BrightnessFeatureStrings {
    static let enUS = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Link all displays",
        linkDisplaysCaption: "Moving any brightness slider or the brightness keys adjusts every display by the same amount.",
    ...
    static let ptBR = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Vincular todas as telas",
        linkDisplaysCaption: "Mover qualquer controle de brilho ou as teclas de brilho ajusta todas as telas pela mesma quantidade.",
    ...
    static let tr = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Tüm ekranları bağla",
        linkDisplaysCaption: "Herhangi bir parlaklık kaydırıcısını veya parlaklık tuşlarını kullanmak tüm ekranları aynı miktarda ayarlar.",
    ...
    static let ru = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Связать все экраны",
        linkDisplaysCaption: "Перемещение любого ползунка яркости или клавиш яркости меняет все экраны на одну и ту же величину.",
    ...
    static let es = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Vincular todas las pantallas",
        linkDisplaysCaption: "Mover cualquier control de brillo o las teclas de brillo ajusta todas las pantallas en la misma cantidad.",
    ...
    static let de = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Alle Displays verknüpfen",
        linkDisplaysCaption: "Jeder Helligkeitsregler oder die Helligkeitstasten stellen alle Displays um denselben Betrag ein.",
    ...
    static let fr = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Lier tous les écrans",
        linkDisplaysCaption: "Déplacer n’importe quel curseur de luminosité ou les touches de luminosité règle tous les écrans de la même quantité.",
    ...
    static let it = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "Collega tutti gli schermi",
        linkDisplaysCaption: "Spostare un cursore della luminosità o i tasti di luminosità regola tutti gli schermi della stessa quantità.",
    ...
    static let ja = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "すべてのディスプレイを連動",
        linkDisplaysCaption: "どの輝度スライダや輝度キーを動かしても、すべてのディスプレイが同じ量だけ調整されます。",
    ...
    static let ko = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "모든 디스플레이 연결",
        linkDisplaysCaption: "어떤 밝기 슬라이더나 밝기 키를 조절해도 모든 디스플레이가 같은 양만큼 조정됩니다.",
    ...
    static let zhHans = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "链接所有显示器",
        linkDisplaysCaption: "移动任一亮度滑块或使用亮度键时，所有显示器会按相同幅度调节。",
        keyboardLight: "键盘背光",
    ...
    static let zhTW = BrightnessFeatureStrings(
        ...
        linkDisplaysToggle: "連結所有顯示器",
        linkDisplaysCaption: "移動任一亮度滑桿或使用亮度鍵時，所有顯示器會以相同幅度調整。",
        keyboardLight: "鍵盤背光",
