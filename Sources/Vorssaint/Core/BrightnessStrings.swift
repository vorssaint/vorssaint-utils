...
struct BrightnessFeatureStrings {
    ...
    let keyboardAutoBrightness: String
    let keyboardAutoBrightnessShort: String
...
extension BrightnessFeatureStrings {
    static let enUS = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Adjust in low light",
        keyboardAutoBrightnessShort: "Auto",
    ...
    static let ptBR = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Ajustar com pouca luz",
        keyboardAutoBrightnessShort: "Auto",
    ...
    static let tr = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Az işıkta ayarla",
        keyboardAutoBrightnessShort: "Oto",
    ...
    static let ru = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Подстраивать при слабом освещении",
        keyboardAutoBrightnessShort: "Авто",
    ...
    static let es = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Ajustar con poca luz",
        keyboardAutoBrightnessShort: "Auto",
    ...
    static let de = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Bei wenig Licht anpassen",
        keyboardAutoBrightnessShort: "Auto",
    ...
    static let fr = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Ajuster en faible luminosité",
        keyboardAutoBrightnessShort: "Auto",
    ...
    static let it = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "Regola con poca luce",
        keyboardAutoBrightnessShort: "Auto",
    ...
    static let ja = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "暗い場所で自動調整",
        keyboardAutoBrightnessShort: "自動",
    ...
    static let ko = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "어두울 때 자동 조절",
        keyboardAutoBrightnessShort: "자동",
    ...
    static let zhHans = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "光线较暗时自动调节",
        keyboardAutoBrightnessShort: "自动",
    ...
    static let zhTW = BrightnessFeatureStrings(
        ...
        keyboardAutoBrightness: "光線昏暗時自動調整",
        keyboardAutoBrightnessShort: "自動",
