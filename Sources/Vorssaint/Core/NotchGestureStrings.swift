...
extension FeatureStrings {
    static func notchGestures(_ language: AppLanguage) -> NotchGestureStrings {
        ...
        case .ar: return NotchGestureStrings(
            title: "إيماءات الجزيرة الديناميكية",
            description: "افتح الجزيرة الديناميكية وأغلقها بالتمرير، ومرّر بإصبعك لتغيير المقاطع.",
            hint: "مرّر لأسفل للفتح. ومرّر لأعلى فوق الصف العلوي للإغلاق. ومرّر يمينًا أو يسارًا فوق الموسيقى لتغيير المقاطع. أما القوائم فتحتفظ بتمريرها الخاص.")
        }
    }
}
