...
extension CommandBarFeatureStrings {
    ...
    static let ar = CommandBarFeatureStrings(
        pageTitle: "شريط الأوامر",
        hubDescription: "حقل واحد يجد كل ما يفعله التطبيق وينفّذه",
        panelCaption: "اكتب لتجد أي شيء وتنفّذه",
        settingsCaption: "اختصار واحد يفتح حقلًا فوق ما تفعله. اكتب بضعة أحرف واضغط Return فيحدث الأمر. ولا يُحفظ شيء مما تكتبه.",
        openButton: "فتح الشريط الآن",
        searchPlaceholder: "اكتب ما تريد فعله",
        suggestionsLabel: "الاقتراحات",
        noResultsTitle: "لا شيء هنا بهذا الاسم.",
        noResultsAction: "عرض الاقتراحات",
        argumentRangeFormat: "%d إلى %d",
        argumentHint: "Return للتطبيق · Esc للرجوع",
        confirmHint: "Return للتأكيد · Esc للإلغاء",
        kindApp: "تطبيق",
        kindClipboard: "لصق من السجل",
        kindSnippet: "إدراج مقطع",
        soundOutputSubtitle: "تبديل مخرج الصوت",
        soundOutputCurrent: "المخرج الحالي",
        volumeTitle: "مستوى الصوت",
        brightnessTitle: "سطوع الشاشة",
        keepAwakeForFormat: "الإبقاء مستيقظًا لمدة %@",
        needsSetupFormat: "فعّل %@ في الإعدادات",
        needsPermissionHint: "يحتاج إذنًا · Return للطلب",
        actionCheckAppUpdates: "التحقق من تحديثات التطبيقات",
        actionCleanURL: "تنظيف الرابط المنسوخ",
        actionOpenSettings: "فتح الإعدادات",
        answerBatteryLabel: "البطارية",
        answerBatteryCharging: "قيد الشحن",
        answerBatteryPlugged: "موصولة بالطاقة",
        answerMemoryLabel: "الذاكرة",
        answerMemoryFormat: "%@ من %@ قيد الاستخدام",
        answerStorageLabel: "التخزين",
        answerStorageFormat: "%@ متاحة من %@",
        copyHint: "Return للنسخ",
        kindWindow: "نافذة",
        quitFormat: "إنهاء %@",
        quitConfirmFormat: "إنهاء %@؟",
        kindMenu: "أمر قائمة",
        ...
        actionRename: "تغيير الاسم الذي يستجيب له",
        actionHide: "عدم إظهار هذا أبدًا",
        actionForget: "نسيان معدل استخدامي لهذا",
        aliasPlaceholder: "الاسم الذي تناديه به",
        aliasTakenFormat: "%@ يستجيب لهذا الاسم أصلًا",
        sourcesTitle: "ما الذي يبحث فيه الشريط",
        sourcesCaption: "أوقف ما لا تريد رؤيته أبدًا. أما إجراءاتك الخاصة فتبقى دائمًا.",
        sourceActions: "إجراءات Vorssaint",
        sourceApps: "التطبيقات",
        sourceMenus: "أوامر قائمة التطبيق في المقدمة",
        sourceWindows: "النوافذ المفتوحة",
        sourceQuitApps: "إنهاء تطبيق",
        sourceSettingsPages: "صفحات الإعدادات",
        sourceSnippets: "المقاطع النصية",
        sourceClipboard: "سجل الحافظة",
        sourceEmoji: "الرموز التعبيرية",
        sourceFolders: "المجلدات",
        sourceAnswers: "إجابات عن هذا الـ Mac",
        sourceCalculator: "العمليات الحسابية والتحويلات",
        namedTitle: "الأسماء التي منحتها",
        namedEmpty: "لم تُسمَّ أي عناصر بعد. افتح الشريط واختر صفًا ثم اضغط مفتاح الإجراءات.",
        pinnedTitle: "المثبّتة",
        pinnedEmpty: "لا شيء مثبّت بعد.",
        hiddenTitle: "التي لا تُعرض أبدًا",
        hiddenEmpty: "لا شيء مخفي.",
        forgetAllButton: "نسيان ما أستخدمه أكثر",
        tryTheseLabel: "جرّب",
        stillLooking: "لا يزال البحث جاريًا",
        removeButton: "إزالة",
        confirmButton: "تأكيد",
        soundMute: "كتم الصوت",
        soundUnmute: "إعادة تشغيل الصوت",
        stateOn: "مفعّل",
        powerSleep: "السكون",
        powerRestart: "إعادة التشغيل",
        powerRestartConfirm: "إعادة تشغيل الـ Mac؟",
        powerShutDown: "إيقاف التشغيل",
        powerShutDownConfirm: "إيقاف تشغيل الـ Mac؟",
        powerLogOut: "تسجيل الخروج",
        powerLogOutConfirm: "تسجيل الخروج؟",
        wifiOn: "تشغيل Wi-Fi",
        wifiOff: "إيقاف Wi-Fi",
        kindEmoji: "رمز تعبيري",
        kindFolder: "مجلد",
        answerDateLabel: "اليوم",
        answerTimeLabel: "الوقت الآن",
        kindAnswer: "إجابة",
        kindSelection: "التحديد",
        selectedTitle: "المحدد",
        selectionCopy: "نسخه",
        selectionSearch: "استخدامه في البحث",
        selectionUpper: "أحرف كبيرة",
        selectionLower: "أحرف صغيرة",
        selectionTitleCase: "أول حرف كبير",
        selectionShelf: "الاحتفاظ به على الرف",
        selectionCount: "عدّه",
        selectionCountFormat: "%d كلمة، %d حرف",
        sourceSelection: "المحدد حاليًا",
        kindLink: "اختصارك",
        linkSearchHint: "اكتب ما تبحث عنه بعد الاسم",
        linksTitle: "اختصاراتك",
        linksEmpty: "لا شيء محفوظ بعد. أضِف موقعًا أو مجلدًا أو بحثًا أو نصًا برمجيًا تستخدمه يوميًا.",
        linkDestinationLabel: "الوجهة",
        linkKindLink: "موقع أو رابط",
        linkKindPlace: "مجلد أو ملف",
        linkPlaceholdersHint: "أدرِج أحد هذه فيُملأ عند الفتح",
        placeholderQuery: "ما تكتبه",
        placeholderClipboard: "ما نسخته",
        placeholderSelection: "ما هو محدد",
        placeholderDate: "اليوم",
        privacyNote: "كل شيء يحدث على هذا الـ Mac: بلا حساب، وبلا سحابة، ولا يُرسل شيء إلى أي مكان.",
        actionShortcut: "امنحه اختصارًا",
        actionShortcutChange: "تغيير الاختصار",
        actionShortcutRemove: "إزالة الاختصار",
        shortcutCaptureHint: "اضغط المفاتيح التي تريدها · Delete يمسحها · Esc للرجوع",
        rowShortcutsTitle: "الصفوف ذات الاختصارات الخاصة",
        rowShortcutsEmpty: "لا يملك أي صف اختصارًا خاصًا بعد. افتح الإجراءات على أي صف لتمنحه اختصارًا.",
        turnOnFormat: "تشغيل %@",
        turnOffFormat: "إيقاف %@",
        everythingTitle: "كل ما يمكنه فعله",
        categoryAll: "الكل",
        restartAppFormat: "إعادة تشغيل %@",
        forceQuitAppFormat: "إنهاء %@ إجباريًا…",
        forceQuitAppConfirmFormat: "إنهاء %@ إجباريًا؟ ستُفقد التغييرات غير المحفوظة.",
        uninstallAppFormat: "إلغاء تثبيت %@…",
        openInBrowser: "الفتح في المتصفح",
        linkKindScript: "نص برمجي",
        scriptHint: "اختر ملفًا قابلًا للتنفيذ. اكتب اسمه متبوعًا بما تريد إرساله. ويعمل عند توقفك عن الكتابة ويعرض النتيجة هنا.",
        scriptRunsWithoutArgument: "التشغيل أيضًا عند كتابة اسمه وحده",
        scriptRunFailed: "تعذّر تشغيل هذا الملف",
        scriptSearchHint: "اكتب ما تريد إرساله بعد الاسم",
        scriptBareSearchHint: "يعمل وحده، أو اكتب ما تريد إرساله",
        linkAddButton: "إضافة اختصار",
        positionCaption: "اسحب العلامة على يسار الحقل لوضع الشريط في أي مكان على الشاشة؛ وانقر العلامة نقرًا مزدوجًا لإعادته إلى الوسط.",
        resetPositionButton: "إعادة الشريط إلى الوسط",
        shortcutToggle: "اختصار عام لفتح الشريط",
        dragHint: "اسحب للتحريك · انقر نقرًا مزدوجًا لإعادته إلى الوسط",
        actionRevealInFinder: "الإظهار في Finder",
        sourceMacSettings: "لوحات إعدادات النظام",
        sourceFiles: "الملفات",
        filesTitle: "ابحث في ملفاتك",
        filesCaption: "حدد المجلدات التي تريد البحث فيها فيعثر الشريط على الملفات بالاسم أثناء كتابتك. ولا تُفهرس أي بيانات ولا يُطلب أي إذن: فهو يستخدم بحث الـ Mac نفسه ولا يعرض إلا ما يمكنك رؤيته في Finder أصلًا.",
        filesEmpty: "لا توجد مجلدات بعد، لذا لا يبحث الشريط عن أي ملفات.",
        filesAddFolder: "إضافة مجلد",
        filesIgnoreCaption: "الأسماء التي لا يستحق إظهارها أبدًا: اسم مجلد أو ملف كامل، أو امتداد يُكتب هكذا ‎*.log‎.",
