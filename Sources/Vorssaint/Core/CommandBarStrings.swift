...
extension CommandBarFeatureStrings {
    ...
    static let he = CommandBarFeatureStrings(
        pageTitle: "סרגל פקודות",
        hubDescription: "שדה אחד שמוצא ומריץ כל מה שהאפליקציה יכולה לעשות",
        panelCaption: "הקלד כדי למצוא ולהריץ כל דבר",
        settingsCaption: "קיצור מקש אחד פותח שדה מעל כל מה שאתה עושה. הקלד כמה אותיות, לחץ Return וזה קורה. שום דבר שאתה מקליד נשמר.",
        openButton: "פתח את הסרגל עכשיו",
        searchPlaceholder: "הקלד מה שאתה רוצה לעשות",
        suggestionsLabel: "הצעות",
        noResultsTitle: "אין כאן דבר בשם הזה.",
        noResultsAction: "ראה הצעות",
        argumentRangeFormat: "%d עד %d",
        argumentHint: "Return מחיל · Esc חוזר",
        confirmHint: "Return מאשר · Esc מבטל",
        kindApp: "אפליקציה",
        kindClipboard: "הדבק מהיסטוריה",
        kindSnippet: "הכנס קטע",
        soundOutputSubtitle: "החלף יציאת שמע",
        soundOutputCurrent: "יציאה נוכחית",
        volumeTitle: "עוצמת שמע",
        brightnessTitle: "בהירות מסך",
        keepAwakeForFormat: "שמור ער למשך %@",
        needsSetupFormat: "הפעל %@ בהגדרות",
        needsPermissionHint: "דורש הרשאה · Return מבקש",
        actionCheckAppUpdates: "בדוק עדכוני אפליקציות",
        actionCleanURL: "נקה את הקישור שהועתק",
        actionOpenSettings: "פתח הגדרות",
        answerBatteryLabel: "סוללה",
        answerBatteryCharging: "בטעינה",
        answerBatteryPlugged: "מחובר לחשמל",
        answerMemoryLabel: "זיכרון",
        answerMemoryFormat: "%@ מתוך %@ בשימוש",
        answerStorageLabel: "אחסון",
        answerStorageFormat: "%@ זמינים מתוך %@",
        copyHint: "Return מעתיק",
        kindWindow: "חלון",
        quitFormat: "צא מ-%@",
        quitConfirmFormat: "לצאת מ-%@?",
        kindMenu: "פקודת תפריט",
        actionsTitle: "פעולות",
        actionsHint: "פעולות",
        reuseHint: "המשך",
        actionPin: "הצמד למעלה",
        actionUnpin: "בטל הצמדה",
        actionName: "תן לו שם משלך",
        actionRename: "שנה את השם שהוא עונה לו",
        actionHide: "לעולם אל תציג את זה",
        actionForget: "שכח כמה פעמים השתמשתי בזה",
        aliasPlaceholder: "השם שאתה קורא לו",
        aliasTakenFormat: "%@ כבר עונה לשם הזה",
        sourcesTitle: "מה הסרגל מחפש",
        sourcesCaption: "כבה מה שאתה לעולם לא רוצה לראות. הפעולות שלך תמיד נשארות.",
        sourceActions: "פעולות Vorssaint",
        sourceApps: "אפליקציות",
        sourceMenus: "פקודות תפריט של האפליקציה בחזית",
        sourceWindows: "חלונות פתוחים",
        sourceQuitApps: "צא מאפליקציה",
        sourceSettingsPages: "דפי הגדרות",
        sourceSnippets: "קטעים",
        sourceClipboard: "היסטוריית לוח הכתיבה",
        sourceEmoji: "רגשונים",
        sourceFolders: "תיקיות",
        sourceAnswers: "תשובות על ה-Mac הזה",
        sourceCalculator: "חישובים והמרות",
        namedTitle: "שמות שנתת",
        namedEmpty: "שום דבר עדיין לא נקרא. פתח את הסרגל, בחר שורה ולחץ מקש פעולות.",
        pinnedTitle: "מוצמדים",
        pinnedEmpty: "שום דבר עדיין לא מוצמד.",
        hiddenTitle: "לעולם לא מוצג",
        hiddenEmpty: "שום דבר לא מוסתר.",
        forgetAllButton: "שכח מה שאני משתמש בו הכי הרבה",
        tryTheseLabel: "נסה",
        stillLooking: "עדיין מחפש",
        removeButton: "הסר",
        confirmButton: "אשר",
        soundMute: "השתק את השמע",
        soundUnmute: "החזר את השמע",
        stateOn: "מופעל",
        powerSleep: "שינה",
        powerRestart: "הפעל מחדש",
        powerRestartConfirm: "להפעיל מחדש את ה-Mac?",
        powerShutDown: "כיבוי",
        powerShutDownConfirm: "לכבות את ה-Mac?",
        powerLogOut: "התנתק",
        powerLogOutConfirm: "להתנתק?",
        wifiOn: "הפעל Wi-Fi",
        wifiOff: "כבה Wi-Fi",
        kindEmoji: "רגשון",
        kindFolder: "תיקייה",
        answerDateLabel: "היום",
        answerTimeLabel: "שעה עכשיו",
        kindAnswer: "תשובה",
        kindSelection: "בחירה",
        selectedTitle: "נבחר",
        selectionCopy: "העתק אותו",
        selectionSearch: "השתמש בחיפוש",
        selectionUpper: "אותיות גדולות",
        selectionLower: "אותיות קטנות",
        ...
        linksTitle: "הקיצורים שלך",
        linksEmpty: "שום דבר עדיין לא נשמר. הוסף אתר, תיקייה, חיפוש או סקריפט שאתה משתמש בהם כל יום.",
        linkDestinationLabel: "לאן זה הולך",
        linkKindLink: "אתר או קישור",
        linkKindPlace: "תיקייה או קובץ",
        linkPlaceholdersHint: "זרוק אחד מאלה והוא יתמלא כשיפתח",
        placeholderQuery: "מה שאתה מקליד",
        placeholderClipboard: "מה שהעתקת",
        placeholderSelection: "מה שנבחר",
        placeholderDate: "היום",
        privacyNote: "הכל קורה ב-Mac הזה: אין חשבון, אין ענן, שום דבר לא נשלח לשום מקום.",
        actionShortcut: "תן לו קיצור מקש",
        actionShortcutChange: "שנה את קיצור המקש",
        actionShortcutRemove: "הסר את קיצור המקש",
        shortcutCaptureHint: "לחץ את המקשים שאתה רוצה · Delete מנקה · Esc חוזר",
        rowShortcutsTitle: "שורות עם קיצור מקש משלהן",
        rowShortcutsEmpty: "אף שורה עדיין לא קיבלה קיצור מקש משלה. פתח את הפעולות בכל שורה כדי לתת לה אחד.",
        appCenterTitle: "קיצורי אפליקציות",
        appCenterCaption: "פתח אפליקציות עם קיצורים משלהן, גם כשהסרגל סגור. הגדר כאן שמות חיפוש והצמד מועדפים.",
        appAliasLabel: "כינוי",
        appShortcutLabel: "קיצור",
        appShortcutsFilter: "עם קיצורים",
        appShortcutRecord: "הקלט…",
        rowShortcutsLimitFormat: "אפשר להקצות עד %d קיצורים. הסר אחד כדי להוסיף אחר.",
        turnOnFormat: "הפעל %@",
        turnOffFormat: "כבה %@",
        everythingTitle: "כל מה שהוא יכול לעשות",
        categoryAll: "הכל",
        restartAppFormat: "הפעל מחדש את %@",
        forceQuitAppFormat: "אלץ יציאה מ-%@…",
        forceQuitAppConfirmFormat: "לאלץ יציאה מ-%@? שינויים לא שמורים יאבדו.",
        uninstallAppFormat: "הסר את %@…",
        openInBrowser: "פתח בדפדפן",
        linkKindScript: "סקריפט",
        scriptHint: "בחר קובץ הפעלה. הקלד את שמו ואחריו מה שאתה רוצה לשלוח. הוא רץ כשאתה משהה ומציג את התוצאה כאן.",
        scriptRunsWithoutArgument: "הרץ גם כשרק השם מוקלד",
        scriptRunFailed: "לא ניתן להריץ את הקובץ הזה",
        scriptSearchHint: "הקלד מה לשלוח אחרי השם",
        scriptBareSearchHint: "רץ לבד, או הקלד מה לשלוח",
        linkAddButton: "הוסף קיצור",
        positionCaption: "גרור את הסמן משמאל לשדה כדי למקם את הסרגל בכל מקום במסך; לחץ לחיצה כפולה על הסמן כדי למרכז אותו.",
        resetPositionButton: "מרכז את הסרגל",
        shortcutToggle: "קיצור מקש גלובלי לפתיחת הסרגל",
        dragHint: "גרור להזזה · לחיצה כפולה למרכוז",
        actionRevealInFinder: "הצג ב-Finder",
        sourceMacSettings: "חלוניות הגדרות מערכת",
        sourceFiles: "קבצים",
        filesTitle: "חפש את הקבצים שלך",
        filesCaption: "ציין את התיקיות לחיפוש והסרגל מוצא קבצים לפי שם כשאתה מקליד. שום דבר לא מתווסף לאינדקס ולא מתבקשת הרשאה: זה משתמש בחיפוש של ה-Mac ומציע רק מה שאתה כבר יכול לראות ב-Finder.",
        filesEmpty: "אין תיקיות עדיין, אז הסרגל לא מחפש קבצים.",
        filesAddFolder: "הוסף תיקייה",
        filesIgnoreCaption: "שמות שלא שווה להציג: שם תיקייה או קובץ מלא, או סיומת כמו *.log.",
        filesIgnorePlaceholder: "שם תיקייה או קובץ",
        filesIgnoreAdd: "הוסף",
        compactModeToggle: "מצב קומפקטי",
        compactModeCaption: "הסרגל נפתח בלי הצעות. תוצאות מופיעות כשאתה מקליד.",
        emojiSkinToneLabel: "גוון עור",
        emojiSkinToneCaption: "רגשונים שתומכים בגוון עור משתמשים בגוון הזה כברירת מחדל. כדי לבחור גוון אחר, פתח את הפעולות בשורת הרגשון.",
        asciiLayoutToggle: "עבור לפריסת ABC כשהסרגל פתוח",
        asciiLayoutCaption: "השדה מקליד אותיות לטיניות בכל פריסה שהייתה פעילה, והפריסה הקודמת חוזרת כשהסרגל נסגר.")
}
