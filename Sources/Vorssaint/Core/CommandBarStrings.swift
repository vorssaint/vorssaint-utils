...
extension CommandBarFeatureStrings {
    ...
    static let ru = CommandBarFeatureStrings(
        ...
        resetPositionButton: "Вернуть панель по центру",
    ...
    static let zhHans = CommandBarFeatureStrings(
        ...
        resetPositionButton: "命令栏位置复原居中",
        shortcutToggle: "启动命令栏全局快捷键",
        dragHint: "拖动移动 · 双击复原",
    ...
    static let zhTW = CommandBarFeatureStrings(
        ...
        resetPositionButton: "指令列位置復原置中",
        shortcutToggle: "啟動指令列全域快速鍵",
        dragHint: "拖曳移動 · 雙按復原",
