...
extension CommandBarFeatureStrings {
    static let enUS = CommandBarFeatureStrings(
        ...
        privacyNote: "Search runs on this Mac with no account or cloud, and what you type leaves it only through sites you open or scripts you add.",
    ...
    static let ptBR = CommandBarFeatureStrings(
        ...
        privacyNote: "A busca roda neste Mac, sem conta nem nuvem, e o que você digita só sai daqui pelos sites que você abrir ou pelos scripts que você adicionar.",
    ...
    static let tr = CommandBarFeatureStrings(
        ...
        privacyNote: "Arama bu Mac’te hesap ve bulut olmadan çalışır, yazdıklarınız yalnızca açtığınız siteler veya eklediğiniz betiklerle dışarı çıkabilir.",
    ...
    static let ru = CommandBarFeatureStrings(
        ...
        privacyNote: "Поиск работает на этом Mac без аккаунта и облака, а введённый текст может уйти наружу только через открытые вами сайты или добавленные вами скрипты.",
    ...
    static let es = CommandBarFeatureStrings(
        ...
        placeholderDate: "hoy",
        privacyNote: "La búsqueda funciona en este Mac sin cuenta ni nube, y lo que escribes solo sale de aquí a través de los sitios que abras o los scripts que añadas.",
    ...
    static let sk = CommandBarFeatureStrings(
        ...
        settingsCaption: "Jedna skratka otvorí pole nad tým, čo práve robíte. Napíšte pár písmen, stlačte Return a stane sa to. Nič z toho, čo napíšete, sa neukladá.",
        openButton: "Otvoriť lištu teraz",
        searchPlaceholder: "Napíšte, čo chcete urobiť",
        suggestionsLabel: "Návrhy",
        noResultsTitle: "Nič s takým názvom tu nie je.",
        noResultsAction: "Zobraziť návrhy",
        argumentRangeFormat: "%d až %d",
        argumentHint: "Return použije · Esc sa vráti",
        confirmHint: "Return potvrdí · Esc zruší",
        kindApp: "Aplikácia",
        kindClipboard: "Prilepiť z histórie",
        kindSnippet: "Vložiť fragment",
        soundOutputSubtitle: "Prepnúť výstup zvuku",
        soundOutputCurrent: "Aktuálny výstup",
        volumeTitle: "Hlasitosť",
        brightnessTitle: "Jas obrazovky",
        keepAwakeForFormat: "Zapnúť bdelý režim: %@",
        needsSetupFormat: "Zapnite funkciu %@ v Nastaveniach",
        needsPermissionHint: "Vyžaduje povolenie · Return si ho vyžiada",
        actionCheckAppUpdates: "Skontrolovať aktualizácie aplikácií",
        actionCleanURL: "Vyčistiť skopírovaný odkaz",
        actionOpenSettings: "Otvoriť Nastavenia",
        answerBatteryLabel: "Batéria",
        answerBatteryCharging: "nabíja sa",
        answerBatteryPlugged: "na napájaní",
        answerMemoryLabel: "Pamäť",
        answerMemoryFormat: "Využité: %@ z %@",
        answerStorageLabel: "Úložisko",
        answerStorageFormat: "Dostupné: %@ z %@",
        copyHint: "Return skopíruje",
        copyFailed: "Nepodarilo sa skopírovať",
        kindWindow: "Okno",
        quitFormat: "Ukončiť „%@“",
        quitConfirmFormat: "Ukončiť „%@“?",
        kindMenu: "Príkaz ponuky",
        actionsTitle: "Akcie",
        actionsHint: "Akcie",
        reuseHint: "Pokračovať",
        actionPin: "Pripnúť navrch",
        actionUnpin: "Odopnúť",
        actionName: "Dať tomu vlastný názov",
        actionRename: "Zmeniť názov, na ktorý reaguje",
        actionHide: "Nikdy nezobrazovať",
        actionForget: "Zabudnúť, ako často to používam",
        aliasPlaceholder: "Názov, ktorý mu dávate",
        aliasTakenFormat: "%@ už na to reaguje",
        sourcesTitle: "Čo lišta prehľadáva",
        sourcesCaption: "Vypnite, čo nikdy nechcete vidieť. Vaše vlastné akcie zostávajú vždy.",
        sourceActions: "Akcie Vorssaint",
        sourceApps: "Aplikácie",
        sourceMenus: "Príkazy ponuky aktívnej aplikácie",
        sourceWindows: "Otvorené okná",
        sourceQuitApps: "Ukončiť aplikáciu",
        sourceSettingsPages: "Stránky Nastavení",
        sourceSnippets: "Fragmenty",
        sourceClipboard: "História schránky",
        sourceEmoji: "Emoji",
        sourceFolders: "Priečinky",
        sourceAnswers: "Odpovede o tomto Macu",
        sourceCalculator: "Súčty a prevody",
        namedTitle: "Názvy, ktoré ste dali",
        namedEmpty: "Zatiaľ nič nemá názov. Otvorte lištu, vyberte riadok a stlačte kláves akcií.",
        pinnedTitle: "Pripnuté",
        pinnedEmpty: "Zatiaľ nič nie je pripnuté.",
        hiddenTitle: "Nikdy nezobrazované",
        hiddenEmpty: "Nič nie je skryté.",
        forgetAllButton: "Zabudnúť, čo používam najviac",
        tryTheseLabel: "Skúste",
        stillLooking: "Hľadá sa ďalej",
        removeButton: "Odstrániť",
        confirmButton: "Potvrdiť",
        soundMute: "Stlmiť zvuk",
        soundUnmute: "Znova zapnúť zvuk",
        stateOn: "zapnuté",
        powerSleep: "Uspať",
        powerRestart: "Reštartovať",
        powerRestartConfirm: "Reštartovať Mac?",
        powerShutDown: "Vypnúť",
        powerShutDownConfirm: "Vypnúť Mac?",
        powerLogOut: "Odhlásiť sa",
        powerLogOutConfirm: "Odhlásiť sa?",
        wifiOn: "Zapnúť Wi-Fi",
        wifiOff: "Vypnúť Wi-Fi",
        kindEmoji: "Emoji",
        kindFolder: "Priečinok",
        answerDateLabel: "Dnes",
        answerTimeLabel: "Aktuálny čas",
        kindAnswer: "Odpoveď",
        kindSelection: "Výber",
        selectedTitle: "Vybraté",
        selectionCopy: "Skopírovať",
        selectionSearch: "Použiť vo vyhľadávaní",
        selectionUpper: "VEĽKÉ PÍSMENÁ",
        selectionLower: "malé písmená",
        selectionTitleCase: "Veľké Začiatočné Písmená",
        selectionShelf: "Nechať na polici",
        selectionCount: "Spočítať",
        selectionCountFormat: "Slová: %d, znaky: %d",
        sourceSelection: "Čo je vybraté",
        ...
        linkKindPlace: "Priečinok alebo súbor",
        linkPlaceholdersHint: "Vložte jeden z týchto a pri otvorení sa doplní",
        placeholderQuery: "čo napíšete",
        placeholderClipboard: "čo ste skopírovali",
        placeholderSelection: "čo je vybraté",
        placeholderDate: "dnes",
        privacyNote: "Vyhľadávanie beží v tomto Macu bez účtu a cloudu a to, čo napíšete, odíde len cez stránky, ktoré otvoríte, alebo skripty, ktoré pridáte.",
        actionShortcut: "Dať tomu skratku",
        actionShortcutChange: "Zmeniť skratku",
        actionShortcutRemove: "Odobrať skratku",
        shortcutCaptureHint: "Stlačte požadované klávesy · Delete vymaže · Esc sa vráti",
        rowShortcutsTitle: "Riadky s vlastnou skratkou",
        rowShortcutsEmpty: "Zatiaľ žiadny riadok nemá vlastnú skratku. Otvorte akcie na ľubovoľnom riadku a nejakú mu dajte.",
        appCenterTitle: "Skratky aplikácií",
        appCenterCaption: "Otvárajte aplikácie vlastnými skratkami, aj keď je lišta zavretá. Tu nastavte vyhľadávacie názvy a pripnite si obľúbené.",
        appAliasLabel: "Alias",
        appShortcutLabel: "Skratka",
        appShortcutsFilter: "So skratkami",
        appShortcutRecord: "Nahrať…",
        rowShortcutsLimitFormat: "Môžete priradiť až %d skratiek. Jednu odstráňte, ak chcete pridať ďalšiu.",
        turnOnFormat: "Zapnúť funkciu %@",
        turnOffFormat: "Vypnúť funkciu %@",
        everythingTitle: "Všetko, čo dokáže",
        categoryAll: "Všetko",
        restartAppFormat: "Reštartovať „%@“",
        forceQuitAppFormat: "Vynútiť ukončenie „%@“…",
        forceQuitAppConfirmFormat: "Vynútiť ukončenie „%@“? Neuložené zmeny sa stratia.",
        uninstallAppFormat: "Odinštalovať „%@“…",
        ...
        scriptBareSearchHint: "Spustí sa samo, alebo napíšte, čo odoslať",
        linkAddButton: "Pridať skratku",
        positionCaption: "Potiahnutím značky vľavo od poľa umiestnite lištu kamkoľvek na obrazovku; dvojitým kliknutím na značku ju vycentrujete.",
        resetPositionButton: "Vycentrovať lištu",
        shortcutToggle: "Globálna skratka na otvorenie lišty",
        dragHint: "Ťahaním presuniete · Dvojklikom vycentrujete",
        actionRevealInFinder: "Zobraziť vo Finderi",
        sourceMacSettings: "Panely Systémových nastavení",
        sourceFiles: "Súbory",
        filesTitle: "Prehľadávať vaše súbory",
        filesCaption: "Zadajte priečinky, v ktorých sa má hľadať, a lišta bude počas písania hľadať súbory podľa názvu. Nič sa neindexuje a nevyžaduje sa žiadne povolenie: používa vlastné vyhľadávanie Macu a ponúka len to, čo už vidíte vo Finderi.",
        filesEmpty: "Zatiaľ žiadne priečinky, takže lišta nehľadá žiadne súbory.",
        filesAddFolder: "Pridať priečinok",
        filesIgnoreCaption: "Názvy, ktoré nikdy nemá zmysel zobrazovať: celý názov priečinka alebo súboru, alebo prípona zapísaná ako *.log.",
        filesIgnorePlaceholder: "Názov priečinka alebo súboru",
        filesIgnoreAdd: "Pridať",
        compactModeToggle: "Kompaktný režim",
    ...
    static let de = CommandBarFeatureStrings(
        ...
        privacyNote: "Die Suche läuft auf diesem Mac ohne Konto und Cloud, und Eingaben verlassen ihn nur über Seiten, die Sie öffnen, oder Skripte, die Sie hinzufügen.",
    ...
    static let fr = CommandBarFeatureStrings(
        ...
        privacyNote: "La recherche s’exécute sur ce Mac, sans compte ni cloud, et ce que vous tapez n’en sort que par les sites que vous ouvrez ou les scripts que vous ajoutez.",
    ...
    static let it = CommandBarFeatureStrings(
        ...
        privacyNote: "La ricerca funziona su questo Mac senza account né cloud, e ciò che scrivi esce di qui solo tramite i siti che apri o gli script che aggiungi.",
    ...
    static let ja = CommandBarFeatureStrings(
        ...
        placeholderDate: "今日",
        privacyNote: "検索はこの Mac の中で、アカウントもクラウドも使わずに動作し、入力した内容が外に出るのは、開いたサイトか追加したスクリプトを通す場合だけです。",
    ...
    static let ko = CommandBarFeatureStrings(
        ...
        placeholderDate: "오늘",
        privacyNote: "검색은 계정이나 클라우드 없이 이 Mac 안에서 처리되며, 입력한 내용은 직접 연 사이트나 추가한 스크립트를 통해서만 밖으로 나갈 수 있습니다.",
    ...
    static let uk = CommandBarFeatureStrings(
        ...
        argumentRangeFormat: "від %d до %d",
        ...
        selectionCountFormat: "Слів: %d, символів: %d",
        ...
        privacyNote: "Пошук працює на цьому Mac без облікового запису й хмари, а введений текст може вийти назовні лише через відкриті вами сайти або додані вами скрипти.",
        ...
        sourceMacSettings: "Панелі Системних параметрів",
        sourceFiles: "Файли",
    ...
    static let zhHans = CommandBarFeatureStrings(
        ...
        placeholderDate: "今天",
        privacyNote: "搜索在这台 Mac 上完成，不需要账户，不上云，输入的内容只会经由你打开的网站或你添加的脚本外传。",
    ...
    static let zhTW = CommandBarFeatureStrings(
        ...
        placeholderDate: "今天",
        privacyNote: "搜尋在這台 Mac 上完成，不需要帳號，不上雲，輸入的內容只會經由你開啟的網站或你加入的腳本外傳。",
