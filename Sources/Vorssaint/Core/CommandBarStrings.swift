...
extension CommandBarFeatureStrings {
    ...
    static let sk = CommandBarFeatureStrings(
        ...
        privacyNote: "Všetko sa deje v tomto Macu: žiadny účet, žiadny cloud, nič sa nikam neposiela.",
    ...
    static let zhHans = CommandBarFeatureStrings(
        ...
        appCenterTitle: "App 快捷键",
        appCenterCaption: "即使关闭命令栏，也能用专属快捷键打开 App。在这里设置搜索别名并置顶常用 App。",
        appAliasLabel: "别名",
