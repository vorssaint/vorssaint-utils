...
extension CommandBarFeatureStrings {
    ...
    static let nl = CommandBarFeatureStrings(
        pageTitle: "Opdrachtbalk",
        hubDescription: "Eén veld dat alles vindt en uitvoert wat de app kan",
        panelCaption: "Typ om iets te vinden en uit te voeren",
        settingsCaption: "Eén sneltoets opent een veld boven op wat je ook doet. Typ een paar letters, druk op Return en het gebeurt. Niets van wat je typt wordt bewaard.",
        openButton: "Open de balk nu",
        searchPlaceholder: "Typ wat je wilt doen",
        suggestionsLabel: "Suggesties",
        noResultsTitle: "Niets gevonden met die naam.",
        noResultsAction: "Bekijk suggesties",
        argumentRangeFormat: "%d tot %d",
        argumentHint: "Return past toe · Esc gaat terug",
        confirmHint: "Return bevestigt · Esc annuleert",
        kindApp: "App",
        kindClipboard: "Plak uit geschiedenis",
        kindSnippet: "Voeg fragment in",
        soundOutputSubtitle: "Wissel geluidsuitgang",
        soundOutputCurrent: "Huidige uitgang",
        volumeTitle: "Volume",
        brightnessTitle: "Schermhelderheid",
        keepAwakeForFormat: "Wakker houden voor %@",
        needsSetupFormat: "Schakel %@ in via Instellingen",
        needsPermissionHint: "Vereist toestemming · Return vraagt",
        actionCheckAppUpdates: "Controleer op app-updates",
        actionCleanURL: "Maak de gekopieerde link schoon",
        actionOpenSettings: "Open Instellingen",
        answerBatteryLabel: "Batterij",
        answerBatteryCharging: "aan het opladen",
        answerBatteryPlugged: "aangesloten",
        answerMemoryLabel: "Geheugen",
        answerMemoryFormat: "%@ van %@ in gebruik",
        answerStorageLabel: "Opslag",
        answerStorageFormat: "%@ beschikbaar van %@",
        copyHint: "Return kopieert",
        kindWindow: "Venster",
        quitFormat: "%@ stoppen",
        quitConfirmFormat: "%@ stoppen?",
        kindMenu: "Menuopdracht",
        actionsTitle: "Acties",
        actionsHint: "Acties",
        actionPin: "Zet vast bovenaan",
        actionUnpin: "Maak los",
        actionName: "Geef het je eigen naam",
        actionRename: "Wijzig de naam waarop het reageert",
        actionHide: "Nooit tonen",
        actionForget: "Vergeet hoe vaak ik dit gebruik",
        aliasPlaceholder: "De naam die je ervoor gebruikt",
        aliasTakenFormat: "%@ reageert daar al op",
        sourcesTitle: "Wat de balk doorzoekt",
        sourcesCaption: "Schakel uit wat je nooit wilt zien. Je eigen acties blijven altijd.",
        sourceActions: "Vorssaint-acties",
        sourceApps: "Apps",
        sourceMenus: "Menuopdrachten van de app op de voorgrond",
        sourceWindows: "Open vensters",
        sourceQuitApps: "Stop een app",
        sourceSettingsPages: "Instellingenpagina's",
        sourceSnippets: "Fragmenten",
        sourceClipboard: "Klembordgeschiedenis",
        sourceEmoji: "Emoji",
        sourceFolders: "Mappen",
        sourceAnswers: "Antwoorden over deze Mac",
        sourceCalculator: "Sommen en omrekeningen",
        namedTitle: "Namen die je gaf",
        namedEmpty: "Nog niets een naam gegeven. Open de balk, kies een rij en druk op de actietoets.",
        pinnedTitle: "Vastgezet",
        pinnedEmpty: "Nog niets vastgezet.",
        hiddenTitle: "Nooit getoond",
        hiddenEmpty: "Niets verborgen.",
        forgetAllButton: "Vergeet wat ik het meest gebruik",
        tryTheseLabel: "Probeer",
        stillLooking: "Nog aan het zoeken",
        removeButton: "Verwijderen",
        confirmButton: "Bevestigen",
        soundMute: "Demp het geluid",
        soundUnmute: "Zet het geluid weer aan",
        stateOn: "aan",
        powerSleep: "Sluimerstand",
        powerRestart: "Herstart",
        powerRestartConfirm: "Mac herstarten?",
        powerShutDown: "Zet uit",
        powerShutDownConfirm: "Mac uitzetten?",
        powerLogOut: "Log uit",
        powerLogOutConfirm: "Uitloggen?",
        wifiOn: "Zet Wi-Fi aan",
        wifiOff: "Zet Wi-Fi uit",
        kindEmoji: "Emoji",
        kindFolder: "Map",
        answerDateLabel: "Vandaag",
        answerTimeLabel: "Tijd nu",
        kindAnswer: "Antwoord",
        kindSelection: "Selectie",
        selectedTitle: "Geselecteerd",
        selectionCopy: "Kopieer het",
        selectionSearch: "Gebruik het in de zoekopdracht",
        selectionUpper: "HOOFDLETTERS",
        selectionLower: "kleine letters",
        selectionTitleCase: "Hoofdletters Per Woord",
        selectionShelf: "Bewaar het op de Shelf",
        selectionCount: "Tel het",
        selectionCountFormat: "%d woorden, %d tekens",
        sourceSelection: "Wat is geselecteerd",
        kindLink: "Jouw snelkoppeling",
        linkSearchHint: "Typ na de naam waar je naar zoekt",
        linksTitle: "Jouw snelkoppelingen",
        linksEmpty: "Nog niets bewaard. Voeg een site, map, zoekopdracht of script toe dat je elke dag gebruikt.",
        linkDestinationLabel: "Waar het naartoe gaat",
        linkKindLink: "Site of link",
        linkKindPlace: "Map of bestand",
        linkPlaceholdersHint: "Zet er een van deze in en het wordt ingevuld bij het openen",
        placeholderQuery: "wat je typt",
        placeholderClipboard: "wat je hebt gekopieerd",
        placeholderSelection: "wat is geselecteerd",
        placeholderDate: "vandaag",
        privacyNote: "Alles gebeurt op deze Mac: geen account, geen cloud, er wordt niets verstuurd.",
        actionShortcut: "Geef het een sneltoets",
        actionShortcutChange: "Wijzig de sneltoets",
        actionShortcutRemove: "Verwijder de sneltoets",
        shortcutCaptureHint: "Druk op de toetsen die je wilt · Delete wist het · Esc gaat terug",
        rowShortcutsTitle: "Rijen met een eigen sneltoets",
        rowShortcutsEmpty: "Nog geen rij heeft een eigen sneltoets. Open de acties van een rij om er een aan te geven.",
        turnOnFormat: "Schakel %@ in",
        turnOffFormat: "Schakel %@ uit",
        everythingTitle: "Alles wat het kan",
        categoryAll: "Alles",
        restartAppFormat: "Herstart %@",
        forceQuitAppFormat: "Forceer stoppen van %@…",
        forceQuitAppConfirmFormat: "%@ geforceerd stoppen? Niet-bewaarde wijzigingen gaan verloren.",
        uninstallAppFormat: "Verwijder %@…",
        openInBrowser: "Open in de browser",
        linkKindScript: "Script",
        scriptHint: "Kies een uitvoerbaar bestand. Typ de naam ervan, gevolgd door wat je wilt versturen. Het draait zodra je pauzeert en toont het resultaat hier.",
        scriptRunsWithoutArgument: "Ook uitvoeren als alleen de naam wordt getypt",
        scriptRunFailed: "Kon dit bestand niet uitvoeren",
        scriptSearchHint: "Typ na de naam wat je wilt versturen",
        scriptBareSearchHint: "Draait vanzelf, of typ wat je wilt versturen",
        linkAddButton: "Snelkoppeling toevoegen",
        positionCaption: "Sleep het teken links van het veld om de balk overal op het scherm te plaatsen; dubbelklik op het teken om het te centreren.",
        resetPositionButton: "Balk centreren",
        shortcutToggle: "Globale sneltoets om de balk te openen",
        dragHint: "Sleep om te verplaatsen · Dubbelklik om te centreren",
        actionRevealInFinder: "Toon in Finder",
        sourceMacSettings: "Onderdelen van Systeeminstellingen",
        sourceFiles: "Bestanden",
        filesTitle: "Doorzoek je bestanden",
        filesCaption: "Geef de mappen op waarin gezocht moet worden en de balk vindt bestanden op naam terwijl je typt. Er wordt niets geïndexeerd en er wordt geen toestemming gevraagd: het gebruikt de eigen zoekfunctie van de Mac en toont alleen wat je al kunt zien in Finder.",
        filesEmpty: "Nog geen mappen, dus de balk zoekt geen bestanden.",
        filesAddFolder: "Voeg een map toe",
        filesIgnoreCaption: "Namen die nooit de moeite waard zijn om te tonen: een hele map- of bestandsnaam, of een extensie geschreven als *.log.",
        filesIgnorePlaceholder: "Een map- of bestandsnaam",
        filesIgnoreAdd: "Toevoegen",
        compactModeToggle: "Compacte modus",
        compactModeCaption: "Balk opent zonder suggesties. Resultaten verschijnen terwijl je typt.")
