...
extension CommandBarFeatureStrings {
    ...
    static let vi = CommandBarFeatureStrings(
        ...
        hubDescription: "Một ô nhập duy nhất giúp tìm và chạy mọi thứ ứng dụng làm được",
        panelCaption: "Nhập để tìm và chạy bất cứ điều gì",
        settingsCaption: "Một phím tắt mở ra một ô nhập ngay trên nội dung đang hiển thị. Gõ vài chữ, nhấn Return là thực hiện. Không có gì được gõ vào bị lưu lại.",
        openButton: "Mở thanh lệnh ngay",
        searchPlaceholder: "Nhập điều muốn làm",
        suggestionsLabel: "Gợi ý",
        noResultsTitle: "Không có gì mang tên này.",
        noResultsAction: "Xem gợi ý",
        argumentRangeFormat: "%d đến %d",
        argumentHint: "Return để áp dụng · Esc để quay lại",
        confirmHint: "Return để xác nhận · Esc để hủy",
        kindApp: "Ứng dụng",
        kindClipboard: "Dán từ lịch sử",
        kindSnippet: "Chèn đoạn văn bản",
        soundOutputSubtitle: "Chuyển đầu ra âm thanh",
        soundOutputCurrent: "Đầu ra hiện tại",
        volumeTitle: "Âm lượng",
        brightnessTitle: "Độ sáng màn hình",
        keepAwakeForFormat: "Giữ máy không ngủ trong %@",
        needsSetupFormat: "Bật %@ trong Cài đặt",
        needsPermissionHint: "Cần quyền truy cập · Return để yêu cầu",
        actionCheckAppUpdates: "Kiểm tra cập nhật ứng dụng",
        actionCleanURL: "Làm sạch liên kết đã sao chép",
        actionOpenSettings: "Mở Cài đặt",
        answerBatteryLabel: "Pin",
        answerBatteryCharging: "đang sạc",
        answerBatteryPlugged: "đã cắm nguồn",
        answerMemoryLabel: "Bộ nhớ",
        answerMemoryFormat: "Đang dùng %@ trong %@",
        answerStorageLabel: "Dung lượng lưu trữ",
        answerStorageFormat: "Còn trống %@ trong %@",
        copyHint: "Return để sao chép",
        kindWindow: "Cửa sổ",
        quitFormat: "Thoát %@",
        quitConfirmFormat: "Thoát %@?",
        kindMenu: "Lệnh menu",
        actionsTitle: "Thao tác",
        actionsHint: "Thao tác",
        actionPin: "Ghim lên đầu",
        actionUnpin: "Bỏ ghim",
        actionName: "Đặt tên riêng cho mục này",
        actionRename: "Đổi tên đang dùng để gọi mục này",
        actionHide: "Không bao giờ hiện mục này",
        actionForget: "Quên mức độ thường xuyên dùng mục này",
        aliasPlaceholder: "Tên dùng để gọi mục này",
        aliasTakenFormat: "%@ đã dùng tên đó rồi",
        sourcesTitle: "Những gì thanh lệnh tìm kiếm",
        sourcesCaption: "Tắt những gì không muốn thấy. Các thao tác riêng luôn được giữ lại.",
        sourceActions: "Thao tác của Vorssaint",
        sourceApps: "Ứng dụng",
        sourceMenus: "Lệnh menu của ứng dụng đang ở phía trước",
        sourceWindows: "Cửa sổ đang mở",
        sourceQuitApps: "Thoát một ứng dụng",
        sourceSettingsPages: "Trang cài đặt",
        sourceSnippets: "Đoạn văn bản",
        sourceClipboard: "Lịch sử khay nhớ tạm",
        sourceEmoji: "Emoji",
        sourceFolders: "Thư mục",
        sourceAnswers: "Thông tin về Mac này",
        sourceCalculator: "Phép tính và chuyển đổi",
        namedTitle: "Tên đã đặt",
        namedEmpty: "Chưa đặt tên cho mục nào. Mở thanh lệnh, chọn một dòng rồi nhấn phím thao tác.",
        pinnedTitle: "Đã ghim",
        pinnedEmpty: "Chưa ghim gì.",
        hiddenTitle: "Không bao giờ hiện",
        hiddenEmpty: "Không có gì bị ẩn.",
        forgetAllButton: "Quên những mục dùng nhiều nhất",
        tryTheseLabel: "Thử",
        stillLooking: "Vẫn đang tìm",
        removeButton: "Xóa",
        confirmButton: "Xác nhận",
        soundMute: "Tắt tiếng",
        soundUnmute: "Bật tiếng trở lại",
        stateOn: "bật",
        powerSleep: "Ngủ",
        powerRestart: "Khởi động lại",
        powerRestartConfirm: "Khởi động lại Mac?",
        powerShutDown: "Tắt máy",
        powerShutDownConfirm: "Tắt Mac?",
        powerLogOut: "Đăng xuất",
        powerLogOutConfirm: "Đăng xuất?",
        wifiOn: "Bật Wi-Fi",
        wifiOff: "Tắt Wi-Fi",
        kindEmoji: "Emoji",
        kindFolder: "Thư mục",
        answerDateLabel: "Hôm nay",
        answerTimeLabel: "Giờ hiện tại",
        kindAnswer: "Câu trả lời",
        kindSelection: "Lựa chọn",
        selectedTitle: "Đã chọn",
        selectionCopy: "Sao chép",
        selectionSearch: "Dùng để tìm kiếm",
        selectionUpper: "CHỮ HOA",
        selectionLower: "chữ thường",
        selectionTitleCase: "Viết Hoa Đầu Từ",
        selectionShelf: "Giữ trên kệ",
        selectionCount: "Đếm",
        selectionCountFormat: "%d từ, %d ký tự",
        sourceSelection: "Nội dung đang được chọn",
        kindLink: "Lối tắt riêng",
        linkSearchHint: "Gõ nội dung cần tìm sau tên",
        linksTitle: "Lối tắt riêng",
        linksEmpty: "Chưa lưu gì. Thêm một trang web, thư mục, tìm kiếm hoặc tập lệnh dùng hằng ngày.",
        linkDestinationLabel: "Đích đến",
        linkKindLink: "Trang web hoặc liên kết",
        linkKindPlace: "Thư mục hoặc tệp",
        linkPlaceholdersHint: "Chèn một trong các mục này vào, nó sẽ được điền khi mở",
        placeholderQuery: "nội dung đã gõ",
        placeholderClipboard: "nội dung đã sao chép",
        placeholderSelection: "nội dung đang được chọn",
        placeholderDate: "hôm nay",
        privacyNote: "Mọi thứ diễn ra trên Mac này: không tài khoản, không đám mây, không gửi đi đâu cả.",
        actionShortcut: "Đặt phím tắt",
        actionShortcutChange: "Đổi phím tắt",
        actionShortcutRemove: "Bỏ phím tắt",
        shortcutCaptureHint: "Nhấn tổ hợp phím mong muốn · Delete để xóa · Esc để quay lại",
        rowShortcutsTitle: "Dòng có phím tắt riêng",
        rowShortcutsEmpty: "Chưa có dòng nào có phím tắt riêng. Mở thao tác của một dòng bất kỳ để đặt phím tắt.",
        appCenterTitle: "Phím tắt ứng dụng",
        appCenterCaption: "Mở ứng dụng bằng phím tắt riêng, ngay cả khi thanh lệnh đang đóng. Đặt tên tìm kiếm và ghim ứng dụng yêu thích tại đây.",
        appAliasLabel: "Tên riêng",
        appShortcutLabel: "Phím tắt",
        appShortcutsFilter: "Có phím tắt",
        appShortcutRecord: "Ghi…",
        rowShortcutsLimitFormat: "Bạn có thể đặt tối đa %d phím tắt. Bỏ một cái để thêm cái khác.",
        turnOnFormat: "Bật %@",
        turnOffFormat: "Tắt %@",
        everythingTitle: "Mọi việc có thể làm",
        categoryAll: "Tất cả",
        restartAppFormat: "Khởi động lại %@",
        forceQuitAppFormat: "Buộc thoát %@…",
        forceQuitAppConfirmFormat: "Buộc thoát %@? Các thay đổi chưa lưu sẽ bị mất.",
        uninstallAppFormat: "Gỡ cài đặt %@…",
        ...
        sourceFiles: "Tệp",
        filesTitle: "Tìm kiếm tệp",
        filesCaption: "Chỉ định thư mục cần tìm và thanh lệnh sẽ tìm tệp theo tên trong lúc gõ. Không có gì được lập chỉ mục và không yêu cầu quyền truy cập nào: nó dùng chính công cụ tìm kiếm của Mac và chỉ hiện những gì đã có thể thấy trong Finder.",
        filesEmpty: "Chưa có thư mục nào, nên thanh lệnh không tìm tệp nào.",
