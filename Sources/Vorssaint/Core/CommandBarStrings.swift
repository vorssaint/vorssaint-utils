...
extension CommandBarFeatureStrings {
    ...
    static let ar = CommandBarFeatureStrings(
        ...
        appCenterTitle: "اختصارات التطبيقات",
        appCenterCaption: "افتح التطبيقات باختصاراتها الخاصة، حتى والشريط مغلق. وعيّن أسماء البحث وثبّت المفضلة من هنا.",
        appAliasLabel: "الاسم البديل",
        appShortcutLabel: "الاختصار",
        appShortcutsFilter: "ذات الاختصارات",
        appShortcutRecord: "تسجيل…",
        rowShortcutsLimitFormat: "يمكنك تعيين %d اختصار كحد أقصى. أزِل واحدًا لإضافة آخر.",
        turnOnFormat: "تشغيل %@",
        turnOffFormat: "إيقاف %@",
        ...
        scriptRunsDirectly: "التشغيل من اختصاره العام دون فتح الشريط",
