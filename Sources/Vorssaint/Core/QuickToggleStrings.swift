...
struct QuickToggleFeatureStrings {
    ...
    let flushDNSTitle: String
    let flushDNSCaption: String
    let flushDNSAdminPrompt: String
...
extension QuickToggleFeatureStrings {
    static let enUS = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "Flush the DNS cache",
        flushDNSCaption: "Clears the system's cached DNS lookups. Asks for the administrator password.",
        flushDNSAdminPrompt: "Vorssaint needs administrator access to flush the DNS cache.",
    ...
    static let ptBR = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "Limpar o cache de DNS",
        flushDNSCaption: "Limpa as consultas de DNS em cache do sistema. Pede a senha de administrador.",
        flushDNSAdminPrompt: "O Vorssaint precisa de acesso de administrador para limpar o cache de DNS.",
    ...
    static let tr = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "DNS önbelleğini temizle",
        flushDNSCaption: "Sistemin önbelleğe aldığı DNS sorgularını temizler. Yönetici parolası ister.",
        flushDNSAdminPrompt: "Vorssaint'in DNS önbelleğini temizlemek için yönetici erişimi gerekiyor.",
    ...
    static let ru = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "Очистить кеш DNS",
        flushDNSCaption: "Очищает сохранённые системные DNS-запросы. Запрашивает пароль администратора.",
        flushDNSAdminPrompt: "Vorssaint нужны права администратора, чтобы очистить кеш DNS.",
    ...
    static let es = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "Vaciar la caché de DNS",
        flushDNSCaption: "Borra las búsquedas de DNS guardadas por el sistema. Pide la contraseña de administrador.",
        flushDNSAdminPrompt: "Vorssaint necesita acceso de administrador para vaciar la caché de DNS.",
    ...
    static let de = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "DNS-Cache leeren",
        flushDNSCaption: "Leert die zwischengespeicherten DNS-Abfragen des Systems. Fragt nach dem Administratorpasswort.",
        flushDNSAdminPrompt: "Vorssaint benötigt Administratorrechte, um den DNS-Cache zu leeren.",
    ...
    static let fr = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "Vider le cache DNS",
        flushDNSCaption: "Efface les requêtes DNS mises en cache par le système. Demande le mot de passe administrateur.",
        flushDNSAdminPrompt: "Vorssaint a besoin d'un accès administrateur pour vider le cache DNS.",
    ...
    static let it = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "Svuota la cache DNS",
        flushDNSCaption: "Rimuove le ricerche DNS memorizzate dal sistema. Chiede la password di amministratore.",
        flushDNSAdminPrompt: "Vorssaint richiede l'accesso da amministratore per svuotare la cache DNS.",
    ...
    static let ja = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "DNS キャッシュを消去",
        flushDNSCaption: "システムに保存された DNS 参照を消去します。管理者パスワードを求めます。",
        flushDNSAdminPrompt: "DNS キャッシュを消去するには Vorssaint に管理者アクセスが必要です。",
    ...
    static let ko = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "DNS 캐시 지우기",
        flushDNSCaption: "시스템에 저장된 DNS 조회 기록을 지웁니다. 관리자 암호를 요구합니다.",
        flushDNSAdminPrompt: "DNS 캐시를 지우려면 Vorssaint에 관리자 권한이 필요합니다.",
    ...
    static let zhHans = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "刷新 DNS 缓存",
        flushDNSCaption: "清除系统缓存的 DNS 记录。需要输入管理员密码。",
        flushDNSAdminPrompt: "Vorssaint 需要管理员权限才能刷新 DNS 缓存。",
    ...
    static let zhTW = QuickToggleFeatureStrings(
        ...
        flushDNSTitle: "清除 DNS 快取",
        flushDNSCaption: "清除系統快取的 DNS 記錄。需要輸入管理者密碼。",
        flushDNSAdminPrompt: "Vorssaint 需要管理員權限才能清除 DNS 快取。",
