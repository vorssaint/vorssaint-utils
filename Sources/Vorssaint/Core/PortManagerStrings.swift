...
extension PortManagerFeatureStrings {
    ...
    static let zhHans = PortManagerFeatureStrings(title: "端口管理器", filter: "按端口、进程或 PID 筛选", openFormat: "%d 个开放", empty: "未找到监听端口", emptyHint: "尝试刷新或更改搜索条件。", listeningCaption: "你的监听端口", kill: "终止", forceKill: "强制终止", loadFailed: "无法读取监听端口。请尝试刷新。", refresh: "刷新", terminateFormat: "要终止 %@ 吗？", terminateMessageFormat: "终止 PID %2$d 将关闭端口 %1$d。", hubDescription: "查看活动的监听端口，并在已安装“结束进程”时终止使用它们的进程", allInterfaces: "所有接口", allInterfacesHelp: "正在所有网络接口上监听，同一网络中的其他设备可能可以连接。")
