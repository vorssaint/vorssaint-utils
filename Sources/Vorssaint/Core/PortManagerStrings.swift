...
extension PortManagerFeatureStrings {
    static let uk = PortManagerFeatureStrings(
        ...
        refresh: "Оновити", copyPort: "Копіювати порт", copyAddress: "Копіювати адресу:порт", terminateFormat: "Завершити %@?",
