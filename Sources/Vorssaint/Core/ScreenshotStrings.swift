...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "Optional. Creates dated subfolders inside the folder above using %y, %year, %mo, %month, %d, %h, %mi, %s and %app, for example %y-%mo for 24-03. %app is the app in front when the capture starts.",
        fileNamePatternLabel: "File name",
        fileNamePatternCaption: "Optional. Overrides the default name using the same %y, %year, %mo, %month, %d, %h, %mi, %s and %app tokens, plus %# for an auto-incrementing number (%## pads to 2 digits, %### to 3, and so on). %app is the app in front when the capture starts.",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "Opcional. Cria subpastas com data dentro da pasta acima usando %y, %year, %mo, %month, %d, %h, %mi, %s e %app, por exemplo %y-%mo para 24-03. %app é o app em primeiro plano quando a captura começa.",
        fileNamePatternLabel: "Nome do arquivo",
        fileNamePatternCaption: "Opcional. Substitui o nome padrão usando os mesmos tokens %y, %year, %mo, %month, %d, %h, %mi, %s e %app, além de %# para um número que aumenta automaticamente (%## preenche com 2 dígitos, %### com 3, e assim por diante).",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "İsteğe bağlı. Yukarıdaki klasörün içinde %y, %year, %mo, %month, %d, %h, %mi, %s ve %app kullanarak tarihli alt klasörler oluşturur, örneğin %y-%mo için 24-03. %app, yakalama başladığında önde olan uygulamadır.",
        fileNamePatternLabel: "Dosya adı",
        fileNamePatternCaption: "İsteğe bağlı. Varsayılan adı %y, %year, %mo, %month, %d, %h, %mi, %s ve %app ile aynı belirteçleri, ayrıca otomatik artan bir sayı için %# kullanarak geçersiz kılar (%## 2 basamağa, %### 3 basamağa tamamlar).",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "Необязательно. Создаёт подпапки с датой внутри указанной папки, используя %y, %year, %mo, %month, %d, %h, %mi, %s и %app, например %y-%mo даёт 24-03. %app: приложение на переднем плане в момент начала снимка.",
        fileNamePatternLabel: "Имя файла",
        fileNamePatternCaption: "Необязательно. Переопределяет имя по умолчанию с помощью тех же токенов %y, %year, %mo, %month, %d, %h, %mi, %s и %app, а также %# для автоматически увеличивающегося номера (%## дополняет до 2 цифр, %### до 3 и так далее).",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "Opcional. Crea subcarpetas con fecha dentro de la carpeta anterior usando %y, %year, %mo, %month, %d, %h, %mi, %s y %app, por ejemplo %y-%mo para 24-03. %app es la app en primer plano al empezar la captura.",
        fileNamePatternLabel: "Nombre de archivo",
        fileNamePatternCaption: "Opcional. Reemplaza el nombre predeterminado usando los mismos tokens %y, %year, %mo, %month, %d, %h, %mi, %s y %app, además de %# para un número que se incrementa automáticamente (%## lo rellena a 2 dígitos, %### a 3, y así sucesivamente).",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "Optional. Erstellt datierte Unterordner im obigen Ordner mit %y, %year, %mo, %month, %d, %h, %mi, %s und %app, zum Beispiel %y-%mo für 24-03. %app ist die App im Vordergrund beim Start der Aufnahme.",
        fileNamePatternLabel: "Dateiname",
        fileNamePatternCaption: "Optional. Überschreibt den Standardnamen mit denselben Tokens %y, %year, %mo, %month, %d, %h, %mi, %s und %app sowie %# für eine automatisch fortlaufende Nummer (%## füllt auf 2 Stellen auf, %### auf 3 usw.).",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "Facultatif. Crée des sous-dossiers datés dans le dossier ci-dessus avec %y, %year, %mo, %month, %d, %h, %mi, %s et %app, par exemple %y-%mo pour 24-03. %app est l’app au premier plan au début de la capture.",
        fileNamePatternLabel: "Nom du fichier",
        fileNamePatternCaption: "Facultatif. Remplace le nom par défaut avec les mêmes jetons %y, %year, %mo, %month, %d, %h, %mi, %s et %app, plus %# pour un numéro qui s’incrémente automatiquement (%## le remplit sur 2 chiffres, %### sur 3, etc.).",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "Facoltativo. Crea sottocartelle datate nella cartella sopra usando %y, %year, %mo, %month, %d, %h, %mi, %s e %app, ad esempio %y-%mo per 24-03. %app è l’app in primo piano all’inizio dell’acquisizione.",
        fileNamePatternLabel: "Nome file",
        fileNamePatternCaption: "Facoltativo. Sostituisce il nome predefinito usando gli stessi token %y, %year, %mo, %month, %d, %h, %mi, %s e %app, più %# per un numero che si incrementa automaticamente (%## lo riempie a 2 cifre, %### a 3, e così via).",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "省略可。上のフォルダ内に %y、%year、%mo、%month、%d、%h、%mi、%s、%app を使って日付付きのサブフォルダを作成します。例: %y-%mo で 24-03。",
        fileNamePatternLabel: "ファイル名",
        fileNamePatternCaption: "省略可。%y、%year、%mo、%month、%d、%h、%mi、%s と同じトークンと %app に加え、自動的に増える番号として %# を使ってデフォルトの名前を上書きします（%## は2桁、%### は3桁に揃えます）。",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "선택 사항입니다. 위 폴더 안에 %y, %year, %mo, %month, %d, %h, %mi, %s, %app를 사용해 날짜별 하위 폴더를 만듭니다. 예: %y-%mo는 24-03이 됩니다.",
        fileNamePatternLabel: "파일 이름",
        fileNamePatternCaption: "선택 사항입니다. %y, %year, %mo, %month, %d, %h, %mi, %s, %app와 같은 토큰과, 자동으로 증가하는 번호를 위한 %#를 사용해 기본 이름을 대체합니다 (%##는 2자리, %###는 3자리로 채웁니다).",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "可选。使用 %y、%year、%mo、%month、%d、%h、%mi、%s 和 %app 在上方文件夹内创建按日期命名的子文件夹，例如 %y-%mo 表示 24-03。",
        fileNamePatternLabel: "文件名",
        fileNamePatternCaption: "可选。使用与 %y、%year、%mo、%month、%d、%h、%mi、%s 和 %app 相同的标记来覆盖默认名称，另外可用 %# 表示自动递增的编号（%## 补齐为 2 位，%### 为 3 位，以此类推）。",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "選填。使用 %y、%year、%mo、%month、%d、%h、%mi、%s 和 %app 在上方資料夾內建立含日期的子資料夾，例如 %y-%mo 代表 24-03。",
        fileNamePatternLabel: "檔案名稱",
        fileNamePatternCaption: "選填。使用與 %y、%year、%mo、%month、%d、%h、%mi、%s 和 %app 相同的標記來覆蓋預設名稱，另外可用 %# 表示自動遞增的編號（%## 補齊為 2 位，%### 為 3 位，以此類推）。",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        folderChoose: "選擇…",
        subfolderLabel: "子資料夾格式",
        subfolderCaption: "選填。使用 %y、%year、%mo、%month、%d、%h、%mi、%s 和 %app 喺上面資料夾入面建立帶日期嘅子資料夾，例如 %y-%mo 即係 24-03。",
        fileNamePatternLabel: "檔案名稱",
        fileNamePatternCaption: "選填。使用同一組 %y、%year、%mo、%month、%d、%h、%mi、%s 同 %app 標記嚟覆蓋預設名稱，另外可以用 %# 表示自動遞增嘅編號（%## 補齊做 2 位，%### 做 3 位，如此類推）。",
        fileNumberStartLabel: "起始編號",
        fileNumberResetButton: "重設",
        fileNumberNextFormat: "下一個：%d",
        delayLabel: "延遲",
