...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Capturing automatically. Choose Done where you want to stop.",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Rolando e capturando. Clique em Concluído onde quiser parar.",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Otomatik kaydırılıyor. İstediğiniz yerde Bitti'yi seçin.",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Идёт автоматическая прокрутка. Нажмите «Готово» в нужном месте.",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Desplazando y capturando. Pulsa Listo donde quieras parar.",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Automatischer Bildlauf. Wähle am gewünschten Ende Fertig.",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Défilement automatique. Choisissez Terminé à l'endroit voulu.",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Scorrimento automatico. Scegli Fatto nel punto in cui fermarti.",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "自動でスクロール中です。止めたい位置で「完了」を選んでください。",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "자동으로 스크롤 중입니다. 원하는 위치에서 완료를 누르세요.",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "正在自动滚动截图。到想停止的位置时请选择完成。",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "正在自動捲動截圖。到想停止的位置時請選擇完成。",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        scrollingCaptureButton: "捲動截圖",
        scrollingCaptureTitle: "捲動截圖",
        scrollingCaptureProgressHUD: "正在自動捲動截圖。到想停止嘅位置時請選擇完成。",
        scrollingCaptureHintOff: "按 S 切換捲動",
        scrollingCaptureHintOn: "捲動已開啟",
