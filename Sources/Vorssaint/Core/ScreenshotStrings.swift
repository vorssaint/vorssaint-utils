...
extension ScreenshotFeatureStrings {
    ...
    static let ar = ScreenshotFeatureStrings(
        pageTitle: "لقطة الشاشة",
        hubDescription: "يلتقط منطقة أو نافذة أو الشاشة ويضيف الشروح إليها",
        captureButton: "التقاط الآن",
        panelCaption: "التقط منطقة أو نافذة أو الشاشة بأكملها",
        fileNamePrefix: "لقطة شاشة",
        hintDrag: "اسحب لتحديد منطقة",
        hintClick: "انقر نافذة لالتقاطها",
        hintFullScreen: "Return يلتقط الشاشة بأكملها",
        hintCancel: "Esc للإلغاء",
        hintRepeat: "R يكرر آخر منطقة",
        freezeToggle: "تجميد الشاشة أثناء التحديد",
        freezeCaption: "تتوقف الصورة أثناء اختيارك للمنطقة، فلا يتحرك شيء أو يتغير خلال التحديد.",
        folderLabel: "الحفظ في",
        folderChoose: "اختيار…",
        subfolderLabel: "نمط المجلد الفرعي",
        subfolderCaption: "اختياري. ينشئ مجلدات فرعية مؤرخة داخل المجلد أعلاه باستخدام ‎%y‎ و‎%year‎ و‎%mo‎ و‎%month‎ و‎%d‎ و‎%h‎ و‎%mi‎ و‎%s‎، مثل ‎%y-%mo‎ لتصبح 24-03.",
        fileNamePatternLabel: "اسم الملف",
        fileNamePatternCaption: "اختياري. يتجاوز الاسم الافتراضي باستخدام الرموز نفسها ‎%y‎ و‎%year‎ و‎%mo‎ و‎%month‎ و‎%d‎ و‎%h‎ و‎%mi‎ و‎%s‎، إضافةً إلى ‎%#‎ لرقم تصاعدي تلقائي (‎%##‎ يملأ خانتين، و‎%###‎ ثلاث خانات، وهكذا).",
        fileNumberStartLabel: "يبدأ من",
        fileNumberResetButton: "إعادة تعيين",
        fileNumberNextFormat: "التالي: %d",
        delayLabel: "التأخير",
        delayOff: "متوقف",
        delaySecondsFormat: "%d ث",
        pointerToggle: "تضمين المؤشر",
        downscaleToggle: "الحفظ بحجم 1x",
        downscaleCaption: "تُحفظ لقطات Retina بنصف حجمها بالبكسل، مما ينتج ملفات أصغر.",
        editorTitle: "لقطة الشاشة",
        toolShortcutsTitle: "أدوات المحرر",
        toolShortcutsToggle: "استخدام اختصارات الأرقام",
        toolShortcutsCaption: "استخدم الأسهم أو اختر رقمًا. تستخدم الأدوات التسع الأولى الأرقام من 1 إلى 9. أما البقية فبلا اختصارات.",
        toolShortcutReserved: "هذا المفتاح يخص المحرر.",
        toolSelect: "تحديد",
        toolArrow: "سهم",
        arrowStyleLabel: "نمط السهم",
        arrowStyleFilled: "مصمت",
        arrowStyleOutline: "محدَّد",
        arrowStyleOpen: "مفتوح",
        arrowStyleDoubleEnded: "مزدوج الرأس",
        arrowStyleScribbly: "مخطوط",
        toolLine: "خط",
        toolRect: "مستطيل",
        toolEllipse: "بيضاوي",
        toolFreehand: "قلم",
        toolHighlight: "قلم تظليل",
        toolText: "نص",
        toolSticker: "ملصق",
        toolCounter: "رقم",
        toolPixelate: "تبقيع",
        toolRedact: "كتلة صمّاء",
        toolCrop: "اقتصاص",
        textPlaceholder: "نص",
        cropApply: "اقتصاص",
        cancel: "إلغاء",
        ...
        copyButton: "نسخ",
        saveButton: "حفظ",
        saveAsButton: "حفظ باسم…",
        pinButton: "تثبيت على الشاشة",
        copyTextButton: "نسخ النص",
        discardTitle: "تجاهل هذه اللقطة؟",
        discardMessage: "لم تُنسخ أو تُحفظ بعد.",
        discardConfirm: "تجاهل",
        copiedHUD: "تم نسخ اللقطة",
        savedHUDFormat: "تم الحفظ في %@",
        savedAndCopiedHUDFormat: "تم الحفظ في %@ والنسخ",
        defaultActionLabel: "الإجراء الافتراضي",
        defaultActionCaption: "يُنفَّذ تلقائيًا مباشرةً بعد الالتقاط. ويظل التأكيد يظهر، فتتمكن من التحرير أو التجاهل بعد ذلك.",
        defaultActionNone: "السؤال في كل مرة",
        defaultActionSaveAndCopy: "حفظ ونسخ",
        captureFailed: "تعذّر التقاط الشاشة",
        pinOpacity: "العتامة",
        pinClickThrough: "تجاهل النقرات",
        pinCloseAll: "إغلاق كل المثبّتات",
        backdropPaddingLabel: "الهامش",
        backdropWallpaperLabel: "صورة الخلفية",
        backdropImageButton: "صورة…",
        backdropSolidLabel: "لون صلب",
        backdropGradientLabel: "تدرج",
        backdropCornersLabel: "الزوايا",
        backdropSavePreset: "حفظ الخلفية",
        backdropDeletePreset: "إزالة",
        backdropCustomLabel: "مخصص",
        openEditorToggle: "فتح المحرر مباشرةً بعد الالتقاط",
        openEditorCaption: "تتخطى اللقطة المعاينة العائمة وتُفتح جاهزة للشرح.",
        autoCopyToggle: "النسخ إلى الحافظة تلقائيًا",
        autoCopyCaption: "تنتقل كل لقطة إلى الحافظة فور التقاطها، جاهزة للصق. ويبقى حفظ الملف خيارًا منفصلًا.",
        hintLoupe: "Z يبدّل العدسة المكبّرة",
        lastRegionToggle: "إظهار مخطط آخر لقطة",
        backdropBlurLabel: "التمويه",
        scrollingCaptureButton: "التقاط بالتمرير",
        scrollingCaptureTitle: "لقطة شاشة بالتمرير",
        scrollingCaptureProgressHUD: "مرّر بالماوس أو لوحة التتبع. اضغط Enter أو اختر “تم”.",
        scrollingCaptureHintOff: "S يبدّل التمرير",
        scrollingCaptureHintOn: "التمرير مفعّل",
        scrollingCaptureTooLongHUD: "توقف الالتقاط عند الحد الآمن",
        editLastCapture: "تحرير آخر لقطة شاشة",
        lastCaptureMissing: "التقط لقطة شاشة أولًا",
        fullScreenShortcutTitle: "التقاط الشاشة بأكملها",
        bringForward: "إحضار للأمام",
        sendBackward: "إرسال للخلف",
        shareSectionTitle: "الروابط المؤقتة",
        shareCaption: "اختر ساعة أو 6 أو 24 ساعة عند المشاركة. وتُحذف الصورة تلقائيًا.",
        shareButton: "مشاركة",
        shareOneHour: "لمدة ساعة",
        shareSixHours: "لمدة 6 ساعات",
        shareTwentyFourHours: "لمدة 24 ساعة",
        sharingHUD: "جارٍ إنشاء الرابط…",
        sharedHUD: "تم نسخ الرابط",
        shareFailedHUD: "تعذّر إنشاء الرابط",
        sharedLinksTitle: "الروابط المشتركة",
        sharedLinksEmpty: "لا توجد روابط نشطة",
        expiresLabel: "ينتهي",
        deleteLink: "الحذف الآن",
        linkDeletedHUD: "تم حذف الرابط",
        deleteFailedHUD: "تعذّر حذف الرابط",
        openLink: "فتح",
        copyLink: "نسخ الرابط",
        done: "تم",
        sharePrivacyButton: "الخصوصية",
        sharePrivacyTitle: "خصوصية الروابط المؤقتة",
        sharePrivacyData: "يرسل Vorssaint الصورة المعروضة ومدة الانتهاء التي تختارها فقط. ولا يرسل اسمك أو حسابك أو معرّف جهازك أو عنوان MAC. وعلى هذا الـ Mac، يحتفظ بالرابط ومدة انتهائه ورمز الحذف الخاص فقط ما دام الرابط نشطًا.",
        sharePrivacyStorage: "يعالج مزودو الشبكة والخدمة عنوان IP العام مؤقتًا لمنع إساءة الاستخدام. وتُحذف الصورة وبيانات رابطها نهائيًا عند حذفك للرابط أو انتهاء مدته. ولا تنشئ الخدمة نسخًا احتياطية للقطات.",
        sharePrivacyAccess: "يمكن لأي شخص لديه الرابط عرض الصورة أو تنزيلها أو حفظها أو إعادة نشرها. والروابط النشطة متاحة لمشغّل الخدمة لأغراض مراقبة إساءة الاستخدام. شارِكها مع من تثق بهم فقط.",
        scrollingCaptureCaption: "اختر منطقة، ومرّر بالماوس أو لوحة التتبع، ثم اضغط Enter أو “تم” لدمجها.",
        scrollingCaptureSelectionHint: "اسحب الجزء المتحرك من الصفحة فقط.",
        scrollingCapturePartialHUD: "تغيّرت الصفحة. وتم الاحتفاظ بالجزء المكتمل.",
        previewPositionLabel: "موضع المعاينة",
        previewPositionAutomatic: "تلقائي",
        previewPositionTopLeft: "أعلى اليسار",
        previewPositionTopRight: "أعلى اليمين",
        previewPositionBottomLeft: "أسفل اليسار",
        previewPositionBottomRight: "أسفل اليمين",
        previewFocusToggle: "تركيز المعاينة تلقائيًا",
        previewFocusCaption: "تعمل الاختصارات لحظة ظهور المعاينة، لكن لوحة المفاتيح تغادر التطبيق الذي كنت تستخدمه حتى تُغلق.",
        hideVorssaintWindowsToggle: "إخفاء نوافذ Vorssaint",
        shareEnabledToggle: "السماح بالروابط المؤقتة",
        editClipboardImage: "تحرير صورة الحافظة",
        clipboardImageMissing: "انسخ صورة أولًا",
        showCaptureMenuOnShortcut: "إظهار قائمة الالتقاط عند استخدام اختصار لوحة المفاتيح",
        screenCaptureTitle: "التقاط الشاشة",
        dragOutHandleLabel: "السحب والإفلات",
        loupeStartsOnToggle: "بدء التحديد والمكبّر مفعّل",
        loupeRememberZoomToggle: "تذكّر آخر تقريب للمكبّر",
        loupeDefaultZoomLabel: "التقريب الافتراضي للمكبّر",
        loupeWheelZoomLabel: "تقريب العجلة",
        loupeZoomFast: "سريع",
        loupeZoomStepped: "خطوة بخطوة",
        loupeZoomOptionCaption: "استمر بالضغط على ⌥ لاستخدام الوضع الآخر مؤقتًا.",
        watermarkLabel: "العلامة المائية",
        watermarkImageLabel: "صورة",
        watermarkTextPlaceholder: "نص العلامة المائية",
        watermarkPositionLabel: "الموضع",
        watermarkSizeLabel: "الحجم",
        watermarkOpacityLabel: "العتامة",
        watermarkRotationLabel: "الدوران",
        watermarkSavePreset: "حفظ العلامة المائية",
        watermarkColorRed: "أحمر",
        watermarkColorOrange: "برتقالي",
        watermarkColorYellow: "أصفر",
        watermarkColorGreen: "أخضر",
        watermarkColorBlue: "أزرق",
        watermarkColorPurple: "بنفسجي",
        watermarkColorBlack: "أسود",
        watermarkColorWhite: "أبيض",
        watermarkPositionTopLeading: "أعلى اليسار",
        watermarkPositionTop: "أعلى الوسط",
        watermarkPositionTopTrailing: "أعلى اليمين",
        watermarkPositionLeading: "وسط اليسار",
        watermarkPositionCenter: "الوسط",
        watermarkPositionTrailing: "وسط اليمين",
        watermarkPositionBottomLeading: "أسفل اليسار",
        watermarkPositionBottom: "أسفل الوسط",
        watermarkPositionBottomTrailing: "أسفل اليمين")
}
