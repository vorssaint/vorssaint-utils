...
struct ScreenshotFeatureStrings {
    ...
    let toolShortcutsModeOff: String
    let toolShortcutsModeNumber: String
    let toolShortcutsModeLetter: String
...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "No shortcuts",
        toolShortcutsModeNumber: "Number shortcuts",
        toolShortcutsModeLetter: "Letter shortcuts",
        toolShortcutsCaption: "Number shortcuts follow the list order below (1 to 9). Letter shortcuts use a fixed key per tool, shown next to it.",
        toolSelect: "Select",
        toolArrow: "Arrow",
        toolLine: "Line",
        toolRect: "Rectangle",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "Sem atalhos",
        toolShortcutsModeNumber: "Atalhos numéricos",
        toolShortcutsModeLetter: "Atalhos de letras",
        toolShortcutsCaption: "Os atalhos numéricos seguem a ordem da lista abaixo (1 a 9). Os atalhos de letras usam uma tecla fixa para cada ferramenta, mostrada ao lado dela.",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "Kısayol yok",
        toolShortcutsModeNumber: "Sayı kısayolları",
        toolShortcutsModeLetter: "Harf kısayolları",
        toolShortcutsCaption: "Sayı kısayolları aşağıdaki liste sırasını izler (1’den 9’a). Harf kısayolları her araç için sabit bir tuş kullanır ve aracın yanında gösterilir.",
        toolSelect: "Seç",
        toolArrow: "Ok",
        toolLine: "Çizgi",
        toolRect: "Dikdörtgen",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "Без сочетаний",
        toolShortcutsModeNumber: "Цифровые сочетания",
        toolShortcutsModeLetter: "Буквенные сочетания",
        toolShortcutsCaption: "Цифровые сочетания следуют порядку списка ниже (от 1 до 9). Буквенные сочетания используют фиксированную клавишу для каждого инструмента, показанную рядом с ним.",
        toolSelect: "Выбор",
        toolArrow: "Стрелка",
        toolLine: "Линия",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "Sin atajos",
        toolShortcutsModeNumber: "Atajos numéricos",
        toolShortcutsModeLetter: "Atajos de letras",
        toolShortcutsCaption: "Los atajos numéricos siguen el orden de la lista de abajo (1 a 9). Los atajos de letras usan una tecla fija para cada herramienta, mostrada junto a ella.",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "Keine Kurzbefehle",
        toolShortcutsModeNumber: "Zifferntasten",
        toolShortcutsModeLetter: "Buchstabentasten",
        toolShortcutsCaption: "Zifferntasten folgen der Reihenfolge der Liste unten (1 bis 9). Buchstabentasten verwenden für jedes Werkzeug eine feste Taste, die daneben angezeigt wird.",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "Aucun raccourci",
        toolShortcutsModeNumber: "Raccourcis numériques",
        toolShortcutsModeLetter: "Raccourcis alphabétiques",
        toolShortcutsCaption: "Les raccourcis numériques suivent l’ordre de la liste ci-dessous (1 à 9). Les raccourcis alphabétiques utilisent une touche fixe par outil, affichée à côté de celui-ci.",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "Nessuna scorciatoia",
        toolShortcutsModeNumber: "Scorciatoie numeriche",
        toolShortcutsModeLetter: "Scorciatoie con lettere",
        toolShortcutsCaption: "Le scorciatoie numeriche seguono l’ordine dell’elenco qui sotto (da 1 a 9). Le scorciatoie con lettere usano un tasto fisso per ogni strumento, mostrato accanto ad esso.",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "ショートカットなし",
        toolShortcutsModeNumber: "数字ショートカット",
        toolShortcutsModeLetter: "文字ショートカット",
        toolShortcutsCaption: "数字ショートカットは下のリストの順序（1から9）に従います。文字ショートカットは各ツールに固定のキーを使用し、ツールの横に表示されます。",
        toolSelect: "選択",
        toolArrow: "矢印",
        toolLine: "直線",
        toolRect: "長方形",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "단축키 없음",
        toolShortcutsModeNumber: "숫자 단축키",
        toolShortcutsModeLetter: "문자 단축키",
        toolShortcutsCaption: "숫자 단축키는 아래 목록 순서(1~9)를 따릅니다. 문자 단축키는 각 도구에 고정된 키를 사용하며 도구 옆에 표시됩니다.",
        toolSelect: "선택",
        toolArrow: "화살표",
        toolLine: "직선",
        toolRect: "사각형",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "无快捷键",
        toolShortcutsModeNumber: "数字快捷键",
        toolShortcutsModeLetter: "字母快捷键",
        toolShortcutsCaption: "数字快捷键遵循下方列表的顺序（1 到 9）。字母快捷键为每个工具使用固定按键，并显示在工具旁边。",
        toolSelect: "选择",
        toolArrow: "箭头",
        toolLine: "直线",
        toolRect: "矩形",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeOff: "無快速鍵",
        toolShortcutsModeNumber: "數字快速鍵",
        toolShortcutsModeLetter: "字母快速鍵",
        toolShortcutsCaption: "數字快速鍵依照下方列表順序（1 到 9）。字母快速鍵為每個工具使用固定按鍵，並顯示在工具旁邊。",
        toolSelect: "選取",
        toolArrow: "箭頭",
        toolLine: "直線",
        toolRect: "矩形",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        toolShortcutsModeNumber: "數字快速鍵",
        toolShortcutsModeLetter: "字母快速鍵",
        toolShortcutsCaption: "數字快速鍵跟住下面清單嘅次序（1 到 9）。字母快速鍵為每個工具用固定按鍵，並顯示喺工具旁邊。",
        toolSelect: "選取",
        toolArrow: "箭嘴",
        toolLine: "直線",
        toolRect: "矩形",
