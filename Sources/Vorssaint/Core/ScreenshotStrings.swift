...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Drag or use the arrows to reorder; choose a number to assign a shortcut. Uncheck tools to hide them without renumbering the others. Select stays visible. Only the first nine slots use 1 to 9.",
        toolSelect: "Select",
        toolArrow: "Arrow",
        toolLine: "Line",
        toolRect: "Rectangle",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Arraste ou use as setas para reordenar; escolha um número para atribuir um atalho. Desmarque ferramentas para ocultá-las sem renumerar as outras. Selecionar fica visível. Só as nove primeiras posições usam 1 a 9.",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Sıralamak için sürükleyin veya okları kullanın; kısayol atamak için bir sayı seçin. Araçları gizlemek için işaretlerini kaldırın; diğerlerinin numarası değişmez. Seçim görünür kalır. Yalnızca ilk dokuz konum 1 ile 9 tuşlarını kullanır.",
        toolSelect: "Seç",
        toolArrow: "Ok",
        toolLine: "Çizgi",
        toolRect: "Dikdörtgen",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Перетаскивайте или используйте стрелки для сортировки; выберите цифру для сочетания. Снимите флажок, чтобы скрыть инструмент, не меняя номера остальных. Выбор остаётся видимым. Только первые девять позиций используют цифры от 1 до 9.",
        toolSelect: "Выбор",
        toolArrow: "Стрелка",
        toolLine: "Линия",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Arrastra o usa las flechas para reordenar; elige un número para asignar un atajo. Desmarca herramientas para ocultarlas sin renumerar las demás. Seleccionar sigue visible. Solo las primeras nueve posiciones usan del 1 al 9.",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Zum Sortieren ziehen oder die Pfeile nutzen; für einen Kurzbefehl eine Ziffer wählen. Werkzeuge abwählen, um sie auszublenden, ohne die anderen neu zu nummerieren. Auswahl bleibt sichtbar. Nur die ersten neun Plätze verwenden 1 bis 9.",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Faites glisser ou utilisez les flèches pour réorganiser ; choisissez un numéro pour un raccourci. Décochez les outils pour les masquer sans renuméroter les autres. Sélection reste visible. Seules les neuf premières positions utilisent 1 à 9.",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "Trascina o usa le frecce per riordinare; scegli un numero per assegnare una scorciatoia. Deseleziona gli strumenti per nasconderli senza rinumerare gli altri. Selezione resta visibile. Solo le prime nove posizioni usano da 1 a 9.",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "ドラッグまたは矢印で並べ替え、数字を選んでショートカットを割り当てます。チェックを外すと、他のツールの番号を変えずに非表示にできます。選択ツールは常に表示されます。1〜9キーを使うのは最初の9枠のみです。",
        toolSelect: "選択",
        toolArrow: "矢印",
        toolLine: "直線",
        toolRect: "長方形",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "드래그하거나 화살표로 순서를 바꾸고 숫자를 골라 단축키를 지정하세요. 체크를 해제하면 다른 도구의 번호를 바꾸지 않고 숨길 수 있습니다. 선택 도구는 항상 표시됩니다. 처음 9개 자리만 1부터 9를 사용합니다.",
        toolSelect: "선택",
        toolArrow: "화살표",
        toolLine: "직선",
        toolRect: "사각형",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "拖动或使用箭头调整顺序，选择数字分配快捷键。取消勾选可隐藏工具，其他工具的编号不变。选择工具始终显示。只有前九个位置使用 1 到 9。",
        toolSelect: "选择",
        toolArrow: "箭头",
        toolLine: "直线",
        toolRect: "矩形",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        toolShortcutsCaption: "拖曳或使用箭頭調整順序，選擇數字指定快速鍵。取消勾選可隱藏工具，其他工具的編號不變。選取工具一律顯示。只有前九個位置使用 1 到 9。",
        toolSelect: "選取",
        toolArrow: "箭頭",
        toolLine: "直線",
        toolRect: "矩形",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        toolShortcutsTitle: "編輯工具",
        toolShortcutsToggle: "使用數字快速鍵",
        toolShortcutsCaption: "拖移或使用箭嘴調整次序，選擇數字指定快速鍵。取消勾選可隱藏工具，其他工具的編號不變。選取工具一律顯示。只有前九個位置使用 1 到 9。",
        toolSelect: "選取",
        toolArrow: "箭嘴",
        toolLine: "直線",
        toolRect: "矩形",
