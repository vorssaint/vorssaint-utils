...
struct ScreenshotFeatureStrings {
    ...
    let autoSaveCaption: String
    let previewToggle: String
    let autoSaveToggle: String
...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Press Escape to close the preview.",
        autoSaveCaption: "Saves each screenshot automatically to the location selected below.",
        previewToggle: "Show screenshot preview",
        autoSaveToggle: "Save screenshots automatically",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Pressione Escape para fechar a prévia.",
        autoSaveCaption: "Salva cada captura automaticamente no local selecionado abaixo.",
        previewToggle: "Mostrar prévia da captura",
        autoSaveToggle: "Salvar capturas automaticamente",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Önizlemeyi kapatmak için Escape tuşuna basın.",
        autoSaveCaption: "Her ekran görüntüsünü aşağıda seçilen konuma otomatik olarak kaydeder.",
        previewToggle: "Ekran görüntüsü önizlemesini göster",
        autoSaveToggle: "Ekran görüntülerini otomatik kaydet",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Нажмите Escape, чтобы закрыть предпросмотр.",
        autoSaveCaption: "Автоматически сохраняет каждый снимок в выбранную ниже папку.",
        previewToggle: "Показывать предпросмотр снимка",
        autoSaveToggle: "Автоматически сохранять снимки",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Pulsa Escape para cerrar la vista previa.",
        autoSaveCaption: "Guarda automáticamente cada captura en la ubicación seleccionada abajo.",
        previewToggle: "Mostrar vista previa de capturas",
        autoSaveToggle: "Guardar capturas automáticamente",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Drücke Escape, um die Vorschau zu schließen.",
        autoSaveCaption: "Speichert jeden Screenshot automatisch am unten ausgewählten Speicherort.",
        previewToggle: "Screenshot-Vorschau anzeigen",
        autoSaveToggle: "Screenshots automatisch speichern",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Appuyez sur Échap pour fermer l’aperçu.",
        autoSaveCaption: "Enregistre automatiquement chaque capture à l’emplacement sélectionné ci-dessous.",
        previewToggle: "Afficher l’aperçu de la capture",
        autoSaveToggle: "Enregistrer les captures automatiquement",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Premi Esc per chiudere l’anteprima.",
        autoSaveCaption: "Salva automaticamente ogni screenshot nella posizione selezionata qui sotto.",
        previewToggle: "Mostra anteprima dello screenshot",
        autoSaveToggle: "Salva automaticamente gli screenshot",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escapeキーを押すとプレビューを閉じます。",
        autoSaveCaption: "各スクリーンショットを下で選択した保存先に自動保存します。",
        previewToggle: "スクリーンショットのプレビューを表示",
        autoSaveToggle: "スクリーンショットを自動保存",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape 키를 눌러 미리보기를 닫습니다.",
        autoSaveCaption: "각 스크린샷을 아래에서 선택한 위치에 자동으로 저장합니다.",
        previewToggle: "스크린샷 미리보기 표시",
        autoSaveToggle: "스크린샷 자동 저장",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "按 Escape 键关闭预览。",
        autoSaveCaption: "将每张截屏自动保存到下方选择的位置。",
        previewToggle: "显示截屏预览",
        autoSaveToggle: "自动保存截屏",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "按 Escape 鍵關閉預覽。",
        autoSaveCaption: "將每張截圖自動儲存到下方選擇的位置。",
        previewToggle: "顯示截圖預覽",
        autoSaveToggle: "自動儲存截圖",
