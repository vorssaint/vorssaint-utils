...
extension ScreenshotFeatureStrings {
    ...
    static let nl = ScreenshotFeatureStrings(
        pageTitle: "Schermafbeelding",
        hubDescription: "Legt een gebied, venster of scherm vast en voorziet het van aantekeningen",
        captureButton: "Nu vastleggen",
        panelCaption: "Leg een gebied, venster of het hele scherm vast",
        fileNamePrefix: "Schermafbeelding",
        hintDrag: "Sleep om een gebied te selecteren",
        hintClick: "Klik op een venster om het vast te leggen",
        hintFullScreen: "Return legt het hele scherm vast",
        hintCancel: "Esc annuleert",
        hintRepeat: "R herhaalt het laatste gebied",
        freezeToggle: "Scherm bevriezen tijdens het selecteren",
        freezeCaption: "Het beeld stopt terwijl je het gebied kiest, zodat er tijdens het selecteren niets beweegt of verandert.",
        folderLabel: "Bewaren in",
        folderChoose: "Kies…",
        subfolderLabel: "Submappatroon",
        subfolderCaption: "Optioneel. Maakt submappen met datum aan in de map hierboven met %y, %year, %mo, %month, %d, %h, %mi en %s, bijvoorbeeld %y-%mo voor 24-03.",
        fileNamePatternLabel: "Bestandsnaam",
        fileNamePatternCaption: "Optioneel. Overschrijft de standaardnaam met dezelfde tokens %y, %year, %mo, %month, %d, %h, %mi en %s, plus %# voor een automatisch oplopend nummer (%## vult aan tot 2 cijfers, %### tot 3, enzovoort).",
        fileNumberStartLabel: "Begint bij",
        fileNumberResetButton: "Herstellen",
        fileNumberNextFormat: "Volgende: %d",
        delayLabel: "Vertraging",
        delayOff: "Uit",
        delaySecondsFormat: "%d s",
        pointerToggle: "Aanwijzer opnemen",
        downscaleToggle: "Bewaren op 1x-grootte",
        downscaleCaption: "Retina-opnames worden bewaard op de helft van hun pixelgrootte, wat kleinere bestanden oplevert.",
        editorTitle: "Schermafbeelding",
        toolShortcutsTitle: "Editorhulpmiddelen",
        toolShortcutsToggle: "Cijfersneltoetsen gebruiken",
        toolShortcutsCaption: "Gebruik de pijltjes of kies een cijfer. De eerste negen hulpmiddelen gebruiken 1 tot en met 9. De overige hebben geen sneltoets.",
        ...
        toolEllipse: "Ellips",
        toolFreehand: "Pen",
        toolHighlight: "Markeerstift",
        toolText: "Tekst",
        toolSticker: "Sticker",
        toolCounter: "Nummer",
        toolPixelate: "Pixeleren",
        toolRedact: "Effen blok",
        toolCrop: "Bijsnijden",
        textPlaceholder: "Tekst",
        cropApply: "Bijsnijden",
        cancel: "Annuleren",
        colorLabel: "Kleur",
        strokeLabel: "Dikte",
        shadowLabel: "Schaduwen",
        backdropLabel: "Achtergrond",
        backdropNone: "Geen",
        editButton: "Bewerken",
        copyButton: "Kopiëren",
        saveButton: "Bewaren",
        saveAsButton: "Bewaren als…",
        pinButton: "Op het scherm vastzetten",
        copyTextButton: "Tekst kopiëren",
        discardTitle: "Deze schermafbeelding weggooien?",
        discardMessage: "Deze is nog niet gekopieerd of bewaard.",
        discardConfirm: "Weggooien",
        copiedHUD: "Schermafbeelding gekopieerd",
        savedHUDFormat: "Bewaard in %@",
        savedAndCopiedHUDFormat: "Bewaard in %@ en gekopieerd",
        defaultActionLabel: "Standaardactie",
        defaultActionCaption: "Wordt automatisch uitgevoerd meteen na het vastleggen. De bevestiging verschijnt nog steeds, zodat je daarna nog kunt bewerken of weggooien.",
        defaultActionNone: "Elke keer vragen",
        defaultActionSaveAndCopy: "Bewaren en kopiëren",
        captureFailed: "Het scherm kon niet worden vastgelegd",
        pinOpacity: "Dekking",
        pinClickThrough: "Klikken negeren",
        pinCloseAll: "Alle vastgezette vensters sluiten",
        backdropPaddingLabel: "Marge",
        backdropWallpaperLabel: "Bureaubladachtergrond",
        backdropImageButton: "Afbeelding…",
        backdropSolidLabel: "Effen",
        backdropGradientLabel: "Verloop",
        backdropCornersLabel: "Hoeken",
        backdropSavePreset: "Achtergrond bewaren",
        backdropDeletePreset: "Verwijderen",
        backdropCustomLabel: "Aangepast",
        openEditorToggle: "Editor meteen na het vastleggen openen",
        openEditorCaption: "De opname slaat de zwevende voorvertoning over en opent direct klaar om er aantekeningen op te maken.",
        autoCopyToggle: "Automatisch naar het klembord kopiëren",
        ...
        scrollingCaptureProgressHUD: "Scroll met je muis of trackpad. Druk op Enter of kies Gereed.",
        scrollingCaptureHintOff: "S schakelt scrollen om",
        scrollingCaptureHintOn: "Scrollen aan",
        scrollingCaptureTooLongHUD: "Opname gestopt bij de veilige limiet",
        editLastCapture: "Laatste schermafbeelding bewerken",
        lastCaptureMissing: "Maak eerst een schermafbeelding",
        fullScreenShortcutTitle: "Het hele scherm vastleggen",
        bringForward: "Naar voren brengen",
        sendBackward: "Naar achteren sturen",
        shareSectionTitle: "Tijdelijke links",
        shareCaption: "Kies 1, 6 of 24 uur bij het delen. De afbeelding wordt automatisch verwijderd.",
        shareButton: "Delen",
        shareOneHour: "Voor 1 uur",
        shareSixHours: "Voor 6 uur",
        shareTwentyFourHours: "Voor 24 uur",
        sharingHUD: "Link maken…",
        sharedHUD: "Link gekopieerd",
        shareFailedHUD: "De link kon niet worden gemaakt",
        sharedLinksTitle: "Gedeelde links",
        sharedLinksEmpty: "Geen actieve links",
        expiresLabel: "Verloopt",
        deleteLink: "Nu verwijderen",
        linkDeletedHUD: "Link verwijderd",
        deleteFailedHUD: "De link kon niet worden verwijderd",
        openLink: "Openen",
        copyLink: "Link kopiëren",
        done: "Gereed",
        sharePrivacyButton: "Privacy",
        sharePrivacyTitle: "Privacy voor tijdelijke links",
        sharePrivacyData: "Vorssaint verstuurt alleen de weergegeven afbeelding en de vervaltijd die je kiest. Het verstuurt niet je naam, account, apparaat-ID of MAC-adres. Op deze Mac bewaart het alleen de link, de vervaltijd en het privé-verwijdertoken zolang de link actief is.",
        sharePrivacyStorage: "Netwerkproviders en de dienst verwerken tijdelijk je publieke IP-adres om misbruik te voorkomen. De afbeelding en de bijbehorende linkmetadata worden definitief verwijderd zodra je de link verwijdert of de tijd verstrijkt. De dienst maakt geen back-ups van schermafbeeldingen.",
        sharePrivacyAccess: "Iedereen met de link kan de afbeelding bekijken, downloaden, bewaren of verder verspreiden. Actieve links zijn beschikbaar voor de beheerder van de dienst voor het modereren van misbruik. Deel ze alleen met mensen die je vertrouwt.",
        scrollingCaptureCaption: "Kies een gebied, scroll met je muis of trackpad en druk daarna op Enter of Gereed om het samen te voegen.",
        scrollingCaptureSelectionHint: "Sleep alleen het deel van de pagina dat beweegt.",
        scrollingCapturePartialHUD: "De pagina is veranderd. Het voltooide deel is bewaard.",
        previewPositionLabel: "Voorvertoningspositie",
        previewPositionAutomatic: "Automatisch",
        previewPositionTopLeft: "Linksboven",
        previewPositionTopRight: "Rechtsboven",
        previewPositionBottomLeft: "Linksonder",
        previewPositionBottomRight: "Rechtsonder",
        hideVorssaintWindowsToggle: "Vorssaint-vensters verbergen",
        shareEnabledToggle: "Tijdelijke links toestaan",
