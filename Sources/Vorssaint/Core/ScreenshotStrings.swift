...
extension ScreenshotFeatureStrings {
    ...
    static let he = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "השתמש בקיצורי מספרים",
        toolShortcutsCaption: "השתמש בחצים או בחר מספר. תשעת הכלים הראשונים משתמשים ב-1 עד 9. לשאר אין קיצור.",
        toolSelect: "בחירה",
        toolArrow: "חץ",
        toolLine: "קו",
        toolRect: "מלבן",
        ...
        scrollingCaptureProgressHUD: "גלול עם העכבר או ה-trackpad. לחץ Enter או בחר סיום.",
        ...
        scrollingCaptureCaption: "בחר אזור, גלול עם העכבר או ה-trackpad, ואז לחץ Enter או סיום לחיבור.",
