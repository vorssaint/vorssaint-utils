...
extension ScreenshotFeatureStrings {
    ...
    static let uk = ScreenshotFeatureStrings(
        ...
        scrollingCaptureProgressHUD: "Прокручуйте мишею або трекпадом. Натисніть Enter або оберіть «Готово».",
        ...
        scrollingCaptureCaption: "Виберіть область, прокрутіть мишею або трекпадом, потім натисніть Enter або «Готово», щоб об’єднати фрагменти в один знімок.",
