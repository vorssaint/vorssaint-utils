...
extension ScreenshotFeatureStrings {
    ...
    static let vi = ScreenshotFeatureStrings(
        pageTitle: "Ảnh chụp màn hình",
        hubDescription: "Chụp một vùng, cửa sổ hoặc màn hình và cho phép chú thích",
        captureButton: "Chụp ngay",
        panelCaption: "Chụp một vùng, một cửa sổ hoặc toàn bộ màn hình",
        fileNamePrefix: "Ảnh chụp màn hình",
        hintDrag: "Kéo để chọn một vùng",
        hintClick: "Nhấp vào cửa sổ để chụp",
        hintFullScreen: "Return chụp toàn bộ màn hình",
        hintCancel: "Esc để hủy",
        hintRepeat: "R lặp lại vùng vừa chọn",
        freezeToggle: "Đóng băng màn hình khi chọn",
        freezeCaption: "Hình ảnh sẽ dừng lại trong khi chọn vùng, nên không có gì di chuyển hay thay đổi trong lúc chọn.",
        folderLabel: "Lưu vào",
        folderChoose: "Chọn…",
        subfolderLabel: "Mẫu thư mục con",
        subfolderCaption: "Tùy chọn. Tạo thư mục con theo ngày bên trong thư mục ở trên bằng %y, %year, %mo, %month, %d, %h, %mi và %s, ví dụ %y-%mo cho ra 24-03.",
        fileNamePatternLabel: "Tên tệp",
        fileNamePatternCaption: "Tùy chọn. Ghi đè tên mặc định bằng các mã %y, %year, %mo, %month, %d, %h, %mi và %s tương tự, cùng với %# cho số tự động tăng (%## đệm thành 2 chữ số, %### thành 3, và cứ thế).",
        fileNumberStartLabel: "Bắt đầu từ",
        fileNumberResetButton: "Đặt lại",
        fileNumberNextFormat: "Tiếp theo: %d",
        delayLabel: "Trễ",
        delayOff: "Tắt",
        delaySecondsFormat: "%d giây",
        pointerToggle: "Bao gồm con trỏ",
        downscaleToggle: "Lưu ở kích thước 1x",
        downscaleCaption: "Ảnh chụp Retina được lưu với một nửa số pixel, giúp tệp nhỏ hơn.",
        editorTitle: "Ảnh chụp màn hình",
        toolShortcutsTitle: "Công cụ trình chỉnh sửa",
        toolShortcutsToggle: "Dùng phím tắt số",
        toolShortcutsCaption: "Dùng phím mũi tên hoặc chọn một số. Chín công cụ đầu dùng phím 1 đến 9. Các công cụ còn lại không có phím tắt.",
        toolShortcutReserved: "Phím này đã được trình chỉnh sửa sử dụng.",
        toolSelect: "Chọn",
        toolArrow: "Mũi tên",
        ...
        toolFreehand: "Bút vẽ",
        toolHighlight: "Bút đánh dấu",
        toolText: "Văn bản",
        toolSticker: "Nhãn dán",
        toolCounter: "Số thứ tự",
        toolPixelate: "Làm mờ pixel",
        toolRedact: "Khối che đặc",
        toolCrop: "Cắt",
        textPlaceholder: "Văn bản",
        cropApply: "Cắt",
        cancel: "Hủy",
        colorLabel: "Màu",
        strokeLabel: "Độ dày",
        shadowLabel: "Đổ bóng",
        backdropLabel: "Nền",
        backdropNone: "Không có",
        editButton: "Chỉnh sửa",
        copyButton: "Sao chép",
        saveButton: "Lưu",
        saveAsButton: "Lưu dưới dạng…",
        pinButton: "Ghim lên màn hình",
        copyTextButton: "Sao chép văn bản",
        discardTitle: "Bỏ ảnh chụp màn hình này?",
        discardMessage: "Ảnh chưa được sao chép hoặc lưu.",
        discardConfirm: "Bỏ",
        copiedHUD: "Đã sao chép ảnh chụp màn hình",
        savedHUDFormat: "Đã lưu vào %@",
        savedAndCopiedHUDFormat: "Đã lưu vào %@ và sao chép",
        defaultActionLabel: "Hành động mặc định",
        defaultActionCaption: "Tự động chạy ngay sau khi chụp. Màn hình xác nhận vẫn hiện ra, nên vẫn có thể Chỉnh sửa hoặc bỏ sau đó.",
        defaultActionNone: "Hỏi mỗi lần",
        defaultActionSaveAndCopy: "Lưu và Sao chép",
        captureFailed: "Không thể chụp màn hình",
        pinOpacity: "Độ mờ đục",
        pinClickThrough: "Bỏ qua thao tác nhấp",
        pinCloseAll: "Đóng tất cả ảnh đã ghim",
        backdropPaddingLabel: "Lề",
        backdropWallpaperLabel: "Hình nền",
        backdropImageButton: "Hình ảnh…",
        backdropSolidLabel: "Màu đặc",
        backdropGradientLabel: "Chuyển sắc",
        backdropCornersLabel: "Góc",
        backdropSavePreset: "Lưu nền",
        backdropDeletePreset: "Xóa",
        backdropCustomLabel: "Tùy chỉnh",
        openEditorToggle: "Mở trình chỉnh sửa ngay sau khi chụp",
        openEditorCaption: "Ảnh chụp bỏ qua bản xem trước nổi và mở ra sẵn sàng để chú thích.",
        autoCopyToggle: "Tự động sao chép vào bộ nhớ tạm",
        autoCopyCaption: "Mỗi ảnh chụp được đưa vào bộ nhớ tạm ngay khi chụp, sẵn sàng để dán. Việc lưu tệp vẫn là một lựa chọn riêng.",
        hintLoupe: "Z bật/tắt kính lúp",
        lastRegionToggle: "Hiện viền vùng chụp gần nhất",
        backdropBlurLabel: "Làm mờ",
        scrollingCaptureButton: "Chụp cuộn",
        scrollingCaptureTitle: "Ảnh chụp màn hình cuộn",
        scrollingCaptureProgressHUD: "Cuộn bằng chuột hoặc trackpad. Nhấn Enter hoặc chọn Xong.",
        scrollingCaptureHintOff: "S bật/tắt cuộn",
        scrollingCaptureHintOn: "Đang cuộn",
        scrollingCaptureTooLongHUD: "Đã dừng chụp ở giới hạn an toàn",
        editLastCapture: "Chỉnh sửa ảnh chụp gần nhất",
        lastCaptureMissing: "Hãy chụp màn hình trước",
        fullScreenShortcutTitle: "Chụp toàn bộ màn hình",
        bringForward: "Đưa lên trên",
        sendBackward: "Đưa xuống dưới",
        shareSectionTitle: "Liên kết tạm thời",
        shareCaption: "Chọn 1, 6 hoặc 24 giờ khi chia sẻ. Hình ảnh sẽ tự động bị xóa.",
        shareButton: "Chia sẻ",
        shareOneHour: "Trong 1 giờ",
        shareSixHours: "Trong 6 giờ",
        shareTwentyFourHours: "Trong 24 giờ",
        sharingHUD: "Đang tạo liên kết…",
        sharedHUD: "Đã sao chép liên kết",
        shareFailedHUD: "Không thể tạo liên kết",
        sharedLinksTitle: "Liên kết đã chia sẻ",
        sharedLinksEmpty: "Không có liên kết nào đang hoạt động",
        expiresLabel: "Hết hạn",
        deleteLink: "Xóa ngay",
        linkDeletedHUD: "Đã xóa liên kết",
        deleteFailedHUD: "Không thể xóa liên kết",
        openLink: "Mở",
        copyLink: "Sao chép liên kết",
        done: "Xong",
        sharePrivacyButton: "Quyền riêng tư",
        sharePrivacyTitle: "Quyền riêng tư của liên kết tạm thời",
        sharePrivacyData: "Vorssaint chỉ gửi hình ảnh đã dựng và thời hạn đã chọn. Vorssaint không gửi tên, tài khoản, mã định danh thiết bị hay địa chỉ MAC. Trên Mac này, chỉ liên kết, thời hạn và mã xóa riêng tư được lưu lại trong khi liên kết còn hoạt động.",
        sharePrivacyStorage: "Các nhà cung cấp mạng và dịch vụ xử lý tạm thời địa chỉ IP công khai để ngăn chặn lạm dụng. Hình ảnh và siêu dữ liệu liên kết sẽ bị xóa vĩnh viễn khi liên kết bị xóa hoặc hết hạn. Dịch vụ không tạo bản sao lưu ảnh chụp màn hình.",
        sharePrivacyAccess: "Bất kỳ ai có liên kết đều có thể xem, tải xuống, lưu hoặc phát tán lại hình ảnh. Các liên kết đang hoạt động có thể được nhà điều hành dịch vụ xem để kiểm duyệt lạm dụng. Chỉ chia sẻ với những người đáng tin cậy.",
        scrollingCaptureCaption: "Chọn một vùng, cuộn bằng chuột hoặc trackpad, rồi nhấn Enter hoặc Xong để ghép lại.",
        scrollingCaptureSelectionHint: "Chỉ kéo chọn phần trang có thể cuộn.",
        scrollingCapturePartialHUD: "Trang đã thay đổi. Phần đã hoàn thành được giữ lại.",
        previewPositionLabel: "Vị trí xem trước",
        previewPositionAutomatic: "Tự động",
        previewPositionTopLeft: "Trên bên trái",
        previewPositionTopRight: "Trên bên phải",
        previewPositionBottomLeft: "Dưới bên trái",
        previewPositionBottomRight: "Dưới bên phải",
        previewFocusToggle: "Tự động đưa tiêu điểm vào bản xem trước",
        previewFocusCaption: "Phím tắt hoạt động ngay khi bản xem trước xuất hiện, nhưng bàn phím sẽ rời khỏi ứng dụng bạn đang dùng cho đến khi nó đóng lại.",
        hideVorssaintWindowsToggle: "Ẩn cửa sổ Vorssaint",
        shareEnabledToggle: "Cho phép liên kết tạm thời",
        editClipboardImage: "Chỉnh sửa hình ảnh trong bộ nhớ tạm",
        clipboardImageMissing: "Hãy sao chép một hình ảnh trước",
        showCaptureMenuOnShortcut: "Hiển thị menu chụp khi dùng phím tắt bàn phím",
        screenCaptureTitle: "Chụp màn hình",
        dragOutHandleLabel: "Kéo và thả",
        loupeStartsOnToggle: "Bắt đầu chọn vùng với kính lúp đang bật",
        loupeRememberZoomToggle: "Ghi nhớ mức thu phóng gần nhất của kính lúp",
        loupeDefaultZoomLabel: "Mức thu phóng mặc định của kính lúp",
        loupeWheelZoomLabel: "Thu phóng bằng con lăn chuột",
        loupeZoomFast: "Nhanh",
        loupeZoomStepped: "Từng bước",
        loupeZoomOptionCaption: "Giữ ⌥ để tạm thời dùng chế độ còn lại.",
        watermarkLabel: "Hình mờ",
        watermarkImageLabel: "Hình ảnh",
        watermarkTextPlaceholder: "Văn bản hình mờ",
        watermarkPositionLabel: "Vị trí",
        watermarkSizeLabel: "Kích thước",
        watermarkOpacityLabel: "Độ mờ",
        watermarkRotationLabel: "Xoay",
        watermarkSavePreset: "Lưu hình mờ",
        watermarkColorRed: "Đỏ",
        watermarkColorOrange: "Cam",
        watermarkColorYellow: "Vàng",
        watermarkColorGreen: "Xanh lá",
        watermarkColorBlue: "Xanh dương",
        watermarkColorPurple: "Tím",
        watermarkColorBlack: "Đen",
        watermarkColorWhite: "Trắng",
        watermarkPositionTopLeading: "Trên bên trái",
        watermarkPositionTop: "Trên giữa",
        watermarkPositionTopTrailing: "Trên bên phải",
        watermarkPositionLeading: "Giữa bên trái",
        watermarkPositionCenter: "Giữa",
        watermarkPositionTrailing: "Giữa bên phải",
        watermarkPositionBottomLeading: "Dưới bên trái",
        watermarkPositionBottom: "Dưới giữa",
        watermarkPositionBottomTrailing: "Dưới bên phải"
    )
}
