...
extension ScreenshotFeatureStrings {
    ...
    static let he = ScreenshotFeatureStrings(
        pageTitle: "צילום מסך",
        hubDescription: "מצלם אזור, חלון או מסך ומאפשר להוסיף הערות",
        captureButton: "צלם עכשיו",
        panelCaption: "צלם אזור, חלון או את כל המסך",
        fileNamePrefix: "צילום מסך",
        hintDrag: "גרור לבחירת אזור",
        hintClick: "לחץ על חלון לצילום",
        hintFullScreen: "Return מצלם את כל המסך",
        hintCancel: "Esc מבטל",
        hintRepeat: "R חוזר על האזור האחרון",
        freezeToggle: "הקפא את המסך בזמן הבחירה",
        freezeCaption: "התמונה עוצרת בזמן שאתה בוחר אזור, כך ששום דבר לא זז או משתנה במהלך הבחירה.",
        folderLabel: "שמור ב",
        folderChoose: "בחר…",
        subfolderLabel: "תבנית תת-תיקייה",
        subfolderCaption: "אופציונלי. יוצר תת-תיקיות עם תאריך בתיקייה למעלה באמצעות %y, %year, %mo, %month, %d, %h, %mi ו-%s, למשל %y-%mo עבור 24-03.",
        fileNamePatternLabel: "שם קובץ",
        fileNamePatternCaption: "אופציונלי. מחליף את השם ברירת המחדל באמצעות אותם טוקנים %y, %year, %mo, %month, %d, %h, %mi ו-%s, בתוספת %# למספר שמתקדם אוטומטית (%## מרפד ל-2 ספרות, %### ל-3, וכן הלאה).",
        fileNumberStartLabel: "מתחיל ב",
        fileNumberResetButton: "אפס",
        fileNumberNextFormat: "הבא: %d",
        delayLabel: "השהייה",
        delayOff: "כבוי",
        delaySecondsFormat: "%d שנ׳",
        pointerToggle: "כלול את הסמן",
        downscaleToggle: "שמור בגודל 1x",
        downscaleCaption: "צילומי Retina נשמרים בחצי מגודל הפיקסלים, מה שיוצר קבצים קטנים יותר.",
        editorTitle: "צילום מסך",
        toolShortcutsTitle: "כלי עריכה",
        toolShortcutsToggle: "השתמש בקיצורי כלים",
        toolShortcutsCaption: "לחץ על קיצור כדי להקליט מקש. הספרות 1 עד 9 מזיזות את הכלי. Delete מנקה את הקיצור שלו.",
        toolShortcutReserved: "המקש הזה שייך לעורך.",
        toolSelect: "בחירה",
        toolArrow: "חץ",
        arrowStyleLabel: "סגנון חץ",
        arrowStyleFilled: "מלא",
        arrowStyleOutline: "קו מתאר",
        arrowStyleOpen: "פתוח",
        arrowStyleDoubleEnded: "דו-כיווני",
        arrowStyleScribbly: "מקושקש",
        toolLine: "קו",
        toolRect: "מלבן",
        toolEllipse: "אליפסה",
        toolFreehand: "עט",
        ...
        copyButton: "העתקה",
        saveButton: "שמירה",
        saveAsButton: "שמירה בשם…",
        pinButton: "הצמד למסך",
        copyTextButton: "העתק טקסט",
        discardTitle: "למחוק צילום זה?",
        discardMessage: "הוא טרם הועתק או נשמר.",
        discardConfirm: "מחק",
        copiedHUD: "הצילום הועתק",
        savedHUDFormat: "נשמר ב-%@",
        savedAndCopiedHUDFormat: "נשמר ב-%@ והועתק",
        defaultActionLabel: "פעולת ברירת מחדל",
        defaultActionCaption: "פועל אוטומטית מיד לאחר הצילום. האישור עדיין מופיע, כך שתוכל לערוך או למחוק אחר כך.",
        defaultActionNone: "שאל כל פעם",
        defaultActionSaveAndCopy: "שמור והעתק",
        captureFailed: "לא ניתן לצלם את המסך",
        pinOpacity: "אטימות",
        pinClickThrough: "התעלם מלחיצות",
        pinCloseAll: "סגור את כל המוצמדים",
        backdropPaddingLabel: "שוליים",
        backdropWallpaperLabel: "טפט",
        backdropImageButton: "תמונה…",
        backdropSolidLabel: "צבע אחיד",
        backdropGradientLabel: "גרדיאנט",
        backdropCornersLabel: "פינות",
        backdropSavePreset: "שמור רקע",
        backdropDeletePreset: "הסר",
        backdropCustomLabel: "מותאם אישית",
        openEditorToggle: "פתח את העורך מיד לאחר הצילום",
        openEditorCaption: "הצילום מדלג על התצוגה המקדימה הצפה ונפתח מוכן להערות.",
        autoCopyToggle: "העתק אוטומטית ללוח",
        ...
        scrollingCaptureProgressHUD: "גלול עם העכבר או משטח המגע. לחץ Enter או בחר סיום.",
        scrollingCaptureHintOff: "S מפעיל/מכבה גלילה",
        scrollingCaptureHintOn: "גלילה פועלת",
        scrollingCaptureTooLongHUD: "הצילום נעצר בגבול הבטוח",
        editLastCapture: "ערוך צילום אחרון",
        lastCaptureMissing: "צלם תמונת מסך קודם",
        fullScreenShortcutTitle: "צלם את כל המסך",
        bringForward: "הבא קדימה",
        sendBackward: "שלח אחורה",
        shareSectionTitle: "קישורים זמניים",
        shareCaption: "בחר 1, 6 או 24 שעות בשיתוף. התמונה נמחקת אוטומטית.",
        shareButton: "שתף",
        shareOneHour: "לשעה אחת",
        shareSixHours: "ל-6 שעות",
        shareTwentyFourHours: "ל-24 שעות",
        sharingHUD: "יוצר קישור…",
        sharedHUD: "הקישור הועתק",
        shareFailedHUD: "לא ניתן ליצור את הקישור",
        sharedLinksTitle: "קישורים משותפים",
        sharedLinksEmpty: "אין קישורים פעילים",
        expiresLabel: "פג תוקף",
        deleteLink: "מחק עכשיו",
        linkDeletedHUD: "הקישור נמחק",
        deleteFailedHUD: "לא ניתן למחוק את הקישור",
        openLink: "פתח",
        copyLink: "העתק קישור",
        done: "סיום",
        sharePrivacyButton: "פרטיות",
        sharePrivacyTitle: "פרטיות קישורים זמניים",
        sharePrivacyData: "Vorssaint שולח רק את התמונה המעובדת ואת זמן התפוגה שבחרת. הוא לא שולח את השם, החשבון, מזהה המכשיר או כתובת ה-MAC שלך. ב-Mac הזה, נשמרים רק הקישור, זמן התפוגה והטוקן הפרטי למחיקה כל עוד הקישור פעיל.",
        sharePrivacyStorage: "ספקי הרשת והשירות מעבדים זמנית את כתובת ה-IP הציבורית שלך למניעת שימוש לרעה. התמונה ונתוני הקישור נמחקים לצמיתות כשאתה מוחק את הקישור או כשהזמן נגמר. השירות לא יוצר גיבויים של צילומי מסך.",
        sharePrivacyAccess: "כל מי שיש לו את הקישור יכול לצפות, להוריד, לשמור או להפיץ מחדש את התמונה. קישורים פעילים זמינים למפעיל השירות לצורך ניטור שימוש לרעה. שתף רק עם אנשים שאתה סומך עליהם.",
        scrollingCaptureCaption: "בחר אזור, גלול עם העכבר או משטח המגע, ואז לחץ Enter או סיום לחיבור.",
        scrollingCaptureSelectionHint: "גרור רק את החלק של הדף שזז.",
        scrollingCapturePartialHUD: "הדף השתנה. החלק שהושלם נשמר.",
        previewPositionLabel: "מיקום תצוגה מקדימה",
        previewPositionAutomatic: "אוטומטי",
        previewPositionTopLeft: "שמאלה למעלה",
        previewPositionTopRight: "ימינה למעלה",
        previewPositionBottomLeft: "שמאלה למטה",
        previewPositionBottomRight: "ימינה למטה",
        previewFocusToggle: "העבר מיקוד לתצוגה המקדימה אוטומטית",
        previewFocusCaption: "קיצורים עובדים ברגע שהתצוגה המקדימה מופיעה, אבל המקלדת עוזבת את האפליקציה שבה עבדת עד שהיא נסגרת.",
        hideVorssaintWindowsToggle: "הסתר חלונות של Vorssaint",
        shareEnabledToggle: "אפשר קישורים זמניים",
        editClipboardImage: "ערוך תמונה מהלוח",
        clipboardImageMissing: "העתק תמונה קודם",
        showCaptureMenuOnShortcut: "הצג את תפריט הלכידה בשימוש בקיצור מקלדת",
        screenCaptureTitle: "לכידת מסך",
        dragOutHandleLabel: "גרור ושחרר",
        loupeStartsOnToggle: "התחל את הבחירה עם זכוכית מגדלת פעילה",
        loupeRememberZoomToggle: "זכור את הזום האחרון של זכוכית המגדלת",
        loupeDefaultZoomLabel: "זום ברירת מחדל של זכוכית המגדלת",
        loupeWheelZoomLabel: "זום בגלגלת",
        loupeZoomFast: "מהיר",
        loupeZoomStepped: "צעד אחר צעד",
        loupeZoomOptionCaption: "החזק ⌥ כדי להשתמש זמנית במצב השני.",
        watermarkLabel: "סימן מים",
        watermarkImageLabel: "תמונה",
        watermarkTextPlaceholder: "טקסט סימן המים",
        watermarkPositionLabel: "מיקום",
        watermarkSizeLabel: "גודל",
        watermarkOpacityLabel: "אטימות",
        watermarkRotationLabel: "סיבוב",
        watermarkSavePreset: "שמור סימן מים",
        watermarkColorRed: "אדום",
        watermarkColorOrange: "כתום",
        watermarkColorYellow: "צהוב",
        watermarkColorGreen: "ירוק",
        watermarkColorBlue: "כחול",
        watermarkColorPurple: "סגול",
        watermarkColorBlack: "שחור",
        watermarkColorWhite: "לבן",
        watermarkPositionTopLeading: "למעלה משמאל",
        watermarkPositionTop: "למעלה במרכז",
        watermarkPositionTopTrailing: "למעלה מימין",
        watermarkPositionLeading: "במרכז משמאל",
        watermarkPositionCenter: "מרכז",
        watermarkPositionTrailing: "במרכז מימין",
        watermarkPositionBottomLeading: "למטה משמאל",
        watermarkPositionBottom: "למטה במרכז",
        watermarkPositionBottomTrailing: "למטה מימין"
    )
}
