...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Use tool shortcuts",
        toolShortcutsCaption: "Click a shortcut to record a key. Digits 1–9 move the tool. Delete clears its shortcut.",
        ...
        defaultActionCaption: "Runs automatically right after capture.",
        confirmationPreviewToggle: "Show confirmation preview",
        confirmationPreviewDurationLabel: "Confirmation duration",
        confirmationPreviewUntilDismissed: "Until dismissed",
        confirmationPreviewCaption: "After a successful automatic action, keep the preview available for editing or discarding.",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Usar atalhos de ferramentas",
        toolShortcutsCaption: "Clique em um atalho para gravar uma tecla. Os números de 1 a 9 movem a ferramenta. Delete remove o atalho.",
        ...
        defaultActionCaption: "É executada automaticamente logo após a captura.",
        confirmationPreviewToggle: "Mostrar prévia de confirmação",
        confirmationPreviewDurationLabel: "Duração da confirmação",
        confirmationPreviewUntilDismissed: "Até fechar",
        confirmationPreviewCaption: "Após uma ação automática bem-sucedida, mantém a prévia disponível para editar ou descartar.",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Araç kısayollarını kullan",
        toolShortcutsCaption: "Tuş kaydetmek için bir kısayola tıklayın. 1–9 rakamları aracı taşır. Delete kısayolu temizler.",
        ...
        defaultActionCaption: "Yakalamadan hemen sonra otomatik olarak çalışır.",
        confirmationPreviewToggle: "Onay önizlemesini göster",
        confirmationPreviewDurationLabel: "Onay süresi",
        confirmationPreviewUntilDismissed: "Kapatana kadar",
        confirmationPreviewCaption: "Otomatik işlem başarıyla tamamlandıktan sonra önizlemeyi düzenleme veya silme için açık tutar.",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Использовать сочетания для инструментов",
        toolShortcutsCaption: "Нажмите на сочетание, затем на нужную клавишу. Цифры 1–9 перемещают инструмент. Delete удаляет сочетание.",
        ...
        defaultActionCaption: "Выполняется автоматически сразу после захвата.",
        confirmationPreviewToggle: "Показывать предпросмотр подтверждения",
        confirmationPreviewDurationLabel: "Длительность подтверждения",
        confirmationPreviewUntilDismissed: "До закрытия",
        confirmationPreviewCaption: "После успешного автоматического действия предпросмотр остаётся доступным для изменения или удаления.",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Usar atajos de herramientas",
        toolShortcutsCaption: "Haz clic en un atajo para grabar una tecla. Los números del 1 al 9 mueven la herramienta. Delete borra el atajo.",
        ...
        defaultActionCaption: "Se ejecuta automáticamente justo después de la captura.",
        confirmationPreviewToggle: "Mostrar vista previa de confirmación",
        confirmationPreviewDurationLabel: "Duración de la confirmación",
        confirmationPreviewUntilDismissed: "Hasta cerrarla",
        confirmationPreviewCaption: "Tras una acción automática correcta, mantiene la vista previa disponible para editar o descartar.",
    ...
    static let sk = ScreenshotFeatureStrings(
        ...
        panelCaption: "Zachyťte oblasť, okno alebo celú obrazovku",
        fileNamePrefix: "Snímka obrazovky",
        hintDrag: "Potiahnutím vyberte oblasť",
        hintClick: "Kliknutím na okno ho zachytíte",
        hintFullScreen: "Return zachytí celú obrazovku",
        hintCancel: "Esc zruší",
        hintRepeat: "R zopakuje poslednú oblasť",
        freezeToggle: "Zmraziť obrazovku počas výberu",
        freezeCaption: "Obraz sa zastaví, kým vyberáte oblasť, takže sa počas výberu nič nehýbe ani nemení.",
        folderLabel: "Uložiť do",
        folderChoose: "Vybrať…",
        subfolderLabel: "Vzor podpriečinka",
        subfolderCaption: "Voliteľné. Vytvára podpriečinky s dátumom vo vyššie uvedenom priečinku pomocou %y, %year, %mo, %month, %d, %h, %mi a %s, napríklad %y-%mo pre 24-03.",
        fileNamePatternLabel: "Názov súboru",
        fileNamePatternCaption: "Voliteľné. Nahradí predvolený názov pomocou rovnakých tokenov %y, %year, %mo, %month, %d, %h, %mi a %s, plus %# pre automaticky rastúce číslo (%## doplní na 2 číslice, %### na 3 a tak ďalej).",
        fileNumberStartLabel: "Začína na",
        fileNumberResetButton: "Obnoviť",
        fileNumberNextFormat: "Ďalšie: %d",
        delayLabel: "Oneskorenie",
        delayOff: "Vypnuté",
        delaySecondsFormat: "%d s",
        pointerToggle: "Zahrnúť kurzor",
        downscaleToggle: "Uložiť vo veľkosti 1x",
        downscaleCaption: "Snímky Retina sa uložia s polovičným počtom pixelov, čo vytvára menšie súbory.",
        editorTitle: "Snímka obrazovky",
        toolShortcutsTitle: "Nástroje editora",
        toolShortcutsToggle: "Používať skratky nástrojov",
        toolShortcutsCaption: "Kliknutím na skratku zaznamenáte klávesu. Číslice 1–9 presúvajú nástroj. Delete vymaže jej skratku.",
        toolShortcutReserved: "Táto klávesa patrí editoru.",
        toolSelect: "Vybrať",
        toolArrow: "Šípka",
        arrowStyleLabel: "Štýl šípky",
        arrowStyleFilled: "Plná",
        arrowStyleOutline: "Obrys",
        arrowStyleOpen: "Otvorená",
        arrowStyleDoubleEnded: "Obojstranná",
        arrowStyleScribbly: "Čmáraná",
        toolLine: "Čiara",
        toolRect: "Obdĺžnik",
        toolEllipse: "Elipsa",
        toolFreehand: "Pero",
        toolHighlight: "Zvýrazňovač",
        toolText: "Text",
        toolSticker: "Nálepka",
        toolCounter: "Číslo",
        toolPixelate: "Pixelizovať",
        toolRedact: "Plný blok",
        toolCrop: "Orezať",
        textPlaceholder: "Text",
        cropApply: "Orezať",
        cancel: "Zrušiť",
        ...
        pinButton: "Pripnúť na obrazovku",
        copyTextButton: "Kopírovať text",
        discardTitle: "Zahodiť túto snímku obrazovky?",
        discardMessage: "Zatiaľ nebola skopírovaná ani uložená.",
        discardConfirm: "Zahodiť",
        copiedHUD: "Snímka obrazovky skopírovaná",
        savedHUDFormat: "Uložené do %@",
        savedAndCopiedHUDFormat: "Uložené do %@ a skopírované",
        defaultActionLabel: "Predvolená akcia",
        defaultActionCaption: "Spustí sa automaticky hneď po zachytení.",
        confirmationPreviewToggle: "Zobraziť náhľad potvrdenia",
        confirmationPreviewDurationLabel: "Trvanie potvrdenia",
        confirmationPreviewUntilDismissed: "Do zatvorenia",
        confirmationPreviewCaption: "Po úspešnej automatickej akcii ponechá náhľad dostupný na úpravu alebo zahodenie.",
        defaultActionNone: "Pýtať sa vždy",
        defaultActionSaveAndCopy: "Uložiť a kopírovať",
        captureFailed: "Obrazovku sa nepodarilo zachytiť",
        pinOpacity: "Nepriehľadnosť",
        pinClickThrough: "Ignorovať kliknutia",
        pinCloseAll: "Zavrieť všetky pripnuté",
        backdropPaddingLabel: "Okraj",
        backdropWallpaperLabel: "Tapeta",
        backdropImageButton: "Obrázok…",
        backdropSolidLabel: "Plná",
        backdropGradientLabel: "Prechod",
        backdropCornersLabel: "Rohy",
        backdropSavePreset: "Uložiť pozadie",
        backdropDeletePreset: "Odstrániť",
        backdropCustomLabel: "Vlastné",
        openEditorToggle: "Otvoriť editor hneď po zachytení",
        openEditorCaption: "Zachytenie preskočí plávajúci náhľad a otvorí sa rovno pripravené na úpravy.",
        autoCopyToggle: "Automaticky kopírovať do schránky",
        autoCopyCaption: "Každé zachytenie sa hneď po vytvorení skopíruje do schránky, pripravené na prilepenie. Uloženie súboru zostáva samostatnou voľbou.",
        hintLoupe: "Z zapína a vypína lupu",
        lastRegionToggle: "Zobraziť obrys poslednej snímky",
        backdropBlurLabel: "Rozmazanie",
        scrollingCaptureButton: "Zachytenie s rolovaním",
        scrollingCaptureTitle: "Snímka obrazovky s rolovaním",
        scrollingCaptureProgressHUD: "Rolujte myšou alebo trackpadom. Stlačte Enter alebo vyberte Hotovo.",
        scrollingCaptureHintOff: "S zapína a vypína rolovanie",
        scrollingCaptureHintOn: "Rolovanie zapnuté",
        scrollingCaptureTooLongHUD: "Zachytenie sa zastavilo na bezpečnom limite",
        editLastCapture: "Upraviť poslednú snímku obrazovky",
        lastCaptureMissing: "Najprv urobte snímku obrazovky",
        fullScreenShortcutTitle: "Zachytiť celú obrazovku",
        bringForward: "Presunúť dopredu",
        sendBackward: "Presunúť dozadu",
        shareSectionTitle: "Dočasné odkazy",
        shareCaption: "Pri zdieľaní vyberte 1, 6 alebo 24 hodín. Obrázok sa automaticky vymaže.",
        shareButton: "Zdieľať",
        shareOneHour: "Na 1 hodinu",
        shareSixHours: "Na 6 hodín",
        shareTwentyFourHours: "Na 24 hodín",
        sharingHUD: "Vytváranie odkazu…",
        sharedHUD: "Odkaz skopírovaný",
        shareFailedHUD: "Odkaz sa nepodarilo vytvoriť",
        sharedLinksTitle: "Zdieľané odkazy",
        sharedLinksEmpty: "Žiadne aktívne odkazy",
        expiresLabel: "Platnosť vyprší",
        deleteLink: "Vymazať teraz",
        linkDeletedHUD: "Odkaz vymazaný",
        deleteFailedHUD: "Odkaz sa nepodarilo vymazať",
        openLink: "Otvoriť",
        copyLink: "Kopírovať odkaz",
        done: "Hotovo",
        sharePrivacyButton: "Súkromie",
        sharePrivacyTitle: "Súkromie dočasných odkazov",
        sharePrivacyData: "Vorssaint odosiela iba vykreslený obrázok a čas platnosti, ktorý zvolíte. Neodosiela vaše meno, účet, identifikátor zariadenia ani MAC adresu. Na tomto Macu uchováva iba odkaz, čas platnosti a súkromný token na vymazanie, kým je odkaz aktívny.",
        sharePrivacyStorage: "Poskytovatelia siete a služba dočasne spracúvajú vašu verejnú IP adresu, aby predišli zneužitiu. Obrázok a metadáta odkazu sa natrvalo vymažú, keď odkaz vymažete alebo keď vyprší jeho platnosť. Služba nevytvára zálohy snímok.",
        sharePrivacyAccess: "Ktokoľvek s odkazom môže obrázok zobraziť, stiahnuť, uložiť alebo ďalej šíriť. Aktívne odkazy sú dostupné prevádzkovateľovi služby na moderovanie zneužitia. Zdieľajte iba s ľuďmi, ktorým dôverujete.",
        scrollingCaptureCaption: "Vyberte oblasť, rolujte myšou alebo trackpadom a potom stlačte Enter alebo Hotovo, aby sa spojila.",
        scrollingCaptureSelectionHint: "Potiahnite iba tú časť stránky, ktorá sa posúva.",
        scrollingCapturePartialHUD: "Stránka sa zmenila. Dokončená časť bola zachovaná.",
        previewPositionLabel: "Poloha náhľadu",
        previewPositionAutomatic: "Automaticky",
        previewPositionTopLeft: "Vľavo hore",
        previewPositionTopRight: "Vpravo hore",
        previewPositionBottomLeft: "Vľavo dole",
        previewPositionBottomRight: "Vpravo dole",
        previewFocusToggle: "Automaticky zamerať náhľad",
        previewFocusCaption: "Skratky fungujú hneď, ako sa náhľad zobrazí, ale klávesnica opustí aplikáciu, ktorú ste používali, kým sa nezavrie.",
        hideVorssaintWindowsToggle: "Skryť okná Vorssaint",
        shareEnabledToggle: "Povoliť dočasné odkazy",
        editClipboardImage: "Upraviť obrázok zo schránky",
        clipboardImageMissing: "Najprv skopírujte obrázok",
        showCaptureMenuOnShortcut: "Zobraziť ponuku zachytenia pri použití klávesovej skratky",
        screenCaptureTitle: "Zachytenie obrazovky",
        dragOutHandleLabel: "Potiahnuť a pustiť",
        loupeStartsOnToggle: "Začať výber so zapnutou lupou",
        loupeRememberZoomToggle: "Zapamätať posledné priblíženie lupy",
        loupeDefaultZoomLabel: "Predvolené priblíženie lupy",
        loupeWheelZoomLabel: "Priblíženie kolieskom",
        loupeZoomFast: "Rýchle",
        loupeZoomStepped: "Postupne",
        loupeZoomOptionCaption: "Podržaním ⌥ dočasne použijete druhý režim.",
        watermarkLabel: "Vodoznak",
        watermarkImageLabel: "Obrázok",
        watermarkTextPlaceholder: "Text vodoznaku",
        watermarkPositionLabel: "Poloha",
        watermarkSizeLabel: "Veľkosť",
        watermarkOpacityLabel: "Nepriehľadnosť",
        watermarkRotationLabel: "Otočenie",
        watermarkSavePreset: "Uložiť vodoznak",
        watermarkColorRed: "Červená",
        watermarkColorOrange: "Oranžová",
        watermarkColorYellow: "Žltá",
        watermarkColorGreen: "Zelená",
        watermarkColorBlue: "Modrá",
        watermarkColorPurple: "Fialová",
        watermarkColorBlack: "Čierna",
        watermarkColorWhite: "Biela",
        watermarkPositionTopLeading: "Vľavo hore",
        watermarkPositionTop: "Hore v strede",
        watermarkPositionTopTrailing: "Vpravo hore",
        watermarkPositionLeading: "Vľavo v strede",
        watermarkPositionCenter: "V strede",
        watermarkPositionTrailing: "Vpravo v strede",
        watermarkPositionBottomLeading: "Vľavo dole",
        watermarkPositionBottom: "Dole v strede",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Werkzeugkurzbefehle verwenden",
        toolShortcutsCaption: "Zum Aufzeichnen auf einen Kurzbefehl klicken. Ziffern 1–9 verschieben das Werkzeug. Delete löscht den Kurzbefehl.",
        ...
        defaultActionCaption: "Wird direkt nach der Aufnahme automatisch ausgeführt.",
        confirmationPreviewToggle: "Bestätigungsvorschau anzeigen",
        confirmationPreviewDurationLabel: "Bestätigungsdauer",
        confirmationPreviewUntilDismissed: "Bis zum Schließen",
        confirmationPreviewCaption: "Nach einer erfolgreichen automatischen Aktion bleibt die Vorschau zum Bearbeiten oder Verwerfen verfügbar.",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Utiliser les raccourcis des outils",
        toolShortcutsCaption: "Cliquez sur un raccourci pour enregistrer une touche. Les chiffres 1 à 9 déplacent l’outil. Delete efface le raccourci.",
        ...
        defaultActionCaption: "S’exécute automatiquement juste après la capture.",
        confirmationPreviewToggle: "Afficher l’aperçu de confirmation",
        confirmationPreviewDurationLabel: "Durée de confirmation",
        confirmationPreviewUntilDismissed: "Jusqu’à la fermeture",
        confirmationPreviewCaption: "Après une action automatique réussie, garde l’aperçu disponible pour le modifier ou le supprimer.",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "Usa le scorciatoie degli strumenti",
        toolShortcutsCaption: "Fai clic su una scorciatoia per registrare un tasto. I numeri da 1 a 9 spostano lo strumento. Delete cancella la scorciatoia.",
        ...
        defaultActionCaption: "Viene eseguita automaticamente subito dopo la cattura.",
        confirmationPreviewToggle: "Mostra anteprima di conferma",
        confirmationPreviewDurationLabel: "Durata conferma",
        confirmationPreviewUntilDismissed: "Fino alla chiusura",
        confirmationPreviewCaption: "Dopo un’azione automatica riuscita, mantiene disponibile l’anteprima per modificarla o eliminarla.",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "ツールのショートカットを使う",
        toolShortcutsCaption: "ショートカットをクリックしてキーを登録します。数字1〜9でツールを移動し、Deleteでショートカットを解除します。",
        ...
        defaultActionCaption: "キャプチャ直後に自動的に実行されます。",
        confirmationPreviewToggle: "確認プレビューを表示",
        confirmationPreviewDurationLabel: "確認の表示時間",
        confirmationPreviewUntilDismissed: "閉じるまで",
        confirmationPreviewCaption: "自動アクションが成功した後も、編集や破棄のためにプレビューを表示します。",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "도구 단축키 사용",
        toolShortcutsCaption: "단축키를 클릭하여 키를 지정하세요. 숫자 1~9는 도구를 이동하고 Delete는 단축키를 지웁니다.",
        ...
        defaultActionCaption: "캡처 직후 자동으로 실행됩니다.",
        confirmationPreviewToggle: "확인 미리보기 표시",
        confirmationPreviewDurationLabel: "확인 표시 시간",
        confirmationPreviewUntilDismissed: "닫을 때까지",
        confirmationPreviewCaption: "자동 작업이 성공한 뒤에도 편집하거나 삭제할 수 있도록 미리보기를 유지합니다.",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "使用工具快捷键",
        toolShortcutsCaption: "点击快捷键以录入按键。数字 1–9 移动工具，Delete 清除快捷键。",
        ...
        defaultActionCaption: "会在截屏后自动执行。",
        confirmationPreviewToggle: "显示确认预览",
        confirmationPreviewDurationLabel: "确认显示时长",
        confirmationPreviewUntilDismissed: "直到手动关闭",
        confirmationPreviewCaption: "自动操作成功后保留预览，以便编辑或丢弃。",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        toolShortcutsToggle: "使用工具快速鍵",
        toolShortcutsCaption: "點按快速鍵以錄製按鍵。數字 1–9 可移動工具，Delete 可清除快速鍵。",
        ...
        defaultActionCaption: "會在擷取後自動執行。",
        confirmationPreviewToggle: "顯示確認預覽",
        confirmationPreviewDurationLabel: "確認顯示時間",
        confirmationPreviewUntilDismissed: "直到手動關閉",
        confirmationPreviewCaption: "自動動作成功後保留預覽，以便編輯或捨棄。",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        toolShortcutsTitle: "編輯工具",
        toolShortcutsToggle: "使用工具快速鍵",
        toolShortcutsCaption: "按一下快速鍵以錄製按鍵。數字 1–9 可移動工具，Delete 可清除快速鍵。",
        toolShortcutReserved: "此按鍵已由編輯器使用。",
        toolSelect: "選取",
        toolArrow: "箭嘴",
        ...
        savedAndCopiedHUDFormat: "已儲存到 %@ 並已拷貝",
        defaultActionLabel: "預設動作",
        defaultActionCaption: "會喺擷取之後自動執行。",
        confirmationPreviewToggle: "顯示確認預覽",
        confirmationPreviewDurationLabel: "確認顯示時間",
        confirmationPreviewUntilDismissed: "直到手動關閉",
        confirmationPreviewCaption: "自動動作成功後保留預覽，方便編輯或捨棄。",
    ...
    static let uk = ScreenshotFeatureStrings(
        ...
        panelCaption: "Захопіть область, вікно або весь екран",
        fileNamePrefix: "Знімок екрана",
        hintDrag: "Перетягніть, щоб вибрати область",
        hintClick: "Натисніть на вікно, щоб захопити його",
        hintFullScreen: "Return захоплює весь екран",
        hintCancel: "Esc скасовує",
        hintRepeat: "R повторює останню область",
        freezeToggle: "Заморозити екран під час вибору",
        freezeCaption: "Зображення зупиняється, поки ви обираєте область, щоб нічого не зрушилося та не змінилося під час вибору.",
        folderLabel: "Зберегти в",
        folderChoose: "Вибрати…",
        subfolderLabel: "Шаблон підпапки",
        subfolderCaption: "Необов’язково. Створює датовані підпапки всередині папки вище, використовуючи %y, %year, %mo, %month, %d, %h, %mi та %s, наприклад %y-%mo для 24-03.",
        fileNamePatternLabel: "Ім’я файлу",
        fileNamePatternCaption: "Необов’язково. Перевизначає типову назву, використовуючи ті самі токени %y, %year, %mo, %month, %d, %h, %mi та %s, плюс %# для автоматичного лічильника (%## доповнює до 2 цифр, %### до 3 тощо).",
        fileNumberStartLabel: "Починається з",
        fileNumberResetButton: "Скинути",
        fileNumberNextFormat: "Далі: %d",
        delayLabel: "Затримка",
        delayOff: "Вимкнено",
        delaySecondsFormat: "%d с",
        pointerToggle: "Додати вказівник",
        downscaleToggle: "Зберігати в розмірі 1x",
        downscaleCaption: "Знімки Retina зберігаються в половину піксельного розміру, що створює менші файли.",
        editorTitle: "Знімок екрана",
        toolShortcutsTitle: "Інструменти редактора",
        toolShortcutsToggle: "Використовувати скорочення інструментів",
        toolShortcutsCaption: "Натисніть скорочення, щоб записати клавішу. Цифри 1–9 переміщують інструмент. Delete очищає його скорочення.",
        toolShortcutReserved: "Ця клавіша належить редактору.",
        toolSelect: "Вибрати",
        toolArrow: "Стрілка",
        arrowStyleLabel: "Стиль стрілки",
        arrowStyleFilled: "Суцільна",
        arrowStyleOutline: "Контурна",
        arrowStyleOpen: "Відкрита",
        arrowStyleDoubleEnded: "Двостороння",
        arrowStyleScribbly: "Намальована від руки",
        toolLine: "Лінія",
        ...
        toolSticker: "Стікер",
        toolCounter: "Число",
        toolPixelate: "Пікселізація",
        toolRedact: "Суцільний блок",
        toolCrop: "Обрізати",
        textPlaceholder: "Текст",
        cropApply: "Обрізати",
        cancel: "Скасувати",
        ...
        backdropLabel: "Фон",
        backdropNone: "Немає",
        editButton: "Редагування",
        copyButton: "Скопіювати",
        saveButton: "Зберегти",
        saveAsButton: "Зберегти як…",
        pinButton: "Закріпити на екрані",
        copyTextButton: "Скопіювати текст",
        discardTitle: "Видалити цей знімок?",
        discardMessage: "Це ще не скопійовано та не збережено.",
        discardConfirm: "Видалити",
        copiedHUD: "Знімок скопійовано",
        savedHUDFormat: "Збережено в %@",
        savedAndCopiedHUDFormat: "Збережено в %@ та скопійовано",
        defaultActionLabel: "Типова дія",
        defaultActionCaption: "Запускається автоматично одразу після захоплення.",
        confirmationPreviewToggle: "Показувати попередній перегляд підтвердження",
        confirmationPreviewDurationLabel: "Тривалість підтвердження",
        confirmationPreviewUntilDismissed: "До закриття",
        confirmationPreviewCaption: "Після успішної автоматичної дії залишає попередній перегляд доступним для редагування або видалення.",
        defaultActionNone: "Запитувати щоразу",
        defaultActionSaveAndCopy: "Зберегти та скопіювати",
        captureFailed: "Не вдалося захопити екран",
        pinOpacity: "Непрозорість",
        pinClickThrough: "Ігнорувати клацання",
        pinCloseAll: "Закрити всі закріплення",
        backdropPaddingLabel: "Поле",
        backdropWallpaperLabel: "Шпалери",
        backdropImageButton: "Зображення…",
        backdropSolidLabel: "Суцільний",
        backdropGradientLabel: "Градієнт",
        backdropCornersLabel: "Кути",
        backdropSavePreset: "Зберегти фон",
        backdropDeletePreset: "Видалити",
        backdropCustomLabel: "Власний",
        openEditorToggle: "Відкрити редактор одразу після захоплення",
        openEditorCaption: "Після створення знімок оминає плаваючу мініатюру й відразу відкривається для розмітки.",
        autoCopyToggle: "Копіювати в буфер обміну автоматично",
        autoCopyCaption: "Кожен знімок потрапляє в буфер обміну щойно зроблений, готовий до вставки. Збереження файлу залишається окремим вибором.",
        hintLoupe: "Z перемикає лупу",
        lastRegionToggle: "Показувати контур останнього захоплення",
        backdropBlurLabel: "Розмиття",
        scrollingCaptureButton: "Прокручуване захоплення",
        scrollingCaptureTitle: "Прокручуваний знімок",
        scrollingCaptureProgressHUD: "Прокручуйте мишею або трекпедом. Натисніть Enter або оберіть «Готово».",
        scrollingCaptureHintOff: "S перемикає прокрутку",
        scrollingCaptureHintOn: "Прокрутка увімкнена",
        scrollingCaptureTooLongHUD: "Захоплення зупинено на безпечному ліміті",
        editLastCapture: "Редагувати останній знімок",
        lastCaptureMissing: "Спочатку зробіть знімок екрана",
        fullScreenShortcutTitle: "Захопити весь екран",
        bringForward: "На передній план",
        sendBackward: "На задній план",
        shareSectionTitle: "Тимчасові посилання",
        shareCaption: "Виберіть 1, 6 або 24 години при поширенні. Зображення видаляється автоматично.",
        shareButton: "Поділитися",
        shareOneHour: "На 1 годину",
        shareSixHours: "На 6 годин",
        shareTwentyFourHours: "На 24 години",
        sharingHUD: "Створення посилання…",
        sharedHUD: "Посилання скопійовано",
        shareFailedHUD: "Не вдалося створити посилання",
        sharedLinksTitle: "Посилання для поширення",
        sharedLinksEmpty: "Немає активних посилань",
        expiresLabel: "Дійсне до",
        deleteLink: "Видалити зараз",
        linkDeletedHUD: "Посилання видалено",
        deleteFailedHUD: "Не вдалося видалити посилання",
        openLink: "Відкрити",
        copyLink: "Скопіювати посилання",
        done: "Готово",
        sharePrivacyButton: "Приватність",
        sharePrivacyTitle: "Приватність тимчасових посилань",
        sharePrivacyData: "Vorssaint надсилає лише готове зображення та обраний термін дії. Він не надсилає ваше ім’я, обліковий запис, ідентифікатор пристрою або MAC-адресу. На цьому Mac зберігаються лише посилання, термін дії та приватний токен видалення, поки посилання активне.",
        sharePrivacyStorage: "Мережеві провайдери та сервіс нетривало обробляють вашу публічну IP-адресу для запобігання зловживанням. Зображення та метадані його посилання безповоротно видаляються, коли ви видаляєте посилання або спливає термін його дії. Сервіс не створює резервних копій знімків.",
        sharePrivacyAccess: "Будь-хто з посиланням може переглядати, завантажувати, зберігати або передавати зображення. Активні посилання доступні оператору сервісу для модерації зловживань. Діліться лише з тими, кому довіряєте.",
        scrollingCaptureCaption: "Виберіть область, прокрутіть мишею або трекпедом, потім натисніть Enter або «Готово», щоб об’єднати фрагменти в один знімок.",
        scrollingCaptureSelectionHint: "Перетягніть лише ту частину сторінки, що рухається.",
        scrollingCapturePartialHUD: "Сторінка змінилася. Завершену частину збережено.",
        previewPositionLabel: "Позиція мініатюри",
        previewPositionAutomatic: "Автоматично",
        previewPositionTopLeft: "Вгорі ліворуч",
        previewPositionTopRight: "Вгорі праворуч",
        previewPositionBottomLeft: "Внизу ліворуч",
        previewPositionBottomRight: "Внизу праворуч",
        previewFocusToggle: "Фокусувати мініатюру автоматично",
        previewFocusCaption: "Клавіатурні скорочення працюють одразу після появи мініатюри, але клавіатура залишає програму, якою ви користувалися, до її закриття.",
        hideVorssaintWindowsToggle: "Сховати вікна Vorssaint",
        shareEnabledToggle: "Дозволити тимчасові посилання",
        editClipboardImage: "Редагувати зображення з буфера",
        clipboardImageMissing: "Спочатку скопіюйте зображення",
        showCaptureMenuOnShortcut: "Показувати меню захоплення при клавіатурному скороченні",
        screenCaptureTitle: "Захоплення екрана",
        dragOutHandleLabel: "Перетягніть та відпустіть",
        loupeStartsOnToggle: "Починати вибір з увімкненою лупою",
        loupeRememberZoomToggle: "Запам’ятовувати останнє збільшення лупи",
        loupeDefaultZoomLabel: "Збільшення лупи за замовчуванням",
        loupeWheelZoomLabel: "Збільшення колесом",
        loupeZoomFast: "Швидке",
        loupeZoomStepped: "Покрокове",
        loupeZoomOptionCaption: "Утримуйте ⌥, щоб тимчасово ввімкнути інший режим.",
        watermarkLabel: "Водяний знак",
        watermarkImageLabel: "Зображення",
        watermarkTextPlaceholder: "Текст водяного знака",
        watermarkPositionLabel: "Позиція",
        watermarkSizeLabel: "Розмір",
        watermarkOpacityLabel: "Непрозорість",
        watermarkRotationLabel: "Обертання",
        watermarkSavePreset: "Зберегти водяний знак",
        watermarkColorRed: "Червоний",
        watermarkColorOrange: "Помаранчевий",
        watermarkColorYellow: "Жовтий",
        watermarkColorGreen: "Зелений",
        watermarkColorBlue: "Синій",
        watermarkColorPurple: "Фіолетовий",
        watermarkColorBlack: "Чорний",
        watermarkColorWhite: "Білий",
        watermarkPositionTopLeading: "Вгорі ліворуч",
        watermarkPositionTop: "Вгорі по центру",
        watermarkPositionTopTrailing: "Вгорі праворуч",
        watermarkPositionLeading: "По центру ліворуч",
        watermarkPositionCenter: "У центрі",
        watermarkPositionTrailing: "По центру праворуч",
        watermarkPositionBottomLeading: "Внизу ліворуч",
        watermarkPositionBottom: "Внизу по центру",
        watermarkPositionBottomTrailing: "Внизу праворуч"
    )
}
