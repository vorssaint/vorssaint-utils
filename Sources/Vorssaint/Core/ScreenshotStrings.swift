...
extension ScreenshotFeatureStrings {
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        subfolderCaption: "İsteğe bağlı. Yukarıdaki klasörün içinde %y, %year, %mo, %month, %d, %h, %mi ve %s kullanarak tarihli alt klasörler oluşturur, örneğin %y-%mo için 24-03. %app, yakalama başladığında önde olan uygulamadır.",
        fileNamePatternLabel: "Dosya adı",
        fileNamePatternCaption: "İsteğe bağlı. Varsayılan adı %y, %year, %mo, %month, %d, %h, %mi ve %s ile aynı belirteçleri, ayrıca %app ve otomatik artan bir sayı için %# kullanarak geçersiz kılar (%## 2 basamağa, %### 3 basamağa tamamlar).",
