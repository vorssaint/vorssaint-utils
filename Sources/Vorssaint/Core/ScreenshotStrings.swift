...
struct ScreenshotFeatureStrings {
    ...
    let previewEscapeCaption: String
    let previewAccessibilityButton: String
...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape closes the preview. When another app is active, Accessibility permission is required. Without it, click the preview first, then press Escape. Screenshot capture remains available.",
        previewAccessibilityButton: "Allow Accessibility for Escape",
        previewToggle: "Show screenshot preview",
        autoCopyToggle: "Copy to the clipboard automatically",
        autoCopyCaption: "Every capture goes to the clipboard as soon as it is taken, ready to paste.",
    ...
    static let ptBR = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape fecha a prévia. Quando outro app está ativo, é necessária a permissão de Acessibilidade. Sem ela, clique primeiro na prévia e pressione Escape. A captura de tela continua disponível.",
        previewAccessibilityButton: "Permitir Acessibilidade para Escape",
        previewToggle: "Mostrar prévia da captura",
        autoCopyToggle: "Copiar para a área de transferência automaticamente",
        autoCopyCaption: "Toda captura vai para a área de transferência assim que é feita, pronta para colar.",
    ...
    static let tr = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape önizlemeyi kapatır. Başka bir uygulama etkinken Erişilebilirlik izni gerekir. İzin yoksa önce önizlemeye tıklayın, ardından Escape tuşuna basın. Ekran görüntüsü almaya devam edebilirsiniz.",
        previewAccessibilityButton: "Escape için Erişilebilirliğe izin ver",
        previewToggle: "Ekran görüntüsü önizlemesini göster",
        autoCopyToggle: "Otomatik olarak panoya kopyala",
        autoCopyCaption: "Her yakalama alınır alınmaz panoya gider ve yapıştırmaya hazır olur.",
    ...
    static let ru = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape закрывает предпросмотр. Когда активно другое приложение, нужен доступ к Универсальному доступу. Без него сначала нажмите на предпросмотр, затем Escape. Снимки экрана остаются доступны.",
        previewAccessibilityButton: "Разрешить Универсальный доступ для Escape",
        previewToggle: "Показывать предпросмотр снимка",
        autoCopyToggle: "Автоматически копировать в буфер обмена",
        autoCopyCaption: "Каждый снимок попадает в буфер обмена сразу после съёмки и готов к вставке.",
    ...
    static let es = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape cierra la vista previa. Cuando otra app está activa, se necesita permiso de Accesibilidad. Sin él, haz clic primero en la vista previa y pulsa Escape. Las capturas siguen disponibles.",
        previewAccessibilityButton: "Permitir Accesibilidad para Escape",
        previewToggle: "Mostrar vista previa de capturas",
        autoCopyToggle: "Copiar al portapapeles automáticamente",
        autoCopyCaption: "Cada captura va al portapapeles en cuanto se toma, lista para pegar.",
    ...
    static let de = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape schließt die Vorschau. Wenn eine andere App aktiv ist, wird die Berechtigung für Bedienungshilfen benötigt. Klicke ohne diese zuerst auf die Vorschau und drücke dann Escape. Screenshots bleiben verfügbar.",
        previewAccessibilityButton: "Bedienungshilfen für Escape erlauben",
        previewToggle: "Screenshot-Vorschau anzeigen",
        autoCopyToggle: "Automatisch in die Zwischenablage kopieren",
        autoCopyCaption: "Jede Aufnahme landet sofort in der Zwischenablage, bereit zum Einfügen.",
    ...
    static let fr = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Échap ferme l’aperçu. Lorsqu’une autre app est active, l’autorisation Accessibilité est nécessaire. Sans elle, cliquez d’abord sur l’aperçu, puis appuyez sur Échap. La capture d’écran reste disponible.",
        previewAccessibilityButton: "Autoriser Accessibilité pour Échap",
        previewToggle: "Afficher l’aperçu de la capture",
        autoCopyToggle: "Copier automatiquement dans le presse-papiers",
        autoCopyCaption: "Chaque capture va dans le presse-papiers dès qu’elle est prise, prête à être collée.",
    ...
    static let it = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Esc chiude l’anteprima. Quando è attiva un’altra app, serve il permesso Accessibilità. Senza di esso, fai clic sull’anteprima, poi premi Esc. Le catture dello schermo restano disponibili.",
        previewAccessibilityButton: "Consenti Accessibilità per Esc",
        previewToggle: "Mostra anteprima dello screenshot",
        autoCopyToggle: "Copia automaticamente negli appunti",
        autoCopyCaption: "Ogni cattura va negli appunti appena viene fatta, pronta da incollare.",
    ...
    static let ja = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escapeキーでプレビューを閉じます。別のアプリがアクティブな場合はアクセシビリティの許可が必要です。許可がない場合は、プレビューをクリックしてからEscapeキーを押してください。スクリーンショットの撮影は引き続き利用できます。",
        previewAccessibilityButton: "Escape用のアクセシビリティを許可",
        previewToggle: "スクリーンショットのプレビューを表示",
        autoCopyToggle: "自動的にクリップボードへコピー",
        autoCopyCaption: "撮影した瞬間にクリップボードへ入り、すぐに貼り付けられます。",
    ...
    static let ko = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape로 미리보기를 닫습니다. 다른 앱이 활성화되어 있으면 손쉬운 사용 권한이 필요합니다. 권한이 없으면 미리보기를 먼저 클릭한 다음 Escape를 누르세요. 스크린샷 캡처는 계속 사용할 수 있습니다.",
        previewAccessibilityButton: "Escape용 손쉬운 사용 허용",
        previewToggle: "스크린샷 미리보기 표시",
        autoCopyToggle: "자동으로 클립보드에 복사",
        autoCopyCaption: "캡처하는 즉시 클립보드에 담겨 바로 붙여넣을 수 있습니다.",
    ...
    static let zhHans = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape 可关闭预览。其他应用处于活动状态时，需要辅助功能权限。未授权时，请先点击预览，再按 Escape。截屏功能仍可使用。",
        previewAccessibilityButton: "允许 Escape 使用辅助功能",
        previewToggle: "显示截屏预览",
        autoCopyToggle: "自动拷贝到剪贴板",
        autoCopyCaption: "每次截屏后会立即进入剪贴板，随时可以粘贴。",
        hintLoupe: "按 Z 切换放大镜",
    ...
    static let zhTW = ScreenshotFeatureStrings(
        ...
        previewEscapeCaption: "Escape 可關閉預覽。其他 App 正在使用時，需要輔助使用權限。未授權時，請先點按預覽，再按 Escape。截圖功能仍可使用。",
        previewAccessibilityButton: "允許 Escape 使用輔助使用",
        previewToggle: "顯示截圖預覽",
        autoCopyToggle: "自動拷貝到剪貼板",
        autoCopyCaption: "每次截圖後會立即進入剪貼板，隨時可以貼上。",
        hintLoupe: "按 Z 切換放大鏡",
    ...
    static let zhHK = ScreenshotFeatureStrings(
        ...
        openEditorToggle: "擷取後立即開啟編輯器",
        openEditorCaption: "截圖會略過浮動預覽，直接開啟即可開始標註。",
        previewEscapeCaption: "Escape 可關閉預覽。其他 App 正在使用時，需要輔助使用權限。未授權時，請先按一下預覽，再按 Escape。截圖功能仍可使用。",
        previewAccessibilityButton: "允許 Escape 使用輔助使用",
        previewToggle: "顯示截圖預覽",
        autoCopyToggle: "自動拷貝到剪貼板",
        autoCopyCaption: "每次截圖後會立即進入剪貼板，隨時可以貼上。",
