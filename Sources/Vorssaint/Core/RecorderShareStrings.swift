...
extension RecorderShareStrings {
    ...
    static let ar = RecorderShareStrings(
        caption: "اختر ساعة واحدة أو 6 ساعات. يُضغط الفيديو النهائي على هذا الـ Mac ليبقى دون 100 ميغابايت ثم يُحذف تلقائيًا.",
        privacyData: "يرسل Vorssaint الفيديو النهائي المُنشأ من هذا التسجيل فقط، بما فيه الصوت الذي أبقيته، ومدة الانتهاء التي تختارها. ولا يرسل اسمك أو حسابك أو معرّف جهازك.",
        privacyStorage: "يعالج مزودو الشبكة والخدمة عنوان IP العام مؤقتًا لمنع إساءة الاستخدام. يُحذف الفيديو وبيانات الرابط نهائيًا عند حذفك للرابط أو انتهاء مدته. ولا تنشئ الخدمة أي نسخ احتياطية.",
        privacyAccess: "يمكن لأي شخص لديه الرابط عرض الفيديو أو تنزيله أو حفظه أو إعادة نشره. والروابط النشطة متاحة لمشغّل الخدمة لأغراض مراقبة إساءة الاستخدام. شارِكه مع من تثق بهم فقط.",
        compressing: "جارٍ الضغط للمشاركة…",
        uploading: "جارٍ الرفع بأمان…",
        tooLarge: "لا يمكن خفض هذا التسجيل دون 100 ميغابايت من دون فقدان جودة كبيرة.",
        failed: "تعذّر إنشاء الرابط المؤقت",
        tourCaption: "اضغط تسجيلًا مكتملًا على هذا الـ Mac وشارِكه لمدة ساعة أو 6 ساعات."
    )
}
