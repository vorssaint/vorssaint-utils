...
extension RecorderShareStrings {
    ...
    static let he = RecorderShareStrings(
        caption: "בחר שעה או 6 שעות. הסרטון הסופי נדחס ב-Mac הזה לגודל של פחות מ-100 מ״ב ונמחק אוטומטית.",
        privacyData: "Vorssaint שולח רק את הסרטון הסופי שנוצר מהקלטה זו, כולל האודיו ששמרת, ואת משך הזמן שבחרת. הוא לא שולח את השם, החשבון או מזהה המכשיר שלך.",
        privacyStorage: "ספקי הרשת והשירות מעבדים זמנית את כתובת ה-IP הציבורית שלך כדי למנוע שימוש לרעה. הסרטון ונתוני הקישור נמחקים לצמיתות כשאתה מוחק את הקישור או כשהזמן נגמר. השירות לא יוצר גיבויים.",
        privacyAccess: "כל מי שיש לו את הקישור יכול לצפות, להוריד, לשמור או להפיץ מחדש את הסרטון. קישורים פעילים זמינים למפעיל השירות לצורך ניטור שימוש לרעה. שתף רק עם אנשים שאתה סומך עליהם.",
        compressing: "דוחס לשיתוף…",
        uploading: "מעלה בצורה מאובטחת…",
        tooLarge: "לא ניתן לדחוס את ההקלטה הזו לפחות מ-100 מ״ב מבלי לפגוע יותר מדי באיכות.",
        failed: "לא ניתן ליצור קישור זמני",
        tourCaption: "דחוס הקלטה שהושלמה ב-Mac הזה ושתף אותה לשעה או 6 שעות."
    )
}
