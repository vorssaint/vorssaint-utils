...
extension MediaImageConverterStrings {
    static let enUS = MediaImageConverterStrings(
        ...
        saveInSubfolder: "Save in “Converted” subfolder",
    ...
    static let ptBR = MediaImageConverterStrings(
        ...
        saveInSubfolder: "Salvar na subpasta “Converted”",
    ...
    static let tr = MediaImageConverterStrings(
        ...
        saveInSubfolder: "“Converted” alt klasörüne kaydet",
    ...
    static let ru = MediaImageConverterStrings(
        ...
        saveInSubfolder: "Сохранять в подпапку «Converted»",
    ...
    static let es = MediaImageConverterStrings(
        ...
        saveInSubfolder: "Guardar en la subcarpeta «Converted»",
    ...
    static let de = MediaImageConverterStrings(
        ...
        saveInSubfolder: "Im Unterordner „Converted“ speichern",
    ...
    static let fr = MediaImageConverterStrings(
        ...
        saveInSubfolder: "Enregistrer dans le sous-dossier «\u{00A0}Converted\u{00A0}»",
    ...
    static let it = MediaImageConverterStrings(
        ...
        saveInSubfolder: "Salva nella sottocartella “Converted”",
    ...
    static let ja = MediaImageConverterStrings(
        ...
        saveInSubfolder: "「Converted」サブフォルダに保存",
    ...
    static let ko = MediaImageConverterStrings(
        ...
        saveInSubfolder: "‘Converted’ 하위 폴더에 저장",
        moreOptions: "추가 옵션",
    ...
    static let zhHans = MediaImageConverterStrings(
        ...
        saveInSubfolder: "存储到“Converted”子文件夹",
        moreOptions: "更多选项",
    ...
    static let zhTW = MediaImageConverterStrings(
        ...
        backgroundBlack: "黑色",
        preserveDate: "保留原始修改日期",
        saveInSubfolder: "儲存到「Converted」子資料夾",
        moreOptions: "更多選項",
