...
extension SnippetFeatureStrings {
    static let ko = SnippetFeatureStrings(
        ...
        editorFormatCaption: "콜론 뒤에 형식을 적으면 원하는 모양이 됩니다. 예: {{date:yyyy-MM-dd}}. 또는 위의 날짜/시간 버튼을 사용하세요. 시간대는 {{date-tz(America/New_York):yyyy-MM-dd}}처럼 -tz(...)로 지정합니다. 확장 후 커서를 둘 위치에 {{cursor}}를 넣으세요.",
...
extension SnippetFeatureStrings {
    static let enUS = SnippetFeatureStrings(
        ...
        editorFormatCaption: "A format after a colon picks how they look, like {{date:yyyy-MM-dd}}, or use the date/time button above. A -tz(...) part sets the timezone, like {{date-tz(America/New_York):yyyy-MM-dd}}. Use {{cursor}} where the caret should go after expansion.",
    ...
    static let ptBR = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Um formato depois de dois pontos escolhe a aparência, como {{date:yyyy-MM-dd}}, ou use o botão de data/hora acima. Uma parte -tz(...) define o fuso horário, como {{date-tz(America/New_York):yyyy-MM-dd}}. Use {{cursor}} onde o cursor deve ficar após a expansão.",
    ...
    static let tr = SnippetFeatureStrings(
        ...
        editorFormatCaption: "İki noktadan sonra yazılan biçim görünümü belirler, örneğin {{date:yyyy-MM-dd}}, veya yukarıdaki tarih/saat düğmesini kullanın. -tz(...) bölümü saat dilimini belirler, örneğin {{date-tz(America/New_York):yyyy-MM-dd}}. {{cursor}} ifadesini, genişletmeden sonra imlecin kalacağı yere yazın.",
    ...
    static let ru = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Формат после двоеточия задаёт вид, например {{date:yyyy-MM-dd}}, или используйте кнопку даты и времени выше. Часть -tz(...) задаёт часовой пояс, например {{date-tz(America/New_York):yyyy-MM-dd}}. Поставьте {{cursor}} там, где должен остаться курсор после развёртывания.",
    ...
    static let es = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Un formato después de dos puntos elige la apariencia, como {{date:yyyy-MM-dd}}, o usa el botón de fecha/hora de arriba. Una parte -tz(...) define la zona horaria, como {{date-tz(America/New_York):yyyy-MM-dd}}. Usa {{cursor}} donde deba quedar el cursor después de expandir.",
    ...
    static let de = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Ein Format nach einem Doppelpunkt bestimmt das Aussehen, etwa {{date:yyyy-MM-dd}}, oder verwende die Datum/Uhrzeit-Schaltfläche oben. Ein -tz(...)-Teil legt die Zeitzone fest, etwa {{date-tz(America/New_York):yyyy-MM-dd}}. Setze {{cursor}} dorthin, wo der Cursor nach dem Ausschreiben stehen soll.",
    ...
    static let fr = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Un format après deux-points choisit l'apparence, par exemple {{date:yyyy-MM-dd}}, ou utilisez le bouton date/heure ci-dessus. Une partie -tz(...) définit le fuseau horaire, par exemple {{date-tz(America/New_York):yyyy-MM-dd}}. Placez {{cursor}} là où le curseur doit rester après le développement.",
    ...
    static let it = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Un formato dopo i due punti sceglie l'aspetto, ad esempio {{date:yyyy-MM-dd}}, oppure usa il pulsante data/ora qui sopra. Una parte -tz(...) imposta il fuso orario, ad esempio {{date-tz(America/New_York):yyyy-MM-dd}}. Usa {{cursor}} nel punto in cui deve restare il cursore dopo l'espansione.",
    ...
    static let ja = SnippetFeatureStrings(
        ...
        editorFormatCaption: "コロンの後に形式を書くと表示を選べます。例: {{date:yyyy-MM-dd}}。または上の日付/時刻ボタンを使ってください。-tz(...) で時間帯を指定できます。例: {{date-tz(America/New_York):yyyy-MM-dd}}。展開後にカーソルを置く位置に {{cursor}} を入れます。",
    ...
    static let zhHans = SnippetFeatureStrings(
        ...
        editorFormatCaption: "冒号后加上格式就能自定样式，例如 {{date:yyyy-MM-dd}}，或使用上方的日期/时间按钮。用 -tz(...) 指定时区，例如 {{date-tz(America/New_York):yyyy-MM-dd}}。在展开后光标应停留的位置输入 {{cursor}}。",
    ...
    static let zhTW = SnippetFeatureStrings(
        ...
        editorFormatCaption: "冒號後加上格式就能自訂樣式,例如 {{date:yyyy-MM-dd}},或使用上方的日期/時間按鈕。用 -tz(...) 指定時區,例如 {{date-tz(America/New_York):yyyy-MM-dd}}。在展開後游標要停留的位置輸入 {{cursor}}。",
    ...
    static let zhHK = SnippetFeatureStrings(
        ...
        editorFormatCaption: "喺冒號後加上格式就可以自訂樣式,例如 {{date:yyyy-MM-dd}},或者用返上面嘅日期/時間掣。用 -tz(...) 指定時區,例如 {{date-tz(America/New_York):yyyy-MM-dd}}。喺展開後游標要停留嘅位置輸入 {{cursor}}。",
        dateTimeInsertButton: "插入日期/時間",
        dateTimeEditButton: "編輯日期/時間",
        dateTimeTypeLabel: "類型",
        dateTimeKindDate: "日期",
