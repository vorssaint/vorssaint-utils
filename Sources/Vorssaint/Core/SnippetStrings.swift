...
extension SnippetFeatureStrings {
    static let ko = SnippetFeatureStrings(
        ...
        editorFormatCaption: "콜론 뒤에 형식을 적으면 원하는 모양이 됩니다. 예: {{date:yyyy-MM-dd}}. 또는 위의 '날짜/시간 삽입' 버튼을 사용하세요.",
...
extension SnippetFeatureStrings {
    static let enUS = SnippetFeatureStrings(
        ...
        editorFormatCaption: "A format after a colon picks how they look, like {{date:yyyy-MM-dd}}, or use the Insert date/time button above.",
    ...
    static let ptBR = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Um formato depois de dois pontos escolhe a aparência, como {{date:yyyy-MM-dd}}, ou use o botão Inserir data/hora acima.",
    ...
    static let tr = SnippetFeatureStrings(
        ...
        editorFormatCaption: "İki noktadan sonra yazılan biçim görünümü belirler, örneğin {{date:yyyy-MM-dd}}, veya yukarıdaki Tarih/saat ekle düğmesini kullanın.",
    ...
    static let ru = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Формат после двоеточия задаёт вид, например {{date:yyyy-MM-dd}}, или используйте кнопку «Вставить дату/время» выше.",
    ...
    static let es = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Un formato después de dos puntos elige la apariencia, como {{date:yyyy-MM-dd}}, o usa el botón Insertar fecha/hora de arriba.",
    ...
    static let de = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Ein Format nach einem Doppelpunkt bestimmt das Aussehen, etwa {{date:yyyy-MM-dd}}, oder verwende die Schaltfläche „Datum/Uhrzeit einfügen“ oben.",
    ...
    static let fr = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Un format après deux-points choisit l'apparence, par exemple {{date:yyyy-MM-dd}}, ou utilisez le bouton Insérer date/heure ci-dessus.",
    ...
    static let it = SnippetFeatureStrings(
        ...
        editorFormatCaption: "Un formato dopo i due punti sceglie l'aspetto, ad esempio {{date:yyyy-MM-dd}}, oppure usa il pulsante Inserisci data/ora qui sopra.",
    ...
    static let ja = SnippetFeatureStrings(
        ...
        editorFormatCaption: "コロンの後に形式を書くと表示を選べます。例: {{date:yyyy-MM-dd}}。または上の「日付/時刻を挿入」ボタンを使ってください。",
    ...
    static let zhHans = SnippetFeatureStrings(
        ...
        editorFormatCaption: "冒号后加上格式就能自定样式，例如 {{date:yyyy-MM-dd}}，或使用上方的“插入日期/时间”按钮。",
    ...
    static let zhTW = SnippetFeatureStrings(
        ...
        editorFormatCaption: "冒號後加上格式就能自訂樣式,例如 {{date:yyyy-MM-dd}},或使用上方的「插入日期/時間」按鈕。",
    ...
    static let zhHK = SnippetFeatureStrings(
        ...
        editorFormatCaption: "喺冒號後加上格式就可以自訂樣式,例如 {{date:yyyy-MM-dd}},或者用返上面嘅「插入日期/時間」掣。",
        dateTimeInsertButton: "插入日期/時間",
        dateTimeEditButton: "編輯日期/時間",
        dateTimeTypeLabel: "類型",
        dateTimeKindDate: "日期",
