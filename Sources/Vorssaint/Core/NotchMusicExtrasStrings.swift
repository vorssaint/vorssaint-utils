...
extension FeatureStrings {
    static func notchMusicExtras(_ language: AppLanguage) -> NotchMusicExtrasStrings {
        ...
        case .zhHK: return NotchMusicExtrasStrings(
            ...
            liveEqualizerHint: "監聽播放器本身的音訊輸出來驅動音柱。macOS 會請求一次系統音訊錄製權限。不會儲存或傳送任何內容。未授權時音柱保持原有動畫。",
            liveEqualizerUnavailable: "需要 macOS 14.4 或更新版本。")
        case .he: return NotchMusicExtrasStrings(
            lyrics: "מילות שיר",
            lyricsDescription: "עקוב אחרי מילות השיר הנוכחי ב-Dynamic Island.",
            enableLyrics: "הצג מילות שיר",
            online: "מצא מילות שיר ברשת",
            onlineHint: "כשמילות השיר פתוחות, שלח את שם השיר, האמן, האלבום והאורך ל-lrclib.net. מילים שיובאו נשארות ב-Mac הזה.",
            importLyrics: "ייבא מילות שיר…",
            importHint: "בחר מילים מתוזמנות להקלטה הנוכחית. הן נשמרות רק כל עוד השיר הזה פתוח.",
            loading: "טוען מילות שיר…",
            unavailable: "אין מילות שיר תואמות להקלטה הזו.",
            failed: "לא ניתן לטעון את מילות השיר.",
            retry: "נסה שוב",
            instrumental: "אינסטרומנטלי",
            waiting: "ממתין לבית הראשון",
            noPosition: "הנגן לא משתף את המיקום שלו.",
            offset: "תזמון",
            earlier: "מוקדם יותר",
            later: "מאוחר יותר",
            reset: "אפס",
            actionFailed: "הנגן לא עבר לשיר הזה.",
            playbackFailed: "לא ניתן לשנות את הניגון.",
            allowPlayback: "אפשר שליטה בניגון",
            automationPermission: "אוטומציית ניגון",
            automationExplanation: "חלק מאפליקציות המוזיקה דורשות הרשאה לפקדי הניגון שלהן. אשר את הנגן שנבחר מתוך Dynamic Island; הגישה ניתנת בנפרד לכל אפליקציה.",
            queue: "הבא בתור",
            queueDescription: "ראה את השירים הבאים בפועל, כפי שהנגן שלך משתף אותם.",
            enableQueue: "הצג את השירים הבאים",
            queueUnavailable: "הנגן הזה לא משתף את השירים הבאים שלו.",
            queueEmpty: "אין שירים בתור",
            playNow: "נגן עכשיו",
            refresh: "רענן",
            openPlayer: "פתח את הנגן",
            liveEqualizer: "הפסים עוקבים אחרי המוזיקה",
            liveEqualizerDescription: "הזז את הפסים של Dynamic Island לפי הצליל שהנגן שלך משמיע.",
            liveEqualizerHint: "מאזין לפלט השמע של הנגן עצמו כדי להזיז את הפסים. macOS מבקש פעם אחת לאשר הקלטת שמע מערכת. שום דבר לא נשמר או נשלח. בלי זה, הפסים ממשיכים בתנועה הרגילה שלהם.",
            liveEqualizerUnavailable: "דורש macOS 14.4 ואילך.")
        }
    }
}
