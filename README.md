...
Vorssaint is local-first, with no account, analytics or tracking. The network is touched only by things you can see: update checks, the speed test, Homebrew actions, optional online lyric lookup, temporary screenshot or recording links, feedback you explicitly send, and a Command Bar web search you choose. The full story is in the [privacy notes](docs/PRIVACY.md).
