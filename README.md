...
- **Dock Preview.** Hover a Dock icon to see adjustable window thumbnails with clear titles, then click one to bring its window forward or drag it to move the window.
