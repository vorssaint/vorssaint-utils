...
- **Finder shortcuts.** ⌘X and ⌘V move files, an optional F2 shortcut renames the selection, ⌦ can move it to the Trash, and copied images can become PNG files with ⌘V.
