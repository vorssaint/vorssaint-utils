...
- **Quit on close.** Quit selected apps when their last window closes. A fullscreen window closes from its red button in one click instead of first returning to its desktop.
