...
def main():
    ...
    write("NotchDestinations.swift", "import Foundation\n\nextension NotchDestinationContract {\n"
          ...
          + declaration(notch, "    private func refreshModules(")
              ...
              .replace("AppFeature.keepAwake.isAvailable", "AppFeature.keepAwake.isAvailable(in: ReviewDefaults.current)")
          ...
          + declaration(notch, "    func collapse(")
          + declaration(notch, "    func toggleSections(")
          + declaration(notch, "    func showKeepAwakeDetail(")
              .replace("AppFeature.keepAwake.isAvailable", "AppFeature.keepAwake.isAvailable(in: ReviewDefaults.current)")
          + "}\n}\n")
