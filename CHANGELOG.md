...
- App Switcher can now open on the screen with the menu bar or the screen with the active window instead of the one under the pointer. Under App Switcher, Show on.
