...
- A running timer in Dynamic Island shares the closed island with the music playing or a working agent. The track's cover or the agent's mark sits left of the camera, as a download already did, the timer stays on the right, and each side opens its own page. Thanks to Pinea for the feedback.
