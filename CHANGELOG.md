...
- Text snippets can now insert a date or time value into a replacement without knowing
  DateFormatter's pattern syntax, including an ISO 8601 shape and an arbitrary timezone.
