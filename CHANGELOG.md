...
### Summary
Dynamic Island adds configurable reopening, hidden-until-hover behavior, media drop choices and smoother tool and desktop transitions. Improvements also cover music, display fit, alerts, recording audio, image conversion and the sharpness of screenshots and recordings.
