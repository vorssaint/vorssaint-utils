...
- Dynamic Island's clipboard search takes the Up and Down arrows to highlight a result and Return to paste or copy it as a click would, instead of only moving the cursor in the search field. Thanks to Slipshady for the feedback.
