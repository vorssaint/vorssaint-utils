...
- Dynamic Island keeps the playback controls of players such as Spotify or a browser as they were when it opens, instead of showing a simpler row for a moment while it checks access to the player again. Thanks to @Yahddyyp.
